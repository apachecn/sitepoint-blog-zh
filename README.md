...
> 原文：[SitePoint Blog](https://www.sitepoint.com/blog/)
> 
...
*   在我们的 [apachecn/sitepoint-blog-zh](https://github.com/apachecn/sitepoint-blog-zh) github 上提 issue.
...
```
docker pull apachecn0/sitepoint-blog-zh
docker run -tid -p <port>:80 apachecn0/sitepoint-blog-zh
...
```
pip install sitepoint-blog-zh
sitepoint-blog-zh <port>
# 访问 http://localhost:{port} 查看文档
```
...
```
npm install -g sitepoint-blog-zh
sitepoint-blog-zh <port>
# 访问 http://localhost:{port} 查看文档
```
