...
> 原文:[https://www.sitepoint.com/backup-your-wordpress-site/](https://www.sitepoint.com/backup-your-wordpress-site/)
...
![Download the WordPress directory](../Images/df258c468bb262a40dd532b73de80ec3.png)
...
![The Export tab](../Images/992a940001343071658b0445c66e02ac.png)
...
![Export as SQL, and save as a file](../Images/c475e97f32a89018fad8cf3ed89d7a6b.png)
...
![Create a new database](../Images/7ff7329f55aca6b4b78d8d1849489b39.png)

在您创建了一个新的数据库之后，您应该能够导航到它并点击导入链接，如图[图 5 所示，“点击导入链接”](#fig_import "Figure 5. Click the Import link")。

**图 5。点击导入链接**

![Click the Import link](../Images/04b193f43dbf438d3d2127c502655463.png)

phpMyAdmin 将提示您选择您的`yourdatabasename.sql`文件。

**图 6。导入你的`.sql`文件**

![Import your .sql file](../Images/b4bbbfe7c65162809c569b1fda0d8e50.png)
...
![New Backup link](../Images/8b3a7035299211693f2bfd67247c0508.png)
...
![A list of all your tables](../Images/9e382f9131f02789476682077874113a.png)
...
![Backup options](../Images/4139ed8cac1e3e06cf9fc5ef462d90b0.png)
...
![Downloading the backup file](../Images/6febedfecb48f4d60a813c4b799b793c.png)

该插件还提供了定期安排备份的选项——每小时、每天或每周——并将备份文件通过电子邮件发送到指定的电子邮件地址，如图[图 11“安排定期备份”](#fig_schedule "Figure 11. Scheduling a regular backup")所示。

**图 11。安排定期备份**

![Scheduling a regular backup](../Images/b6e9d4d1ee7281bbd93155819ea574ba.png)
...
![Configuration options are here](../Images/743a46cb597cb452a70f0967a9854848.png)
...
![WordPress Backup Options form](../Images/c119606e067bfa89b732dcb7d38c1af7.png)
