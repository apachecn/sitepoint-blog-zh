...
> 原文:[https://www.sitepoint.com/desktop-node-apps-with-electron/](https://www.sitepoint.com/desktop-node-apps-with-electron/)
...
![Electron Binary](../Images/3d1e993068f3e07edea802852c5528a6.png)
...
![File Structure](../Images/2bcd43f13d7f02cf2c69b1b20e56cd0a.png)
...
![Launch Application](../Images/6676f97cd7eb1a6a80911b5a1af262b3.png)

## 打包应用程序

将代码打包成“本地”应用程序很简单，但需要几个部分。首先是应用程序徽章的图标。这个图标的外观和文件类型将取决于你的目标操作系统，但这里是我使用的图标，取自漫威的官方 Android 应用程序。

![App Badge](../Images/8b7ac3fa78aec73d2d215c8bf78d805c.png)
...
![App Badge](../Images/f8c88398a8f4bafa970ca432b90b0402.png)
