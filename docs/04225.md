...
> 原文：<https://www.sitepoint.com/cta-buttons-that-work/>
...
![Some sites forget to use a clear CTA ](img/96b904c43a4bb3f313302d567687f209.png)
...
![Two examples: One button says 'Download', the other says 'Get Started'.](img/04105a7bf2fecdfde55b66a0d112a43e.png)
...
![Two examples: One with a CTA that overwhelms the content](img/d33e8729e7defe266a79b1e0010d4856.png)
...
![Two attractive CTAs (one even using red well).](img/0ad95df1207b887be8a7271089ffe24e.png)
...
![There are natural, comfortable places to ask for user actions.](img/31a4ff5f928e98e275a2de099b44d27d.png)

把你的东西扔在房子周围肯定会丢东西。这就是我们为这些东西创造去处的原因，CTA 也是如此。将 CTA 放在页面的任何地方都会影响接收和检测，这是你不想错过的两件事。如果你必须搜索 CTA，那么它显然是在错误的领域。

## 务必建立连接

![Buttons need to be near the items they relate directly to.](img/0941da32c5723a45e8884566fe275d6d.png)

使用 CTA 建立连接意味着按钮的位置符合网站访问者的兴趣。这将意味着按钮的提示与附近的副本匹配或相关。你不仅创建了一个向导，而不会让访问者一头雾水，不知道下一步去哪里或如何继续，而且你还提高了点击按钮的可能性。

## 不要害怕使用几个 CTA

![Basecamp offers CTAs at a number of points in their story.](img/3f252a91799605e407f87c3f00ce8541.png)
...
![A CTA using the positive, inclusive language 'Invite Friends'](img/1fee6bfcfaf83e5258b12234b85a97c8.png)
...
![Data Story site showing a clear (though red) CTA](img/6bfb521403db6be90fe074ddaa32477b.png)
...
![A subscription box rendering on mobile.with a full screen width submit button](img/1aebd9893c07e0e0ea9e9828afe8ea91.png)

随着移动设备似乎成为上网的新方式，您需要确保您的 CTA 是移动友好的。您需要确保桌面用户看到的内容与手机或平板电脑上的用户看到的内容相同。为了抓住移动用户，体验应该尽可能的一致。

## 不要太罗嗦

![Two example with buttons: One says 'Download iTunes' , one says Download the iTunes App'.](img/540c76132c6377e266dd00d952bc1e2a.png)

你的 CTA 要像蛇一样。它应该罢工快，咬努力抓住你的访客。过于罗嗦会让访问者失去耐心，很可能会点击返回按钮或者完全忽略你的按钮。不仅如此，使用太多的词语和不能开门见山会造成混乱，再次导致按钮没有被点击。

## 一定要表明你的按钮是一个按钮

![Two examples: One shows and icon that may or may not be clickable](img/8465046e93507f26eb2961883cf626ef.png)
...
![Two examples: One showing the Amazon shopping cart rendered in red.](img/e0251009298157ab188341c221114a42.png)
...
![Two examples: One shows a button that is too small to read](img/615309cbe915698f5b5b2bb4b7960839.png)
