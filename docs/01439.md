...
> 原文:[https://www . site point . com/conditional-tags-load-styles-and-scripts-in-WordPress/](https://www.sitepoint.com/conditional-tags-load-styles-and-scripts-in-wordpress/)

![Conditional Loading of Styles and Scripts in WordPress](../Images/c7ee0668beb864279327a7fdcd2cb7a3.png)
...
*   点击页面进入您网站上所有页面的列表
    ...
    ![Pages menu in WordPress Admin panel](../Images/b543fb3d35febbd162d236dbaf3b58d4.png)
*   点击您感兴趣的页面标题，在编辑器
    ![Select the page whose ID you want to know from the list of all the pages in the Admin panel of your WordPress install.](../Images/754bd529f9b93ded4407e127dc5b293d.png)中打开它
*   现在页面已经在编辑器中打开，请查看浏览器地址栏中的 URL。您应该会看到类似于`post=`加上一个数字的内容。那个号码就是页面 ID:

    ![WordPress page id in browser's address bar.](../Images/5184f7116feb751310d250ee65304a90.png)
