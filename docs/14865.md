...
> 原文:[https://www.sitepoint.com/design-introduction-tables-2/](https://www.sitepoint.com/design-introduction-tables-2/)
...
<q>*“这是一个反馈回路，在一定程度上。如果我们想让人们编写 HTML 4 兼容的页面，就必须支持完整的 HTML 4 规范，并且公开支持。”—乔·克拉克*T3】</q>
