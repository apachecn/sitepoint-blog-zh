...
> 原文:[https://www . site point . com/create-a-github-tracker-with-push-notifications-in-svelte/](https://www.sitepoint.com/create-a-github-tracker-with-push-notifications-in-svelte/)
...
![The new tracker component](../Images/752ae3b29abd8bc94f33eddbfe075b6a.png)
...
![Creating a new Atlas user](../Images/47d1b9ea05b938d82077047304f2bcf8.png)

要连接到数据库，您需要连接字符串。将新的用户和密码保存在某个地方，然后进入集群概述。点击右侧的**连接**按钮，选择**连接您的应用**作为连接方式。您应该会看到类似下面的连接字符串。

![Connection string](../Images/44169a86d250e08562e09cf97abd40d0.png)
...
![The users collection in Atlas](../Images/dbc29ea9f1d3e23f1e249c13c8c423e0.png)
...
![Tracked repositories are accurate now](../Images/d3fdd83fecd0d7ffb10870172f2866c7.png)
...
![Screenshot of the application tab](../Images/6d1193f48cc0d3efb0cf3ba9c8410c78.png)
...
![Screenshot of the installed app](../Images/752ae3b29abd8bc94f33eddbfe075b6a.png)
...
![Vercel environment variables](../Images/8a18e51aaf78000fa2433b4673082526.png)
...
![Push Notification Subscription logged in the console](../Images/bdce804e42b28db685d18b73a04eefff.png)
...
![The notification](../Images/ccdd72ad7c7926e19e3631ad1221a648.png)
...
![Notification prompt](../Images/d61968afc89f3783f9b22b270e2258fc.png)
...
![Creating a new CRON job](../Images/74bdf2ac4ba54efe80f50650c55554e4.png)
