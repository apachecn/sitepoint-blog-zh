...
> 原文:[https://www.sitepoint.com/build-auto-expanding-textarea-1/](https://www.sitepoint.com/build-auto-expanding-textarea-1/)

![Auto-Expanding Textarea](../Images/e7bf96eadcccf9d19a99c3ed1c5bac5a.png)自动扩展`textarea`元素在脸书等网站上很流行。根据用户输入的文本数量，`textarea`框的高度会伸缩。有几个优点:
