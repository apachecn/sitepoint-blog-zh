...
> 原文:[https://www . site point . com/how-to-create-a-pokemon-spawn-locations-recorder-with-couch db/](https://www.sitepoint.com/how-to-create-a-pokemon-spawn-locations-recorder-with-couchdb/)
...
![pokespawn screen](../Images/106bf3cc7d3f474fd952c4c10f6d5eb6.png)
...
![create new view](../Images/1a41ca9086154be446bd07fa8bdbdbbc.png)

完成后，点击**另存为**按钮，添加`pokemon`作为设计文档的名称，添加`by_name`作为视图名称。按下**保存**保存视图。稍后，您将使用该视图根据用户输入的内容来建议口袋妖怪的名称。

![save view](../Images/25ecba2d6db72e17ca40e29d8d2c59bc.png)
...
![block anonymous writes](../Images/985eaf73d423b4d6abe382931a2854ce.png)
