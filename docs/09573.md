...
> 原文:[https://www . site point . com/10-jquery-plugins-improve-html-forms/](https://www.sitepoint.com/10-jquery-plugins-improve-html-forms/)
...
![Turn-any-webform-into-a-powerful-wizard-with-jQuery-FormToWizard-plugin.jpg](../Images/53dcc332d7010385edfa20774b2f3ef1.png)
...
![BabySteps1.jpg](../Images/52c40af9d85a2f218c40934a3c8bb3dd.png)
[来源](http://plugins.jquery.com/project/babysteps)

## 3.jQuery 的文件样式插件

文件样式插件使您能够将图像用作浏览按钮。您也可以使用 CSS 将 filename 字段的样式设置为普通的 textfield。
![File-Style-Plugin-for-jQuery1.jpg](../Images/bb3be025a920d0a0b7135d83a57d10ad.png)
...
![How-to-create-Skype-like-buttons-using-jQuery.jpg](../Images/b9ba9131c2cafd28ad0fa11ba67ccf2d.png)
...
![jQuery-Impromptu.jpg](../Images/1ed859fae953a064912e5de4361cdc35.png)
[来源](http://trentrichardson.com/Impromptu/index.php)

## 6.高光

通过在与页面交互时突出显示元素来提高可用性。它主要用于表单，但也可用于表格、列表或您指定的任何元素。
![Highlight.jpg](../Images/390efce18ca186c265fe90acb03f6bc0.png)

## 7.地理观测员检查

一种用户友好的方式来显示复选框。
![Geogoer-VChecks1.jpg](../Images/6b4adc3757d1e3f8593ffd3431c1c2be.png)
...
![Make-image-buttons-a-part-of-input-fields.jpg](../Images/4d40036e2d669d7bd736cebffb7c36b3.png)
...
![clearField1.jpg](../Images/ae6317c5d6e3c9c3afac3cb8f0c96f92.png)
[来源](http://plugins.jquery.com/project/clearField)

## 10.麦克德罗普顿

允许用户从复杂的分层选项树中进行选择。
![mcDropdown.jpg](../Images/d245168a71fb024e028235d650c7940c.png)
