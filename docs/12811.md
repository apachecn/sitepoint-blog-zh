...
> 原文:[https://www.sitepoint.com/beautiful-web-site-archives/](https://www.sitepoint.com/beautiful-web-site-archives/)
...
![New Concept web page](../Images/54f3936bda4e665033d5171a91077ed8.png)

在本例中，归档列表显示在第二列，即页面右侧的两个侧栏之一。

![New Concept's sidebar](../Images/2986f8bc1c02dc7b152359a9147f4b3f.png)

这个档案列表从类别开始，然后有两个链接指向一个完整的档案和一个类别档案，后面是最近的评论。它有一个非常块状的处理，但它很好地与网站设计。

这里是 [Viget 实验室激发](http://www.viget.com/inspire)

![Viget Labs' Inspire page](../Images/1d140b611e65ddb386de78ffcc8525c7.png)

这个侧边栏中的存档处理，显示了最近的评论和最近的条目，虽然很少但很优雅。间距和排版工作得很好，使这个例子非常有吸引力。

![Viget Labs Inspire sidebar](../Images/85d8c92f81cfbce6eb814dbbff984b97.png)
...
![The Statement web page](../Images/7ec1f267f6008d502c83c6155a35944a.png)

该语句为其归档列表使用了一个加粗的侧边栏，感觉很立体，尽管它只是一个带有规则的实心条纹。

![The Statement's sidebar](../Images/173cb9e098fcd70da433172d743051b0.png)
...
![Viget Extend web page](../Images/9a03f7b6e2e380e4ef2396de7edc4e79.png)

这是日历的特写。

![viget Extend's calendar sidebar](../Images/29bf669836574a9edd7d3295504756bf.png)

上面日历中的块状日期样式是一个不错的选择。有帖子的日子更突出，您可以使用日历顶部列出的月份和年份的左右分页来查看上个月和下个月。

看一看瑞秋的《Intensify.org》

![Intensify web page](../Images/8aba0bde7eff852efaafd83a7e2e26b4.png)

这个网站还在侧边栏中使用了一个日历，除了一个索引链接和一个 RSS feed 链接图标之外，没有什么其他的。

![Intensify's calendar sidebar](../Images/5534ba32eb4330a6ea1a9d64634cfc8a.png)
...
![Coda web page](../Images/3194ebda14fbb2dcf002f815e01415dc.png)

该网站的侧边栏处理使用标签云来显示帖子被标记的关键词的受欢迎程度。它还列出了最近的评论和最受欢迎的帖子，在一个简单但风格优美的列表中。

![Coda's sidebar](../Images/983749806b52080f959b89afe99f5172.png)
...
![Jeff Croft's web page](../Images/1137ce327b16778d27f6309f0dba374c.png)

Jeff 的网站非常简洁，但使用了一些非常好的细节，从圆角和阴影到令人难以置信的条形图。

![Jeff Croft's sidebar](../Images/2414a09895cf01f5af12236b8007da2a.png)
...
![Alex Buga's web page](../Images/06fed40914b038dcccd86939817d74a7.png)

这个侧边栏中的存档处理，显示了最近的评论和最近的条目，虽然很少但很优雅。间距和字体设计使得这个例子非常吸引人。

![Alex Buga's sidebar](../Images/8afe5e2ffb91da1505096ff29f7056f7.png)

侧边栏中的最近文章模块非常漂亮，有扩展和收缩功能来显示或隐藏内容。虽然不幸的包装问题是不雅观的，其他一切看起来真的很紧。

这里有另一种方法:[达伦·霍伊特网站](http://www.darrenhoyt.com/)

![Darren Hoyt Dot Com web page](../Images/94a805f4997690d7c7d1c95d96e64f94.png)

本网站侧边栏中的存档列表避免了过度设计，并且非常简洁。

![Darren Hoyt Dot Com's sidebar](../Images/0bd07f08082051d7e4cab59b0a5ff38d.png)

清单的样式很好，我喜欢它的颜色。一个批评是，这个列表看起来与它所属的交互标题非常分离，并且有一些间距问题。

然后是[科莫多传媒](http://www.komodomedia.com/blog/)。

![Komodo Media web page](../Images/22d818ee1fe33bae25ac43bfe7e3e592.png)

这个侧边栏使用标签切换风格的存档列表，显示不同的存档列表视图，并有助于保持侧边栏在所有视图中的整洁。

![Komodo Media's sidebar](../Images/8fcd1053be9c7251f4034dcdc37e4099.png)
...
![Viget Labs Inspire web page](../Images/27b256ce85d62f3ebac2ffdffd1cc783.png)

这个网站的页脚处是一个大而暗的区域，主要用于存档。类别列表与内容区域的宽度相同，而月度存档与侧边栏区域的宽度相同。

![Viget Labs Inspire's footer](../Images/0eab73e149f8d09cb939bf0fe37326bd.png)

这些档案列表中使用的排版非常华丽，并强调了良好的规则和简单而优雅的图形处理。

接下来，[设计新闻](http://www.designingthenews.com/archive/)。

![Designing the News web page](../Images/42d415225c38c5c724f9ab16752f0f1d.png)

设计新闻也使用页面底部的黑色空间来显示补充信息。

![Designing the News's footer](../Images/0b31a70f7ee10e13fd80b4cbdd6a3654.png)

这里的存档处理非常简单:只是一个流行标签和最新实验的列表。

Nimbupani Designs 有一个有趣而有效的解决方案。

![Nimbupani Designs web page](../Images/3394ec49af37bfdf8faa96148bac7fc7.png)

不能错过此页脚部分中的存档列表；亮黄色让人难以忽视！

![Nimbupani Designs's footer](../Images/d81f4bddb990908f2c9df1dda7702887.png)
...
![Komodo Media web page](../Images/568cdbaa063d3887bbcf77bfedfaf755.png)

Komodo 在内容区的底部使用了一个非常好看的日历；这就是我所说的“伪页脚”，因为它更像是帖子区的底部，而不是网站的底部。

![Komodo Media's ](../Images/2eb5ea9c8416643c305bbf07b2b4804c.png)
...
![Bottom section of Intensify web page](../Images/72b14564824d1d2c1dd38372e1d639d4.png)

![Intensify's movie review section](../Images/b5e75ec8b614b7de785eaef5315ed121.png)
...
![Fling Media web page](../Images/ee53596f61264c9ede28ba3b5bef369c.png)

Fling Media 在页面底部使用了一个“swisher”或“slider”(无论你怎么称呼它)。

![Fling Media's ](../Images/bb09c99ad0cff65b2bdd2b3fe7918715.png)
...
![Jason Santa Maria's archive page](../Images/ae4686651253c00c0a5585f1e34b533e.png)
...
![Boagworld archive page](../Images/e8ff64da67048986471592aaf6aa3fe6.png)
...
![Orderedlist archive page](../Images/26f3de2b40b6e00c7a8bfa017b5eeab1.png)

还有一个过滤搜索栏，使用类似“实时搜索”的效果，可以与 Mac OS X 的 Spotlight 搜索相提并论。

[设计新闻](http://www.designingthenews.com/archive/)使用一个简单的存档页面，按月份和类别存档。

![Designing the News archive page](../Images/31f159f0574ee305cf287d5fb93962cd.png)

虽然我确实觉得这一页可以推得更远一点，但我喜欢存档与搜索的结合。

这是杰夫·克罗夫特的网站。

![Jeff Croft's archive page](../Images/7221b3fb71703a79bd9eaeefcfba580c.png)

Jeff 在侧边栏实现中使用的条形图样式再次在他的标记归档页面上使用——这是一种直观显示受欢迎程度的令人耳目一新的方式。

还有另一个来自[的出场声明](http://theoldstate.com/blog/?local=archive)！

![The Statement archive page](../Images/e802cfc91252260fbc1a14dac6ef46ae.png)

该声明在其存档页面上再次使用了前面提到的侧边栏处理，但也提供了一个时尚、有吸引力的存档页面。

老实说，我不认为我需要说太多关于 AvalonStar 的事情

![Avalon Star's archive page](../Images/7c27287ed1cac4546dc877584a1da6b0.png)
