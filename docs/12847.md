...
> 原文:[https://www.sitepoint.com/voting-widget-flex-3-part-1/](https://www.sitepoint.com/voting-widget-flex-3-part-1/)
...
![Where Flash applications fit into the client landscape](../Images/9cedec3856c5137198d93831a1d9899b.png)
...
![How Flex Builder works](../Images/5869e983d5d9761f060cb94735bad3c4.png)
...
![The starting point with Flex Builder 3](../Images/6df7e21741acc9fac5a837e9ecff30b3.png)

这是空的 Flex IDE。下一步是创建我们的第一个 Flex 项目。从 New 菜单中选择 Flex Project，您应该会看到这个窗口。

![Creating your first project](../Images/73966a115b274ebcd49e13fc416e1d26.png)

您可以随意命名您的项目。我选择了`Voteview`，因为出于本文的目的，我将只构建一个查看当前投票总数的应用程序。我们将在下一篇文章中发现交互式小部件。

在您点击 Finish 来构建项目之后，您应该会看到下图所示的结果。

![The auto-generated application](../Images/eefc3d4f2f2cfcc8335fcafc7e874285.png)
...
![Just checking to make sure everything works](../Images/153825f3729dd5dc16ee1654d279ecf5.png)
...
![A grid presentation of the data](../Images/fedb8dd6f093acd1b22354c4c7692010.png)
...
![A pie chart that displays the data](../Images/8b21fe34627f98a294c81db33a3985ae.png)
...
![A cool 3D pie chart of the vote results using Elixir](../Images/88ac5f84acfb80ddcc034918930f7979.png)
...
![The AMF data service viewed in the AMFPHP browser](../Images/cc2e92d894ed3caadc4175f2107a7409.png)

接下来，点击`votes/VoteService`并点击呼叫按钮。这将导致 AMF 浏览器调用服务并显示结果，如下所示。

![The AMF browser showing the vote service result](../Images/3e5636a81d38bf26654844ecd53adc39.png)
...
**[参加小测验！](https://www.sitepoint.com/quiz/flex3/part1)T3】**
