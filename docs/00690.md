...
> 原文:[https://www . site point . com/how-to-use-typescript-to-build-a-node-API-with-express/](https://www.sitepoint.com/how-to-use-typescript-to-build-a-node-api-with-express/)
...
![Guitar Inventory Demo](../Images/e16ba4711d213d78ce5e60f5721af49f.png)
...
![Hello World](../Images/7e2500114ecbc15bfaedff3e5c6301cf.png)
...
![Guitar Inventory home page](../Images/87b110d17ccc4555a470a42da3070185.png)
...
![Sign up for free account](../Images/d3f764d9fa2befa262337a42b16b82e6.png)

创建您的帐户后，点击顶部的**应用**链接，然后点击**添加应用**。

![Create application](../Images/d608610f1164949d446ba01332b08bba.png)

接下来，选择一个**网络应用**，点击**下一步**。

![Create a web application](../Images/1c7264962e2476f3c355ea028b586010.png)

输入应用程序的名称，例如*吉他库存*。验证端口号是否与为本地 web 应用程序配置的端口号相同。然后，点击 **Done** 完成应用程序的创建。

![Application settings](../Images/cc42fbd946faeb29a27dc83694f1bccb.png)
...
![Client credentials](../Images/d7a36b078a66b18ec9cada23343d2294.png)

### 启用自助注册

Okta 的一个很棒的特性是允许应用程序的用户注册一个帐户。默认情况下，此功能是禁用的，但您可以轻松地启用它。首先，点击**用户**菜单，选择**注册**。

![User registration](../Images/087610e8cae2cd6fe1dc070c845b5927.png)

1.  点击**编辑**按钮。
2.  将**自助登记**改为*启用*。
3.  点击表格底部的**保存**按钮。

![Enable self-registration](../Images/80b6c55c092b18f21fcd7cb6347bf8f9.png)
...
![Okta login](../Images/161f44e83f4baa9e9428d95ea5951caf.png)
...
![Navigation](../Images/60df2cfa0ae6188485a887bd72272d06.png)
...
![Guitar Inventory](../Images/179fb2c622a2174064dd074cc7bf65b6.png)
