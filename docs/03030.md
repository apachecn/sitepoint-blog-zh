...
> 原文:[https://www . site point . com/moving-modulated-promises-via-geolocation/](https://www.sitepoint.com/moving-modularized-promises-via-geolocation/)
...
![Lemon-Aide application](../Images/d764468ea1a1f788c95d2548dc8e8e17.png)
...
*地理定位的开端… [地理定位演示](https://github.com/DevelopIntelligenceBoulder/promise/blob/master/demos/geolocation.js)T3】*

![Geolocation demo](../Images/c513d24d3b92eea3d9391ae54549e61d.png)
...
![Geolocation demo successful interaction](../Images/63133eec2fdc95700acfdf627cf050bc.png)

注意@ line 10 的`resolveLocation`回调函数被浏览器赋予了一个位置对象。这个位置对象包含所需的纬度和经度属性。它们是从`position.coords`对象中访问的。

*Aw，拒绝… [地理定位演示](https://github.com/DevelopIntelligenceBoulder/promise/blob/master/demos/geolocation.js)T3】*

![Geolocation demo rejection](../Images/3f55698cd0aada6800b04d18a10beb2e.png)
...
*模块进行封装&复用……[展示模块模式演示](https://github.com/DevelopIntelligenceBoulder/promise/blob/master/demos/revealing-module-pattern.js)T3】*

![Revealing module pattern demo](../Images/ef5bf559407c26764b179e8e6278bb75.png)
...
![Interacting with external module](../Images/fd9fb31927d107c29b398a5380f6f4e6.png)
...
*模块化地理定位… [定位模块演示](https://github.com/DevelopIntelligenceBoulder/promise/blob/master/demos/location-module.js)T3】*

![Location module demo](../Images/a540d6d9cf38415921ea4d1a5066cb8b.png)
...
![Callback calling code example](../Images/ab361ca161533ecef8081c1e95ca5af8.png)
...
![Callback calling code example](../Images/115876aa3e7c751824d1f379eb6321bf.png)
...
![Messaging calling code example](../Images/d7ee9cdca271f33da69dbced6d48acc1.png)
...
![Messaging module code example](../Images/b1966551a22378acfa5c39a8127a77c2.png)

![Messaging module code example](../Images/ff0415c11c8b617a35b438ded7ed57d2.png)
...
![Messaging module code example](../Images/4da76ac14309755aea41ec88c4f86e63.png)
...
![Promise calling code example](../Images/53a2efc71d410aadaaba12b8e61cb2a1.png)
...
![Promise module code example](../Images/bd5a671b970456f34a4f01da5aab0a73.png)
...
*见承诺在行动@[http://promise-blog.azurewebsites.net/promise-es6/](http://promise-blog.azurewebsites.net/promise-es6/)T3】*

![ES6 Promise Architecture](../Images/9d87542b47c98c4553fce2ab55f3df0a.png)
