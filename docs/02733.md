...
> 原文:[https://www . site point . com/embedding-virtual-reality-cross-the-web-with-VR-views/](https://www.sitepoint.com/embedding-virtual-reality-across-the-web-with-vr-views/)
...
![A rather absurd squished floor](../Images/9e00a7d1de7122a1f0cbe11a08737e06.png)
...
![Three panoramic images copied over](../Images/6b4acc52a0f7813568c9cd40982a6ce2.png)

拉伸所有三个，使其充满画布，然后使用*编辑>变换>垂直翻转*翻转顶部和底部的图像:

![Flipping the top and bottom images](../Images/64874fff731ad889d86a6536f7ce1793.png)

应该是这样的:

![With images flipped](../Images/ece75bc657299925c715aa8c8dbd41e0.png)

复制顶部和底部的图像，然后使用*滤镜>模糊>高斯模糊*模糊副本:

![Go to Filter > Blur > Gaussian Blur](../Images/bb49ced738c214908bdeecc8adbce274.png)

尝试不同的半径值，因为有些场景模糊程度越高效果越好，反之亦然:

![Changing the radius values](../Images/ab1b826f52dd36b19fb597e5c03a3450.png)

拉伸每个模糊层，使它们延伸到图像之外(因为边缘会淡出，我们不希望它们在画布边缘淡出):

![Stretching the bottom blurred layer to the bottom of the canvas](../Images/003dd245b17608fecec4944541f002ca.png)

我们图像的最终结果应该是这样的:

![Our final image nicely put together](../Images/53cecbf99fd28709c34d69a87d4dc3fc.png)
...
![Forking the GitHub repo](../Images/618a79e6a4b1e6f564533dc2940b323c.png)

然后，在回购的分支中，找到 CNAME 文件并单击它:

![Finding the CNAME file](../Images/26734a90fca9d5da35eb5052c6651cbc.png)
...
![Deleting or renaming that CNAME file](../Images/7d76a7c4fd3103c6a33e4da0b5fbf2f9.png)

提交变更:

![Committing updates](../Images/c06db10b3de7a09ed20b297761bdb9bb.png)

最后，在 VR 视图的分叉版本中创建一个新的分支，并将其命名为*“GH-pages”*。该分支中的所有内容都可以在您的 GitHub 页面上访问到:

![Branching into gh-pages](../Images/131dceb0616f7355065967c11985432f.png)
