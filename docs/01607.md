...
> 原文:[https://www . site point . com/how-can-I-use-laravel-envoy-or-deployer-with-semaphoreci/](https://www.sitepoint.com/how-can-i-use-laravel-envoy-or-deployer-with-semaphoreci/)
...
![Combination of SemaphoreCI and Deployer logos](../Images/34bd79c384c875bbeff7d7f48dafb39b.png)
...
![Project Page](../Images/773078089c6065c5497cc62921ff7816.png)

接下来，我们选择通用部署选项，以便 SemaphoreCI 让我们可以自由地添加手动配置。

![Generic Deployment](../Images/26eabd912d564b77615b3216269eebd5.png)

![Deployment Strategy](../Images/4cc7116e3b4e579a00cfe4993234cede.png)

选择自动部署后，SemaphoreCI 将为我们提供指定部署命令的能力。手动和自动的区别在于，自动部署是在每次成功的测试之后触发的，而手动将允许我们部署任何成功的提交。

![Deployment Commands](../Images/e2761be582a0fa75c331ac910af6b0d3.png)
...
![Deployment Key](../Images/8ae18a4b03386c85ce8e0eb239a791c3.png)
...
![Successful Deployment](../Images/618b325df1f05c577130ac6c89e730a7.png)

如果出现问题，我们可以单击失败的部署过程并查看日志来进一步调查问题。

![Failed Deployment](../Images/09be5313226bda480cc471eb3c355755.png)

上面的截图是一个失败的提交，原因是因为没有启用`mcrypt`扩展，所以`php artisan clear-compiled`命令返回了一个错误。

**注意**:semaphore ci 提供的另一个巧妙的技巧是连接到构建服务器来查看哪里出错了。

![Build Server SSH](../Images/07195aacd3a9685f49c897e16523e7e8.png)
