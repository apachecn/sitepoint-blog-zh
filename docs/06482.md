...
> 原文:[https://www . site point . com/getting-started-Android-library-projects-part-3/](https://www.sitepoint.com/getting-started-android-library-projects-part-3/)
...
![Viewing the options menu under Android 2.3.3.](../Images/e449b6286def46f0bf4364d5a5a74d24.png)

**图 1:** 查看 Android 2.3.3 下的选项菜单。

按 Info 菜单项，您应该看到图 2 的 about 对话框。

![Scroll the dialog box to observe more of the about text. Pressing the email link results in an 'Unsupported Action' dialog.](../Images/469f8afa2344275f503007214eda5838.png)
...
![Viewing the options menu under Android 4.1.](../Images/7df422b091163f0f693c512fab443e18.png)

**图 3:** 查看 Android 4.1 下的选项菜单。

按 Info 菜单项，您应该看到图 4 的 about 对话框。

![Scroll the dialog box to observe more of the about text. Pressing the email link results in an 'Unsupported Action' dialog.](../Images/38670f0ae368abfb3a5253f75471b4d8.png)
