...
> 原文:[https://www.sitepoint.com/wsl2/](https://www.sitepoint.com/wsl2/)
...
![Windows specifications](../Images/471c853b1437072ae7ca196abc915001.png)
...
![Control Panel power options](../Images/4b3ecb958a8bdab765ae7901aa28fecf.png)
...
![Windows Terminal](../Images/8171f8e9bb4a3cf2b0408a39dab909c0.png)
...
![enable WSL2](../Images/adb7dcf67de221f3d384f2df0b214ed6.png)
...
![list Linux distros](../Images/fc899a09020ed96b41fc562c790fa06b.png)
...
![Microsoft Store](../Images/f51b2468299814f712a8085b09ae5ae8.png)
...
![map Linux drive](../Images/a86a3c0dc7e9dc74293b51bf9167b435.png)
...
![Docker WSL2 engine](../Images/9f92f9879e793423a634218f6fab55e6.png)
...
![VS Code default terminal shell](../Images/5de6675bae0533595ebd2a6b58c34dbb.png)
...
![VS Code remote window icon](../Images/76fb5fb309891657c061eef81a3d9d6c.png)

或者使用活动栏中新的**远程浏览器**图标。这允许您从下拉列表中选择一个目标类型，并相应地进行连接。

![VS Code Remote Explorer](../Images/6a1a5c6a83184a930f93e1e8d7c28805.png)

VS 代码的远程实例有一组单独的扩展和设置供 Linux 使用，但是有些可以全局启用。**扩展**面板允许您在远程实例中启用和配置扩展。

![VS Code extensions](../Images/3b31495ff9ab50e12cd4ddaec2e0cddb.png)
...
*   [*PHP & MySQL:新手到忍者*T3】](https://www.sitepoint.com/premium/books/php-mysql-novice-to-ninja-7th-edition/)
