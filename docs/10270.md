...
> 原文:[https://www.sitepoint.com/lock-freeze-web-page-jquery/](https://www.sitepoint.com/lock-freeze-web-page-jquery/)

本教程向您展示了如何为您的 web 页面设置一个 jQuery 定时器，以便在指定的时间长度内锁定界面。

![webpage-timer-buttons](../Images/8975d274616e8c7d64a8534ce92e7570.png "webpage-timer-buttons")

![webpage-timer-show](../Images/3d59f6d23c20cc881ece4cff2ddc6354.png "webpage-timer-show")
