...
> 原文:[https://www . site point . com/10-slider-based-WordPress-plugins/](https://www.sitepoint.com/10-slider-based-wordpress-plugins/)
...
![Dynamic-Content-Gallery1.jpg](../Images/d789406d648956d32a45aede4ba45b33.png)
...
![Lazyest-Stack.jpg](../Images/807d3ccb76788083dc4bba923e9d0b62.png)
...
![CUBE3D-images-gallery-menu-slider1.jpg](../Images/73c7788d37419e8a97fcdca855b76553.png)
...
![iSlidex1.jpg](../Images/6bb66bbc3bcd31a7fb835c498edf081e.png)
[来源](http://www.shambix.com/en/news/wordpress-plugin-islidex/)

## 5.WordPress 文章/页面的标签/滑块

标签和幻灯片(在文章/页面中)插件使您能够轻松地添加内容标签和/或内容幻灯片。
![TabSliders-for-WordPress-postspages.jpg](../Images/9cba65d2e8ebe00195bcd5f7a2a79541.png)

## 6.jQuery 可访问滑块

滑块控制你的博客最近文章的数量，并使用 jQuery WAI-ARIA 支持的手风琴和滑块。
![jQuery-Accessible-Slider1.jpg](../Images/401b7a57e955760e8c3aed213b73f4e5.png)
...
![Rekt-Slideshow.jpg](../Images/80dec9c5987fb6b22c9e36ed2bbce118.png)
[来源](http://www.rektproductions.com/rektslideshow/)

## 8.特色文章精简版

将特色帖子或页面放入一个别致的 JavaScript 滑块中，该滑块可以设置为显示在任何类别页面、页面或主页上。
![Featured-Articles-Lite.jpg](../Images/1b2118e528dabe9cd6c850d16cea3322.png)

## 9.流星滑道

使用简短代码或小工具轻松创建幻灯片并发布它们。这些幻灯片由 jQuery Cycle 提供支持，有二十多种过渡风格可供选择。
![Meteor-Slides.jpg](../Images/6375c9eefd1e9da46529b26cb05974a7.png)
[来源](http://www.jleuze.com/plugins/meteor-slides/)

## 10.取消零点滑块

是一个为你的新闻或页面显示幻灯片的插件！它完全可以用 CSS 定制，并自动缩放图像到合适的大小。
![UnPointZero-Slider.jpg](../Images/70f5f756a91f22b1d46a97de0390c1af.png)
