...
> 原文:[https://www . site point . com/working-with-the-Facebook-API-in-a-Cordova-app/](https://www.sitepoint.com/working-with-the-facebook-api-in-a-cordova-app/)
...
![new facebook app](../Images/71a69b4f6b0dfdf606a50f3a837f4b8f.png)

输入应用程序的名称，并点击*创建新的脸书应用程序 ID* 按钮。

![new facebook ID](../Images/916aceeadfc28e0011673137cfd9a381.png)

这将询问您该应用程序是否是现有应用程序的测试版本，将其保留为默认的*否*。另一个选项是类别，为页面选择*应用*，然后点击*创建应用 ID* 按钮。

![app category](../Images/8c0f45accc7304f51b92af109f3fbd90.png)
...
![project details](../Images/0233bf26b360b2835189ae6774371dc4.png)

一旦完成，我们需要添加开发和发布密钥哈希。这些验证你的应用程序的真实性，以便脸书确定你是应用程序的作者，对他们的 API 的请求来自你。

![development hashes](../Images/6b088219340b30a7dc0079807a0290a8.png)
...
![facebook login](../Images/d45303c0413c015d82e934c539b447ea.png)
...
![user details](../Images/69e8905056e8d27968707518334178b8.png)
...
![posting status](../Images/47f1b39a3229bc6a8c1b14f72eadd116.png)
...
![posting photo](../Images/2ecd576426f1740576430f3c103f5608.png)
...
![sending message](../Images/2b9a33c5303f64c188b40bb92f204d4f.png)
