...
> 原文:[https://www.sitepoint.com/uploading-files-cgi-perl/](https://www.sitepoint.com/uploading-files-cgi-perl/)
...
![The file form field displaying a text box and a Browse button](../Images/1d607ff3d8f13b5cf1ade8065bec2255.png)

用户点击“浏览…”按钮，调出文件选择器，选择他们希望上传的文件。然后，当他们单击表单上的“提交”按钮时，该文件的数据将与表单的其他数据一起上传到 Web 服务器:

![Clicking Submit to send the data to the server](../Images/c9be353a3bb720b868b0510f737f0d1b.png)
