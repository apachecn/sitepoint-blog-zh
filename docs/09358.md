...
> 原文:[https://www.sitepoint.com/tips-developing-jquery-notepad/](https://www.sitepoint.com/tips-developing-jquery-notepad/)

![notepad-plus-dev-tips](../Images/415e5fbf3fd773137c28555210c7bcbf.png "notepad-plus-dev-tips")
...
然后选中第一个文件按 ALT+D 或点击菜单中的 ***插件>比较>比较**T3】*

[![notepadplus-quick-compare](../Images/dc85fe7799c03b8367aaee5c123ae914.png "notepadplus-quick-compare")T2】](https://www.sitepoint.com/wp-content/uploads/jquery4u/2011/09/notepadplus-quick-compare.png)

如果文件匹配，你会得到一个弹出窗口说“文件匹配”。否则，如果差异出现在突出显示的右侧窗格中，您可以轻松地双击它们来查看代码。

[![notepadplus-compare-lines](../Images/703abf1afdd23e2e7ece344de446dfec.png "notepadplus-compare-lines")T2】](https://www.sitepoint.com/wp-content/uploads/jquery4u/2011/09/notepadplus-compare-lines.png)

然后要摆脱比较窗口按 CTRL+ALT+D 或点击菜单中的 ***插件>比较>清除结果**T3】*

如果你愿意，你也可以水平观看！只需右键单击分隔线列，然后单击

[![notepadplus-compare-horizonal](../Images/701646100cd41482a1070fa53ee5cfd9.png "notepadplus-compare-horizonal")T2】](https://www.sitepoint.com/wp-content/uploads/jquery4u/2011/09/notepadplus-compare-horizonal.png)
...
*   ***编辑>空白操作>修剪页眉和尾部空格*T3】**
*   ***编辑>空白操作>删除不必要的空白和 EOL*T3】**

![](../Images/e58acecefa4c123804ebb1c2779a0088.png)
另见:其他方法[缩小/隐藏你的 JavaScript 代码](http://www.jquery4u.com/security/hide-jquery-source-code/)。

## 5.使用 Notepad++整理你的代码

之前我已经发布了如何使用 Notepad++让你的 jQuery 代码变得漂亮。从主菜单中简单选择***TextFX>TextFX Edit>rein dent c++ Code**T5】。
![](../Images/81a527709781502799d0f3cda81519b1.png)*
...
[![tsvn-screenshot](../Images/7c4d8ee90071edbdeb13e1038cecffb7.png "tsvn-screenshot")](https://www.sitepoint.com/wp-content/uploads/jquery4u/2011/09/tsvn-screenshot.png) 
...
[![notepadplus-wiki](../Images/297aff17080ea6259b48fb349bfa0dcb.png "notepadplus-wiki")T2】](https://www.sitepoint.com/wp-content/uploads/jquery4u/2011/09/notepadplus-wiki.png)
...
[![notepadplus-language](../Images/9f9c4777430ad4f1bf89c4afb20525af.png "notepadplus-language")T2】](https://www.sitepoint.com/wp-content/uploads/jquery4u/2011/09/notepadplus-language.png)

## 9.删除行号

有时，当从其他网站复制代码时，我们最终会得到愚蠢的行号，为了使用这些代码，必须手动删除它们。记事本++拯救世界！

***TextFX > TextFX 工具>删除行号或首字**T3】*

![notepadplus-remove-line-numbers](../Images/5c294cc50479e210b149ef012148e893.png "notepadplus-remove-line-numbers")
...
![notepadplus-word-wrap](../Images/3f3d7e02fb396ae3ab9345d6dea3bd9b.png "notepadplus-word-wrap")

## 11.快速复制文件名，文件路径

只是多一个提示，这是一个巨大的时间节省。
***右击文件头(tab) >点击完整文件路径到剪贴板***
![notepad-plus-filepath](../Images/3578a8c107f01d988e1977d015ccb19e.png "notepad-plus-filepath")
