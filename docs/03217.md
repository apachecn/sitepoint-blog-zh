...
> 原文：<https://www.sitepoint.com/ux-principles-behind-ubuntu-phone/>
...
![Customizable Scopes - Image from OMG Ubuntu](img/70691adc355c890b5416e9c45716642d.png)
...
![Process Diagram](img/cf3fcaaf104e8aabc5ce37cafaca849b.png)

作用域调用的源在这里并不重要，这意味着作用域可以调用作用域(*scope reception*！).作用域可以聚合来自任何数据源(包括其他作用域)的数据，即使没有初始查询字符串，它们也可以提供内容。

![Scope Flow Diagram](img/6846c7e09d4f509f45466ed66f8be09d.png)
...
![Ubuntu Phone Edge overview](img/aa0773457df5843a4cb3602578e6fd12.png)
