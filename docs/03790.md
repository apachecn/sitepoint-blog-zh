...
> 原文:[https://www.sitepoint.com/vps-wordpress-lemp/](https://www.sitepoint.com/vps-wordpress-lemp/)
...
![Create Droplet](../Images/f3c7b010a13c3fce9183bd2dceea647d.png)
...
![Droplet Hostname](../Images/cdf9f9fc6bcc1c17b4db4fc1471bd3e2.png)

点击*创建 Droplet* 按钮，然后你会在屏幕上看到创建 VPS (Droplet)的进度。

![Creating droplet](../Images/b54533713366729a9b067942c9e2c6bb.png)

一旦完成，你会在屏幕上看到你的 VPS。记下 IP 地址:

![VPS](../Images/ef1689d33eb723632410a6d1139e6c55.png)
...
![PuTTY Configuration](../Images/f0cd4a50321153bfb0e5dbc80cbc0799.png)

点击“打开”，你会看到一个安全警告。这告诉我们服务器的主机密钥是新的，因此询问我们是否要信任它。单击“是”。

![PuTTY Security Alert](../Images/490de390b8b2cc8f9ca80421da45449d.png)
...
![Server Key](../Images/85861c00047fd58a3cc6a238862497e2.png)
...
![Root Password](../Images/d8003768d3ceefdcd94e6607ea910ccb.png)

输入当前密码，然后在出现提示时输入新密码。

![UNIX Password](../Images/af31a7414dfdc48e012e623fd0edc434.png)
...
![Components](../Images/31fd319815e478df4fbf6702b80233c8.png)
...
![MySQL](../Images/8f1c76413e4a8f7a6bbdcd3be5bca231.png)
...
![Configuring PHP](../Images/cb81810b59438ea069e10bbdb4d135c0.png)

按住`Ctrl`键并按下`W`，你将被要求输入一个搜索字段。输入:

`fix_pathinfo`并按回车键:

![Configuring PHP](../Images/e4967a056faae1a8c3df2279feb648d2.png)
...
![Configuring nginx](../Images/2a89ec2229f5b2bfa78daf9b42243f01.png)

让我们删除当前配置。持续按下`Ctrl`和`K`来剪切配置文件的每一行，直到空白为止:

![Removing current configuration](../Images/417c701aec5b7f256989fb829fa4db6c.png)
...
![Creating a SSH Login](../Images/e4587d3a9343bee759567acd8ccbab87.png)
...
![Configure SSH Login](../Images/1ffdb856c1a500aa365236ccb1af1b37.png)
...
![WordPress config](../Images/259b5c7419ed1f1af326961c0efe1062.png)

点击*提交*，如果详细信息正确，将要求您运行安装:

![Run Installation](../Images/37179b59a09568aa58f4b75357c19c3d.png)

在点击*安装 WordPress* 之前，输入你的“站点标题”、“用户名”、“密码”和“电子邮件地址”

![WordPress Install](../Images/a88cbf7d10f5d78e60140b8614b6246f.png)
