...
> 原文:[https://www.sitepoint.com/10-jquery-plugins-cost-money/](https://www.sitepoint.com/10-jquery-plugins-cost-money/)
...
>勤奋支持
 ...
 [![Slidedeck](../Images/4efe5894b0fdb05e959353563ef26c90.png)](http://www.slidedeck.com/) 
...
李 jQuery 图像滑块/横幅图像旋转器是精心制作的滑块/图像旋转器，功能齐全，非常容易安装和定制。每当你需要一个功能齐全的滑块图像旋转器或你需要一个简单的广告横幅，李 jQuery 图像滑块将做这项工作与轻松！
 ...
 [![jQuery Slider Banner Image Rotator for HTML](../Images/e191eafd455176af5d2346d229c2fb40.png)](http://www.spotnil.com/envato/codecanyon/li-slider/) 
...
您可以将标题的位置设置为左、右、上或下，但您也可以给它一个自定义的位置和大小。此外，你可以选择两种字幕效果:滑动和淡化。
 ...
 [![Advanced Slider v2.5](../Images/14b49388a150db65a5bfe78c0f897cce.png)](http://bqworks.com/products/advanced-slider/v2.5/example_basic.html) 
...
是一个非常灵活和易于使用的 jQuery 图像幻灯片插件，具有一组以前没有的真正独特的过渡，以及一些基本的过渡，因此滑块将适合每个项目。
 ...
 [![AviaSlider - jQuery Slideshow](../Images/cd8efc142e567cfe7b005bccd565e029.png)](http://codecanyon.net/item/aviaslider-jquery-slideshow/105090) 
...
DDSlider 推出了一个新的易于使用的滑块，具有 9 种不同的独特过渡(+渐变和随机-总共 11 种)，支持内嵌内容。在同一个页面中也可以有多个滑块。
 ...
 [![DDSlider - 10 Transitions - Inline Content Support](../Images/411cf1ca6fb8fc7af77667daae27915b.png)](http://codecanyon.net/item/ddslider-10-transitions-inline-content-support/104797) 
...
是一个 jQuery 插件，可以用来显示你的图片和视频。CSS3 动画由 Animate.css 驱动。它是移动友好的，支持在您的触摸设备上向左/向右擦除。
 ...
 [![jQuery Simple Slider Plugin](../Images/8f153a39bc3063aabf4ada606d14fb5d.png)](http://codecanyon.net/item/jquery-simple-slider-plugin/747688?WT.ac=category_item&WT.seg_1=category_item&WT.z_author=sike) 
...
最棒的 jQuery 图片滑块
 ...
 [![Nivo Slider Pro](../Images/087bb84eb38762dec922a19154af153d.png)](http://nivo.dev7studios.com/pro/) 
...
这个滑块带有两个漂亮的主题，组织良好的 PSD 源和清晰的 CSS 规则，允许快速简单的皮肤定制，以融入任何网站。这个 jQuery 插件提供了丰富的接口，可以改变任何默认设置，比如动画时间，输入方向等等。
 ...
 [![Diamond Slider - Ken Burns Image Slideshow](../Images/ba43c9730cf90eef326636c7f74fbfbe.png)](http://codecanyon.net/item/diamond-slider-ken-burns-image-slideshow/686708?WT.ac=category_item&WT.seg_1=category_item&WT.z_author=BillyKid) 
...
是一个 jQuery 内容滑块插件，具有无限的过渡动画(真的，无限！)和各种各样的功能，如支持触摸、移动优化界面、动画层、响应能力和许多其他功能。
 ...
 [![UnoSlider - Responsive Touch Enabled Slider](../Images/d07af6edc284a806e45afd6ae2a5800d.png)](http://codecanyon.net/item/unoslider-responsive-touch-enabled-slider/657866?WT.ac=category_item&WT.seg_1=category_item&WT.z_author=Unodor) 
...
是最伟大和最引人注目的动画 jQuery 图像滑块之一，拥有超过 150 种预定义的效果，包括 3D 效果！
 ...
 [![Chop Slider 2 jQuery Plugin](../Images/40fb2bf5df30e78b94b271a0f670586e.png)](http://codecanyon.net/item/chop-slider-2-jquery-plugin/591516?WT.ac=category_item&WT.seg_1=category_item&WT.z_author=iDangerous) 
