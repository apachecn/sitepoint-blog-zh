...
> 原文：<https://www.sitepoint.com/top-100-jquery-plugins-2012-part-25/>
...
[![Calendario.jpg](img/5a53541be46f4924f90e75325938f610.png)](http://tympanus.net/codrops/2012/11/27/calendario-a-flexible-calendar-plugin/) 
...
[![Socialist.jpg](img/9838d0a1cc12a03e9ff3526a46d25de4.png)](http://plugins.in1.com/socialist/demo)
[Source+Demo](http://plugins.in1.com/socialist/demo)

## 23.适配器 jQuery 内容滑块

一个轻量级的内容滑块，旨在为开发人员提供一个简单的界面来创建酷 2D 或 3D 幻灯片动画过渡。
[![Adaptor.jpg](img/daff4173e039ceaece7ba7cc9069e429.png)](https://github.com/p-m-p/jquery-box-slider) 
...
[![productColorizer.jpg](img/1126c8759536dad5a499eb9e2a64aa11.png)](http://sandbox.nikorablin.com/productColorizer/) 
...
带绝对定位的自动翻转
[![imBookFlip.jpg](img/b36b50b613d52b6ba478dc5ba7938181.png)](http://grasshopperpebbles.com/demos/bookflip/pos_absolute) 
[源+演示](http://grasshopperpebbles.com/demos/bookflip/pos_absolute)

## 26.jQuery 任意拉伸

一个 jQuery 插件，允许你添加一个动态调整大小的背景图片到任何页面或块级元素中。
[![jQuery-Anystretch.jpg](img/ab14c0bfc88731fa93b076f57932f9a5.png)](https://github.com/danmillar/jquery-anystretch) 
...
[![jQuery-Easy-Image-Zoom.jpg](img/40beded711529e2ac123b8cd0a12d559.png)](http://cssglobe.com/lab/easyzoom/easyzoom.html) 
[源+演示](http://cssglobe.com/lab/easyzoom/easyzoom.html)

## 28.雷达声音插件

实时音频合成实验。在 Chrome 和 Safari 上运行良好，但在 Firefox 上运行缓慢。
[![Radar-Sound-Plugin.jpg](img/cd404e34a30e6e625d35f4a428980629.png)](http://lab.hakim.se/radar/) 
[源+演示](http://lab.hakim.se/radar/)

## 29.动画响应图像网格

一个 jQuery 插件，用于创建一个响应式图像网格，使用不同的动画和计时来切换图像。
[![Animated-Responsive-Image-Grid.jpg](img/ff9ed8578ed8fb538bd22b05ee983ee6.png)](http://tympanus.net/codrops/2012/08/02/animated-responsive-image-grid/) 
...
jQuery 制作表格插件用户可编辑
[![uiTableEdit.jpg](img/1a50b8823c4698fc5fd3c7370f3086bd.png)](http://gregweber.info/projects/uitableedit.html) 
[源码+演示](http://gregweber.info/projects/uitableedit.html)

## 31.jQuery 切换

一个轻量级的 jQuery 插件，可以创建样式简单的切换按钮
[![jQuery-Toggles.jpg](img/75cd93d833975dbe90092d713ccf1fcd.png)](http://simontabor.com/toggles/) 
...
[![HoverTransitions.jpg](img/3078eb50042e85b66763b3515fe7b359.png)](http://codecanyon.net/item/hovertransitions-jquery/2801099) 
...
[![PayPal-Buy-It-Button.jpg](img/429028ec7395303d2bdcab3b80579b5f.png)](http://www.jquery4u.com/plugins/jquerypaypalbuyitnow/) 
...
[![Makisu-CSS-3D-Dropdown.jpg](img/3f2a260a14f790948c5b03972d0d8c53.png)](https://github.com/soulwire/Makisu) 
[来源](https://github.com/soulwire/Makisu) [演示](http://soulwire.github.com/Makisu/)

## 35.infinity . js–平滑滚动

这是一个适用于网络的视图:它可以加速长列表的滚动，让你的用户的无限订阅源保持平稳
[![Infinityjs.jpg](img/fc398665662256bbaa1c3c2ab05bc2a9.png)](http://airbnb.github.com/infinity/)
[Source](http://airbnb.github.com/infinity/)[Demo](http://airbnb.github.com/infinity/demo-on.html)

## 36\. Meny

三维且节省空间的菜单。
[![Meny.jpg](img/4a46b64bad210c9d57dcd8b5997dffe0.png)](http://lab.hakim.se/meny/) 
[源+演示](http://lab.hakim.se/meny/)

## 37.ARCTEXT。JS–用 CSS3 和 JQUERY 弯曲文本

它计算每个字母的右旋，并将字母平均分布在给定半径的假想圆弧上。
[![ARCTEXTJS.jpg](img/8f38610d1cd0f51d624dfaf494bf8fdf.png)](http://tympanus.net/codrops/2012/01/24/arctext-js-curving-text-with-css3-and-jquery/) 
...
[![Treesaversjs.jpg](img/b6bf974d2025a2e392774f800d875e7c.png)](http://treesaverjs.com/) 
[源+演示](http://treesaverjs.com/)

## 39.交互式可过滤投资组合

一个交互式可过滤的 jQuery Portfolio 插件。
[![Interactive-Filterable-Portfolio.jpg](img/23d654ea9a5b5d8f95d5f99572fcd6bb.png)](http://www.gethifi.com/blog/a-jquery-plugin-to-create-an-interactive-filterable-portfolio-like-ours) 
...
[![wmuSlider.jpg](img/41798497e7f8c2978c32771f56ded2ba.png)](http://brice.lechatellier.com/code-design/wmuslider/) 
