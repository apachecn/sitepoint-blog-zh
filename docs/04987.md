...
> 原文:[https://www . site point . com/using-source-maps-debug-sass-chrome/](https://www.sitepoint.com/using-source-maps-debug-sass-chrome/)
...
![Screenshot of Dev tools](../Images/59f90783dcb750e96399e4c3e56fdfd0.png)
...
[![Inspecting and live editing Sass in the browser](../Images/27e439bda7ad38d7fcee6185a41eeabe.png)T2】](https://uploads.sitepoint.com/wp-content/uploads/2014/09/1411481139sourcemaps-2.gif)
...
![Enabling Source maps in the browser](../Images/9704f9d58f3598cdae7e2bfccecba10a.png)
...
![Enabling Workspaces in chrome](../Images/e1e4d76d598cabfb804d27c7d72f5795.png)
...
3.  在左侧的文件树中，右键单击您的样式表并选择“映射到文件系统资源…”。
    ![Map to file system resource](../Images/15f6de29c05acb6a4367668f47030894.png)
4.  这将打开文件搜索对话框。选择适当的文件(您的样式表)。
    ![Select your stylesheet](../Images/2ad23f1407a08960e24cb9a22d160a14.png)
5.  重新启动开发者工具。
