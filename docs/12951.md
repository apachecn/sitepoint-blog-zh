...
> 原文:[https://www.sitepoint.com/building-buttons-photoshop-2/](https://www.sitepoint.com/building-buttons-photoshop-2/)
...
**[没错——整本书可以免费下载。](https://www.sitepoint.com/premium/books/photoshop-cs6-unlocked-2nd-edition)T3】**
...
![Examples of aqua buttons](../Images/54c448b4f2d4940e04d00f9fc10d882b.png)

***解***

1.  从一个圆形矢量按钮开始。我们将为它添加一个渐变覆盖，所以它的颜色并不重要——使用任何你喜欢的颜色！第一步是应用渐变叠加到我们的按钮。点击**图层**面板底部的**添加图层样式**按钮，并从出现的菜单中选择**渐变叠加**，打开**图层样式**对话框。

![Applying a gradient overlay to the button](../Images/a0677f01fcde0a4c3939fc62b6ee79f8.png)

*   在对话框中，设置角度为 90 °(如上所示),点击**渐变**补丁，显示**渐变编辑器**的另一个对话框，如下图所示。

![Changing the gradient settings](../Images/c4f1dd96f07deacf9ccbd03425ba2318.png)
...
![Applying an Inner Glow layer style](../Images/47a1d64ff252ea3c335f1449662a4e4a.png)

*   接下来，我们将应用一个轻微的发光效果。点击**外发光**。将**混合模式**更改为**正常**，将**不透明度**更改为 ***50%*** ，将**扩散**更改为*，将**大小**更改为 ***5px*** (您可能需要调整这些设置以适应按钮的大小)。把色标换成明亮的水绿色，如下图——我用的是#00bae8。* *![Applying the Outer Glow layer style](../Images/90f08723ea635170714844ff946134e9.png)

*   点击**确定**应用所有样式。*   为了创建按钮高亮，通过在**图层**调板中按下 ***Ctrl-J*** 来复制按钮图层(在 Mac 上为 ***Command-J*** )。点击相应的眼睛图标，关闭该层的**外发光**和**内发光**样式，如下图所示。

![Turning off the layer styles of the highlight](../Images/1337f5cc703925d1587e0fe883a1a44d.png)

*   在**图层**调板中双击**渐变叠加**样式名称。将出现**图层样式**对话框，选择**渐变叠加**。点击**渐变**补丁，调出**渐变编辑器**。

![Editing the gradient](../Images/92c0cf53e7da8fa1619b27fca524620e.png)

*   双击**渐变编辑器**中渐变条下面的色标，并将它们都设置为白色。*   点击上方和渐变条左侧的补丁*——这是左侧的不透明度停止点。将其**不透明度**字段设置为 ***0%*** ，如图所示。*

![Creating a white-to-transparent gradient](../Images/b2b8a92a8831a8c0f4d982ef634d3dd1.png)

*   点击 **OK** 退出**渐变编辑器**，再次应用新样式。*   在**图层**调板中，将形状的填充改为 ***0%*** 。这将允许底层的按钮显示出来，如下图所示。

![Changing the fill of the highlight layer](../Images/73cc0030250dd7b995bbaf01c07d8535.png)
...
![Transforming the highlight layer](../Images/1c234f2e370be466844adb6152df6cbd.png)

*   切换到直接选择工具(*)。单击并向上拖动高光路径的底部边缘，将其展平，如下所示。如果需要，可以使用 ***Ctrl-+*** (在 Mac 上使用 ***Command-+*** )进行放大。* *![Changing the shape of the highlight](../Images/7ee3c8b45e843a97c6eeed545e9fc111.png)

*   我们终于准备好添加文本了！在高亮层和按钮层之间创建一个文本层，然后输入文本。我用深蓝色作为我的颜色。我还在我的文本中添加了一个微妙的阴影样式，如下例所示。

![Applying a drop shadow to text](../Images/db1002ccd4f7fa5658a79235b1c7f46e.png)
...
![Duplicating the button layer](../Images/e6466828593d7e1d4bb2c09bf9c71918.png)
...
![Applying the Bevel and Emboss style](../Images/d4ae9207368c6c2c65397fa6a89d2968.png)

*   在对话框的底部，你会看到**高光模式**和**阴影模式**的不透明度区域。将这两个都设置为 ***93%*** 。*   最后，在按钮边缘画一笔。您现在应该对此很熟悉了！在**图层样式**对话框中选择**描边**，给你的按钮一个 ***1px*** 黑色描边 ***60%*** 不透明度，如下图对话框所示。

![Adding a Stroke layer effect](../Images/19395fedaae4c0ba2d3e128d7483c21b.png)

*   点击**确定**应用图层样式。*   下面我们把 ***浮雕*** 图层的**填充**改为 ***0%*** ，如图所示，这样它下面的按钮层就可以透出来了。

![Changing the fill of the emboss layer](../Images/bbdf0fc04e20f83b65f9537f1459cacc.png)

我们的嵌入式 aqua 按钮已经完成！这张图片显示了我们的正常和嵌入式浅绿色按钮。

![Completed aqua buttons](../Images/1981da9b146ddb32b4ac62b26971da1b.png)
...
![Copying styles to another layer](../Images/5cc0e609f7452e1935b609f00a43a7f2.png)

*   要将图层效果从原来的浅绿色按钮复制到矩形按钮，请按住 ***Alt*** (在 Mac 上为 ***Option*** )并将图层样式图标从原来的按钮图层拖到其对应的矩形按钮图层上，如图所示。

![Button layer with styles applied](../Images/f0169422552cadf2d3f955d1339f9d67.png)

*   将 ***高光*** 图层的填充改为 ***0%*** 。

![Highlight layer with styles applied](../Images/e06bae0f3757e287803ba3953ca29cd9.png)

*   添加按钮文本并重复步骤 2，复制我们用于原始文本的阴影样式。

就是这样！您的矩形 aqua 按钮已经可以使用了，看起来应该和这里的一样。

![The final rectangular button, and the rounded button on which it was based](../Images/40f5bb3250b2b06f6c6af42259c74a3c.png)

##### 制作透明的浅绿色按钮

我们也可以让我们的 aqua 按钮透明，就像这里显示的一样。

![Transparent aqua button](../Images/c15e18093e8428993691a1262909228c.png)
...
![Basic aqua button on top of faint, striped background](../Images/285f2403c6c22af2102ee3f77b2b040a.png)

*   双击图层的 **f** 图标——这将弹出**图层样式**对话框。选择**渐变叠加**样式，点击**渐变**样本，调出**渐变编辑器**。*   在渐变条上方，在此图像所示的位置点按一次，以创建新的不透明度色标。将其不透明度更改为 ***50%*** 。

![Adding new opacity stop](../Images/2c7504bd1251c5fd2f2143551adfa0ba.png)

*   点击**确定**退出**渐变编辑器**，在**图层样式**对话框中再次点击**确定**应用样式。*   将按钮图层的填充设置为 ***0%*** ，如下图。背景会显现出来。

![Changing the fill of the button layer](../Images/5191f206ef41f0b4220da83e41764da8.png)

看起来不错！但是，和往常一样，我们可以做一些事情来使它看起来更加完美。

*   双击 **f** 图标打开**图层样式**对话框，选择**阴影**样式。为阴影选择明亮的浅绿色(#90c9e7)，并稍微增加**距离**和**尺寸**。将**不透明度**更改为 ***40%*** ，如下图所示。

![Adding a drop shadow](../Images/7b9debad2bc1e1c75ac07e194e7b491d.png)

*   接下来，选择**笔画**样式。添加深蓝色(#0d487b) 1px 描边，不透明度 75%左右，如下图。

![Adding a stroke](../Images/929ef3c6aa2888fced9da8dc2828afd1.png)

*   最后选择**内阴影**样式。改变阴影颜色为蓝色，比我们在原来的渐变按钮中使用的颜色稍微暗一点。降低**不透明度**到**T5 50%**，改变**距离**到大约 ***10px*** (或者任何适合你按钮大小的)，如下图。

![Adding an inner shadow](../Images/ada4b9641db7e7da891b57212f735124.png)

*   点击**确定**应用这些新样式。正如你在下面看到的，我们已经完成了最后一个透明的浅绿色按钮！唰，*非常*唰！

![See-through aqua button](../Images/d82e4d9ae8f09853ffe491d0a8fe515e.png)

##### 制作一个塑料按钮

在这个解决方案中，我们将使用 Photoshop magic 把我们的朋友——基本渐变按钮——变成一个塑料按钮，如图所示。

![Plastic button](../Images/1bdb65706fed682090bb69a9b317ddcc.png)
...
![Green rounded rectangle gradient button](../Images/dac8c30cd5daf3adaf6890148d30922f.png)

*   给你的按钮添加一个深绿色的 1px 描边图层样式，如下所示。

![Adding a stroke to the button](../Images/c26e9c11a65b8573a74830f5430fb769.png)

*   使用按钮颜色的明亮版本添加外部发光，如下所示。

![Adding an outer glow](../Images/40e4d70d384f8ced1fce441540bed932.png)

*   在**图层**调板中选择 ***按钮*** 图层，使用***Control-J***(Mac 上使用 ***Command-J*** )复制。右键点击(按住 ***控制键*** 并点击)新图层，从出现的菜单中选择**清除图层样式**，如图所示。

![Clearing the layer style](../Images/3d06f8bc9351698c2256a167f37e082a.png)

*   将该层的**不透明度**更改为 ***50%*** ，双击其色标打开**拾色器**。如图所示，将形状的颜色设置为白色。

![Changing the color of the shape layer](../Images/b52cfa172bb971d22fdc1d34ba9aa0d6.png)

*   现在，点击**图层**面板中相同图层的矢量形状。使用直接选择工具( ***A*** )，点击圆角矩形的底线，向上拖动一点，如图所示。你可能需要放大这个。

![Editing the vector shape](../Images/2bc9b601a8d61216d52f5f3bb8dc8bfe.png)

*   仍然使用直接选择工具( ***A*** )，点击左下方的锚点，这样就可以看到该点的手柄(如果需要可以放大)。点击底部车把，按住 ***Shift*** ，向上拖动手柄转弯。

![Curving the corner](../Images/7d324098313681b4fadf0ce77f4c794d.png)

*   对右下角的点重复步骤 7。你的形状的侧面现在应该看起来像这里显示的那样。

![Shape after modifications](../Images/0b43bdd3b807def81f8c58652f693c5a.png)

*   使用直接选择工具( ***A*** )，单击并拖动鼠标进行选择，以捕捉所有的底部点，如下图所示。

![Selecting multiple points for editing.](../Images/31df6923d9572a278d7e0c20bbe7c508.png)

*   按住 ***Shift*** 向上拖动选中的点，做成一条细条，如下图——这是我们的亮点。如果需要，使用上下箭头键微调移动。

![Making the highlight strip](../Images/f3473506295d1f48a96fc52a7f53d728.png)

*   在**图层**调板中选择高亮图层，使用***Ctrl-J***(***Command-J***)复制。选择**编辑>变换>垂直翻转**翻转复制的图层。*   使用移动工具( ***V*** )将翻转的高亮显示移动到矩形按钮的底部，如下所示。

![Adding bottom highlight](../Images/2f6ca33fc44e8401c59593cd3b141ee3.png)

*   我们快到了！现在复制按钮形状图层，命名为*。将形状的颜色改为白色。***   选择 ***中间高亮*** 形状的底部锚点，并将它们向上移动到原始按钮形状的中心。将该图层的不透明度更改为 ***25%*** ，如下图所示。

![Modifying the third highlight shape](../Images/85359bd931abb87ffea4be20291eceae.png)

*   在原始按钮形状的顶部立即添加一个文本层(在三个高亮层的下面),然后键入文本。如果你喜欢，添加一个阴影来增加三维效果，就像我为这个完整的按钮所做的那样。

![The completed plastic button](../Images/d45594877720d14a1950d82ed7999b00.png)

##### 制作玻璃按钮

在这个解决方案中，我们将创建一个令人瞠目的玻璃按钮，当它覆盖在照片和非实心背景上时特别有效。

![Example of a glassy button](../Images/96181f37d11804b6e42e3a9859557d0e.png)
...
![Bevel and Emboss settings for the glass button](../Images/c05a8e62d707ad75a84fad21eb6f02e7.png)
...
*   **Gloss Contour:** Rolling slope-descending (Set this by clicking on the drop-down arrow next to the contour shape and choosing the Rolling slope-descending option, as depicted below.)
    ...
    ![Setting Gloss Contour](../Images/519406ec238adf453208075924a34d8e.png)
...
![After applying a Bevel and Emboss effect](../Images/d685ca6f253efeea2c6c9182f054ae9d.png)

在应用斜面和浮雕效果后

*   在**图层样式**对话框中，点击**斜面和浮雕**下的**轮廓**样式将其选中。点击轮廓的缩略图，调出**轮廓**编辑器，如下所示。

![Changing the contour curve](../Images/0ec0cb30340b0ffd6b58d0fb7ce4c03b.png)

*   选择并移动轮廓的左下角点，直到它正好位于第一个水平网格标记的上方。然后，单击轮廓线添加另一个点，并拖动它形成一条曲线。

下图显示了应用轮廓效果后的按钮。

![After applying the Contour curve](../Images/e18ba809817fc3b84b0a352d2125dabc.png)

*   不错吧。现在，选择**缎面**图层样式，应用如下设置:

![Applying the Satin layer style](../Images/0db473a4ad80b4c3c0e0855d55075234.png)
...
![Applying a drop shadow](../Images/997dba52412b931ce4cdefec6817f8e0.png)

在这一阶段，我们的按钮看起来很光滑，如下图所示。

![Satin and Drop Shadow layers applied](../Images/c53f004e903bf6981a2b3416cc1492f2.png)

*   我们现在需要做的就是添加一个简单的文字层，加上一点阴影！完成后的按钮应该如下图所示。

![Completed glassy button](../Images/d9e6db97181758a628b824ef1892317a.png)

您可以轻松地将此图层样式复制到其他形状图层。当你这样做，记得设置新的图层填充为 0%。尝试图层效果来改变按钮的外观。这里的图像显示了我的玻璃按钮的变化。

![Glassy button style applied to various shapes](../Images/c799807174f870b1ae2216d95daa02f8.png)

##### 制作珍珠纽扣

这里有一个使用真正魔法的解决方案…嗯，差不多！我们将把在“制作玻璃按钮”中创建的玻璃按钮变成珍珠按钮。

![Example of a pearl button](../Images/73e7dfc7cb9f3d83952382302673a554.png)

***解***

1.  从您在名为“制作玻璃按钮”的解决方案中创建的玻璃按钮开始改变按钮层的填充为 100%，如图所示，并使用一个非常轻的，珍珠色的形状。我用#fae1f9 作为我的粉色珍珠按钮。

![Changing the fill color](../Images/7e873a66334bf02a6ff80f630cba4f8d.png)

*   通过添加轻微的内部发光来增强按钮的三维效果。双击图层的 **f** 图标，调出**图层样式**对话框，如下所示。

![Adding an Inner Glow effect](../Images/3f2297a204f13806a88867e00451a977.png)
...
![Examples of angled tab buttons](../Images/1b52d8d34fce1530ac9d6fc3943a803d.png)
...
![Starting with a rectangular button](../Images/d5a638dd129eb2b416700fe443687af7.png)

*   使用直接选择工具(*)，选择矩形左上角的锚点。按住 ***Shift*** 键，按一次或两次右箭头将指针向右移动。你的图像应该看起来像下面这样。* *![Moving the anchor point](../Images/e8be97abf3bfcf928d220d0b1a626b72.png)
...
![Completed angle button](../Images/c1fb590935dfb349c22476af0c9f4948.png)

**切角标签**

1.  这一次，我们将制作一个带有切角的选项卡按钮。再次，从一个矩形矢量形状开始。选择添加锚点工具—您会在钢笔工具的弹出菜单中找到它( ***P*** )，如下所示。

![Selecting the Add Anchor Point Tool](../Images/a3df5fcc277e429dcb5c54e3e436dad0.png)

*   像我在下面的例子中做的那样，在按钮的侧面添加一个锚点(你可能需要放大)。

![Adding a point to the button](../Images/3a892fa21d4aee5f4be2b6734129c77f.png)

*   选择转换点工具，它也在钢笔工具的弹出菜单中( ***P*** )。

![Selecting the Convert Point Tool](../Images/004819c8f662bdbd9f017f7ccbba48fe.png)

*   使用直接选择工具( ***A*** )，点击顶角锚点，使用箭头键移动锚点，形成一个“切角”，如下图所示。

![Moving the anchor point](../Images/59c4aa54bf6f3e4004e452205bed3e47.png)

![Completed cut-corner tab](../Images/6f033297c40ac0566769f91de1ddc08d.png)
...
![Rounded tab button](../Images/f16a0045ead21589974fbee541b61c58.png)

***解***

1.  从一个圆角矩形矢量形状开始，如下所示。

![Rounded rectangle shape](../Images/9edd7821f4a720cfc1b58ba7035426cd.png)

*   选择钢笔工具( ***P*** )弹出菜单中的“转换点”工具。如下所示，在两个锚点上单击一次，将它们从曲线点转换为角度点。

![Converting the anchor points](../Images/c4ec702dc48ff5795db559e1dce88dd6.png)

*   使用直接选择工具( ***A*** )围绕形状上最底部的两个锚点进行选择。为了表示它们已被选中，这些点将从白色正方形变成实心正方形，如下所示。

![Selecting the bottom two anchor points](../Images/a4fee4f5c39be3f3475b701f9f87bc7b.png)

*   通过按键盘上的 ***退格键*** 或 ***删除*** 来删除锚点。您的图像现在应该类似如下所示。

![Deleting the two points](../Images/4b6c0bda3dec894f185ff72be8d5144f.png)

*   使用钢笔工具( ***P*** )，先点击左侧底部锚点，再点击右侧锚点，如下图所示。

![Closing the shape](../Images/371508b569a69c007eaab6b6e67f6f6a.png)

这将绘制一条连接两点的线，并完成形状，如下所示。

![Completed rounded tab button](../Images/47cdc652596591cf47f1d932ddef77a1.png)

##### 制作文件夹标签按钮

在这个解决方案中，您将学习如何创建一个漂亮的文件夹标签，形状很像文件柜中使用的真正的文件夹标签。还记得那些老掉牙的东西吗？

![Example of a file folder tab button](../Images/59cdd7d1c568da0f3b44b7ea9090faa1.png)

***解***

![Step-by-step file folder tab](../Images/c8259a7d8c9e79bcf928e6ff7ebb312e.png)
...
![Completed file tab button](../Images/27bc52a382c914add66f1806da897ea2.png)
