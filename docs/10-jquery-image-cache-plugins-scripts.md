...
> 原文：<https://www.sitepoint.com/10-jquery-image-cache-plugins-scripts/>
...
一个简单的 jQuery 插件，用于预先缓存图像。该插件可用于消除非样式内容(FOUC)的闪烁，并改善可感知的页面加载时间。提供了加载、错误和中止事件的回调。
 ...
 [![jquery-cacheimage](img/8814fc37cb4ef2a1e64e345bd138d102.png)](https://github.com/alexrabarts/jquery-cacheimage#readme) 
...
>易于使用(键/值对)
 ...
 [![jQuery Image Cache](img/18912bb0cd07e81f10802dd164cbfc61.png)](http://dumitruglavan.com/jquery-image-cache-plugin-cache-images-in-browsers-local-storage/) 
...
这就是如何使用 jQuery 预加载图像，将图像添加到浏览器缓存中(作为隐藏的 DOM div 元素的一部分)。
 ...
 [![jquery add image to browser cache](img/d33d01b8ace374bd664c103e4bd8eb31.png)](http://www.jquery4u.com/snippets/jquery-add-image-browser-cache/#.T9HrqphMiSo) 
...
带有回调机制的图像预加载程序，允许在图像加载完成时发出通知。
 ...
 [![jQuery Image preloader with callback](img/a80d78733ffeaf9a476947405baf2088.png)](http://www.roslindesign.com/2010/05/11/jquery-image-preloader-with-callback/) 
...
这个加载器告诉用户页面加载和显示需要多长时间。
 ...
 [![Caching Images with JavaScript and HTML5 progress Bars](img/f9a9a60d9525819e7439064b3674a1bc.png)](http://www.useragentman.com/blog/2012/01/16/caching-images-with-javascript-and-html5-progress-bars/) 
...
该脚本遍历附加到当前页面的每个样式表中的每个规则，如果规则的值包含图像 URL，它将加载图像，从而确保在文档中使用时图像在缓存中可用。
 ...
 [![Preloading Images with jQuery](img/cdf98261a946c34f021ec1f82ddd8505.png)](http://ajaxian.com/archives/preloading-images-with-jquery) 
...
这个脚本是一个小 jQuery 插件，它缓存链接/导入的 CSS 文件中引用的所有图像(它遍历附加的每个样式表中的每个规则，如果规则的值包含图像 URL，它就加载图像，从而确保在文档中使用时图像在缓存中可用。
 ...
 [![jQuery Preload CSS Images](img/88b0f5fa51fba51fd669b6923629255b.png)](http://www.jquery4u.com/image-scripts/jquery-preload-css-images/#.T9HwMphMiSo) 
...
为什么要使用长脚本和 jQuery 插件来实现只用一行代码就能完成的事情呢？
 ...
 [![easiest way to preload images with jQuery](img/18fe689de729e012664a3300501fbca2.png)](http://chipsandtv.com/articles/jquery-image-preload) 
...
jQuery imgpreload 插件允许您在加载 dom 之前和/或之后预加载图像。
 ...
 [![jQuery Image Preload Plugin](img/33c3724e66b75ee330bbb41ae085ba2b.png)](http://www.farinspace.com/jquery-image-preload-plugin/) 
...
创建一个加载屏幕，使用 jQuery 为网站预加载图像和内容。加载过程中出现闪屏。
 ...
 [![jPreLoader](img/c94aee6ca86ba41a3ef97238b304a1b5.png)](http://www.inwebson.com/jquery/jpreloader-a-loading-screen-to-preload-images/) 
