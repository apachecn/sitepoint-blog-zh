...
> 原文:[https://www.sitepoint.com/site-mysql-postgresql-2/](https://www.sitepoint.com/site-mysql-postgresql-2/)
...
**pg_fetch_object($result，$ row)**T3】获取结果集的指定行。必须包含 `$row` *值，没有内部计数器。否则，它就像相应的 MySQL 函数一样工作。*
