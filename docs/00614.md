...
> 原文:[https://www.sitepoint.com/vue-js-quasar-framework/](https://www.sitepoint.com/vue-js-quasar-framework/)
...
![A page from the Quasar docs](../Images/2593bff0dd1b67124b0a4b22ebed4137.png)
...
![Terminal readout of installed Node and npm versions](../Images/1078ec0ea61695c1699f2e9a81bf89cc.png)
...
![Terminal view of Quasar being installed](../Images/ffb3b810e2048b4b0660eb46692dcef2.png)
...
![Using Quasar help in the terminal](../Images/bcf5f7a18ec6d66f34f2857cb03dca9b.png)

然后我们会看到一个关于我们想要引导的项目的选择列表。

![Running quasar create in the terminal](../Images/a8b06faa7b87657889a3d835136fb0bd.png)

项目搭建完成后，我们可以`cd`进入目录，用`quasar dev`启动一个开发服务器。项目构建完成，浏览器将在本地主机上打开临时索引页面。

![Our provisional index page](../Images/7eda47c8c81d35ca99f3221979564d0f.png)
...
![Our directory structure](../Images/094a1788b1bdc9d113b0a37b5fc5514d.png)
...
![A list of configuration settings](../Images/6e8b291724d091c013f50dea6e80dd23.png)
...
![Updating the components list](../Images/fead7a42a62533a0fa5291dd85e502de.png)

一旦我们保存了这些更改，我们应该会在浏览器中看到结果。

![The updated index page](../Images/1a96d52166bfdbd003cc3bb481aeb6d0.png)
...
![A table in the middle of our layout](../Images/d6c68fe18d436d39e5ec9270ec2e33b1.png)
...
![A view of the editor](../Images/673f71ea1870843234ad6ff12094e808.png)
