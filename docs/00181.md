...
> 原文:[https://www.sitepoint.com/mediastream-api-record-audio/](https://www.sitepoint.com/mediastream-api-record-audio/)
...
请注意，我们对麦克风使用了图像。你可以在 [Iconscout](https://iconscout.com/icon/microphone-2666576) 上下载图标，也可以在[的 GitHub 库](https://github.com/sitepoint-editors/mediastream-tutorial/blob/master/public/assets/images/microphone.png)中使用修改后的版本。
...
![Record Page](../Images/878dcf535a820b04e88101704152bf69.png)
...
如果条件为假(也就是说，`mediaDevices`和`getUserMedia`都被支持)，我们首先将录制按钮的图像更改为`stop.png`，您可以从 [Iconscout](https://iconscout.com/icons/stop) 或[GitHub 库](https://github.com/sitepoint-editors/mediastream-tutorial/blob/master/public/assets/images/stop.png)下载并将其放在`public/assets/images`中。
...
![Allow Prompt](../Images/33ba4ebb412b3823fdc49740d57ace56.png)
...
![Recording icon](../Images/ca728243ae9b5ec30b850c56a6800f7b.png)

尝试录制几秒钟。然后点击**停止**按钮。按钮的图像会变回麦克风图像，音频播放器会出现两个按钮——**保存**和**丢弃**。

![Audio player](../Images/c337c2209f0a08297b6ab74b29b7b0b9.png)
...
![Saved Recordings](../Images/0c969067679a0a1e210dba1792b681e1.png)
