...
> 原文：<https://www.sitepoint.com/the-21-step-checklist-for-bulletproof-mobile-user-onboarding/>
...
![Clear App Screenshot - Gizmodo](img/4301c9ea2290f3fb1cc5d1484c4f2826.png)

*图片来源:[Gizmodo](http://gizmodo.com/5885307/clear-app-cross-chores-off-your-to-do-list-with-a-swipe)*
...
![Groupon](img/b34431699b2a26f68dcc47b08241bbfd.png)
...
![Explicitly Show Advancement to the User](img/77713d50cdd9c31af6937a40c29cadd9.png)
...
![onboarding--0000](img/99ffa1e391498c47bb7fed2008bbbc62.png)

*图片来源:[砸弹匣](http://www.smashingmagazine.com/2014/08/mobile-onboarding-beginners-guide/)*
...
![AirBnB Referral - AirBnB](img/0944b38734ca101943ccdd6ec814803e.png)
...
![iPhone: Slide to unlock UI](img/4ee6d0ccda8c122bf32cc615fe53d889.png)

一个很好的例子是，当 iPhone 被锁定时，“滑动解锁”会显示如何解锁，如果密码不正确，“再试一次”会抓住你的注意力。

### 18.空状态

![Buffer empty state requesting user to compose an update](img/d4862c6d58cf34fbb7e226b436e9a49d.png)

空状态:即应用程序中没有内容、数据和结果的地方不应为空。它应该用来教育用户和/或提示他们采取行动来填充它。

Buffer app 就是一个很好的例子，它利用空状态让用户编写更新。

*图片来源:[空态](http://emptystat.es)*

### 19.请求许可前的上下文

除非你需要，否则不要要求用户访问某些功能(如摄像头、推送通知)。当你这样做的时候，在请求许可之前告诉用户许可的好处。

![Ask for user permission - TechCrunch](img/e72b80f764313e440d3ba13ee2df4137.png)
...
![Visual Analysis Heatmap - UXCam](img/a268af1e86cfb3977110f788d3a3d42d.png)
...
![User Recording - UXCam](img/079473c13879274982732535767db6f2.png)
