...
> 原文:[https://www.sitepoint.com/10-jquery-rating-plugins/](https://www.sitepoint.com/10-jquery-rating-plugins/)
...
![jRating.jpg](../Images/e5ecb8d090ff3aaccedc64dd4e0df27d.png)
...
![jQuery-Opineo-Plugin.jpg](../Images/311781e2e42558c01fa77977d557536c.png)
T3】来源
...
![Half-Star-Rating-Plugin.jpg](../Images/3aefa642783c4844c49abb14a1dbf7bc.png)
T3】来源
...
![Content-Rater-with-ASPNET-Ajax-and-jQuery.jpg](../Images/a7fe10fd979114a0b59c09294cc1b7aa.png)
T3】来源

## 5.jQuery 星级插件

这是 Ritesh Agrawal 创建的 star rating 的黑客版本，它将一组单选类型的输入元素转换为 star rating 类型，并保留单选元素的名称和值，因此可以与您的表单集成。它相当于一个普通的单选按钮。
![jQuery-Star-Rating-Plugin.jpg](../Images/37a0f0ed983a6a71904f82762cfba1d2.png)

## [6。TracHacks](http://trac-hacks.org/ticket/6693)

按照现在的情况，这个黑客在一个单独的表中创建所有的投票。由于我使用投票来对人们认为重要的票证/错误/功能进行排名，因此了解哪些票证有什么评级是很有用的。
![TracHacks.jpg](../Images/264f4c7b918e734ed835595de3458973.png)
T3】来源

## [7。jQuery Raty——一个星级插件](http://www.wbotelhos.com/raty/)

jQuery Raty 是一个自动生成可定制星级的插件。
![jQuery-Raty-A-Star-Rating-Plugin.jpg](../Images/1c4eb9a8ac9996c2751f59770fb93efa.png)
T3】来源

## 8.新的 jQuery 星级评分插件

jQuery Star Rating 小部件是一个可以添加到您的网站的简洁控件。它有许多选项，让您可以轻松地定制它。
![New-jQuery-Rater-Plugin-for-Star-Ratings.jpg](../Images/a4dc9b504edd0e3c101886f6e11afc79.png)

## 9.jQuery 星级插件测试版

这是我快速和肮脏的重新创建一个星级插件。这是一个完全可降解的插件，基于简单的表单结构创建星级评定界面。
![jQuery-Star-Rating-Plugin-beta.jpg](../Images/2a6c95ea999836bb57264bf2b2d5c2c3.png)

## 10。jQuery 星级插件 v3.13

星级插件是 jQuery JavaScript 库的一个插件，它基于一组单选输入框创建一个不显眼的星级控件。
![jQuery-Star-Rating-Plugin-v3pt13.jpg](../Images/9ec2d7a9321c95d45f1cadfb8139880a.png)
T3】来源
