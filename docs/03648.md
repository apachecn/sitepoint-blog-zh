...
> 原文:[https://www . site point . com/20-docs-guides-front-end-developers-5/](https://www.sitepoint.com/20-docs-guides-front-end-developers-5/)
...
[![SitePoint Sass Reference](../Images/d0db2509745a0568ab6fb0b57d9a1e7f.png)T2】](https://www.sitepoint.com/sass-reference/)
...
[![SVG viewBox and preserveAspectRatio Interactive Demo](../Images/7b3fd5fb6ed638940811b408c30e9159.png)T2】](http://sarasoueidan.com/demos/interactive-svg-coordinate-system/)
...
[![CSS 2.1 Index List](../Images/c0f2eccbe746b9f4b1c0481c12bcd5e0.png)T2】](https://www.w3.org/TR/CSS2/indexlist.html)
...
[![Popular Coding Convention on Github](../Images/a82aeccb218f4649ef3d2dc23d4e6f62.png)T2】](http://sideeffect.kr/popularconvention/)

## [5。地下城与开发者](http://www.dungeonsanddevelopers.com/)

这不是一个交互式游戏，而是一个类似 RPG 的网页开发技能的天赋树表示，带有各个地方的链接，可以学习列出的不同技能。

[![Dungeons and Developers](../Images/818a93b9d92e8bf74303ff12bf35f869.png)T2】](http://www.dungeonsanddevelopers.com/)
...
[![JSON API](../Images/cca83ce76c2534360c8dc1423483214e.png)T2】](http://jsonapi.org/)

## [7。jQuery UI 事件清单](http://bitsofco.de/2015/jquery-ui-events/)

指定哪些 jQuery 事件适用于桌面与移动以及鼠标与键盘的图表。

[![jQuery UI Events Cheatshee](../Images/332d2556df28114589dd4e023bc4531b.png)T2】](http://bitsofco.de/2015/jquery-ui-events/)
...
[![Weightof.it](../Images/b3beba16b71f8c760875887cd1efd5de.png)T2】](http://weightof.it/)
...
[![JavaScript in one pic](../Images/be7e0f4f3daef0500fb8ee2191e7f53f.png)T2】](https://github.com/coodict/javascript-in-one-pic)
...
[![Understanding NPM](../Images/ae3e14f6066df336d71fce1be580af85.png)T2】](https://unpm.nodesource.com/)

## [11。网络上的 SVG](https://svgontheweb.com/)

Jake Giltsoff 对 SVG 的概述，让您快速了解如何在网站上使用 SVG，并提供一些提示和技巧来帮助您。

[![SVG on the Web](../Images/fe9218581aad7958c0a0e1f9b59462d4.png)T2】](https://svgontheweb.com/)

## [12。格林斯托克备忘单](https://ihatetomatoes.net/greensock-cheat-sheet/)

PDF 格式的快速参考使用 GreenSock 强大的 JavaScript 动画库。

[![GreenSock Cheat Sheet](../Images/311118157701cfcf1263aceca7ac29dc.png)T2】](https://ihatetomatoes.net/greensock-cheat-sheet/)

## 13。JavaScript 图形库比较

比较 JavaScript 图形/图表库的简单方法。只需将鼠标悬停在一个图块上，您将获得有关支持的图表类型、价格和依赖关系的信息。您还可以选择按类别(图表类型、价格、选项和相关性)过滤库。

[![JavaScript Graphing Library Comparison](../Images/98326e00be6ed793af5504363b5d8bca.png)T2】](http://www.jsgraphs.com/)

## [14。可访问性备忘单](http://bitsofco.de/2015/the-accessibility-cheatsheet/)

来自 Ire Aderinokun，这是网络内容可访问性指南(WCAG)的压缩版，由一些实际例子支持。

[![The Accessibility Cheatsheet](../Images/dc08e73053e36f8dde8b9ce07bcf1790.png)T2】](http://bitsofco.de/2015/the-accessibility-cheatsheet/)

## 15。AngularJS 风格指南

“本风格指南的目标是为一个 AngularJS 应用程序提供一套最佳实践和风格指南。”

[![AngularJS Style Guide](../Images/db68d2d3f5f8d4a4527ea02b9140d8ba.png)T2】](https://mgechev.github.io/angularjs-style-guide/)

## 16。默认浏览器焦点轮廓样式

这是一个使用截屏显示不同浏览器在不同情况下如何处理各种表单元素上的焦点样式的表格。

[![Default Browser Focus Outline Styles](../Images/4ee7502a3170d658853d5018f23e9ab4.png)T2】](http://medialize.github.io/ally.js/tests/focus-outline-styles/index.html)

## 17.Flexbox 在 5 分钟内

新 flexbox 规范的所有主要特性的交互式浏览。包括演示，并允许您使用页面上的功能。

![Flexbox in 5 Minutes](../Images/2df608d7701a349e745ed78fc158cf9a.png)

## 18。Sass 函数备忘单

一个可搜索的 Sass 函数列表(颜色、不透明度、数字、字符串等)。)作为方便的参考。您可以下载两页彩色或黑白 PDF 或 LaTeX 文档。

[![Sass Functions Cheat Sheet](../Images/0f6fa1aaae9249624e4701ad602525a9.png)T2】](http://www.cheatography.com/hamidyfine/cheat-sheets/sass-functions/)

## [19。网页类型的状态](http://stateofwebtype.com/)

"关于支持网络上的类型和印刷特征的最新数据."

[![The State of Web Type](../Images/6421e07a66bea536c749b3c98d5e0706.png)T2】](http://stateofwebtype.com/)
...
[![ES6 Katas](../Images/ba3f11d43f1d88edddd0576a04dfcc00.png)T2】](http://es6katas.org/)
