...
> 原文:[https://www.sitepoint.com/update-angular-projects/](https://www.sitepoint.com/update-angular-projects/)
...
![Update Angular with the Angular Update Guide](../Images/87a03d1610d0b8a77daa9677aa5d7668.png)

对于我们的 Angular Todo 应用程序，我们希望从 Angular 4.0 升级到 Angular 5.0。

让我们选择应用程序复杂性级别*高级*，这样我们就可以看到我们需要采取的所有可能的措施:

![Angular Update Guide Results](../Images/fbdb60fbf9e4246f4b1cc9de47bb26fe.png)
...
![Angular Version](../Images/88e1a97898b2025b3a24505995258f78.png)
