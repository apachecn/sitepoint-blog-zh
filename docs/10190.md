...
> 原文:[https://www.sitepoint.com/getting-type-to-the-web/](https://www.sitepoint.com/getting-type-to-the-web/)
...
[![](../Images/dec92b393d3a0ccec0e5b80618b40750.png "fontdeck-homepage")T2】](https://www.sitepoint.com/wp-content/uploads/2011/01/fontdeck-homepage.png)
...
[![](../Images/c400e98408184245a78b0e3b2c576f1c.png "font-squirrel-webfont-generator-museo500-example")T2】](https://www.sitepoint.com/wp-content/uploads/2011/01/font-squirrel-webfont-generator-museo500-example.png)
...
[![](../Images/5636a397f000a11dc866fc646ae05e68.png "font-book-postscript-font-name-screenie")T2】](https://www.sitepoint.com/wp-content/uploads/2011/01/font-book-postscript-font-name-screenie.png)
...
就像 mod_deflate 的`FilesMatch`使用`mod_gzip_item_include file`一样，我们可以列出 mod_gzip 应该试图压缩的文件的文件扩展名。内容类型也可以通过`mod_gzip_item_include mime`行列出，方法是将 [IANA 媒体类型](http://www.iana.org/assignments/media-types/)标记为特定于供应商的<acronym title="Embedded OpenType">EOT</acronym>T3】。
