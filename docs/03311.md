...
> 原文:[https://www . site point . com/how-to-build-responsive-images-with-srcset/](https://www.sitepoint.com/how-to-build-responsive-images-with-srcset/)
...
2.  **浏览器的缩放级别:**对于相同的设备，更高的缩放级别意味着每个 CSS 像素有更多的设备像素，因此设备像素比也更高。例如，考虑这个图:![Zoom level of the browser](../Images/f4b5a27ad20ac8643f751c7af73db008.png)当你在浏览器上放大(Ctrl + Plus)时，你的 div 的 CSS 像素数保持不变，但是它所占用的设备像素数增加了。因此，每个 CSS 像素有更多的设备像素。
...
![Viewport width set between 1001px to 1400px](../Images/b2ae6cc70d0d95eface71c4626ff1997.png)

***视口宽度设置在 701px 和 1000px 之间:图像宽度与视口宽度相同。(正在使用的图片来源是 stick-figure.png)***
![Viewport width set between 701px to 1000px](../Images/96c0bb8a88da479fab938bf9f0327e2b.png)

***视口宽度设置在 501px 到 700px 之间:图像宽度为视口宽度的 1/10。(正在使用的图片来源是 stick-figure-narrow.png)***
![Viewport width set between 501px to 700px](../Images/4fab68013bc5c1586b4c202ce646de73.png)

***视口宽度设置在 0px 到 500px 之间:图像宽度为视口宽度的一半。(正在使用的图片来源是 stick-figure-narrow.png)***
![Viewport width set between 0px to 500px](../Images/dc4a91c1be49690b0ad5d883cd7048b7.png)
