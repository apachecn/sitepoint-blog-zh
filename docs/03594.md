...
> 原文:[https://www . site point . com/remote-debug-and-test-JavaScript-with-new-vor lon-js-plug-ins/](https://www.sitepoint.com/remotely-debug-and-test-javascript-with-new-vorlon-js-plug-ins/)
...
**注**:如果你还在疑惑 Vorlon.js 是什么，请先阅读大卫·卡图赫的这篇文章:_[T3】http://blogs . msdn . com/b/eternal coding/archive/2015/04/30/why-we-made-vorlon-js-and-how-to-use-it-debug-your-JavaScript-remote . aspx](http://blogs.msdn.com/b/eternalcoding/archive/2015/04/30/why-we-made-vorlon-js-and-how-to-use-it-to-debug-your-javascript-remotely.aspx/?WT.mc_id=13416-DEV-sitepoint-article40)*)。*
...
![DOM Explorer](../Images/de2edd8f92652c31c6a8c6dd8f3f264a.png)

额外功能:当客户端的 DOM 发生变化时，刷新按钮中的圆形指示器会变为红色！

![Refresh indicator](../Images/ff08d62637b842f499e01c867e94febe.png)

如您所见，DOM Exploring 窗格更漂亮，也更容易阅读。

你现在可以通过点击来编辑 HTML 内容和属性。当按 ENTER 键时，更改将应用于客户端。

![Editable HTML content 1](../Images/a94292e6a77dd06bf2b91a8fa39ec1e2.png)

![Editable HTML content 2](../Images/07529d442450954fa0d46cd6ae2b7794.png)

DOM 高亮特性更容易访问。当您的鼠标经过 Vorlon 仪表板中 DOM explorer 上的 DOM 元素时，就会发生这种情况。

![DOM Highlighting](../Images/3b2c22eeb318f7c1f6405c2437afb44f.png)

你也可以右击一个元素来删除或编辑内容。这是在属性上启用删除的最佳人机工程学方法。

![Editing elements with a right click](../Images/9591c21c8a5857ab4c85f282b60fb28e.png)

在右窗格中，你有更多的信息，现在只有真正的 CSS 代码。

“布局”选项卡为您提供了传统 F12 工具中常用的信息:边距、填充、边框和大小信息。

![Layout tab](../Images/9842d20230dc5fa9d351580a0c31024e.png)

对于包含所有显式和隐式继承的 CSS 样式的**计算样式**也是如此。

![Computed styles](../Images/a70d5974809906a27104fdc92f697771.png)

HTML 标签是编辑 DOM 中文本的更好的工具。您可以创建隔断线，然后点击保存按钮应用更改。

![HTML tab](../Images/892f7738c23852e2fd4c2d17004d74ea.png)

最后，**设置**部分是您可以激活 DOM 自动刷新的地方。

### 交互式控制台也有一些新特性。

![Interactive console](../Images/d0ab30f0c1203f2d6872df9228875f58.png)
