...
> 原文:[https://www.sitepoint.com/flash-mx-livemotion-2-0/](https://www.sitepoint.com/flash-mx-livemotion-2-0/)
...
![The Flash MX user interface](../Images/e7f4c77871f73ed4626c38dc0a8f20e4.png)*Figure 1: The Flash MX user interface*
...
![The Properties Inspector gives direct access to the selected object’s properties](../Images/11a653489a88ff4293f7cc7fdcccd75d.png)*Figure 2: The Properties Inspector gives direct acess to the selected object’s properties*
...
![The timeline now lets you group layers into folders to keep them organized](../Images/7829d1f2700a25b3df89cdbba4c5d57a.png)*Figure 3: The timeline now lets you group layers into folders to keep them organized*
...
![Editing a shape with the Free Transform tool in Envelope mode](../Images/1f179f43f3824d7655cf6efaaff39983.png)*Figure 4: Editing a shape with the Free Transform tool in Envelope mode*
...
![Positioning a shape precisely along pixel boundaries with Snap to Pixels](../Images/bf8134110575ab73fb27ff5295ee061b.png)*Figure 5: Positioning a shape precisely along pixel boundaries with Snap to Pixels*
...
![Use the Import Video to set compression options and preview your video](../Images/2b4804a30a640e2f2379687457f9f2c8.png)*Figure 6: Use the Import Video to set compression options and preview your video*
...
![The new Actions editor includes full code highlighting and hinting](../Images/df1166b05eff7813739f2e17821c67be.png)*Figure 7: The new Actions editor includes full code highlighting and hinting*
...
![The new ActionScript debugger lets you step through your code as it runs](../Images/fbdeb31ac14d0af970da8ea9e4916f8c.png)*Figure 8: The new ActionScript debugger lets you step through your code as it runs*

如果所有这些额外的脚本工具还不足以让您相信 Macromedia 希望您用 Flash 设计应用程序界面，那么新的基于组件的创作功能肯定会让您信服！图 9 显示了 Flash MX 附带的一组基本用户界面组件。

![MX includes a set of components, and lets you create and distribute your own](../Images/17651687eb0e96e80e8eb2ccb81c428a.png)*Figure 9: Flash MX includes a set of components, and lets you create and distribute your own*
...
![LiveMotion 2.0 Box Shot](../Images/d369df2f6b0d2f7cd8e6a8380c845ea4.png)尽管市场上有许多产品可以让你设计 Flash 动画(见我们对 [SWiSH 2.0](http://www.webmasterbase.com/article/681) 和 [Swift3D 2.0](http://www.webmasterbase.com/article/380http://www.webmasterbase.com/article/681) 的评论)，Adobe LiveMotion 却是 Macromedia Flash 的唯一直接竞争对手，这一荣誉令人怀疑。虽然 Adobe 似乎注定要赶上 Macromedia 推出的最具创新性的功能(毕竟，只要 SWF 文件格式不支持他们想要添加的功能，Macromedia 就可以自由地向 Flash Player 添加新功能)，但在我对 LiveMotion 2.0 的测试中，我发现了一种产品，它真正采用了一种不同的方法来制作 Flash 动画，并使其工作正常——在某些情况下，比 Macromedia 更好！
...
![The LiveMotion 2.0 user interface](../Images/5d50d32f29462f744011e50660dbabf5.png)*Figure 10: The LiveMotion 2.0 user interface*
...
![lets you add drop shadows without using a separate graphics app](../Images/c2e16efd450abf6323862a4a1c04ed05.png)*Figure 11: LiveMotion lets you add drop shadows without using a separate graphics app*
...
![A SitePoint logo created in (a) Macromedia Flash, and (b) LiveMotion 2.0\. The LiveMotion version ben](../Images/14a8bcea6b70d8962dfaabe8070d1585.png)*Figure 12: A SitePoint logo created in (a) Macromedia Flash, and (b) LiveMotion 2.0\. The LiveMotion version benefits from the bitmapped effects that LiveMotion provides.*
...
![Export panel lets you set bitmap quality options](../Images/7a0fa7a732bfa94a8857796b0c8d2ed0.png)*Figure 13: The Export panel lets you set bitmap quality options*
...
![The LiveMotion timeline is based on objects and time, not layers and frames](../Images/9adf9dfd32bf6133677035d8eb9f8b42.png)*Figure 14: The LiveMotion timeline is based on objects and time, not layers and frames*
...
![The LiveMotion script editor provides code highlighting and a reference panel](../Images/34db85f9aa98847bf2d553581c10838f.png)*Figure 15: The LiveMotion script editor provides code highlighting and a reference panel*
...
![LiveMotion includes a full-featured script debugger](../Images/98d85966dfb2b32a57795f952eee7e1c.png)*Figure 16: LiveMotion includes a full-featured script debugger*
...
![The TextFX LiveTab](../Images/4f44b3e3dfa0524c81b509bc7d0e20f8.png)*Figure 17: The TextFX LiveTab*
