...
> 原文：<https://www.sitepoint.com/testing-3-hosted-shopping-carts-operations/>
...
![shopify set up](img/a872387f7d4910ff12cdc88002af5c2b.png)

使用 Shopify 设置您的商店只需不到一分钟的时间，输入您的个人信息后，您会被带到仪表盘。

![shopify dashboard](img/cc7cbfef5c5a1c651320a5a0584642c0.png)

您可以在集合中对产品进行分组，这就像一个分类系统。

每个产品，你可以设置适当的搜索引擎优化设置和管理你的库存。

![shopify inventory](img/ad77bdd1694918f2cca61d2930736adf.png)

于是，几分钟后，我的第一件产品就展示出来了。

一切都非常清楚，直截了当。

![shopify pages](img/78ea27af0c6f3bd06a83feae676ff957.png)

有一个内置的 CMS，你可以用它来管理你的非产品页面，博客和页脚。同样，非常清楚，它只是做它需要做的。

![shopify cms](img/2ab5a06c9796278e1292935a04ad4e4e.png)

切换主题非常容易，只需从他们的主题商店中选择一个，并直接安装在您的商店中。

您可以下载文件来离线更改 HTML/CSS。

![shopify html](img/89568642194eeb11e2a2e8ac7d95a975.png)
...
![shopify apps](img/d68000a6fc9ef917cc338869d32a5492.png)
...
![yahoo start](img/91a0ea4366f7e9dc332e140ec9e203d9.png)
...
![yahoo copyright](img/70f7321a552c69e341f7c01d3f09b698.png)

下一步:添加产品。

同样，您可以通过执行一系列步骤来做到这一点。

![yahoo product info](img/18ce01a4905575ade3a5e41b1c088260.png)

每次你做出改变或添加产品时，你都必须发布你的站点，这让你等了半分钟。

![yahoo demo store](img/8128d678fa209df401edda96b4ba23f1.png)

几分钟之内，我添加了我的第一个产品。你可以为你的产品选择“选项”，就像这个例子中的困难。您可以使用此字段来销售产品的多个变体。

在完成所有额外的支付、纳税和运输步骤(这些步骤都非常简单，并且描述得很好)后，您将看到真正的仪表板。

![yahoo dashboard](img/8fcd3ccce8d62412f6bb185e917e7eba.png)
...
![magento start](img/84b6ee690c97ae27c68076ceeb2873c3.png)

Magento 提供了一个方便的设置向导，它会带你完成启动你的商店所需的所有步骤。在安装过程中，您可以选择加载示例数据，这样您就可以立即看到商店的工作版本。

![magento demo store](img/945e3e9505f9fb44d3956a73664843d2.png)

我选择将其设置在他们的英国数据中心(离我最近)，我惊讶地发现他们已经在底部添加了所需的 Cookie 法律通知栏。

![magento products](img/5e666ec68edb074353e862f00ad7a663.png)

当你开始在商店工作时，你很快就会发现为什么会显示设置向导:Magento 有很多很多选项供你配置，添加产品不像 Shopify 那么简单。

他们的导航栏相当广泛，配置屏幕一开始可能会令人生畏。

![magento configuration](img/0a44ef8b7bb9129d61b37a251954c329.png)

这是你作为一个开发者可以展示你的咨询能力的地方，当然，如果你知道你的方法的话。

![magento product info](img/b293783bdd71e09bea29832c62b97472.png)
...
| ![shopify desktop](img/caba25f75ffc34ae8f5698a063623dd9.png) | ![shopify mobile](img/a12b10b4964cab341b283a4bd38381a2.png) |
| *桌面版* | *手机版(响应式)* |
...
| ![shopify mobile dashboard](img/ff86da41e1f18b847fb3e4f76106392f.png) | ![shopify mobile products](img/bfa1931178917e8e20d5cf1c5926b39a.png) |
| *手机仪表盘* | *产品的移动编辑* |
...
| ![yahoo desktop](img/63b235a1d85009e734145ebfb75474ca.png) | ![yahoo mobile](img/b4cdacd71372e20011f6f115a29960ba.png) |
| *桌面版* | *手机版* |
...
| ![magento desktop](img/fb79bfd3892c27c1deca6cb60311aa9f.png) | ![magento mobile](img/5dd6a8435aa91038f9529131e5198425.png) |
| *桌面版* | *手机版(响应式)* |
