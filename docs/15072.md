...
> 原文:[https://www.sitepoint.com/build-a-mercator/](https://www.sitepoint.com/build-a-mercator/)

Gerhard us Mer ca tor:佛兰德制图师，他发明了“墨卡托投影”(1568 年)。T3】
...
13.  ![900_step10](../Images/5d09487dd9fa6c0b1c33c0b6b6d936bf.png)按 Ctrl+Shift+I 反转选择。然后按 Delete 键，再按 Ctrl+D 取消选择。然后再次应用“球形化”滤镜。这将增加线条的球形外观，同时增加球体的大小，这就是为什么我们在第 8 步缩小了球体。这就是让这个效果看起来又好又干净的秘诀。
...
*   ![900_gurutips1](../Images/0ab135908e42700f34638ec57211b3ee.png)The trick to getting the best results from this effect are is in Step 8 — scaling down the sphere before re-applying the ‘Spherize’ filter a second time.
...
3.  ![900_wireframe3](../Images/bc9e640cc36da772e23303c2289e407e.png)对选区应用从白到黑的径向渐变。按住 Shift 键，在圆的正中心启动渐变工具，并将其拖动到正中心。让选择继续。
4.  ![900_wireframe4](../Images/cc86ce3d758a23e78390d9db83fc0423.png)Add an Adjustment Layer right above the sphere layer (click the split black and white circle image at the bottom of the Layers palette). Choose the "Posterize" filter for this adjustment layer. Set the filter to 6\.
...
3.  ![900_style2step31](../Images/f8199c75b27d747838a9032a77f88b49.png)Again under the EDIT menu, go to the ‘Transform’ option and choose the ‘Scale’ function. Hold down the ALT key, grab one of the side control handles, and drag it inward so the circle gets thinner. Make it look like an oval — like the example image here.
...
*   ![900_gurutips2](../Images/9b8d4117657a8f6b13da60f224115a6b.png)At this point, you might do well to create a new custom Brush out of your Mercator shape. That way, next time it will only be one click away. So, how can you do it?
