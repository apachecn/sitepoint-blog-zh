# 父对象和 iFrames 之间的 jQuery 共享(inherit.js)

> 原文：<https://www.sitepoint.com/jquery-sharing-parents-iframes-inherit-js/>

用于通过 iFrames 在单个 jQuery 实例之间共享。请注意，iFrame 内容必须来自同一个域，否则这个插件将无法正常工作。

[下载页面](http://code.google.com/p/jquery-inheritance/downloads/list)
