...
> 原文:[https://www.sitepoint.com/css-angles-the-edge-you-need/](https://www.sitepoint.com/css-angles-the-edge-you-need/)
...
![Showing the border angle](../Images/b22fe68ad7bf1a2ab9739d7f26e5b998.png)

我们可以通过将`border-top-color`声明更改为白色来进一步强调这一行，这会创建一个带有框的挖空效果:它使它看起来没有顶部，但保留了角度。

![Triangles](../Images/6ff1ef62570afa38c1bc7a7a5fb16de4.png)
...
![Negative space](../Images/577329844d1c0b0b18010085657c3e79.png)

多做几次，混合一些定位，最终你会得到一个漂亮的，像指南针一样的方向箭头。每个三角形的斜度可以通过改变每个元素边框的宽度来控制。

![Our compass-like arrows](../Images/58c51b066fa40f2202b0f33bd0ad3fd1.png)
...
![A little shelf](../Images/2db89ff3fd9df6691e7f6552d7291a82.png)
...
![Anatomy of the shelf](../Images/459e5e68d197265bac592df4cb24a964.png)
...
![A shelf full of links](../Images/87d662c838d4b2d710ef38c82d502a98.png)
...
![Diagonal headings with CSS3](../Images/8fb7a3dc406d685bb524d2cac49483d3.png)
