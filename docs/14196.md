...
> 原文:[https://www.sitepoint.com/eval-is-dead-long-live-eval/](https://www.sitepoint.com/eval-is-dead-long-live-eval/)

我是拉克伦·唐纳德，SitePoint 的新人。我将和这里的其他人一起帮助 PHP 博客内容。

最近，Eval 似乎是一个热门的讨论话题，特别是考虑到最近[vBulletin](http://www.vbulletin.com/)T4】利用和[过去利用](http://www.osvdb.org/8400)在常见应用程序中，如 [phpMyAdmin](http://www.phpmyadmin.net/) 。Eval 是 PHP 中可以执行任意代码的函数之一。一般来说，eval 要么被缺乏经验的程序员出于各种错误的原因使用，要么被试图突破 PHP 界限的人使用。激励我发表这篇文章的是 PHP 的创始人拉斯马斯·勒德尔夫的一句话:
