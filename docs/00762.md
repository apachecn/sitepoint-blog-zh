...
![Using grid-auto-rows to specify the height of implicit grid items](../Images/dd363df62b8789c7b0f34a40dbee5d72.png)Using `grid-auto-rows` to specify the height of implicit grid items
