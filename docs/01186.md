...
> 原文:[https://www . site point . com/JavaScript-functions-that-define-and-rewrite-self/](https://www.sitepoint.com/javascript-functions-that-define-and-rewrite-themselves/)
