...
> 原文:[https://www . site point . com/how-to-use-the-new-custom-menu-feature-in-WordPress-3-0/](https://www.sitepoint.com/how-to-use-the-new-custom-menu-feature-in-wordpress-3-0/)
...
![](../Images/83acec616354eeb4b5026eb7e947e5a5.png "Add a new menu")
**添加新菜单**

一旦你添加了一个菜单，页面左侧的界面就会被激活:你现在可以添加类别或页面到你的菜单，以及任何你喜欢的外部或内部链接。您还会看到一个对话框，告诉您您的主题支持菜单，并要求您为主导航分配一个菜单:

![](../Images/f3230434a6fac3601925a7a7e2f8a471.png "Primary Navigation") **二十个十个主题的主导航**
...
![](../Images/35ca7d352feb91de5246016919789d17.png "Our secondary menu") **我们的二级菜单**
