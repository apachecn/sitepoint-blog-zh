...
> 原文:[https://www . site point . com/the-grand-tour-a-crash-course-in-Java-less-JSP/](https://www.sitepoint.com/the-grand-tour-a-crash-course-in-java-less-jsp/)
...
虽然我当时没有提到，但是 ToDoItem 类是根据**JavaBean s 标准T3】设计的。尽管它有一些更复杂的部分，JavaBeans 规范(不要与 Enterprise JavaBeans 混淆，这是一个完全不同的规范)主要只是**类和方法的命名约定。****
