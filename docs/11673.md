...
> 原文:[https://www . site point . com/easy-touchting-with-the-spot-healing-brush-in-Photoshop/](https://www.sitepoint.com/easy-retouching-with-the-spot-healing-brush-in-photoshop/)

![Photoshop_logo](../Images/f05c7df370dd24a454e0439410d1bd69.png "Photoshop_logo")
...
![Butterfly](../Images/0dc791b64e0270c84d2014bc25350710.png "Butterfly")

1.在工具箱中，选择斑点修复笔刷工具(![clip_image004](../Images/9184036b56e86b868afa71162997280d.png "clip_image004"))。

![clip_image006](../Images/b309ebfbbbf10265e220fb13e30ecbd3.png "clip_image006")
...
NaN.  On the tool options bar, click the Brush pop-up menu and make the brush slightly larger than the spot you want to remove. In this case I set the brush to be about 32 pixels and set the hardness to 25%.
    ...
    ![Brush Size](../Images/367b5064faa977ceaf1930d4d5a2889c.png "Brush Size")

NaN.  Using the Spot Healing Brush, click just once over the spot you want to remove.

    ![HealingBrushClick](../Images/38398816060492b965ae923160706288.png "HealingBrushClick")

当你用鼠标按下时，画笔的形状会呈现黑色或深灰色。然而，一旦你释放鼠标按钮，该区域将被“治愈”,斑点将消失。
![HealingBrushFinished](../Images/99da6642247a9d0a4a086c9a5d2089cf.png "HealingBrushFinished")
修复画笔的神奇之处在于它保留了纹理和颜色，但去除了污点。

要移除蝴蝶上的所有斑点，只需调整每个斑点的笔刷大小，使其仅比*稍大，然后单击一次。如果你让笔刷在每个点都保持相同的大小，你不会得到好的效果。这是一种比使用克隆工具更快的处理瑕疵的方法。*

 *![HealingBrushFinished](../Images/08f2f201f73285a4e93b184b8847c375.png "HealingBrushFinished")
哒哒！* 
