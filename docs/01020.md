...
> 原文:[https://www.sitepoint.com/add-authentication-vue-okta/](https://www.sitepoint.com/add-authentication-vue-okta/)
...
![Vue.js Homepage](../Images/a2fe9a91995ee86b3a2de71f88b87cf9.png)
...
![Welcome to Your Vue.js PWA](../Images/9651b6127fb44ae140a69adcc29fdebb.png)
...
![Okta Developer Sign Up](../Images/7880c60816741b9df17ada0cac58bac4.png)

登录后，单击“添加应用程序”创建一个新的应用程序。

![Add Application](../Images/4fbf32887333a7879dd005e13d594efa.png)

选择“单页应用程序”平台选项。

![New Application Options](../Images/0bda5207569feded45a5c8d068570869.png)

默认的应用程序设置应该和图中的一样。

![Okta Application Settings](../Images/d98cc78f6b7aa870e38a98824185cd88.png)
...
![Hello World](../Images/2e2e7ed1358d694bb52b86a321f83b5c.png)

如果你点击**帖子管理器**或**登录**，你应该会被引导到 Okta 的流程。输入您的 Okta dev 帐户凭据。

**注意:**如果您登录到您的 Okta 开发者帐户，您将被自动重定向回应用程序。你可以用匿名或私人浏览模式来测试。

![Okta Sign-In](../Images/e0f939b36f2d3164cccbc15d20e0cd80.png)

如果成功，您应该返回登录的主页。

![Homepage after logging in](../Images/f3a4c45f7986c077802886f7e8ec5b0d.png)

点击**帖子管理器**链接应该呈现受保护的组件。

![Posts Manager](../Images/92a3036d7884260820c68b497278b84b.png)
...
![New Post](../Images/65c115c25c7a5b05bc098abd7f86b5e0.png)

![New Hello World Post](../Images/3c04edadd609d51d0404b420e2bbb75f.png)

![Delete Post](../Images/97e769caefda9aa0951abbec9714dcdf.png)
