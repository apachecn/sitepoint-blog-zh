...
> 原文:[https://www . site point . com/jam stack-form-handling-cloud flare-workers/](https://www.sitepoint.com/jamstack-form-handling-cloudflare-workers/)
...
![sandbox sending domain setup](../Images/f2a24c78610403c88d49d3596b00c154.png)
...
5.  应该会出现一个请求选项卡。点击它进入。应该会有一些 JSON 数据。属性“key”是 API 令牌。复制它。
    ...
    ![01-wrangler-login-workaround](../Images/72f9b8981e80cc04c49b6c5019cb6541.png)
...
2.  将您的域名服务器更改为 Cloudflare: [此处有说明](https://support.cloudflare.com/hc/en-us/articles/205195708)。
    ...
    ![02-global-dns-checker](../Images/159fb9f97516ff65189f8856a6d3083a.png)
...
![first workers request](../Images/d5b6342111806983abeb578564007b74.png)
...
![successful post request](../Images/49ca64f9a11b2bad6abc585ac1bd144b.png)
...
![post request invalid missing fields](../Images/5a905392607e3a75f9662d589dad361d.png)
...
![cloudflare form env variables](../Images/21b8b358509cdad8be58c12bac229a7e.png)
...
![sendmail inbox](../Images/10bf2b675c4abae7b3e6fb32cc9fb192.png)
...
![cloudflare dns subdomain](../Images/9f0c8f006886456ab869d50ed30d7436.png)
...
![cloudflare form ui deployed](../Images/96829cba02fe2efdb22e3add95ba4849.png)
