...
> 原文:[https://www . site point . com/self-sizing-cells-uitableview-auto-layout/](https://www.sitepoint.com/self-sizing-cells-uitableview-auto-layout/)
...
![Create Class](../Images/9d7a2decd1c4d316da7df76f6c41cf09.png)

然后创建一个`UITableViewController`的子类。因为我们将在应用程序中使用故事板，你可以不勾选*也创建 XIB 文件*选项。

![UITableViewController Subclass](../Images/9d5d1f9fee8b9a745b50e97e4bef9545.png)

在*单元格*组下，创建`UITableViewCell`的子类。

这一次，我们**将**检查 XIB 选项，因为我们稍后将使用它来设置单元。

![UITableViewCell Subclass](../Images/4313b391e6be18024338530626878b7a.png)
...
![Change UITableViewController Class](../Images/1a38b7d30ee9ec76f9cc6bd64345fcd0.png)
...
![Set Initial View Controller](../Images/1a385a53c8145719f3900232c6eea760.png)

故事板现在应该看起来像这样:

![Storyboard](../Images/ac5193f5eeab9e2b072bac08a4723288.png)
...
![TableViewCell](../Images/3ee641d25f026aa540d9fe05dcfe5805.png)
...
![ImageView](../Images/32fee97c10c7b979fd58dc49877ac3de.png)
...
![Label Config](../Images/46d17a55b1970ca5dfc88d0f2e9cd237.png)

![Label Bounds](../Images/aac048b829f9b5b9f519ec4c8eaaae7f.png)

当设置标签的约束时，将*内容拥抱*优先级设置为值 751，即高，这将确保标签将调整大小以适合其内容。

![Label Constraints](../Images/4b88362ec19d602c99a0228a7a3e2979.png)

#### Name Label

由于名称不太可能很长，并且需要多行，所以我们将行数设置为 1，将高度设置为固定的 21 磅。

![Name Label](../Images/8ecfb96a30703054446a485ebca2b2d1.png)
...
![Final App](../Images/4378a68995653005563e054f70714829.png)
