...
> 原文:[https://www . site point . com/were-building-a-marvel-catalog-reader-Avengers-assemble/](https://www.sitepoint.com/were-building-a-marvel-catalog-reader-avengers-assemble/)

在本教程中，我们将看看[漫威 API](http://developer.marvel.com/) ，这是漫威为开发者提供的一个工具，用于访问漫威漫画 70 多年的数据。

![Marvel logo](../Images/0510ba260c1f5cb5efb15e5ea61c568c.png)
...
![expected data](../Images/67485d23aa54f2e00c0d6a8c7c0954cc.png)

…用于指定为请求提交的不同参数的文本字段:

![parameters](../Images/495c2f16a172fdcb9235b4281ab3463e.png)

…错误状态代码:

![error codes](../Images/c6f843d024b64f4dbb68381606100a4d.png)

…请求 URL、响应正文、响应代码和响应标题:

![request and response](../Images/9fd086d72585ade45947a3ab642fba82.png)
...
![comics page](../Images/e6befec1175ee460ef1d75d2262c05fd.png)
...
![comic page](../Images/bc99edeb95899d3649257445295cd091.png)
...
![characters page](../Images/d5ad02ca73228bf6d98454476d1095d0.png)
