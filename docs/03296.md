...
> 原文:[https://www . site point . com/how-to-add-images-into-your-pebble-watch faces/](https://www.sitepoint.com/how-to-add-images-into-your-pebble-watchfaces/)
...
![Image Converter for Aplite](../Images/75990feedcc4582e51f9a7be2d13f4af.png)

您可以向下滚动，更改亮度、对比度等。一旦您对图像的外观感到满意，请点按页面底部的图像，将其下载到您的电脑上以备使用。

![Downloading from Image Converter](../Images/528c4587d77dd1fe17a94a75be1138ab.png)
...
![HyperDither](../Images/1b4e2f78729c204f593aee1b2e790a02.png)

将图像拖到应用程序中:

![HyperDither with an image](../Images/94491267fae11191521de7da68cd30cd.png)

然后，您可以调整设置，例如“对比度”,如下所示:

![HyperDither with the contrast option](../Images/3b5cfaa1cf994c23a4cb304d68dafc9a.png)

或者锐化它:

![HyperDither with the sharpen setting](../Images/c70a115e2f08b1c2d55b5128b6b03128.png)
...
![Selecting the indexed color option in Photoshop](../Images/de15034979c5fc781470cece78d0074c.png)

为你的调色板选择一个“局部”或“统一”选项，将颜色数量设置为 2，并调整扩散选项，看看什么最适合你的图像:

![Photoshop's Black and White dithering settings](../Images/a634b85c8ce16d8a26523b2785a2b21e.png)
...
![Image Converter creating an 64 color image](../Images/a23d4c55984bc0ff20e2819c4625c447.png)
...
![Downloading the .act file for Photoshop](../Images/a2e40a824d8e8166852e9e60ff35403c.png)

然后，返回到*图像>模式>索引颜色…* ，但是从调色板中选择“自定义”。会出现一个要求“颜色表”的对话框，点击该屏幕上的“加载”并找到您的`.act`文件:

![Loading a custom palette in Photoshop](../Images/23b833fdff9c69b02c1887611eec50a4.png)

64 色调色板看起来应该是这样的:

![The 64 color palette loaded in Photoshop](../Images/22ffe1e06d18694c911960cd81b45b82.png)

单击“确定”,然后您将返回到可以调整设置的屏幕:

![Photoshop's 64 color dither settings](../Images/66a9ec04a6e0339c041b161a09ab4a1a.png)
...
![Adding a new resource](../Images/f554a4ec38bb45eb6b650d9bf109b0cd.png)
...
![Uploading a resource image](../Images/bc3f6e25d478a1112cad5e58233ded2e.png)

如果您点击“保存”，图像资源将被上传，您将看到一个更新的界面，预览您的图像在每个可用的平台。如你所见，我们目前在每个平台上都显示黑白图像。接下来，我们将添加其他特定于平台的映像。

![Monochrome image uploaded successfully](../Images/ad642dad288553509ebdf18ca62ce400.png)

如果你滚动到资源屏幕的底部，你会发现一个“上传新文件”部分。把你的矩形彩色图像上传到那个里面。加载时，您会看到界面因冲突而变红。不要害怕。这只是意味着我们需要添加一些标签，以便它知道每个图像是为不同的平台。

![Conflicts in resource uploads](../Images/7c5236c6b013900a7812f4e69915eceb.png)

回到我们的黑白图像，并添加标签“单色”。这告诉我们的 Pebble 应用程序，该图像用于黑白显示(例如我们的经典 Pebble 和 Pebble Steel)。

![Tagging monochrome image](../Images/dcf3fe56dfb9f9af8cf78aad4f9eeeb1.png)

一旦有了这个标签，您应该会看到“Aplite”平台被自动检测到，危险的红色冲突消息已经消失。

![Aplite tag replacing conflict one](../Images/2dc67e7936e061d14148ebe57f36eeb9.png)
...
![Other tags appearing automatically](../Images/e561deb6b639eb33ed383c435d9dc977.png)

保存后，您现在应该可以看到细晶岩的黑白图像以及玄武岩和白垩的彩色图像。

![Basalt image uploaded successfully](../Images/b5600d6e26e1e041c2ed3c072220f165.png)

向下滚动，最后一次点击“上传新文件”选项。选择你的正方形彩色图像。它将再次出现冲突，因为我们还没有告诉它要关注的平台。键入“Round”作为该图像的标签，它会自动将该图像的平台设置为 Chalk-Pebble Time Round 平台。

![Tagging an image as round](../Images/3acc33808c4e0ebf5d050eb386197239.png)

我们的矩形彩色图像被自动赋予玄武岩平台，因为它是唯一剩下的平台。

![Automatically tagged basalt image](../Images/08830a43b37ab71497795249f83aca4e.png)

给这张图片添加“颜色”和“矩形”的标签。这确保了在未来的平台上也能正确使用该映像。他们将知道该图像用于这些目的，并确保我们能够控制该图像的使用时间。

![Tagging rectangular color image](../Images/1a02689776191397cd77846a95581bbf.png)

单击“保存”保存我们新的正方形彩色图像和我们包含的新标签。保存后，我们应该会看到图像的每个版本都显示在正确的平台预览中:

![All resources uploaded successfully](../Images/ead78f5de2ede3d81df08cdf4bd9574e.png)
...
![Our App Running in Aplite](../Images/0724dcb7221c813d8f9e4c0f16a7236f.png)

这是玄武岩上的:

![Our App Running in Basalt](../Images/d77ea663494543fb7405481fd3a8ecc4.png)

在圆形粉笔平台上，它看起来是这样的:

![Our App Running in Chalk](../Images/d5211f603acf119f892b32c393a8511f.png)
