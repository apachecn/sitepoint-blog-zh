...
> 原文:[https://www . site point . com/10-lightweight-minimal-CSS-frameworks/](https://www.sitepoint.com/10-lightweight-minimal-css-frameworks/)
...
![1-line-CSS-Grid-Framework.jpg](../Images/8ec47df149c946a150b3364f6a51b8b8.png)
T3】来源

## 微小流体网格

Tiny Fluid Grid 附带了一个带有演示代码的 index.html，以及包含您创建的网格的 css 的 grid.css。
![Tiny-Fluid-Grid.jpg](../Images/2026d89922746ed5656cf5cacff5d4ff.png)
T3】来源

## 1KB CSS 网格

不需要博士学位的简单、轻便的方法。
![The-1KB-CSS-Grid.jpg](../Images/2eab6913d5e3c425bba075dec615e506.png)
T3】来源

## 感觉

代表合理的标准 CSS 基线，(读作“sense”)。它为 CSS 中所有重复的部分提供了合理的样式，并且不会强迫你使用一个布局系统。
![SenCSs.jpg](../Images/c62a6740d4c4397aa3a67a926d348213.png)
T3】来源

## 有限元 CSS 框架

基于 960.gs 的固定布局，但其理念有所改变，使其更灵活、更快速地使用盒子。它只有一个 12 列的网格，各列每边有 10px 的边距，形成一个 20px 的装订线，让各框之间有一些空隙。
![FEM-CSS-Framework.jpg](../Images/e6db3ba5c5da0b9595650370d0dbcc68.png)

## 基线

Baseline 以排版标准为基础，使得开发一个具有令人愉悦的网格和良好排版的网站变得非常容易。
![Baseline.jpg](../Images/4e8ca6cc6cc52fc28f94ff6b9a6ddfe0.png)
T3】来源

## 共济失调 CSS 框架

工作就像任何其他网格系统，但只有大约 10 行的 CSS，它的主要重点是排版。这个项目背后的想法是提供一个坚实的，但最小的，开始每个开发项目的基础。
![Atatonic-CSS-Framework.jpg](../Images/60b9caa815cba03cd13c58d59d4e75e9.png)

## 正方形网格

基于 35 个等宽列的简单 CSS 框架。您可以在各种列中使用网格:18、12、9、6、4、3、2，网格的总宽度为 994 像素，这是大多数现代显示器都支持的。
![The-Square-Grid.jpg](../Images/6f58f6513f52c07bd5209ba8e5ce49e1.png)
T3】来源

## 少框架 3

已经过构建，因此您可以正常设计默认布局，然后使用内嵌媒体查询设计所有附加布局。
![Less-Framework-3.jpg](../Images/00e01bacec96a10b412b00434f3fa68f.png)
