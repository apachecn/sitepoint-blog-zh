...
> 原文:[https://www.sitepoint.com/pusher-vue-real-time-chat-app/](https://www.sitepoint.com/pusher-vue-real-time-chat-app/)
...
![The ChatKit dashboard](../Images/bfd9c25506bd6947c7767a5cc53e91af.png)

单击“创建”按钮创建新的 ChatKit 实例。我要叫我的`VueChatTut`。

![Creating a new ChatKit instance](../Images/b374467bb3b5dc2846e06618422258d0.png)

在本教程中，我们将使用免费计划。它支持多达 1，000 个独立用户，这对我们的需求来说绰绰有余。前往*控制台*标签。您需要创建一个新用户来开始。继续点击*创建用户*按钮。

![Creating a ChatKit user](../Images/16dd4c8ba5ddd9669c726163f22c66a4.png)
...
![A snapshot of the console](../Images/d60a935518a6f01ad0c0f22007d9274e.png)

接下来，您可以转到*房间*选项卡，使用为每个房间选择的用户创建一条消息。这是为了测试目的。然后转到*凭证*选项卡，记下*实例定位器*。我们将需要激活*测试令牌提供者*，它用于生成我们的 HTTP 端点，并记录下来。

![Test token](../Images/6e103e8dd52bf479054101e3565f7854.png)
...
![Questions to be answered](../Images/8395c2bf0aa886b099ba565f025aea72.png)

确保你已经选择了 Babel，Vuex 和 Vue 路由器作为附加功能。接下来，创建以下文件夹和文件，如下所示:

![Files and folders to create](../Images/1cf0658e0d17f4399e9fd757659f27ef.png)
...
![Our login UI](../Images/a9b95120feb08e7f4304684b8d062b52.png)
...
![The blank chat dashboard](../Images/18b0281288b681489352a2a04fc36ed0.png)
...
![Displaying mock data](../Images/823d622b4aa2e822ee73ff8524c58a2c.png)
...
![A login error](../Images/17e9f1728cbc5515e1c02646f37f9c2d.png)

在上面的例子中，我使用了一个不正确的用户名，只是为了确保错误处理功能正常工作。

![A successful login](../Images/cb08a1e12489dda8e3d83c8de412c42c.png)
...
![More detailed login information](../Images/2ac4092eed10b666a3dc840f23fa1066.png)
...
![The current chat dashboard](../Images/ffcfc465de971f3ed9613c92268cdc43.png)
...
![Changing chat rooms](../Images/c35927ca18314d0e56a34c2cb08fd256.png)
...
![A notification in another user’s chat window](../Images/acffa11d3b11ff4812116cebb2c1c873.png)
...
![Switching between member accounts](../Images/9bbff4dfa7eba701c86383e2aed9789d.png)
