...
> 原文:[https://www.sitepoint.com/css-desktop-adobe-air/](https://www.sitepoint.com/css-desktop-adobe-air/)
...
![Application options form in Aptana ](../Images/353fe8fd76998edffabd136092aafea1.png)
...
![The Harpoon application custom window chrome](../Images/8ff98ad69d999e98f190197350ff8eac.png)
...
![body element padding](../Images/e4d49c8eac53157f303f312b5fae68f3.png)
...
![#wrapper, #head, and #foot elements](../Images/9e9d16c355d9b653a01487dd3533a2ab.png)
...
![Position of the #app element](../Images/72df180ff33b8f432cfbe73c311f9c97.png)

好了，我们的布局完成了。为了向您展示它的灵活性，下面的应用程序显示了一个搜索结果列表，同时调整了大小:

![Resized window and scrolling content](../Images/d2fe5f0c1565256f88ea0cbdd0c03448.png)

##### 窗口控件

暂时忽略中间的应用程序区域，下一步是连接所有的窗口控件，比如最小化和退出按钮、窗口拖动和调整大小手柄。计划是这样的:

![Harpoon window controls](../Images/a76379225556dfa495f4cf1a87e6f908.png)
...
![CSS applied to the minimize and quit buttons](../Images/5fa047b61fe938e61455bd9833d82feb.png)
...
![The window resize handle](../Images/45baae704d6c8935f1f14da77a54a1b9.png)
