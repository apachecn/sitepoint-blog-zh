...
> 原文:[https://www.sitepoint.com/deploy-your-rails-app-to-aws/](https://www.sitepoint.com/deploy-your-rails-app-to-aws/)

![vector illustration of personal computer display showing window with deploy title isolated on white](../Images/324e594619262d24a4ce900d57770eaa.png)
...
![rails-aws-1](../Images/e8684dc98b32498bec8ee91753caa154.png)

单击“启动实例”:

![rails-aws-2](../Images/3449e94a58bc0ee86dcbf1586c859884.png)

选择一个 Amazon 机器映像(AMI)。我们将使用“LTS Ubuntu 服务器 14.04”:

![rails-aws-3](../Images/1a18e9c55f9a3e6b6af8e74a4d2e4b06.png)

根据您的要求选择实例类型。我选择“t2.micro ”,因为它免费/便宜。对于真正的生产服务器，您可能希望更大。单击“下一步:配置实例详细信息”继续。

![rails-aws-4](../Images/c7b7bb75807ddd752d849e8084bc1d48.png)

默认设置适合我们的教程。单击“下一步:添加存储”。

![rails-aws-5](../Images/e3aecc22f6cad952d856aaea10f35b31.png)

默认存储为 8GB。根据您的空间需求进行调整。单击“下一步:标记实例”

![rails-aws-6](../Images/219831efe6c3976cf32c9e9479dad04e.png)

输入实例名称。单击“下一步:配置安全组”。

![rails-aws-7](../Images/dc6f2330bce24064fa5f58a18c577286.png)

单击“添加规则”。从“类型”中选择“HTTP”。这是从互联网访问 nginx 服务器所必需的。点击“查看并启动”

![rails-aws-8](../Images/4b38ad534a650b4b5950feba736d6925.png)

检查所有设置是否正确。点击“启动”

![rails-aws-9](../Images/ceda79e64a86578694e4108efdbbcb42.png)

选择或创建一个密钥对以连接到实例。为了 ssh 到 EC2 实例，您的本地机器上必须有私钥。关键要活在你的 **~/里。ssh** 目录。单击复选框“我确认…”并单击“启动实例”。等待实例启动。

![rails-aws-10](../Images/edcecb287c5d4bf3c87a5d79ef4ad40f.png)

该实例应处于“正在运行”状态。选择实例并单击“连接”。

![rails-aws-11](../Images/eea54147254ddbb961e883f239e5b758.png)
...
![rails-aws-12](../Images/884b8004bee118fa74c4d669d624ed5c.png)
