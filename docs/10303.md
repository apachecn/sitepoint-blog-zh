...
> 原文:[https://www.sitepoint.com/jquery-matrix-effects/](https://www.sitepoint.com/jquery-matrix-effects/)

## 介绍

这是一个很酷的 jQuery 插件，基于著名电影《黑客帝国》。这很简单。这个插件模仿电影本身的数字效果，选择一个将变成它的图像，并开始做修改。你应该试试这个，很有趣！

![jquery-matric-effect](../Images/8248ac32497d8bdbd716ae390a1b3d0b.png "jquery-matric-effect")
