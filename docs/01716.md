...
> 原文:[https://www . site point . com/Skype-bot-electronic-Microsoft-bot-framework/](https://www.sitepoint.com/skype-bot-electron-microsoft-bot-framework/)

![A humanoid robot (built with Microsoft Bot Framework?) serving coffee to office workers](../Images/9b54d9e550d8a57e31d7d936a35af1c5.png)
...
![bot framework connectors: Kik, Skype, Twilio, Telegram, Microsoft Teams, Office 365 mail, Slack, Facebook Messenger, GroupMe](../Images/a5bd53b9b8992be50cce670433c886a4.png)
...
![Rugby ball](../Images/35fc0130e9173c946c1318556b341d79.png)
...
![The default screen of a new Electron Boilerplate app](../Images/17e3cfd1adc52a09b3943d876ef0692d.png)
...
![The team management screen, with options to select or add a team](../Images/c308770b45fdba2f2fe51a47c9613d2b.png)

![Typing in a new team name](../Images/ff55fac476029f94e43c17ea16231f83.png)

![The 'New team added!' success message](../Images/4ed4b8ebe7a392b9021696a75bbdeb76.png)
...
![bot](../Images/a1735147e7490b119fe6d5709bacb553.png)
...
![bot framework architecture](../Images/3ddee4b10687adb526b3387ee62f46cd.png)
...
![Microsoft Bot Framework Emualator](../Images/4e80454106460aad5d98fef323073678.png)
...
![emulator connect config](../Images/94fbf89a21de772c3c07c88fa1876a59.png)

将 Microsoft 应用 ID 和密码留空；因为我们正在本地运行测试，所以不需要这样做。点击*连接*。

现在你可以试试这个机器人。你总是会收到 Hello World 消息，因为这是我们目前为止配置的全部内容。

![emulator hello world](../Images/3f1cec86a8760380bc323a82a91052c3.png)
...
![emulator waterfall](../Images/c9c78c533610356f261af4ca35a74bf1.png)
...
![emulator first run](../Images/2417a9ccb5ae98b87ecff45cae24f9e0.png)
...
![demo #1](../Images/2417a9ccb5ae98b87ecff45cae24f9e0.png)
...
![demo #2](../Images/719f8851db6c7bcc5cef1f5a7a6145b0.png)
