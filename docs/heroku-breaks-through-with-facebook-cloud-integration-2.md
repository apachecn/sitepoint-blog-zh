...
> 原文：<https://www.sitepoint.com/heroku-breaks-through-with-facebook-cloud-integration-2/>
...
![Success dialog](img/61c51c7926f02b6364068859dfd0139c.png)
...
[![](img/2c04021654df04a50b46e4979d83b631.png)](https://www.sitepoint.com/wp-content/uploads/2011/09/permission_dialog1.png)
...
Email: adam@example.com Password:
...
```
$ git clone git@heroku.com:furious-robot-218.git -o
heroku Initialized empty Git repository in /Users/adam/facebook-template-php/.git/
remote: Counting objects: 273, done.
remote: Compressing objects: 100% (183/183), done.
remote: Total 273 (delta 2), reused 261 (delta 0)
Receiving objects: 100% (273/273), 25.55 KiB, done. Resolving deltas: 100% (2/2), done.

$ cd furious-robot-218

$ ls AppInfo.php FBUtils.php close.php images index.php stylesheets utils.php 
```
...
[master 0ff313a] changed greeting 1 files changed, 1 insertions(+), 1 deletions(-) 
```
...
SetEnv FACEBOOK_SECRET dcd5d23d003d53cb2b68e01 </VirtualHost> 
```
