...
> 原文:[https://www . site point . com/setting-up-PHP-7-servers-with-laravel-forge-and-digital ocean/](https://www.sitepoint.com/setting-up-php-7-servers-with-laravel-forge-and-digitalocean/)
...
[![DigitalOcean logo](../Images/56376fb5da0bc40b828a8f3956521ac2.png)T2】](https://www.digitalocean.com/?refcode=173851694812)
...
![Server Creation Page](../Images/cd7198d8c00192e22961024c2eacb3ad.png)
...
![Enable Backup on DO](../Images/d3ea365f7f4a9465af364dc139a12a4c.png)
...
![Server Provisioning](../Images/50134473e44b1a63ed76d5b4b788c0e0.png)

一旦提供了服务器，我们就可以通过类似于 [PuPHPet](https://www.sitepoint.com/5-easy-ways-getting-started-php-vagrant/) 这样的工具的界面来配置它。

![Server configuration](../Images/c332c657edc0b3ce80ebf8778de4e226.png)

在这一点上，Forge 提供了一些令人难以置信的实用功能，可以说一举证明了其价格的合理性。从图形用户界面编辑 PHP 配置…

![PHP-FPM configuration interface](../Images/1c48629906b2a2e4e4d6d494f8804039.png)
...
![The Server is Running](../Images/d7edbcf06f401155c38d2816e771450f.png)

一切都好！现在，让我们添加一个新站点。不设置专用域，我们就用 IP，点击修改按钮，修改 forge 添加的默认站点。下一个屏幕将让我们将 Github repo 绑定到我们正在创建的应用程序，这就是前面提到的 Dash repo 的用武之地。

![Binding a repo to the app](../Images/4fe59a6a1122560d874d22b45f3990be.png)
...
![Emmet view of several dashboards](../Images/694a5241ca1c39aafc66bde45c68880e.png)
...
![Working info screen](../Images/b907f23897f47aadeec0ece524bbc3d1.png)
