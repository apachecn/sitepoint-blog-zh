...
> 原文:[https://www.sitepoint.com/puppeth-introduction/](https://www.sitepoint.com/puppeth-introduction/)

我们之前已经写过关于 Geth 的文章，这是最受欢迎的以太坊节点之一。

![Download screen](../Images/ded4cd769bceca178ec02e9893523a31.png)
...
![Ethstats local](../Images/30485fc61cb6db8f4e283f447531471a.png)
...
![Booty is listed](../Images/021755b6460fa9c063f0ca206cff7a07.png)
...
![Sealer has been added](../Images/a4efc649e1ef7e03646f99412d766db8.png)
...
![connected](../Images/2f0dfcd9bd79a31f2d76a731997ecb1e.png)
...
![All services are listed](../Images/2f38ec0cfd1020af10181db158ce6a11.png)

### 仪表盘

最后，Puppeth 提供了“仪表板”，这是一个 web 界面，它结合了我们迄今为止推出的所有界面。部署过程同样简单:只需按照步骤操作，当询问是否链接到现有组件时，选择那些我们已经启动的组件。最终结果应该是这样的:

![Dashboard](../Images/2dd1a4cb3de36839331e0dfc53c73da8.png)
