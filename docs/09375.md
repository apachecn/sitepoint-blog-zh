...
> 原文:[https://www.sitepoint.com/10-plugins-august-2011/](https://www.sitepoint.com/10-plugins-august-2011/)
...
![Font-Sizer.jpg](../Images/b8ab5b4e411d6a5e40fb8a1ecc77bd56.png)

## 2.提示 2–jQuery 工具提示

允许你使用 jQuery JavaScript 库轻松创建漂亮的工具提示。Tipped 从流行的 Prototip 库发展而来，通过使用 HTML5 让你完全控制工具提示的外观和感觉，将工具提示提升到了一个新的层次。
![Tipped-2.jpg](../Images/3fdf6ac61bb11d9bacc95f6b618a089d.png)
...
![Auto-Truncator1.jpg](../Images/bf680705802e2acd6d53c194b1d225a0.png)
...
–文档有点差，而且不太用户友好。
![jOVI.jpg](../Images/dd789937b2bca01ff4fb0e3dc98d7a98.png)
...
![Minimal-Placeholder.jpg](../Images/4b061e96bab85eb930da6ac06bda1a50.png)
[来源](http://matthewbjordan.me/mph/)

## 6.copyCSS

一个小小的更新，另一个扩展简化了将样式复制到另一个元素。
![copyCSS1.jpg](../Images/bb7f4d2808f38eb5d0f1cdd1a683c59d.png)
[来源](http://upshots.org/?p=192)

## 7.jQuery 字符限制

这个插件允许表单输入域和文本区域元素有字符限制。字母数字是默认设置，但是可以选择仅字母、仅数字和正则表达式。其他允许的字符可以添加到字母数字、字母和数字选项中。
![jQuery-Character-Restriction.jpg](../Images/17aced662da0d0056dfdf00c5830c02b.png)
...
![Auto-Save-Form-script1.jpg](../Images/c0f07b72afd457e5a52385d1ae455c5b.png)
...
![ht5ivf.jpg](../Images/e9320e6142e365fb74459354349911f5.png)
...
> jQuery 漂亮的悬停效果。
>轻重量
![Smart-Social-Counter.jpg](../Images/6069c08c7fe6558dc75819309cb48cfb.png)
