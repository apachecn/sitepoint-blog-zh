...
> 原文:[https://www.sitepoint.com/10-jquery-inline-editor-plugins/](https://www.sitepoint.com/10-jquery-inline-editor-plugins/)
...
![WYMeditor-web-based-XHTML-editor.jpg](../Images/345f923b5b075c165cbf4c774e8da483.png)
T3】来源
...
![PimenTech-scripts-jqueryjframejs.jpg](../Images/cf6d983cf0737d904d5ecb7cf95f323c.png)
T3】来源

 [T2】](http://www.appelsiini.net/projects/jeditable)
...
![Jeditable-Edit-In-Place-Plugin-For-jQuery-.jpg](../Images/5b7aa6e3beef00129451b24180b88900.png)
T3】来源

 [T2】](http://www.dyve.net/jquery/?editable)

## [4。可编辑](http://www.dyve.net/jquery/?editable)

用 jQuery 创建就地编辑字段的简单方法。
![editable.jpg](../Images/b6690810ccc60b044611f53235f94b5f.png)
T3】来源

## 5.使用 jQuery JavaScript 库使用 AJAX 就地编辑

一个 AJAX(或 AHAH)概念验证页面，允许访问者在不离开页面的情况下编辑他们正在查看的 HTML 页面。
![Edit-In-Place-with-AJAX-Using-jQuery-JavaScript-Library.jpg](../Images/c73145e24e963d5807edbea844fdf2d6.png)

 [T2】](http://dev.iceburg.net/jquery/tableEditor/demo.php)

## [6。表格编辑器](http://dev.iceburg.net/jquery/tableEditor/demo.php)

提供灵活的 HTML 表格就地编辑。用户定义的处理函数可以很容易地加入进来，例如，通过 AJAX 请求更新数据源。
![TableEditor.jpg](../Images/a49a12723633f21fa3a8fe5d749695db.png)
T3】来源

 [T2】](http://www.codenothing.com/archives/2009/inline-text-edit/)

## [7。嵌入式文本编辑](http://www.codenothing.com/archives/2009/inline-text-edit/)

允许用户通过 ajax 调用在浏览器中编辑文本块，而不是重新加载页面。使用半特定的 DOM 树。
![In-Line-Text-Edit.jpg](../Images/78442ac7562a4690d92f119990a60c12.png)
T3】来源

 [T2】](http://www.yvoschaap.com/instantedit/)

## [8。AJAX 即时编辑脚本–干净的 HTML](http://www.yvoschaap.com/instantedit/)

这是一个即时编辑脚本，你可能会喜欢。尽情享受吧！
![AJAX-instant-edit-script-clean-HTML.jpg](../Images/aafa8d663e6504f0806ebb9caf5aa601.png)
T3】来源

 [T2】](http://inplacericheditor.box.re/demos)

## [9。就地丰富编辑器](http://inplacericheditor.box.re/demos)

在 FF 3+，IE 6+，Safari 4+，Chrome 11+和 Opera 10+
![Inplace-Rich-Editor.jpg](../Images/61a48272be63697338b4ef71c27ee23a.png)
[上测试来源](http://inplacericheditor.box.re/demos)

## 10。约瑟夫·斯科特·杰普

一个简单的 jQuery 就地编辑插件。
![Josephscott-Jeip.jpg](../Images/ceb9592307b4c0b94f1a05b468b167fd.png)
T3】来源
