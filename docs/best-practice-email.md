...
> 原文：<https://www.sitepoint.com/best-practice-email/>

![Postcards - the first graphic mail format](img/7fb55ce0e83c5ed547278633baeec403.png)
...
![Email in AOL View Pane](img/12718270bd7cb1871411a4747edcc515.png)

### 规则二。少用背景图片

自 2007 版以来，Outlook 已提供零背景图像支持。在你的设计中使用分层图像时，确保它们可以优雅地降级。始终使用纯色背景作为 Outlook 的备用颜色，并确保没有重要信息或图像只存在于背景图像中。

![Background image with fallback for Outlook](img/2a1ee237747defa180bbcd1e0fc43058.png)
...
![Email with good use of text and images](img/3d740d76f624c77d140b3d38d49adbce.png)
