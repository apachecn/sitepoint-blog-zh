...
> 原文：<https://www.sitepoint.com/stretchy-images-with-html-and-css/>
...
![Stacking order diagram](img/67864a72f6b72f0a9f1d370e2a5b92d0.png)

我们的图像由三个较小的重叠图形组成，每个图形都被设置为`**position:absolute**`，这只是简化了重叠它们的整个过程。包含它们的包装 DIV 被设置为`**position:relative**`,以将它们保存在它们的盒子中。

![Stretchy images in action](img/ce33af85302d024b08eaa701510e88d1.png) **图文 1:书**
...
![The 3 Feature boxes](img/a4205bcb629b3cacf92e367c3bccf96e.png) **图形 2:三个特征框**
...
**![The stretchy graphic](img/ebf80f49c43993464d26452cdd1dd3af.png)图形 3:连接臂**
...
```
 <span id="stretch"  >
<img src="https://www.sitepoint.cimg/books/design1/design1-stretch2.png" alt="" /></span> 
```
