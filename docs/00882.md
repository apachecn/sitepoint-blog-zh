...
> 原文:[https://www . site point . com/interactive-data-visualization-JavaScript-D3/](https://www.sitepoint.com/interactive-data-visualization-javascript-d3/)
...
![Line chart showing how incomes have been changing over time in the US](../Images/5de03373ccb09bcea3d6ddb9e8115200.png "Google’s Public Data Explorer")
...
![My first sketch representing “the pie getting bigger”](../Images/3f42beae0b0c5ed7f29f9c5a08bcce45.png)
...
![What the sketch actually looked like …](../Images/81d0e038cf90a11a918aa6a11e803dd5.png)

在这里，随着时间的推移，最贫穷的美国人似乎变得越来越富有，这证实了直觉上的真理。我对这个问题想了更多，我的解决方案包括保持每个圆弧的角度不变，而每个圆弧的半径动态变化。

![My first sketch representing “the pie getting bigger”](../Images/7761007a8771e420fc98504d023d75cb.png)

下面是它在实践中的结局:

![What the new sketch looked like](../Images/81c2906b6ab2cd3f941b863ce5b75d68.png)

我想指出的是，这个图像仍然倾向于低估这里的效果。如果我们使用简单的条形图，效果会更明显:

![How this would look as a bar chart](../Images/7e67a371b3dac87a6e4be8dff88ec598.png)
...
![The pie chart that we’re starting with](../Images/660f757ff89aad9572647a33c8541aa5.png)
...
![The output of this path SVG code](../Images/cf05c0ca28a28d34200fb30ebae701f1.png)
...
![Our chart rendered for the first year of our data](../Images/4291895533e7e8cc78c746f5d57f65cf.png)
...
![Our updating chart between every year in our data](../Images/38cbaea506a60ad7859b1fc713688af5.png)
...
![Our chart after adding in a table and some styling](../Images/3574afe0cee55355ff5a0fe921b1fdea.png)
...
![Our chart after adding in some grid lines for the first year of our data](../Images/f4225d0b7ec69ede2a86cd6bea97604d.png)
...
![Our chart after adding in some interactive elements](../Images/e1bb9f5af6f551035a8c154d45b5d991.png)
