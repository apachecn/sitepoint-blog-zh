...
> 原文:[https://www . site point . com/deploy-online-vorlon-js-server-authentic ation/](https://www.sitepoint.com/deploy-online-vorlon-js-server-authentication/)
...
![Dashboard credentials](../Images/a66e443b1cf4e0e0b98f224b7764a37f.png)
...
![readme file deploy on Azure](../Images/f38a658175e3170c2bf796f1bc6af94b.png)
...
![Basic authentication config.json file](../Images/32d5ddf86fa8f6dff7ca13ee1a4a2584.png)

该文件位于您的 Vorlon.js 部署文件夹的 **/server** 文件夹中(或者如果您使用 **npm** 进行部署，则位于 *node_modules* 文件夹中)。

重启您的 Vorlon 实例和 **BAM** ，现在会提示您并要求您提供用户名和密码。

![Dashboard Login screen](../Images/519bf4b5f14e7449b5d59b9f54bfd587.png)
...
![Change config.json file on Azure Web App](../Images/6edec5d571c9e4f54fbceaab53b803ed.png)

然后，您可以访问 web 应用程序仪表板页面上的 **Edit in Visual Studio Online** 按钮。

![Visual Studio Online Monaco](../Images/04e7505123e1103f6cbb1f19618fbe11.png)

导航到 config.json 文件并编辑它以激活身份验证(或者添加/删除插件！):

![Console config.json file](../Images/f1321a079316917b0991b2e3be83ad94.png)

***注意:不要忘记重新启动服务，这一点要考虑在内。*T3】**
...
*如果你对这篇文章或 Vorlon.js 有任何问题，请随时在 Twitter 上联系我:[http://twitter.com/meulta](http://twitter.com/meulta)T3】*
