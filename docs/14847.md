...
> 原文:[https://www.sitepoint.com/flash-script-led-display/](https://www.sitepoint.com/flash-script-led-display/)
...
![1175_3](../Images/a4dbadfacec6fff825400c47a8e19877.png)

**7。**将图形与 mv_bar 实例对齐，如下所示:

![1175_4](../Images/f28fe1d8a6536b7628c799d89d003df4.png)

**8。**将最低块的颜色设置为黑色(使其与电影背景颜色相同)。

![1175_5](../Images/f45051defbecec94bf9d7f3a2d92fcbe.png)

**9。**设置图层属性，使上层成为蒙版，下层成为蒙版图层。

![1175_6](../Images/0a50de0a227915877798bcd9d94040f8.png)

10。回到场景 1，将图层 1 重命名为“LED”。将 mv_LEDbar 的几个实例拖到舞台上。如下所示对齐实例。

![1175_7](../Images/e05a1e084795291e6d88e64d6b10b9f8.png)

**11。**在 LED 图层上方添加一层，命名为“框架”。画一个矩形，然后删除填充颜色，以便您可以看到下面的 LED 实例。

![1175_8](../Images/6bfc365b1c9bfece1031ba3042412dad.png)
