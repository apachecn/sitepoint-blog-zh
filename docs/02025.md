...
> 原文:[https://www . site point . com/Amazon-product-API-exploration-lets-build-a-product-search/](https://www.sitepoint.com/amazon-product-api-exploration-lets-build-a-product-search/)

![Amazon Logo](../Images/04fbff4a93aab1408cb0b08bc1d36902.png)
...
2.  根据您所在的地区，注册成为产品广告 API 开发人员。转到[该页面](http://docs.aws.amazon.com/AWSECommerceService/latest/DG/becomingDev.html)并向下滚动到底部，找到您所在地区的 URL。这需要您输入以下信息:
    ...
    ![product advertising signup](../Images/42de446d7e4aa6602633b4b54ad3104e.png)

3.  完成后，应该会显示以下屏幕:

    ![product advertising signup success](../Images/9e28e4593f87cd6584d0d32ac9172c3b.png)

4.  单击管理您的帐户的链接，应该会返回以下页面:

    ![manage account](../Images/3c1cddb79a250a82ef8cbc7806c73a53.png)
...
6.  点击*访问键*选项卡，显示您已经拥有的访问键列表。默认情况下，应该会列出一个，但是您实际上无法使用它，因为您看不到相应的密钥。如果这是一个新帐户，您可以删除它。
    ...
    ![create new access key](../Images/6948649ebc68fb0cc654bf5e0d8141f7.png)

7.  点击*创建新的访问密钥*按钮，生成新的访问密钥和秘密密钥组合。生成后，复制密钥组合或下载密钥文件。这是因为您将无法在网站上再次看到密钥。

    ![generated access key and secret key](../Images/58befff916573d509e3e908d94e13dd5.png)
...
![select operation](../Images/5fa5a2da48a12a462b1149a274947b8a.png)

提供公共参数。这包括您希望执行请求的 Amazon 网站、您的员工 ID、访问密钥和密钥。

![supply common parameters](../Images/9774e635a417a5f39874b5e793e6f2e6.png)

接下来是请求参数。在这里，您可以选择要搜索的类别(搜索索引)、查询(关键字)、要返回的特定产品数据(响应组)、排序、浏览节点以及希望添加到请求中的任何附加参数。

![supply request parameters](../Images/8721e58607fbade5a93ad6f805d07b24.png)

点击*运行请求*按钮发送请求。

一旦收到响应，它应该会显示以下内容:

![response](../Images/85dd31449d61482ce864468017db857d.png)
...
![amazon searcher](../Images/13ab5c13977d6223d6c576fdf68bb831.png)
