...
> 原文：<https://www.sitepoint.com/php-development-environment/>
...
![Windows 10 running inside Arch Linux](img/9ab8139370200bd2e4296f0d161cf624.png)
...
![The Open Terminal option in Windows 11](img/309905022ebc29649ef47355d7d254dc.png)
...
![macOS: Enable New Terminal at Folder](img/b8035d7320f73be43c668a74ecdc9e26.png)
...
![Running the installer](img/44d2def04a661f8fb2868f5d3b7f7c3f.png)
...
![The output of docker compose up](img/5b6301c23d99e9da7239f72a24596997.png)
...
![A screenshot of the server test page](img/5b6301c23d99e9da7239f72a24596997.png)
...
现在，您可以在服务器上查看您的网页。默认情况下(我们稍后会看到这可以被覆盖), URL 直接映射到一个文件。放在`public`目录下的一个名为`test.html`的文件可以在`https://v.je/test.html`上访问，`public/products.html`可以在`https://v.je/products.html`上查看，文件甚至可以放在子目录中。比如`publimg/logo.png`可以在网址`https://v.img/logo.png`查看。
