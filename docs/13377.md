...
> 原文:[https://www.sitepoint.com/user-style-sheets-come-of-age/](https://www.sitepoint.com/user-style-sheets-come-of-age/)
...
![A before and after comparison of Google Reader, as styled by Jon Hicks](../Images/757cd3dc31d504546ecd1d93cf6d5ef0.png)

希克斯的重新设计很微妙，反映出他希望将谷歌阅读器设计成“看起来更像一个 OS X 应用程序”，而不是完全抛弃原来的布局。正如你在下面的截图中所看到的，一些文本链接被优雅地设计成图标，结果是同一个 web 应用程序的一个更干净、更漂亮的版本。

![A before and after comparison of the navigation bar of Google Reader, as styled by Jon Hicks"](../Images/e1c2bc593be6d587a620d0049aedfc17.png)
