...
> 原文：<https://www.sitepoint.com/10-premium-jquery-plugins/>
...
jQuery Sliders 全集有 4 个版本:固定尺寸、全宽、全屏和侧边栏横幅/迷你 Galeries。
 ...
 [![Ken Burns](img/806cad669f731a4daf8bc634e4eca91a.png)](http://codecanyon.net/item/jquery-slider-ken-burns-effect-fully-responsive/2457203?ref=jqueryrain) 
...
使用不引人注目的 JavaScript 和强大的效果和设计元素配置面板，将简单的 HTML 标记块转换为漂亮优雅的滑块。
 ...
 [![Zuper Responsive Multitouch Slider](img/cc2a1e7e36387631e10d61b117613751.png)](http://codecanyon.net/item/zuper-responsive-multitouch-slider/2028436?ref=jqueryrain) 
...
–轻松嵌入视频/图像/表格等。
 ...
 [![Push Menu](img/9ed5a6e057f9d54905ec4b66ec4c8f23.png)](http://codecanyon.net/item/jquery-push-menu/2488854?ref=jqueryrain) 
...
这可以应用于任何 html 元素，并且可以根据自己的需要进行定制。并且可以在所有最新的浏览器中运行:Firefox、Chrome、Opera、Safari 和 Internet Explorer 7、8、9 以及 iPhone/iPad 上的 Mobile Safari。
 ...
 [![RingShare](img/39472e24165852d6207035800488fdae.png)](http://codecanyon.net/item/ringshare-best-way-to-share-your-content/2474204?ref=jqueryrain) 
...
Pinterest 风格布局画廊是一个 lightbox 支持图像和 youtube，vimeo 视频。CSS3 驱动的动画，优雅的退化，它会切换旧浏览器中的渐变过渡。
 ...
 [![Pinterest Style Gallery](img/ae20cae54c27911ed9ef8f10a61526c9.png)](http://codecanyon.net/item/jquery-pinterest-style-gallery-plugin/2463876?ref=jqueryrain) 
...
-更多
 ...
 [![Nishtyak Gallery](img/681b0bc2cb7a4514dcedf0fcf10cdb89.png)](http://codecanyon.net/item/jquery-awesome-nishtyak-gallery/2440496?ref=jqueryrain) 
...
该脚本是一个复杂的 jQuery 优雅的字形下拉菜单(水平和垂直)，对于任何项目都有巨大的可能性。
 ...
 [![Glyph Menu](img/7023fdc230e2b8e1fd3da2ab09240b65.png)](http://codecanyon.net/item/jquery-glyph-menu/2418146?ref=jqueryrain) 
...
这个插件不仅可以用来替换原有的浏览器滚动条，甚至可以用来创建带有外部控件的幻灯片。
 ...
 [![RollBar](img/644ed3a943c5135631c5c5c05f6fec9b.png)](http://codecanyon.net/item/rollbar-jquery-scrollbar-plugin/2113353?ref=jqueryrain) 
...
给你的网站一种动态的感觉。它会自动将图像载入并显示到项目的背景中，以平滑过渡的方式切换图像。
 ...
 [![Easy Background with jQuery](img/49ca78e0b861a45bc870449ab4efba13.png)](http://codecanyon.net/item/easy-background/2219383?ref=jqueryrain) 
...
动画按钮和菜单 jQuery 插件允许你轻松地用动画按钮替换
 ...
 [![jQuery Animated Button & Menu](img/5eb573a3f79826c1c0e98bbba049900e.png)](http://codecanyon.net/item/jquery-animated-button-menu/2364062?ref=jqueryrain) 
