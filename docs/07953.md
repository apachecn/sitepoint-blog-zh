...
> 原文:[https://www.sitepoint.com/using-yaml-in-php-projects/](https://www.sitepoint.com/using-yaml-in-php-projects/)
...
**[PECL 扩展](http://php.net/manual/en/book.yaml.php "PHP: Yaml - Manual")T3】**
