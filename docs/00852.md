...
> 原文:[https://www . site point . com/how-to-boost-your-server-performance with varnish/](https://www.sitepoint.com/how-to-boost-your-server-performance-with-varnish/)
...
![Varnish cache miss](../Images/4574744b0066344b1453165a6bca9cf7.png)
...
![Varnish cache hit](../Images/ec65d17897cf7c44058ebadb9f02dc7e.png)
...
**清漆可通过[VMODS](https://info.varnish-software.com/blog/varnish-modules-vmods-overview)T3】扩展。这些模块可以使用标准 C 库并扩展 Varnish 功能。这里列出了社区贡献的 VMODS。它们的范围从头部操作到 Lua 脚本、请求节流、认证等等。**

**Varnish 有自己特定领域的语言，[VCL](http://book.varnish-software.com/4.0/chapters/VCL_Basics.html)T3】。VCL 提供了全面的可配置性。对于像 Varnish 这样的全页面缓存服务器，有许多错综复杂的问题需要解决。**

![vcl scheme](../Images/358dc5c1b09b2ad55ba89a4034a7507c.png)
...
*   `varnishstat`显示关于 varnishd 实例的统计数据:
    ...
    ![varnishstat](../Images/4d30248c95c2d0a567a2106edb5e7ae3.png)
...
![locust nginx](../Images/9a23c6d9e5be7b6f4d9f5c8a5e3c73ac.png)

**Nginx+清漆的蝗虫结果:**

![Locust varnish](../Images/62aeec907d8eb2e90f000b93b6be459a.png)

Pingdom 的结果也很好。

【Nginx 堆栈的 Pingdom 结果，在加利福尼亚测试:

![Pingdom nginx ](../Images/451a0b0c3554fdb35ffa42402d089e45.png)

**加州 Nginx + Varnish 的 Pingdom 结果:**

![Pingdom varnish](../Images/18d2c99a63e538b8f91e17c338306ae9.png)

还要注意每种情况下的 [TTFB](https://en.wikipedia.org/wiki/Time_to_first_byte) 。

**Nginx 单独:**

![TTFB nginx](../Images/f4b474fa30dd44744895cc9f03c41818.png)

**Nginx +清漆:**

![TTFB varnish](../Images/cac036efeb3ad4ce497064e0e7e36adf.png)
...
![Node Hello World - Pingdom](../Images/18a545b642024634e031851056fec0e4.png)
...
![Response Headers](../Images/50cc2767904d7c0846632ced9084aa72.png)
