...
> 原文:[https://www . site point . com/authenticate-your-rails-API-with-jwt-from-scratch/](https://www.sitepoint.com/authenticate-your-rails-api-with-jwt-from-scratch/)
