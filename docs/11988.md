...
> 原文:[https://www . site point . com/illustrator-drawing-tools-part-3-the pencil-tool/](https://www.sitepoint.com/illustrator-drawing-tools-part-3-the-pencil-tool/)
...
1.从工具箱中选择铅笔工具![image0012](../Images/07225ff764ac7199290cbac3b1cd78a4.png)(或按 N 快捷键)。
2。单击要开始路径的位置，然后拖动并绘制。

![image0032](../Images/2bef0696d1e2a36bafdaad670e1f8c87.png)

您会注意到，当您拖移时，指针后面会出现一条虚线。锚点将出现在路径的起点和终点，以及路径上的几个点。完成拖动后，路径将采用您设置的任何描边和填充属性。

![image0052](../Images/ca30a715bce9f18807829cd2864a8298.png)
...
![image0072](../Images/60f79c5f185945ae5b11d083540f90c4.png)
...
![image0092](../Images/d430db4b5edb6689c1f3d66ec8725a11.png)

1.选择您刚刚绘制的对象或路径。
2。从工具箱中选择平滑工具![image0112](../Images/c08235e597d1b4d662669ed50135e90e.png)，或者按住 **Alt/Option** 键从钢笔工具快速切换到平滑工具。
3。沿着要平滑的路径段的长度拖动工具。你不必在整个物体上拖动它。

![image0132](../Images/bf05bd4422a85ea3eb760ef6a62763ad.png)
4。继续平滑，直到你对路径满意。
