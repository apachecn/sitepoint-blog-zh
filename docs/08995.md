...
> 原文：<https://www.sitepoint.com/10-jquery-mootools-prototype-lightbox-scripts/>
...
*   [**jQuery light box vs ColorBox vs fancy box vs Thickbox**](http://www.jquery4u.com/plugins/jquery-lightbox-colorbox-fancybox-thickbox/)
...
一个 lightbox 克隆，支持 PDF，flv，swf，音频，图像，内嵌 html 和远程 HTML 文件。有用的网页设计脚本。
 ...
 [![Bumpbox 2.0 Mootools lightbox clone](img/7ceb038068586326c2ba6c356063776c.png)](http://www.artviper.net/bumpbox-demo/index.html#demos) 
...
紧凑且易于使用的脚本，允许您在弹出框中显示放大的图像。虽然网站是俄语的。
 ...
 [![jsImageBox](img/615c3cc39be1866902b3c7869f6798a2.png)](http://jsimagebox.ru/index.html#SampleGallery) 
...
一个完全可编程的、多用途的原型窗口工具包。
 ...
 [![Control.Modal windowing toolkit for Prototype](img/95fb0833acaebf74735584dbb81d969f.png)](http://livepipe.net/control/window) 
...
易于使用，可以与图片，flash，FLV，YouTube，DivX 和 iframes。
 ...
 [![EnlargeIt! JavaScript gallery](img/27ce4a46910f1f151c6acffa2cc9ed76.png)](http://enlargeit.timos-welt.de/english/11/example01.php) 
...
这个 lightbox 插件可以处理任何图像、文本、标题和 flash。
 ...
 [![FancyZoom using the jQuery library](img/9cda67e8a663ed7d1449a5f469f02bd8.png)](http://static.railstips.org/orderedlist/demos/fancy-zoom-jquery/) 
...
Floatbox 是一个 JavaScript 插件，用于在网页顶部显示窗口内容(弹出式灯箱)。此图库适用于所有主流浏览器。
 ...
 [![Floatbox JavaScript lightbox gallery](img/f26bdfb0f400040b56d74a0065055df8.png)](http://floatboxjs.com/demo) 
...
它可以用于在弹出窗口中显示网站、图像(和图库)和其他内容。
 ...
 [![GreyBox](img/fbb490e0b6d25cc0197ef56475e7bf0d.png)](http://orangoo.com/labs/GreyBox/) 
...
是用 JavaScript 编写的图像、媒体和图库查看器。
 ...
 [![Highslide JS JavaScript thumbnail viewer](img/ab8fb538fe96c5f4c138ffdb4d221a16.png)](http://highslide.com/) 
...
是 Lokesh Dhakar 编写的广受欢迎的 Lightbox 2 脚本的 4 KB 可视化克隆，使用 jQuery javascript 库(版本 2)或 MooTools javascript 框架(版本 1)编写。它被设计成非常小，高效，标准友好，完全可定制，更方便，并与最初的 light box 2 100%兼容。
 ...
 [![Slimbox](img/3019c76f7d0571f156e7414c199089f1.png)](http://code.google.com/p/slimbox/) 
...
是一个基于 web 的 JavaScript 媒体查看器应用程序，支持许多不同的媒体格式(图像、图片库、QuickTime、Windows Media Player、Flash、Flash 视频、HTML，甚至外部网页)。可与 IE6+，Firefox 1.5+，Safari 2+，Chrome，Opera 9+兼容。
 ...
 [![Shadowbox](img/cbab46d68331d3c00bc6a7df5d6aede6.png)](http://shadowbox-js.com/download.html) 
