...
> 原文:[https://www . site point . com/handling-player-input-in-cross-platform-games-with-libgdx/](https://www.sitepoint.com/handling-player-input-in-cross-platform-games-with-libgdx/)
