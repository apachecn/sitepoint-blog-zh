...
> 原文:[https://www . site point . com/create-your-own-scribbled-scratchy-typeface-in-illustrator/](https://www.sitepoint.com/create-your-own-scribbled-scratchy-typeface-in-illustrator/)
...
1.  我用过 Myriad Pro Bold Condensed(如果你安装了 Illustrator，你的系统上应该有)，但这种效果对各种字体都很有效。这里的字体大小是 120px，填充颜色是黑色，没有笔画。
    ![Step1](../Images/d799f0e95a1ea09b9f3850a6030e2238.png "Step1")
...
3.  现在，我们可以玩滑块来实现不同类型的涂鸦。我让线条宽度变得更细，线条间隔变得更紧密，还改变了每个选项的变化。
    ![Step3](../Images/00943a752fff321a0bd2a6a7b5fb47ac.png "Step3")
4.  当您对文本满意时，点按“好”。仅此而已。使用这种方法真正酷的部分是文本仍然是可编辑的，并且您添加的任何额外字符都将自动呈现涂鸦效果。
    ![scribble-text](../Images/97aeaed3129aae1b136aa14f6d9f8cd7.png "scribble-text")
5.  通过使用不同的字体，你可以得到一些有趣的结果。这里还有几个使用各种涂鸦设置创建的例子。

![scribble-examples](../Images/0b9938ec50d86fac3f24d68b3bafa74d.png "scribble-examples")
