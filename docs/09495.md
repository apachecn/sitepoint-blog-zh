...
> 原文:[https://www.sitepoint.com/firebug-18-whats-new/](https://www.sitepoint.com/firebug-18-whats-new/)
...
![Firebug DOM Panel options](../Images/6d9f3e32424bd90b9f448f6386b6c1f6.png)

## CSS 颜色工具提示

Firebug 现在显示 hex、rgb、rgba、hsl 和 hsla 颜色预览，就像它的几个竞争控制台一样:

![Firebug CSS color tooltips](../Images/19404c5a39ec6aa15b488f244a5cb832.png)
...
![Firebug CSS3 box-sizing](../Images/68dcf7dcd450bb834297a312b7508a3b.png)

## 控制台.时间戳

Firebug 的脚本分析工具通过新的`console.timeStamp([msg])` API 命令得到了增强。当在您的代码中遇到`console.timeStamp();`时，一个时间轴标记被添加到网络面板:

![console.timeStamp](../Images/97152da194fac482a8114183c3474a2b.png)
...
![Firebug Net panel IP address](../Images/05d1a145a46cd820f5cd7bc181c792db.png)

## 网络面板中的 HTML 预览

如果您使用 Ajax 下载 HTML 代码片段，您会很高兴听到 Net Panel 还允许您预览呈现的代码:

![Firebug Net panel HTML preview](../Images/a0280d8868341a5b14119974a04ebbeb.png)

## 外部编辑器的附加选项

我错过的另一个特性是对外部编辑器的支持。除了传递%url 和%file 参数，1.8 版还引入了%line number 参数:

![Firebug external editors](../Images/66ab83c0993ed2d8949800744f2787e4.png)
