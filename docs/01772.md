...
> 原文:[https://www . site point . com/achieve-60-fps-mobile-animations-with-css3/](https://www.sitepoint.com/achieve-60-fps-mobile-animations-with-css3/)
...
![Critical Rendering Path](../Images/71e1ce1f0155d7062476cccd6f4c5f3e.png)
...
![Styles](../Images/43dc37cbcbef3fa1568de08298035c09.png)

浏览器开始计算应用于元素的样式—重新计算**样式**。

**2。布局**

![Layout](../Images/7f884a7a53d19e6f1e3ff0b97bb267a1.png)

在接下来的层中，浏览器生成每个元素的形状和位置— **布局**。这是浏览器设置页面属性的地方，例如`width`和`height`，以及它的`margin`或`left/top/right/bottom`。

**3。油漆**

![Paint](../Images/3e8d9d7fdaad6ae92548d774d9f227d4.png)
...
![Composite](../Images/718ecdd0241b55019871c08ebd4067eb.png)
...
![app-menu inside layout class](../Images/28f201f92f34c164163f43731e9eeace.png)
...
![Avoid transitions](../Images/0617be84ab75597e5b4b3c7ac7db6028.png)
...
![DevTools Timeline](../Images/35779bcfc43baf60ffe4659008162aab.png)
...
![Using Transform](../Images/141508cfc2d0af545e04b6fea1d2dad2.png)

这正是时间线所反映的:

![Timeline using transform](../Images/872aff2f3677e7b042e9c45c585f35de.png)
...
![Animations in GPU](../Images/25938295a5a0b755a3e0121a96fe95f3.png)

看到多光滑了吗？时间表证实:

![Timeline running animations](../Images/e1eb13d810c4b525b94695d7bcaadeb6.png)
...
![Fully enabled CSS3 example](../Images/a424309ea5f1c80b0b4d7cce7c089338.png)

时间线向我们展示了什么？

![Timeline of CSS3 example](../Images/ba8c682e743736e81c05be9127f5aeae.png)
