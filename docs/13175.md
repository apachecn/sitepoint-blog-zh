...
> 原文:[https://www.sitepoint.com/web-2-0-effects-photoshop-2/](https://www.sitepoint.com/web-2-0-effects-photoshop-2/)
...
![A reflected logo](../Images/4128ae7d814aee8a5c82747ef685965a.png)

**2。进入图层面板，点击添加图层样式图标，选择投影，添加一个投影。“设置”对话框将允许您调整阴影效果的不透明度、颜色、方向、大小和距离，如下所示。**

![Adding a drop shadow](../Images/eb798bb5b8545491cb959fb260e468e8.png)

**3。**最后，简单地定位图标，使其打破“网格”可以使设计更有趣。下面的例子通过在容器的边缘戳来制造一些张力，这使得内容区域更有趣。

![Making a content area more interesting](../Images/c559ba562c85d701aa5c2e6da8d23355.png)
...
![Using a rounded rectangle for our container](../Images/8aeadedd8f2fe26e7aacc77f1fa8f9cf.png)

**2。**将照片或插图作为新图层直接粘贴到形状图层上方，将其放置在圆形框的左侧，如下所示。

![Pasting the image to be contained](../Images/9bac9e191d9379466598bbdd5aec0175.png)

**3。**在图层面板中，将光标移动到照片图层和形状图层之间。按住 Alt 键(Mac 的选项)，当光标变为重叠的圆圈(如下所示)时，单击鼠标按钮。这将创建一个“剪辑蒙版”，只允许显示照片层中与下面的层重叠的部分。

![Creating a clipping mask between two layers](../Images/7ff2c0e84df28a17e7985baab7288242.png)

**4。**您现在可以四处移动照片，它会一直夹在盒子里。最后一步是添加一个图层蒙版到照片层。这里显示的是结果
。

![The final image, contained within a rounded rectangle](../Images/a5f83339178472bf7c95a028a93fa18c.png)
...
![Photoshop's built-in palette of glyphs](../Images/21055e18a185ea404a16f03d7a61965e.png)

你也可以通过选择多边形工具(U)来创建你自己定制的星爆。在选项栏中，增加边数(30 对我来说很好)。然后单击形状行旁边的小箭头以访问多边形选项。选中“星形”并为“缩进边数”字段选择一个小数值。如下图所示，我选择使用 10%。

![Tweaking the parameters of our starburst polygon](../Images/3e3d68786a265a12b60f3ea0b07f31ee.png)

现在，在页面上画一个形状，就会出现下图这样的星爆！

![Our custom starburst](../Images/61ff8b8a71c810b8d2928e31e73ecf28.png)

和任何其他形状一样，你可以在星爆上使用其他 Web 2.0 效果的组合。这里有一些例子。

![Adding a gradient](../Images/43177641b4036aeeec00613416addb8a.png)

![Adding a drop shadow](../Images/d64d6f0b76eb7b73cd404a67616e8380.png)

![Adding a stroke, which can also be found in the Layer effect options](../Images/5c1398679252ac1123362902f82007b0.png)
...
![The completed document](../Images/9636d8711a7f511faa719e69b49a47ba.png)
