...
> 原文:[https://www.sitepoint.com/maven-and-php/](https://www.sitepoint.com/maven-and-php/)
...
![maven-1](../Images/3173b0764c71b6e23c3c832fe612a095.png)
...
![maven-2](../Images/4f407f0b8efa9d472b65ffde5011cdca.png)

Maven 将开始下载所有需要的依赖项到您的计算机上。在某些时候，Maven 会要求您为`groupId`、`artifactId`、`version`和`package`定义一个值，如下所示:

![maven-3](../Images/2fc9b6c212cf95c6a695c2c4e062865a.png)
...
![maven-4](../Images/9d00b3d900f9b363f8192819dc1d84a7.png)
...
![maven-5](../Images/c1f884654d0bb596c975d9e127cdc45e.png)

要构建新创建的 Maven 项目，您可以运行命令`mvn:package`。您将再次注意到 Maven 自动开始下载项目所需的任何依赖项。

下载完所有需要的依赖项并执行构建操作后，您应该会看到以下成功消息:

![maven-6](../Images/b6422c52db29022dbfb12dfe2bb73b0b.png)
...
![maven-7](../Images/dc8b7dc7df8a59ddef3b04ab8d948919.png)

![maven-8](../Images/91e2fd0ddf50d9d5c6431e6335a43957.png)

安装完成后，当您创建一个新项目时，您会发现 PHP-Maven 项目选项。选择它，然后按下一步以安装插件。

要在 Eclipse 中创建新项目，请选择 File > New > Other(或按 CTRL + N 组合键),您应该会看到类似下图的内容:

![maven-9](../Images/5efd0c7c1325207e7555c1da217d0d4e.png)

按下“下一步”按钮后，您将收到不同原型的列表。

![maven-10](../Images/7dc37f68fe0adbd00fd703395e492188.png)

选择您的工件，您将被提示输入项目信息，就像前面的命令提示符一样。

![maven-11](../Images/2e998bbf6ba285c7e13b583d98cd8ef7.png)

新项目将被添加到项目浏览器选项卡中。文件夹结构与从命令行创建的项目结构非常相似。

创建项目后，右键单击它，您会在菜单底部看到 PHP-Maven 选项，其子项目列出了 PHP-Maven 项目最重要的阶段。

![maven-12](../Images/c0184c8a2d24a0a0999736f25e5bb7ae.png)
