...
> 原文:[https://www.sitepoint.com/9-causes-of-web-page-obesity/](https://www.sitepoint.com/9-causes-of-web-page-obesity/)
...
许多小图像通常比单个大图像消耗更多的带宽。每个图像需要一个单独的 HTTP 请求/响应，大多数浏览器一次最多下载 4 个文件。将许多图像放入一个文件中，然后用 CSS `background-position`属性将它们分开可以节省带宽。[Amazon.com 有一个很好的例子](http://g-ecx.images-amazon.com/images/G/01/gno/images/orangeBlue/navPackedSprites-US-15._V202471683_.png)。
