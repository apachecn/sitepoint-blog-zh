...
> 原文:[https://www . site point . com/using-closure-space-create-real-private-members-JavaScript/](https://www.sitepoint.com/using-closure-space-create-real-private-members-javascript/)
...
![Browser performance table showing the closure space version is nearly always faster than the regular version](../Images/fedd4614ec8c14ed7da1bbd3d516d6f3.png)

![Browser performance chart showing the closure space version is nearly always faster than the regular version](../Images/acbb9b896c7a762cf14fd16ea882bf2a.png)
...
![Chart showing that using closure space or even a property can be ten times slower than direct access to a member](../Images/2eb0654b4f4efa7ac1fa914caf4e3a30.png)
...
![Internet Explorer’s embedded memory profiler](../Images/6eb0a8261145e5f25a4a650f68e9b8ee.png)

以下是我在电脑上得到的结果:

![A chart showing that between closure space and regular way, only Chrome has slightly better results for closure space version](../Images/e070a4cde4e269d30d56b7e0de844952.png)
