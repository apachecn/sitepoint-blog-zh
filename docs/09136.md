...
> 原文:[https://www . site point . com/online-loading-Ajax-spinner-generators/](https://www.sitepoint.com/online-loading-ajax-spinner-generators/)
...
[![css-load](../Images/a7d50d138aa03737518e9ed7284376a1.png "css-load")T2】](http://cssload.net/)

## 2.Ajax 加载在线工具

ajaxload.info 完全按照 tin 上说的做，在几秒钟内为您创建一个 ajax 加载程序。限于微调，你可以选择，但它总是可靠的，需要几秒钟来选择和生成自己的彩色微调透明背景选项。

[![ajax-load](../Images/99ac6c1ad1fbf6c812d31986350f809a.png "ajax-load")T2】](http://www.ajaxload.info/)

## 3.加载信息在线工具

loadinfo.net 为你提供了 132 张旋转图片，选择一张后，你可以改变颜色和尺寸，最大可达 48×48。唯一的缺点是它比其他选项稍慢，但我们仍然在这里只谈论秒。不错的选择。

[![load-info](../Images/85d0a40f15d70a2c266683fee990105e.png "load-info")T2】](http://loadinfo.net/)

## 4.预加载器在线工具

preloaders.net 可能是我最好的选择，因为它有很好的选择自定义图片的选项。

[![preloaders](../Images/4f8eeec3d9b30448dd0e9026503602aa.png "preloaders")T2】](http://preloaders.net/)

## 5.Spin.js 在线工具

Spin.js 是一个插件，可以用来为 Ajax Spinners 创建你自己的在线工具。

[![spin-js](../Images/013658fc6363b8166791efbf5819e39f.png "spin-js")T2】](http://fgnass.github.com/spin.js/)
