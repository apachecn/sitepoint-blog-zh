...
> 原文:[https://www . site point . com/easy-add-social-logins-to-your-app-with-socialist/](https://www.sitepoint.com/easily-add-social-logins-to-your-app-with-socialite/)
...
![Socialite merging social networks](../Images/064b0bae33cf1fe5cdba71855dbca824.png)
...
![Laravel form based authentication](../Images/362a250d9349973a7477f34d67d0f7fc.png)
...
![Github app creation page](../Images/8ad3235386b2e559a19f2139031c1978.png)
...
![Github app edit page](../Images/a765f93f57d722a3906e614a8bef8f6f.png)
...
![Log in form with Github link](../Images/5f4eb92944786c2a5d7d0a6a47cfc82a.png)

如果我们点击*登录 Github* ，我们将被转到 Github 的授权页面:

![Github authorization endpoint](../Images/76f31106eea75bdc876eb5ca038e35c5.png)
...
![Login page with Spotify link](../Images/c74d4e83f88a670ed3ca85fa053b9008.png)

我们可以重用我们在上一个例子中定义的路由(通过 Github 进行身份验证),或者用新的控制器和逻辑创建新的路由。

点击`Login with Spotify`，我们将被重定向到 Spotify 的授权页面:

![Spotify authorization endpoint](../Images/8a7a785358e0189e1edd163b5cdede2b.png)
