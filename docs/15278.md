...
> 原文:[https://www.sitepoint.com/transform-php-xslt/](https://www.sitepoint.com/transform-php-xslt/)
...
![A DocBook document transfored to HTML with XSLT in PHP](../Images/25e41c8db29964ec6e87581e651db103.png)修改这个脚本来提供来自数据库的内容非常简单。只需以通常的方式提取存储在数据库中的 XML 代码，然后使用`xslt_process`用 XSL 样式表将其转换成 HTML。样式表可以存储在数据库中，动态生成，或者保存在服务器上的文件中，如上例所示。
