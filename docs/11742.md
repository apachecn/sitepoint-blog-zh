...
> 原文:[https://www.sitepoint.com/version-control-git/](https://www.sitepoint.com/version-control-git/)
...
![Git GUI startup screen](../Images/71c2aec05c5c6170ee366a5aa2514b12.png) * Git GUI 启动屏幕([在新窗口查看大图。](https://i2.sitepoint.com/graphics/1749-git-gui-startup.png) )*
...
![Unstaged Changes](../Images/cf1341e28dfb5d2303fbbfc86ed858ee.png) *未分级修改([在新窗口查看大图。](https://i2.sitepoint.com/graphics/1749-git-gui-unstaged-changes.png) )*

您可以使用命令`git status`从命令行检索相同的信息。

![git status](../Images/e75aa69c696f9512ff910b432121e304.png) * git 状态([在新窗口查看大图。](https://i2.sitepoint.com/graphics/1749-git-bash-status.png) )*
...
![](../Images/43dd6ab05230fe4792601035df6da501.png) *两阶段过程([在新窗口中查看更大的图像。](https://i2.sitepoint.com/graphics/1749-git-index-diag.png) )*
...
![](../Images/09fd68814845c11859ccfbaa935a43ec.png) *全局配置([在新窗口中查看大图。](https://i2.sitepoint.com/graphics/1749-git-gui-config.png) )*
...
![](../Images/14744a9e7db52d576021443203a590fd.png) *选择文件进行暂存([在新窗口中查看大图。](https://i2.sitepoint.com/graphics/1749-git-gui-unstaged-changes-panel.png) )*

然后选择**提交>阶段提交** (ctrl+T)。然后显示屏显示我们没有等待进行的变更，但是我们有要提交的变更。

![](../Images/a97e8454f2f277f437f6258b321ddaaf.png) *待提交文件([在新窗口查看大图。](https://i2.sitepoint.com/graphics/1749-git-gui-staged.png) )*
...
![](../Images/0c5a269e63c7107edf0e660656bfdb02.png) * Git GUI 提交示例([在新窗口中查看大图。](https://i2.sitepoint.com/graphics/1749-git-gui-staged-commit.png) )*
...
![](../Images/c7326e09b1db43fc2f80f19a66a55e01.png) *显示 Git GUI 中的差异([在新窗口中查看大图。](https://i2.sitepoint.com/graphics/1749-git-gui-unstaged-changes-2.png) )*
...
![](../Images/641846d806f9da2c74d571a7b6103ffb.png) *可视化历史([在新窗口查看大图。](https://i2.sitepoint.com/graphics/1749-git-gui-history-viz.png) )*
...
![](../Images/1876e758b6782751f9f6f90f84edb082.png) *差异显示([在新窗口中查看大图。](https://i2.sitepoint.com/graphics/1749-git-gui-prod-rel2-unstaged.png) )*
...
![](../Images/3ff7036a594f1efd4a648301a3fe3fe2.png) *第一次提交 rel_2 ( [在新窗口中查看大图。](https://i2.sitepoint.com/graphics/1749-git-gui-prod-rel2-history.png) )*
...
![](../Images/dbffd002824b26f7cbeb5f0b8ed56cbc.png) * gitk 显示多个分支([在新窗口查看大图。](https://i2.sitepoint.com/graphics/1749-git-gui-prod-support-history.png) )*
...
![](../Images/c02a7f8cd526fe5107a47b03e6b8362b.png) *合并后([在新窗口中查看更大的图像。](https://i2.sitepoint.com/graphics/1749-git-gui-prod-support-history-merged.png) )*
