...
> 原文：<https://www.sitepoint.com/10-jquery-html5-players/>
...
开放视频播放器(OVP)是一项倡议，包括在媒体播放器应用程序的开发中使用开放标准、最佳实践和已建立的开发方法。
 ...
 [![jQuery HTML5 Open Video Player](img/af59698e0bd0377fa2fc5a1aeeb2d17f.png)](http://openvideoplayer.sourceforge.net/html5video/) 
...
是一个支持字幕的 HTML5 视频播放器。它支持广泛使用的桌面浏览器和移动设备。还支持 IE6、IE7、IE8 和 Safari(windows 上没有 Quicktime)。
 ...
 [![LeanBack Player](img/d64b76a45707a4e0ef007a5aaaf819d3.png)](http://leanbackplayer.com/) 
...
是一个开源且易于使用的 HTML5 jQuery 视频播放器。它有一个播放和暂停按钮，也可以设置音量。具有皮肤、缓冲和全屏模式的能力。
 ...
 [![FryPlayer](img/c7c902d031b2f7a33c3d82fe1ee9c2a6.png)](http://fryplayer.net/) 
...
jQuery Fancybox 和 Flowplayer 集成教程
 ...
 [![FancyPlayer](img/d84781de9a48fb387d564f36ac0fcfe9.png)](http://www.webgurusdesignblog.com/2009/08/fancyplayer-jquery-fancybox-and-flowplayer-integration-tutorial/) 
...
jQuery UI 视频小部件增强了您的 HTML5。
 ...
 [![jQuery UI Video Widget](img/33f5f86e52c6e1573b2bf887fbb3e76c.png)](https://github.com/azatoth/jquery-video) 
...
是一个 jQuery 插件，它实现了 YouTube 播放器 API，并允许你为 YouTube 电影创建自己的控件和组件。除了 jQuery，它还需要 SWF 对象来支持跨浏览器。
 ...
 [![TubePlayer](img/3518ed509f55e4955d44268c42ff8bcc.png)](http://www.tikku.com/jquery-youtube-tubeplayer-plugin) 
...
嵌入 MP3 播放器的 jQuery 插件(多声道)。
 ...
 [![julienMP3Player](img/03671cd41095e3ea4218f3bfb43af850.png)](https://github.com/juliend2/julienMP3Player) 
...
Kaltura 是一个先进的视频发布平台，它正在分享一个免费的开源 HTML5 视频和媒体 JavaScript 库。
 ...
 [![Kaltura JavaScript](img/651d83167bf01bed2b9508376237b5d3.png)](http://html5video.org/) 
...
在本教程中，您将创建一个用 xHTML 和 jQuery 编码的惊人的音乐播放器，它利用了鼠标手势和热键。你可以用鼠标点击和拖动来与界面的音乐播放器交互，或者用方向键和空格键来代替鼠标。
 ...
 [![Music Player in jQuery](img/0c37d90fa198f4c9a0550bb43931b13a.png)](http://yensdesign.com/2008/12/create-an-amazing-music-player-using-mouse-gestures-hotkeys-in-jquery/) 
...
HTML5 引入了 audio 元素，它提供了一种在浏览器中本地播放音频的方式。然而，原生控件在风格上有点欠缺。令人欣慰的是，HTML5 还带来了媒体元素 API 来进行交互，这允许我们按照我们想要的方式来处理音频对象。
 ...
 [![Boombox.js](img/9073ee8e0e8889b93d8964c826e9b1ae.png)](https://audiofile.cc/boombox/) 
