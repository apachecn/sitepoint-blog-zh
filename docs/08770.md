...
> 原文:[https://www.sitepoint.com/10-css-css3-resources-tools/](https://www.sitepoint.com/10-css-css3-resources-tools/)
...
在本教程中，你将学习如何使用 CSS 精灵来叠加 CSS 菜单。
 ...
 [![Cool Sprites - Free overlapped CSS menu using CSS Sprites](../Images/13e8291a100f4f682b6f1d3b6ba3e08f.png)](http://deepubalan.com/blog/2010/01/18/cool-sprites-free-overlapped-css-menu-using-css-sprites/) 
...
基本上第一个是上边距，所有的东西都是顺时针向右，向下，向左。你们中的许多人可能熟悉这条规则，但也有许多人是从 CSS 开始的，所以我希望这篇教程能有所帮助。
 ...
 [![CSS Shorthand Clockwise Rule](../Images/94f766663ecce7587db4b73576345dea.png)](http://www.vcarrer.com/2010/01/css-shorthand-clockwise-rule.html) 
...
一个简单的解决方案来缩小你的网站中嵌入的 CSS。这将涉及到 PHP 和 Apache 重写规则的一点知识。
 ...
 [![CSS Minification on the Fly](../Images/6adc1aea2a816fa914b0e485175bd2b7.png)](http://shinylittlething.com/2010/01/20/css-minification-on-the-fly/) 
...
就算了！重要声明应该谨慎使用，它是一个非常有用和强大的表达式，在我们的 CSS 世界中它应该占有一席之地。这篇文章提供了一个指南，介绍声明是什么，它做什么，以及你应该如何使用它。
 ...
 [![The Importance of the !important CSS Declaration](../Images/e423b1e4178d55ca20a9a11a240f37ef.png)](http://www.webcredible.co.uk/user-friendly-resources/web-dev/css-important.shtml) 
...
在这篇文章中，我试图阐明这个问题并解释原因，以及在网络上调整字体大小的不同方法。
 ...
 [![Guide to Font Sizing with CSS](../Images/0eeb561a6aa542a8c9339297b7ded89f.png)](http://www.frederikvig.com/2010/02/guide-to-font-sizing-with-css/) 
...
在这个实验中是我前段时间做的一系列不同光照位置的纸鸟(鹤)照片，我创建了一个纯 CSS 效果——没有 JavaScript——根据滚动条的位置一张一张地显示它们。
 ...
 [![CSS Paper Bird](../Images/824598906f9772b33ebd57193c366854.png)](http://www.romancortes.com/blog/css-paper-bird/) 
...
>灵活性–可用于 3 级或更高级别–只需稍加调整即可
 ...
 [![Multi-level Multi-column Multi Menus with Pure CSS](../Images/833c1bf2f760382a989421d595676c4c.png)](http://www.wittysparks.com/2009/09/21/build-multi-level-multi-column-multi-menus-with-pure-css/) 
...
投影为任何设计增加了额外的眩光。它们可以在任何图形编辑器中轻松完成；然而，这在 web 编程中有点棘手。
 ...
 [![Drop Shadow in Images: No extra markup](../Images/65f69cbb100c976118a60f5841eb43de.png)](http://www.nitinh.com/2010/01/drop-shadow-in-images-no-extra-markup/) 
...
在本教程中学习如何用 jQuery 和 CSS3 创建一个漂亮的自定义对话框。
 ...
 [![Beautiful Looking Custom Dialog Box with jQuery and CSS3](../Images/579d5507975ed7b87a0e46289657e4f1.png)](http://www.queness.com/post/1696/create-a-beautiful-looking-custom-dialog-box-with-jquery-and-css3) 
...
允许您以报纸风格的形式创建专栏。新闻网站和博客欢欣鼓舞！让我们看看如何使用新模块创建列。
 ...
 [![Multi Columned Layouts in CSS3](../Images/ab91c38a1feeaab3d61cdb8f8e9a3fdc.png)](http://jamesblogs.com/2009/07/31/multi-columned-layouts-in-css3/) 
