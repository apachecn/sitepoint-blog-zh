...
> 原文:[https://www . site point . com/adding-maps-to-an-Android-app-with-Google-play-services/](https://www.sitepoint.com/adding-maps-to-an-android-app-with-google-play-services/)
...
![Dashboard Sidebar](../Images/0003a309b004f9773221478521aaa6be.png)

选择*谷歌地图 Android API* ，点击出现在下一页的*启用 API* 按钮。

API 启用后，点击左侧面板中的*转到凭证*。

![Dashboard Sidebar](../Images/36972871501eee59d12dd9edacbdc08f.png)

从*添加凭证菜单*中，选择 *API 键*。

![Add Credentials](../Images/1fd43d31fa8de92526803d50c0e16fa8.png)

选择*安卓键*。

![Create a Key](../Images/685a38b0520218a313e8fbeaebe19dc5.png)

在下一个对话框中，你可以更改键名，但我保留了默认的 <q>Android key 1</q>

![Name the Key](../Images/cd1b0440797d076f7e705637a6696c79.png)
...
![Map View](../Images/3434200136785ff508a1cdc7555dec51.png)
...
![Map View](../Images/3cc1135cb5ad9a16f122468577e67c51.png)
...
![Map View](../Images/51a0cc14d5806e4635ac204676849c49.png)
...
![Map View](../Images/dfac0cf0f674555eaca5bd36405f3c36.png)
...
![Map View](../Images/11e362fd3b3e79ec7bd379883b90afbb.png)
