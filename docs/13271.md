...
> 原文:[https://www.sitepoint.com/getting-started-photoshop-6/](https://www.sitepoint.com/getting-started-photoshop-6/)
...
![Creating a new alpha channel](../Images/78fd4a1a94c0e702aaa152c35e35fddf.png)

然后，您可以使用 Photoshop 的任何绘画或绘图工具来创建代表选区的灰度图像，白色区域代表选定区域，黑色区域代表取消选定区域，灰色区域代表选区中的透明度。

![Creating a grayscale image](../Images/567e29210384c724d94dd7dee571978e.png)

要将 alpha 通道杰作变成选区，只需按住 Ctrl 并点按通道的缩略图(如果您在 Mac 上，请按住 Command 并点按)。

![Creating a channel-based selection](../Images/149d95dfe56df44980b771929289f608.png)

要返回到正常的图像视图，点击层调色板标签，并选择任何层。您的选择仍然可见。

![Returning to the Layers palette](../Images/04bafd481e511a1dd4b01de36bd6e4fd.png)
...
![Saving the selection to a channel](../Images/16c5afe68ab61616c0b7a8326856f7df.png)

如果你去通道面板，你会看到一个新的选择在列表的底部，名为土地在下面的图像-这是你保存的选择。现在，您可以根据需要多次重新加载您的土地选择！

![New channel in the Channels palette](../Images/96f66a4fdf39273878228ed4a401ca2a.png)
...
![Creating a history snapshot](../Images/1734946cca7d567c59a88dbd76388cfd.png)
