...
> 原文：<https://www.sitepoint.com/how-many-users-need-accessible-websites/>
...
***注意:本文中以图像形式呈现的一些数据是不可访问的。这些图像仅仅是为了以另一种格式展示一些统计数据。所有的图片都有源链接，在那里可以找到更容易理解的格式(如 PDF)的数据。***
...
![Causes of Blindness](img/3152aa9aa1a2b47ece37cd9cd82fe9db.png)
...
![Number of people (in thousands) blind, with low vision and visually impaired per million population](img/71010a77c9c09dd24cb400fd7e2002b1.png)
...
![2010 Global estimate of the number of people visually impaired by age, for all ages in parenthesis the corresponding prevalence (%)](img/879947d2750d3da59f59e32e42144661.png)

2010 年按年龄分列的全球视力障碍人数估计数，括号内为所有年龄的相应患病率(%) ( [来源](http://www.who.int/blindness/GLOBALDATAFINALforweb.pdf))

![Number of people visually impaired and corresponding percentage of the global impairment by WHO Region and country, 2010](img/3f100695daa0bd00b7a0a885c7c1edee.png)
...
![Worldwide hearing loss statistics](img/2ec1a9ce93d9f42a2e4b73e9b441bb92.png)

全球听力损失统计([来源](http://www.who.int/pbd/deafness/WHO_GE_HL.pdf)

![Prevalence of Disabling Hearing Loss (DHL) in some regions](img/b3297cd5955b5adcd46a88b53924b17b.png)

某些地区致残性听力损失(DHL)的患病率([来源](http://www.who.int/pbd/deafness/WHO_GE_HL.pdf)

![Disabling hearing loss statistics](img/19a403ca0f4e45b82eef8719feddec2e.png)
...
世界各地正在开展许多活动来提高人们对可访问性、视觉障碍者、听觉障碍者和其他问题的认识，包括[谷歌的网页可访问性课程](https://webaccessibility.withgoogle.com/course)、[抗击失明基金会](http://blindness.org/)、 [Adobe 的可访问性活动(PDF)](http://www.adobe.com/governmeimg/pdf/access_gov_fs.pdf) 等等。
