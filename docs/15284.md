...
> 原文:[https://www.sitepoint.com/get-xsl-dirty-work/](https://www.sitepoint.com/get-xsl-dirty-work/)
...
![A Typical Content-Based Site Design](../Images/64edfa771af873d36d47551fc14c0e92.png)**Fig. 1: A Typical Content-Based Site Design**
...
![XML to Formatted HTML Conversion with XSL](../Images/7f6d885cd3dcad9424360851e4e4baca.png)**Fig. 2: XML to Formatted HTML Conversion with XSL**
...
<q>*如果您决定使用 DTD 来验证您站点上使用的标签，您可能希望在文档被处理之前自动向文档添加* `DOCTYPE` *声明，而不是强迫用户在每篇文章的顶部键入它。你甚至可以自动添加* `<article>` *和* `</article>` *标签，以减少用户需要输入的标签数量。*T12】</q>

将上述文件另存为`docbook.xml`，然后在 MSIE 6 或更高版本中打开。您应该会看到如图 3 所示的内容。

![An XML Document in MSIE 6](../Images/607a1c7e70d5a662706897ea83a0c47f.png)**Fig. 3: An XML Document in MSIE 6**
...
![Internet Explorer spots an unclosed tag](../Images/22df3dce1570b599cc2334cc38dc0b0a.png)**Fig. 4: Internet Explorer spots an unclosed tag**
...
![A DocBook with Minimal Style](../Images/e54f6000e55c4b515951c00ccf0ed655.png)**Fig. 5: A DocBook with Minimal Style**
...
<q>*注意，由于* < xsl:value-of > *标签不包含任何文本或标签，我们通过用斜线(* `/` *)结束标签，使结束标签* < /xsl:value-of > *标签成为开始标签的一部分。如果没有这个快捷键，我们将不得不键入* `<xsl:value-of select="title"></xsl:value-of>` *。*T13】</q>
...
![A Slightly More Stylish DocBook](../Images/0890ef2374b68b15c28b685dead90968.png)**Fig. 6: A Slightly More Stylish DocBook**
...
![The Fully Styled Article](../Images/985848a29c04b00c2f5016c6330f2545.png)**Fig. 7: The Fully Styled Article**
...
![An XML-Based CMS](../Images/22ea98413d83e193c29bef9ccf59bb5e.png)**Fig. 8: An XML-Based CMS**
...
![Professional XSL](../Images/40fc13b236a83d541ba5f508272f12c6.png) [专业 XSL ](http://amazon.com/exec/obidos/ASIN/1861003579/webmasterresou05/) (Wrox 出版社)
...
![XSLT](../Images/fac621d34b061d89614b9f677c734235.png) [ XSLT](http://amazon.com/exec/obidos/ASIN/0596000537/webmasterresou05/)
