...
> 原文:[https://www.sitepoint.com/configuring-web-logs-apache/](https://www.sitepoint.com/configuring-web-logs-apache/)
...
Apache 对错误日志级别的定义如下:
![1299_apachelogstable1](../Images/42024fc2898facb71cccafb00c6bd6ef.png)
跟踪网站活动
...
```
LogFormat starts the line and simply tells Apache you are defining a log file type (or nickname), in this case, combined.  Now let's look at the cryptic symbols that make up this log file definition.![1299_apachelogstable2](../Images/9fb280bb5e50a85f0b277a9c7a873e14.png)
