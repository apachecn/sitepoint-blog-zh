...
> 原文:[https://www.sitepoint.com/javascript-from-scratch/](https://www.sitepoint.com/javascript-from-scratch/)

JavaScript 是一种非常有用的语言，提供了许多独特的好处。稍微考虑一下脚本功能是如何退化的，你就可以使用 JavaScript 为你的网站带来一系列功能、设计和可用性的改进。

这篇文章实际上是摘自 SitePoint 的新标题，[*《JavaScript 选集:101 个基本技巧、窍门&黑客*T3】。这里包括的四个章节包括:](https://www.sitepoint.com/books/jsant1/)
...
![Firefox's JavaScript Console](../Images/80a064f87f7fda9c248ba0a6c04971e9.png)
...
![Opera's JavaScript Console](../Images/ae3f98ed4a38509b9f2c9edfe3494d53.png)
*图 1.2。Opera 中的 JavaScript 控制台*

![IE's JavaScript Console](../Images/1c6a17ae6234fd1e2d3b0fc9d3b91fa3.png)
...
![Firefox's JavaScript Warnings Console](../Images/a03ea2238f766ebeba6b98d4d469690e.png)
...
![The DOM structure of a simple HTML page](../Images/ad8492641db003d87158c25cdb3d3e02.png)
...
表 13.1。DOM 0 事件处理程序
![Table listing DOM 0 event handlers](../Images/62f326e43b0677c686d361f594a8d3cf.png)
...
![A dynamically generated layer that appears on mouseover](../Images/19693b0c88dda8f81bc1c5c129d49c41.png)
...
![A table sorted on its last column in descending order](../Images/bbf15d7d87c49f2dfb596b7164af5fe0.png)
*图 13.2。第四列*按降序排序的可排序表格

![A table sorted on its second column in ascending order](../Images/7f07b27d92f25ce16cfc473a97d02d8e.png)
...
以上就是我们的样本[*《JavaScript 选集:101 个基本技巧、窍门&黑客*T3】。下一步是什么？](https://www.sitepoint.com/books/jsant1/)
