...
> 原文:[https://www.sitepoint.com/use-rabbitmq-php/](https://www.sitepoint.com/use-rabbitmq-php/)
...
![Hello world example routing](../Images/56d7e6cf8cb13185082422dc0235ac6e.png)

## 词汇表

| 概念 | 定义 | 图标 |
| --- | --- | --- |
| *制作人* | 发送消息的应用程序端点 | ![Producer icon](../Images/57645c70a5dfd90d579ba5d5f8d45254.png) |
| *消费者* | 接收消息的应用程序端点 | ![Consumer icon](../Images/ce5ae3e23e7fdf3d7ff385d4d13ce204.png) |
| *连接* | 处理协议、错误、认证等。连接使用 TCP 协议完成。 | – |
| *频道* | 连接通过信道被多路复用。尽管所有通道共享同一个 tcp 连接，但一个通道的通信完全独立于另一个通道。 | – |
| *交换* | 从生成器接收消息，并将它们推送到队列。根据具体情况，这对于开发人员来说是透明的。 | ![Exchange representation](../Images/8d0bfd7de499c58893fc56af4f813503.png) |
| *队列* | 存储消息的缓冲区 | ![Queue icon](../Images/fefad716d7c7494ef7b61944441c87a9.png) |
...
![sources.list](../Images/b419b88639a3e5be6c598460d320d112.png)
...
![enter image description here](../Images/35dcdf8d857c9977ada0a0e03bd36b92.png)

我们将实现最简单的模式:

![enter image description here](../Images/5cc5e8965b4ef9f46f2c507434f2f541.png)
