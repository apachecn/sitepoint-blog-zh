...
> 原文:[https://www . site point . com/CSS-properties-to-control-we B- typography/](https://www.sitepoint.com/css-properties-to-control-web-typography/)
...
![text-transform capitalize example](../Images/65498c7a1ac3b2ca4aa90f45f1728452.png)
...
![text-transform uppercase example](../Images/09dc18f165b612cb4f5db903e1911ba9.png)
...
![text-transform lowercase example](../Images/5fd3e3be905afff81a4592244dcd37f8.png)
...
![text-transform full-width example](../Images/b914d5e3963d01407f907255974c5fd0.png)
...
![first letter after a hyphen character is not turned into uppercase in Firefox when the capitalize value is applied](../Images/e24eb826789e179a008c2b661ccb9286.png)

注意连字符后的第一个字母没有大写。另一方面，下面是 Chrome 中显示的相同文本:

![first letter after a hyphen character is turned into uppercase in Chrome and all other major browsers when capitalize value is applied](../Images/91d78bb7e6f765829bf4834fcc04d077.png)
...
![Example of white-space set to the pre keyword](../Images/3f9dc65f6e16b423eed8dc571435a6bd.png)

![Example of source code styled with the pre keyword of the white-space property](../Images/9b0211635c9c8fd5e592ce686ca473c8.png)
...
![Example of pre-wrap keyword for the white-space property](../Images/db8c5817e099855835e347a452100a1f.png)

![Source code styled with the pre-wrap keyword of white-space property](../Images/3ac8a169104b5238b45dfde0fd1af2a6.png)

然而，缩小你的浏览器屏幕，你会注意到换行以适应他们的容器。

![Small screen display of text formatted with the pre-wrap keyword of the white-space property](../Images/6cde7ff5134b1c33174276337f43122d.png)
...
![Example of text formatted with pre-line keyword of white-space property](../Images/bb2ed4fee6bf5ada58d52733badfcdb0.png)

![Source code of the example for pre-line keyword of white-space property](../Images/ddc31cd29111414e39f66a8e40d3f989.png)
...
![Link with double arrow symbol as use case for the nowrap value of the white-space property](../Images/365e77857ca52a1c8823645df9143759.png)

上面是一个链接，后跟一个`»`符号。让这个字符移到下一行，例如在流动的网页布局中，是不可取的。

![Link with double arrow symbol unseemly dropped to the next line](../Images/390e5c0ce6cd0e32e6b92fdfb57f572c.png)
