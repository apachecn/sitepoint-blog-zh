...
> 原文:[https://www . site point . com/running-performance-metrics-on-cold fusion-functions-and-operators/](https://www.sitepoint.com/running-performance-metrics-on-coldfusion-functions-and-operators/)

*…发帖人* [大卫·梅德洛克](https://www.sitepoint.com/forums/member.php?u=24385) *:*

您是否注意到开发人员在陈述各种操作符和函数与其他函数和操作符相比表现如何？例如，<cfif not="" variable="" eq="" variable2="">与<cfif variable="" neq="" variable2="">相比表现如何？真的有显著差异吗？</cfif>T3】</cfif>
