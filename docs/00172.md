...
> 原文:[https://www.sitepoint.com/react-firebase-build-mvp/](https://www.sitepoint.com/react-firebase-build-mvp/)
...
![entity relationship diagram](../Images/e76dd76c4889bc44a69d8ebffb7339c2.png)
...
![application architecture diagram](../Images/7012bd03d46f57cfce9e83a51d3485b5.png)
...
3.  在 Firebase 控制台中，创建一个新的 **Web 应用**，并将其命名为`sitepoint-books-app`。您可以访问 Firebase 控制台，如下图所示。
    ![firebase-mvp-create-project](../Images/f10ea1e675ef08c035809686399d20e2.png)

4.  在下一步中，为您的应用程序命名(可以与项目名称相同)，然后单击**注册应用程序**。

5.  在**添加 Firebase SDK** 部分，选择**使用 npm** 并复制输出。
    ![firebase web app config](../Images/1739a8441543547ae50cb5cd86982003.png)
...
2.  上传我通过这个 [zip 文件](https://uploads.sitepoint.com/wp-content/uploads/2021/08/1629975705sitepoint-book-images.zip)提供的图片。你应该有下面的结构:
    ![firebase cloud storage](../Images/16414377ba262b94539aa5eda43feaca.png)
...
![firestore-place-id](../Images/05bc923881fdc0f6301344081e812916.png)
...
![cloud firestore database](../Images/4aeac953b20204fb1b57b17ecaac2e1a.png)

## 启动开发服务器

随着数据库的填充，我们现在可以执行`npm run dev`并浏览到`localhost:3000`来与项目交互。请注意，这是一个为学习而构建的原型应用程序，并非所有功能都已完全实现。

![app book detail](../Images/5741737927993d62a2dc1381f342632b.png)
...
![author list](../Images/8b730f6b4027e81bf7ef4a88d77ab19e.png)
...
![app author form](../Images/818295fd95a3e838bee075ce77818a44.png)
...
![app category list](../Images/4f03e083362e860b072cf1c6dd3cf77e.png)
...
![Firebase app category form-dropdown](../Images/3161f35bd30c18d5b0e336127bbde79b.png)
