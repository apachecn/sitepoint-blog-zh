...
> 原文:[https://www.sitepoint.com/coldfusion-components/](https://www.sitepoint.com/coldfusion-components/)
...
![Our BlogEntryList page](../Images/cf7d2dacc096251ec14c6c2ab4700f1b.png)

正如你对博客网站的期望，主页，或者更具体地说是我们的`index.cfm`页面，显示了最新博客条目的列表。

![Our index.cfm page](../Images/a8234b4631c24a36c4557f565f6070de.png)

而`profile.cfm`页面显示特定作者的博客条目。

![Our profile.cfm page](../Images/f93fc6216816fedb04262017f06eb287.png)
