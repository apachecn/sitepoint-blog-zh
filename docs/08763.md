...
> 原文:[https://www.sitepoint.com/10-jquery-signup-form-demos/](https://www.sitepoint.com/10-jquery-signup-form-demos/)
...
对于 web 开发者来说，用一个交互性强、耗时少的注册表单来打动用户是非常必要的。因为在大多数网站中，第一步是注册。所以今天我们将学习一个具有弹性 jQuery 效果的交互式 jQuery 注册表单。
 ...
 [![Registration Form with Elastic Effect](../Images/8ca9ad98a201a8ac7514bfb3d2a946eb.png)](http://demo.smartnetzone.com/jquery-registration-form-with-elastic-effect/) 
...
在本教程中，我们将向最好的人学习，创建一个类似 facebook 的注册表单。
 ...
 [![Facebook-like Registration Form](../Images/324c75f748e09fce92f9b63e80d43472.png)](http://tutorialzine.com/2009/08/creating-a-facebook-like-registration-form-with-jquery/) 
...
这是一个注册向导，带有原始的输入验证逻辑和一个用于验证错误的“twitter”风格的消息框。
 ...
 [![Scrollable Registration Wizard](../Images/bb491fb687b96a0c87309eae915e82d8.png)](http://flowplayer.org/tools/demos/scrollable/wizard.html) 
...
在本教程中学习如何使用 jQuery 注册研讨会。
 ...
 [![Seminar Registration](../Images/cfc89779e084630cc783d5debc3efc0e.png)](http://css-tricks.com/examples/SeminarRegTutorial/) 
...
这个详细的教程将向你展示如何把长的 webform 变成一个带有“向左走几步”信息的向导。一个插件也可以下载。
 ...
 [![FormToWizard plugin](../Images/a4a22bea5ed84d8f924ace400aafbb6f.png)](http://www.jankoatwarpspeed.com/post/2009/09/28/webform-wizard-jquery.aspx) 
...
jQuery.dForm 插件允许您从 JavaScript 对象(因此也包括 JSON)以编程方式创建 HTML 表单。
 ...
 [![jQuery::dForm 0.1.3](../Images/4dc0973994d2f1b718dbdbb45070c7df.png)](http://neyeon.com/p/jquery.dform/doc/files2/readme-txt.html) 
...
有时候注册表格决定了你的 web 应用程序的成功率，我觉得第一步(注册)应该少一些字段，引人注目，一定会给用户留下深刻印象。
 ...
 [![Gravity Registration Form ](../Images/b423eb1d393e941c6547a8e72139afc6.png)](http://www.9lessons.info/2011/01/gravity-registration-form-with-jquery.html) 
...
在本教程中，我们将创建一个滑动面板，滑入显示更多内容，使用 JQuery 动画显示面板的高度。
 ...
 [![Incredible Login Form ](../Images/cbd23b9a617439139513fdde1fdc5a09.png)](http://net.tutsplus.com/tutorials/javascript-ajax/build-a-top-panel-with-jquery/) 
...
在本教程中，我们将看到如何使用 CSS3 和 jQuery 创建一个简单的多步注册表单。为了增加趣味，我们将在表单中包含进度条，这样用户就可以看到表单完成的百分比。
 ...
 [![Multi-Step Signup Form](../Images/a85c9cf7f66727ad2f0474efde17a656.png)](http://webexpedition18.com/articles/how-to-create-a-multi-step-signup-form-with-css3-and-jquery/) 
...
这将向你展示如何使用 jQuery 创建一个 Twitter 风格的登录下拉列表。
 ...
 [![dropdown box likes Twitter](../Images/febacafd4fa74e24c6a371460317bdd9.png)](http://aext.net/2009/08/perfect-sign-in-dropdown-box-likes-twitter-with-jquery/) 
