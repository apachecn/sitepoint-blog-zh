...
> 原文:[https://www.sitepoint.com/10-online-button-generators/](https://www.sitepoint.com/10-online-button-generators/)
...
这是一个很棒的免费工具，可以为你的按钮生成 CSS 代码。按钮的不同部分有不同的颜色。颜色选择器顶部的滑块允许您修改左侧按钮的大小和形状。
 ...
 [![Button Maker](../Images/b21bf0c789338693d3be547a9ef85ad4.png)](http://css-tricks.com/6478-css3-button-maker/) 
...
这为你提供了很好的按钮创建工具。您可以改变按钮的大小、文本阴影、样式、颜色和输出类型(PNG / JPEG / GIF / ICO)。您对按钮所做的更改会随着您的工作而更新。
 ...
 [![Da Button Factory](../Images/c25ca9832e7b2cb4db6007b1c063bea0.png)](http://dabuttonfactory.com/) 
...
如果你正在寻找一个创建 Flash 按钮的资源，那么免费的 Flash 按钮生成器将会出色地完成这项工作。首先选择一种按钮样式。可以通过十六进制值改变颜色。底部窗格允许您向按钮添加链接以及链接的名称。单击最后一个按钮会生成您的按钮及其相应的 HTML 代码。
 ...
 [![Free Flash Button Generator](../Images/7c867d9d09bbbec732c3661ee1334edf.png)](http://swishit.com/FreeFlashButtons.html) 
...
您可以通过选项卡式界面编辑来创建按钮。定制选项覆盖了很多领域，可以满足你所有的按钮创建需求。结果可以作为 PNG 图像文件下载。
 ...
 [![As Button Generator](../Images/a8de73802ad8055993b29b295a1879d9.png)](http://jirox.net/AsButtonGen/) 
...
Adam Kalsey 的这个按钮创建工具有一个简单的界面。您可以选择按条分割图标，并选择条和按钮边缘之间的像素距离。
 ...
 [![Adam Kalsey’s Button Maker](../Images/1f4c33ed09d6f63b23c5a305e2999ef8.png)](http://kalsey.com/tools/buttonmaker/) 
...
为你网站的菜单系统创造一些闪亮的玻璃按钮。
 ...
 [![Glassy buttons](../Images/e227ed7f166af955829e0d7cdcbe738e.png)](http://www.glassybuttons.com/glassy.php) 
...
这个免费的在线按钮制作工具可以用来制作 88 x 31 像素的按钮，在你的网站上使用。如果你喜欢按钮制造商，请链接到这个页面。
 ...
 [![Online Button Maker](../Images/a0f5e5649bd02e49f90e1b24fd6ab306.png)](http://www.yugatech.com/make.php) 
...
免费的在线工具来创建 Flash 横幅，菜单，按钮和更多。
 ...
 [![Flash Vortex](../Images/bf1df31a7dabb549412ce08aa6e02953.png)](http://www.flashvortex.com/download.php?generatorId=151) 
...
基于网络的在线按钮生成器——在这个页面上，你可以为按钮创建数百种样式来装扮任何网页。
 ...
 [![Web 2.0 Button Maker](../Images/4335561ee460911730c364b4ff08f2ba.png)](http://www.web2.0button.com/) 
...
这是一个 JavaScript 按钮代码生成器工具，生成的 JavaScript 代码可以在你的网站上使用。
 ...
 [![Flash DB JavaScript Button Code Generator](../Images/75b674aa7d66f621dbaf94568fad18b6.png)](http://www.flash-db.com/PopUp/) 
