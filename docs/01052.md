...
> 原文:[https://www . site point . com/build-user-registration-with-node-react-and-okta/](https://www.sitepoint.com/build-user-registration-with-node-react-and-okta/)
...
![application listing screen](../Images/035d6bfd407ea0f799c9634e4b419fed.png)

然后，您将被带到应用程序创建向导。选择**单页 App** 按钮，点击底部的**下一步**。

![single page app screen](../Images/d88423f962da44d1e2be6e19435fcf4a.png)
...
![single page app settings screen](../Images/d0f7ce003df16d1b8fbee5cc89f756b1.png)

然后点击底部的 **Done** 按钮。

创建应用程序后，从应用程序列表中选择它，并点击**常规**选项卡查看应用程序的常规设置。

![general settings tab](../Images/88739f0e0400de8945e00fa5375bda68.png)
...
![okta api tokens screen](../Images/d6a7d7f18bd874b896c5e6acca4afcf2.png)

在那里，单击创建令牌。为令牌命名，如“Membership ”,然后单击“Create Token”。

![create token screen](../Images/25602bbcbc9015a6f2c2706a83be9bc7.png)
...
![user profile page](../Images/a36e284303c1c4e2e3aad839ad1f95b2.png)
