...
> 原文:[https://www . site point . com/server less-development-with-node-js-AWS-lambda-and-MongoDB-atlas/](https://www.sitepoint.com/serverless-development-with-node-js-aws-lambda-and-mongodb-atlas/)
...
![Clusters](../Images/f5aecfee8264a072f52649e2cc852579.png)

![Lambda user](../Images/e695e99e7e5ce9db98dda9c3a817028c.png)

在 ***用户权限*** 部分，选择<strongshow advanced="" options="">链接。这允许我们在特定的数据库上分配读/写，而不是任何数据库。</strongshow>

![user privileges](../Images/717ccb6c1a0fec8578f3234d716149ac.png)

然后，您可以选择分配更细粒度的访问控制权限:

![Access Control](../Images/0a615fc61d227804155f2bfb39c4899a.png)

在**选择角色**下拉列表中，选择读写，并在**数据库**字段中填写您将用来存储文档的数据库的名称。我已经选择把它命名为`travel`。

![Select Roles](../Images/98741c36c6d98519c96d2aebe97d8852.png)
...
![Connect cluster](../Images/7a3cc24aafecedc174799e0eb8467f5b.png)

复制 ***URI 连接字符串*** 值，并将其安全地存储在文本文档中。我们将在后面的代码中需要它，以及您刚刚设置的密码。

![URI Connection String](../Images/5b1a115fe17e8ad90c6ac9c901c43097.png)
...
![Add whitelist entry](../Images/137f534da267275aeff39c1d624a55ce.png)
...
![Console output](../Images/c7ac82e481fbc9267f31cb15b3639a8b.png)
...
![Console output](../Images/fef3907244d78dd0eb38db3e5ffc9cfe.png)
...
![AWS Lambda Basic Execution Role](../Images/83b698d81d86db49780d687878a62490.png)

现在让我们导航到 AWS Lambda 页面。点击**立即开始**(如果你从未创建过 Lambda 函数)或点击**创建 Lambda 函数**按钮。我们不会使用任何蓝图，也不会配置任何触发器，所以直接在左侧导航栏中选择**配置功能**:

![AWS Lambda Configure](../Images/19cb043eb90bd68140c4920e2af4ba5f.png)
...
![Configure function](../Images/e64540b0e02b2659a7bfbc5be3f0f622.png)
...
![Lambda function handler](../Images/14a39e1feff505871f81465027e39cc9.png)
...
![Lambda create function](../Images/e1245182c9379deff82e7240f8e304d6.png)
...
![Environment variables](../Images/0c57b0eed61e9580da30f3f747d1e2bb.png)
...
![Encription key](../Images/596df60128e25af9923e6825a1c2a5e6.png)

接下来，为 MONGODB_ATLAS_CLUSTER_URI 变量选择 **Encrypt** 按钮:

![Select encrypt](../Images/58ccf2bc5b5ffad95c9b5f413b439a2c.png)
...
![Input test event](../Images/2455e15649b96a51d6e37a0e616a9049.png)

滚动并按下**保存和测试**按钮。

如果您正确地配置了一切，您应该在 Lambda 日志输出中收到以下成功消息:

![Lambda log output](../Images/aad58eee3971e6319de83a2f8a38fc5f.png)
