...
> 原文:[https://www . site point . com/build-a-video-chat-service-with-JavaScript-webrtc-and-okta/](https://www.sitepoint.com/build-a-video-chat-service-with-javascript-webrtc-and-okta/)
...
![vchat screenshot with no styling](../Images/4a842cbce28f5be3035e89dcd3585ebb.png)
...
![vchat screenshot with styling](../Images/f66c856cde3d40c3308542e1b0483ebe.png)
...
![Okta create app](../Images/0f36d364ff7dec12436b840b70c1098a.png)

一旦你到达**创建新应用**页面，用以下信息填写**应用设置**表格:

![Okta app settings](../Images/3517f0fecce76251ad26f6ef693ed9ab.png)
...
![Okta create trusted origin](../Images/05e2fbd374be924f30dcdf3581e165b4.png)

一旦进入 **Add Origin** 屏幕，输入以下信息，Okta 将允许您在本地测试环境中使用 Okta 认证服务:

![Okta create trusted origin](../Images/a961c549260f38f8b0f5a95ca14d16ff.png)

最后，现在您已经配置了 Okta 应用程序和所有必要的安全规则，您应该在 Okta 中创建一些用户帐户，以便以后登录。您可以通过点击**用户**选项卡，然后点击**添加人员**按钮来完成此操作:

![Okta create user](../Images/b9b8af83ea72150dfdc54429d4bb21a7.png)
...
![Okta dashboard](../Images/a38dbf051e5502a11aaf140d9415c5ab.png)

您还需要查看您之前创建的应用程序来获取**客户端 ID** 值。下面将使用这两个值(客户端 ID 和组织 URL)。

![Okta app credentials](../Images/2d0526fbf3537b2850d7b4e6d98b1d51.png)
...
![vchat test Okta login](../Images/4bc0aedc760a5e530737af1f25c283d5.png)
...
![vchat state management](../Images/9685861e08d7e17448a53c22d5790619.png)
