...
> 原文:[https://www.sitepoint.com/github-profile-readme/](https://www.sitepoint.com/github-profile-readme/)
...
![GitHub profile readme GIF](../Images/f460df015c8167ce5bf50a7f7897a712.png)
...
2.  Click on **+** icon at top right of the page and select **New Repository**.![GitHub Create Repository](../Images/9cc70e818d449b7a65b28c60903ab3b3.png)
3.  A *Create a new repository* page opens. In the **Repository name** field, enter the username of your GitHub account. After entering the username, GitHub displays a message describing that you’re about to create a GitHub special repository.![Repository name input field](../Images/49ab2c28da54b64e6bf1d5d8656e590a.png)
...
5.  Check the **Add a README file** checkbox. This will add a `README.md` file where we’ll add the profile contents. The field values should look similar to thepicture below.![Create repository form fields](../Images/bd0384143dc27c1117606f17ecc129da.png)
6.  Click on the **Create repository** button. A special repository is created successfully. Go to the repository you just created and you’ll see a `README.md` file added to the repository.![Special repository created](../Images/70c639346a63b975bc0ce969e730c920.png)
...
![Header section](../Images/29641dd41e40dd605f88060ce67fd877.png)
...
![GIF preview](../Images/cae3e1b8cc2a65cac3a54d51a66a346d.png)
...
![Linkedin badge with no styling](../Images/2cf2b543889730432f847608e71f97a3.png)
...
![Linkedin badge with styling](../Images/feb1d3f5a55487efce02ed8474256265.png)
...
![Badges preview](../Images/22aefc6ef35e66ebbd71c77076d7d7d2.png)
...
![Profile counter preview](../Images/64ef54254c7c3d4ace490c1e3e9e1381.png)
...
![Hey there text preview](../Images/c7b77a28fc5a4034eee3c698997499d3.png)
...
![About me section](../Images/3af1467e5212aa43a63158ad104357c1.png)
...
![GIF banner preview](../Images/6df2bad0701946cfe828232dc442a9df.png)
...
![About yourself description preview](../Images/0010515a3d0b93db0de45b4e4278bb63.png)

## 添加语言和工具

这是我们将在此部分添加的内容的图片。

![Languages and tools section](../Images/ec29ec257b606422cdabe56dd3e68e58.png)
...
![DevIcons react logo](../Images/50203cb791859c10252c6fd06def81f4.png)
...
![Languages and tools preview](../Images/de4ac9dc8b035131f08bfa42ffa74adc.png)

## 添加 GitHub 统计数据

这是我们将在这一部分添加的内容的图像。

![GitHub stats section](../Images/ab71cdb3a2e9237c5244a5fe80044ae5.png)
...
![Streak stats preview](../Images/c9c728a769cbc901c5fac409cd7b7065.png)
...
3.  降价生成后，点击**复制到剪贴板**按钮，将复制的降价添加到`README.md`。![Streak Stats Tool](../Images/30c2bcec679364f7ee2d691485bc2d64.png)
...
![GitHub readme stats preview](../Images/403890264dad1e727a60ac6e21e5919d.png)

## 将最近的博客添加到您的 GitHub 个人资料自述文件

下图显示了我们在这一部分的目标。

![Blog posts](../Images/6b0ae38c6af90fcd9370a235bfdc8d7c.png)
...
2.  点击**提交更改**按钮保存更改。
3.  The configuration of GitHub workflow is defined in a `.yml` file, which follows a [YAML](https://www.redhat.com/en/topics/automation/what-is-yaml) syntax. In your repository, in the **Add File** dropdown, select **Create New file**.![Create new file in GitHub](../Images/e441afc5edd14a6cf680cd05e654dcec.png)
4.  In **Name your file..** field, enter `.github/workflows/blog-post-workflow.yml`. All GitHub workflow’s `.yml` configuration files reside under the `.github/workflows` directory.![Create blog post yml file](../Images/b0dc88f9fe855d61dcd278c28635f4c3.png)
...
3.  In the **Run workflow** dropdown, click on the **Run workflow** button. The workflow will start executing.![Run Blog post workflow](../Images/415ec88a751ceb26a94013412e5b8eba.png)
4.  Go to your GitHub profile page, and under the “Blog Posts” section you’ll see a list of all the blog posts from the blogging platforms defined in the `blog-post-workflow.yml` file. Below is the output for `"https://dev.to/feed/itszed0"` in the `feed_list`.![Blog posts](../Images/6b0ae38c6af90fcd9370a235bfdc8d7c.png)
