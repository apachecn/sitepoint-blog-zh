...
> 原文：<https://www.sitepoint.com/unix-server-performance/>
...
<q>*“SSH(Secure Shell)是一种通过网络登录到另一台计算机，在远程机器上执行命令，以及将文件从一台机器移动到另一台机器的程序。它在不安全的通道上提供强大的身份验证和安全的通信。它旨在替代 rlogin、rsh 和 rcp。*</q>
