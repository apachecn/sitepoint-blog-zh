...
> 原文:[https://www . site point . com/optimizing-CSS-id-selectors-and-other-myths/](https://www.sitepoint.com/optimizing-css-id-selectors-and-other-myths/)
...
这使事情变得复杂，因为解析 CSS 只是浏览器呈现管道中的一个步骤。下面是一个面向渲染的视图，展示了浏览器如何将单个帧渲染到屏幕上(来源: [Google](https://developers.google.com/web/fundamentals/performance/rendering/images/intro/frame-full.jpg) ):

![The browser rendering pipeline](../Images/f5d8fc56ef9599f0961402732be58ff8.png)
