...
> 原文:[https://www . site point . com/using-JSON-for-language-independent-configuration-files/](https://www.sitepoint.com/using-json-for-language-independent-configuration-files/)
