...
> 原文：<https://www.sitepoint.com/build-a-basic-crud-app-with-node-and-react/>
...
![Create React App default homepage](img/881e34beef19ef89c33f4ef8120184f4.png)
...
![Blank homepage](img/cb58060c2883d0746b52c40d013b0c64.png)
...
![Create new application settings](img/069f328051fa7613f63be3332f0df6f7.png)
...
![homepage with login button](img/a44d383c18a900a05cc0a67368bf7a73.png)

当您单击登录按钮时，您将被重定向到您的 Okta 组织 URL 以处理身份验证。您可以使用在开发人员控制台中使用的相同凭据登录。

![Okta sign in](img/68069edc1414a7a67725fe5ab7f6d454.png)

成功登录后，您将返回到您的应用程序，现在应该会看到一个图标，显示您已登录。如果你点击图标，你会在注销按钮上看到你的名字。点击该按钮会让您停留在主页上，但会让您再次注销。

![homepage, logged in](img/43f30925e1f230345925dbbf1623d47e.png)

![homepage without logout button](img/9d52f6dfc44635e3b8334013e19c80b6.png)
...
![new post](img/9a829a37a983670763c9c1b9d29165df.png)

![list of posts](img/d2bde22be7003798a14df8dd8d5249a7.png)
