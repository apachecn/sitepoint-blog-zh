...
> 原文:[https://www . site point . com/build-framework less-we B- app-modern-JavaScript-we b-components/](https://www.sitepoint.com/build-frameworkless-web-app-modern-javascript-web-components/)
...
![lack of running once meme](../Images/0cca4e9d12655cb763a8aaee6ab91f7a.png)

## 最终演示

这是带有可观察对象和 web 组件的应用程序的外观:

![final demo](../Images/d3ad883d09de6c40f38a49907ecadf67.png)
