...
> 原文:[https://www . site point . com/virtualbox-branched-snapshot s-tutorial/](https://www.sitepoint.com/virtualbox-branched-snapshots-tutorial/)
...
![VirtualBox Snapshots tab](../Images/8f15b262ec5d9750dd0cae6d3828e91c.png)

突出显示当前状态，然后单击**拍摄快照**图标(用红色圈出)，并为其命名和描述，例如“XP SP3”。

![VirtualBox Snapshot 1](../Images/59a367f52ca04c0fb64661349351b45b.png)

## 2.创建 IE6 快照

当前状态应该已经安装了 IE6，但最好再拍一张快照，因为更新会随着时间的推移而应用。突出显示当前状态，点击**拍摄快照**图标，并为其命名和描述，例如“XP IE6”。

![VirtualBox Snapshot 2](../Images/a6ffcf84e83ae23ff5d98860c117dea1.png)

## 3.恢复到根快照

聪明的地方就在这里。突出显示根“XP SP3”虚拟机，并单击**恢复快照**图标(用红色圈出)。你会被警告你会丢失当前的机器状态，但是无论如何点击**恢复**——你不会丢失 IE6 快照。

![VirtualBox Snapshot 3](../Images/776ebb7bb2a87c91019be1a0bf233f22.png)
...
![VirtualBox Snapshot 4](../Images/19e32d5c733a4684258b3449f818ee11.png)
