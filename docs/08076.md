...
> 原文:[https://www . site point . com/10-jquery-mouse-text-shadow-plugins/](https://www.sitepoint.com/10-jquery-mouse-text-shadow-plugins/)
...
一个非常简单的 jQuery 插件，它使用 CSS 文本阴影和框阴影功能来根据当前鼠标位置改变阴影方向。
 ...
 [![jQuery Fancy Drop Shadow](../Images/c2c8a92aebef7e60a9a6bc64bbbc1d6a.png)](http://www.ralphharrer.at/blog/artikel/jquery-fancy-drop-shadow-plugin) 
...
Text-shadow 是一个简洁的 CSS3(实际上是 CSS2)属性，允许你在文本后面显示阴影。
 ...
 [![Cross browser text-shadow](../Images/1cd05526e7e4394362d3004b9c2c3e0a.png)](http://kilianvalkhof.com/2008/design/almost-cross-browser-text-shadow/) 
...
jQuery 插件，你可以把它应用到一个元素上，让它自动为你做所有的工作，同时仍然在 IE6，IE7 和 IE8 中工作。
 ...
 [![CSS3 Text-Shadows In Internet Explorer](../Images/e4ead45ea533bffb2471983abbc39539.png)](http://www.nealgrosskopf.com/tech/thread.php?pid=61) 
...
它的作用是给一个元素一个阴影，根据鼠标光标的位置改变它的属性。
 ...
 [![Real Shadow](../Images/37b01fe7c100ea7e8d68a57d6af4e525.png)](http://blogfreakz.com/tutorial/real-shadow-a-jquery-plugin-for-creating-realisitc-shadows/) 
...
![Textgrad](../Images/cf9e476450bd211528247557ecb03154.png)

## 6.代号彩虹

这在大型网站或动态内容上特别有效，因为为每个实例创建图像是不切实际的。

 [![Codename Rainbows](../Images/09aed90b014c763d054ec891be4b25d5.png)](http://labs.dragoninteractive.com/rainbows.php) 
...
是一个简单、轻量级的 jQuery 插件，它允许你使用 jQuery 的常规。动画方法。
 ...
 [![animate-textshadow](../Images/b7b4a035abf3e86bac9f565754fc6b07.png)](http://www.alexpeattie.com/projects/animate-textshadow/) 
...
一个 jQuery 插件，用于创建各种类型的投影。
 ...
 [![jQuery Shadow](../Images/4aa8b003e833b17314e438c54dd4c395.png)](https://github.com/sydlawrence/jQuery-Shadow#readme) 
...
文本和方框阴影动画 jQuery 插件。
 ...
 [![NuvuShadow](../Images/583b297b9884465ab5dbb217fff704e8.png)](http://www.behance.net/gallery/NuvuShadow-TextBox-Shadow-Animation-jQuery-Plugin/1629597) 
...
添加当你悬停在元素上时使元素“发光”的功能。对于支持文本阴影 CSS 属性的浏览器，您还可以添加一个光环。
 ...
 [![jquery-glow](../Images/2ea5fd5fbb0ddd6ab3254ebbe815223e.png)](https://github.com/nakajima/jquery-glow#readme) 
