...
> 原文：<https://www.sitepoint.com/extracting-website-data-creating-apis-wrapapi/>
...
![WrapAPI Web Builder](img/c06cf652a8fb80237286bf6c04295bd2.png)
...
![Preview of SitePoint inside WrapAPI Builder](img/f5412732cefc914ccadfcb484423d98d.png)
...
![Selecting titles in the builder](img/6deab97da693a7b9b270dc7bb8299705.png)
...
![Extract/Ouput options](img/bd9cf1707ca4dd7433faf75fe6d21cc1.png)

**Preview** 选项卡将显示我们的数据在 JSON 中的表示，您可能会对 API 的外观有所了解。如果你对结果满意，你可以点击**保存**按钮来保存 API 的一个版本。

![Saving API endpoints](img/cb3945a1547bd2809a7ecc33d39f5b43.png)
...
2.  将其移至一个单独的窗口。
    ...
    ![Undocking the Chrome extension from DevTools](img/fad52cf19c1b80e3fcd4a7683b92b793.png)

3.  使用您的 WrapAPI 凭据登录。

    ![WrapAPI Chrome extension](img/14e0493fc48f474e7b6c8dbf1b156fe9.png)

4.  准备好之后，按下**开始捕获请求**按钮。

5.  刷新您正在使用的主选项卡。

    ![WrapAPI extension in Developer Tools](img/61e16ec5ccc3bc42a2c1f3b6f655362d.png)
...
![Ready to publish our API](img/320ed0b98635e120fc01dcc33fe1718a.png)

全绿？这一定意味着我们已经成功地完成了发布我们的 API 所需的步骤，这几乎是正确的。最后一步是点击 URL 栏后顶部的**发布**按钮。您已经可以看到可以用来测试 API 的不同编程语言。我将使用带有扩展的浏览器，以更好的方式呈现 JSON。

这是我们最后的 API:

![Visiting the created API](img/a76fd90d072cfa8c02a1a8e25f33e490.png)
