...
> 原文：<https://www.sitepoint.com/windows-8-productivity/>
...
[![Windows 8 Win+X menu](img/5f8feca6d309c90bb38e2d240648f4af.png)](https://blogs.sitepointstatic.cimg/tech/762-windows-8-shortcuts-winx.png) 如果只记得一个热键，那就做成 **Win+X** 。它显示了有用选项的菜单，如常用的控制面板设置、磁盘管理、计算机管理和命令提示符。
...
[![Windows 8 shutdown options](img/944c7b67f1883a3e764c915128e443e3.png)](https://blogs.sitepointstatic.cimg/tech/762-windows-8-shortcuts-power.png) 这里有一个更简单的选项:*合上笔记本电脑的盖子或者按下电脑的电源按钮*。
