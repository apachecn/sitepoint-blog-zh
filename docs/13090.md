...
> 原文:[https://www . site point . com/Drupal-7-a-living-breathing-semantic-web-citizen/](https://www.sitepoint.com/drupal-7-a-living-breathing-semantic-web-citizen/)
...
> “未来就在这里。只是分布还不均匀。”
> 
>  [![DBPedia, US Census data, RDF Book Mashup, W3C WordNet, CIA factbook, FOAF, Musicbrainz.](../Images/28512aa3d914130b6ff10d8cb5bda5b5.png)
> T4】](https://esw.w3.org/topic/SweoIG/TaskForces/CommunityProjects/LinkingOpenData)
> 
...
Drupal 7 看起来完全接受了这种链接数据网的想法，其中每个站点都成为自己的数据服务器——能够与其他站点和其他数据源进行交互和融合。数据库本身将向 Web 公开(根据您的需要使用或多或少的安全性),其中各个字段标记有语义含义；想 [hCard](https://microformats.org/wiki/hcard) 、 [hReview](https://microformats.org/wiki/hreview) 、 [hCalendar](https://microformats.org/wiki/hcalendar) 、 [FOAF](https://www.foaf-project.org/) 等。
 ...
 [![Linking Open Data logo](../Images/c8114219105826484021b8959090fc9b.png)T3】](https://esw.w3.org/topic/SweoIG/TaskForces/CommunityProjects/LinkingOpenData)
