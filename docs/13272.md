...
> 原文:[https://www.sitepoint.com/getting-started-photoshop-4/](https://www.sitepoint.com/getting-started-photoshop-4/)

***移动工具***

移动工具(V)移动选定区域或整个层。使用大多数其他工具时，您可以通过按住 Ctrl 键(Mac 上的 Command 键)来临时调用移动工具。

![The Move Tool in action](../Images/0901c573c994dc2ea8c41bc26d9352a7.png)
...
![Copying a layer with the Move Tool](../Images/cc84765f9b90ae4b7e543216b09576d1.png)

***裁剪工具***

![Creating a selection using the Crop Tool](../Images/2a604cd1f5f5f9ebcd0aadfc77479174.png)

裁剪工具(C)用于修剪图像。使用裁剪工具创建选区，然后双击选区的中心，或按 enter 键，将图像裁剪到选区的大小。

要取消而不进行裁剪，请选择另一个工具或按 Esc 键。

![The cropped image](../Images/d529113df04d363e198ba4ef25ff60f1.png)
...
![Drawing and painting tools](../Images/6026dd3072c52454736ae76e13aeb99e.png)

除了其非凡的照片编辑能力，多才多艺的 Photoshop 还提供绘图和绘画工具，允许您创建自己的形状和背景。

**刷**

![The Brush options](../Images/3161451bc47f06565bfbbe6d2bc3941f.png)
...
![Aliased vs anti-aliased lines](../Images/b9aa246b8527351e9c6e5d831ae10ac4.png)
...
![The Gradient options](../Images/4b11d2081253d2a138c3cf011b2bb14f.png)
...
![The Shape options](../Images/055a5e93ff1a995408baf966656c5ad3.png)

![Different ways to create shapes](../Images/3adf4afec843e8fe48c14cd91591149d.png)
