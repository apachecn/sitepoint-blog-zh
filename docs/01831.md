...
> 原文:[https://www . site point . com/building-Facebook-chat-bot-node-heroku/](https://www.sitepoint.com/building-facebook-chat-bot-node-heroku/)
...
![A man and his Facebook chat bot, sat on the sofa watching Metropolis on a large TV](../Images/793999acbc04297d960275a8b94e1de0.png)
...
![Create Heroku Config Var](../Images/5f1b059911bbd716944267dda73d6621.png)
...
![Screenshot of the Create a Page options, showing the six different types of page](../Images/49225c7b9fa1d9a4446912d27c64ee02.png)

然后选择页面的类别和名称。

![Screenshot of the dropdown menu prompting for a category and page name](../Images/f55d993f90d839c7623017712e95381f.png)

点击*开始*后，页面将被创建，您将被要求提供关于您的应用程序的更多详细信息(描述、网站、个人资料图片、目标受众等)。您现在可以跳过这些设置步骤。

![screenshot of the newly created Facebook page](../Images/e4693bac47aec4bec60b58ddde605ef4.png)

要创建脸书应用程序，请前往[添加新应用程序](https://developers.facebook.com/quickstarts/)页面，点击其他平台选项下方的*基本设置*链接。

![Screenshot of the 'Add a New App' page, prompting to select a platform](../Images/67e24fdc99f66abe17fb91fbd3f55b4d.png)

填写必要的详细信息。选择页面的*应用作为类别。*

![Screenshot of the 'Create a New App ID' form](../Images/2a3fd533e32bd589b17371656d1c94a5.png)

点击*创建应用 ID* ，将打开应用的仪表盘。

![Screenshot of the App Dashboard](../Images/1ae5fcc268ac0c4ed013e82bfb582f6a.png)

从右侧的*产品设置*中，点击*信使*部分的*开始*。然后您将被带到下面显示的 Messenger 设置页面。

![Screenshot of the Facebook Messenger Settings page](../Images/0326eb48e3e0c34fde0126781ebcbaca.png)
...
![Webhook Settings](../Images/e26adef1f2c28a38841f84c407c7cb48.png)
...
![Webhooks panel showing 'complete' message](../Images/470ffb92b62ca6a582cd9d61b492d9c8.png)

在*令牌生成*部分，从下拉菜单中选择您的页面。身份验证后，将为您生成一个页面访问令牌。

![Token Generation section showing Page Access Token](../Images/d13bbef24f140579d4d32efe3f469957.png)
...
![Subscribe Webhook to Page Events](../Images/0c7ccc5dfd963df2d0613d0abf147a43.png)
...
![Page Settings](../Images/df85474b66a1214ae2c7a3775184fce9.png)

从左侧面板选择*消息*，然后打开*在右侧面板显示消息问候*。根据您的喜好设置消息。

![Customize Greeting Text](../Images/0dce0bd917bbbb82c60b151c32e139cc.png)
...
![Page search](../Images/051a1eac1dc1b8e76d4cfe774268c3b9.png)

从上面可以看出，您不能总是保证页面的名称是唯一的。您的用户可能会选择错误的页面。为了防止这种情况，您可以为页面设置一个唯一的用户名。为此，进入你的页面主页，从*更多*下拉菜单中选择*编辑页面信息*。

![More Dropdown Menu](../Images/ac1959fd209bdf96e839bccbf30e6f47.png)

然后设置用户名。

![Set Page Username](../Images/84961826266dbf43f6ab5b1ab3d73647.png)

现在如果你搜索`@page_username`，你会找到正确的页面。也可以去`https://m.me/PAGE_USERNAME`开始互动。

下面，您可以看到我们为欢迎屏幕设置的问候文本以及*开始*按钮。

![The Welcome Screen of your Facebook chat bot](../Images/83aa853a003a39e9519ef9083a6706ec.png)

点击按钮，您应该会看到从服务器发送的消息。

![Initial Message](../Images/3c360a0200794bd5a34c56476f63bf02.png)
...
![MLab Add On](../Images/d0915aa1c93d6545215802273c3a5862.png)

如果您在 Heroku 上检查您的环境变量，您将看到一个已经设置了 MongoDB 的 URI 的环境变量。

![MONGO DB Environment Variable](../Images/750b10d33cc3e31a00b6a6a13cf60253.png)

### 通过司法实验室网站建立数据库

如果您喜欢在 mLab 网站上设置 MongoDB 数据库，那么在那里注册一个帐户，然后前往[创建新部署](https://mlab.com/create)页面。将*计划*设置改为*单节点*，然后从*标准线*部分选择*沙箱*。

![mLab Create Database](../Images/4d19401008493109e28c03df3f6253b8.png)

为您的数据库设置一个名称，并通过单击*Create new MongoDB deployment*按钮来完成这个过程。

![mLab Create Database](../Images/b04bf0ae91e6493effa3743010eb7652.png)
...
![Example of a Structured Message from the Facebook chat bot](../Images/e801708368c9d55468b4113d41d4b510.png)

在 web(和 iOS)上，这看起来有点不同。

![Example of the Structured Message output on iOS](../Images/c61d51a2bbae763c5234eb901149dc9e.png)
...
![Incorrect Payload Sent](../Images/8822c9da3910bcf515b7b280a6a71b96.png)

然后，用户可以进行另一个查询。

![Search for Movie](../Images/b49236e8f211ca31d35d4865e1f607b3.png)

在确认这是正确的电影后，他们将从机器人那里获得如何进行的进一步指示。

![Movie Details](../Images/6c585694f1783c654d75fdadcf49dffb.png)
...
![Movie with no Poster](../Images/cf3b68f72c2bef6f727751a99e293864.png)

![Movie with Poster](../Images/bda092ce6ac4b5dcd2543cb6ce755ec8.png)

如果没有找到符合用户查询的电影，机器人会让他们知道这一点。

![Movie not Found](../Images/e8601defbc97cbf4183b7a4e0ff9b982.png)
