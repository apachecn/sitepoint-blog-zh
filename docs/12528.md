...
> 原文:[https://www . site point . com/YouTube-PPC-ads-are-smart-move-not-deadline-one/](https://www.sitepoint.com/youtube-ppc-ads-are-smart-move-not-desperate-one/)

![](../Images/cd32ffc0299dc2bbf74b9d04d25560cd.png "youtube-logo")昨天， [YouTube 宣布](http://www.youtube.com/blog?entry=geqKl0QNkkw)将以赞助视频的形式向网站添加点击付费广告。用户和广告商现在可以对与网站搜索结果并排的定向广告进行竞价，并将用户推向特定的剪辑。TechCrunch 的 Erick Schonfeld 认为 YouTube 的新广告是弱势的表现。但是我们不同意。
