...
> 原文:[https://www.sitepoint.com/html-css-beginners-guide-10/](https://www.sitepoint.com/html-css-beginners-guide-10/)
...
成功找到了到达起点的路——或者在
这种情况下，找到了我们的主页。</p>
</div>T127】！–body content div->
</body>
</html>

您现在应该会看到如下所示的页面。

![Displaying simple navigation on the page](../Images/f32d05cb1d797d55aa333fe7fdc8a5f6.png)

将链接块添加到`contact.html`和`about.html`，然后尝试点击刚刚添加的链接。应该可以在所有三页之间快速切换。这是一个里程碑:你现在是一个工作的、可导航的网站的创建者。现在让我们讨论几个可以添加到页面中的 XHTML 元素。

![Navigating the web site](../Images/c47cc3e7246531e2a567a89c0099c875.png)
...
![Displaying a quotation on the page](../Images/ad5ff7856160baa9fe124a7e2c87c19b.png)
...
![Displaying different emphasis styles in the browser](../Images/d5edabc44ed39cceda349af4ca0c04a3.png)
