...
> 原文:[https://www.sitepoint.com/rss-datalist-control-asp-net/](https://www.sitepoint.com/rss-datalist-control-asp-net/)
...
![1324_image1](../Images/5d0f95a784c579c1518f97dcb9aec1bc.png)
...
7.  Using the property selector in Visual Studio, you can define the feed you whish to associate with the control through the `Location` variable:
    ...
    ![1324_image2](../Images/ba5a33cf387d8eda08675bb9d882b5a9.png)
...
![1324_image3](../Images/dc360e5e13ca7437b6e8370a4ebc19a7.png)
