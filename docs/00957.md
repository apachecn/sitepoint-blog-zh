...
> 原文：<https://www.sitepoint.com/how-the-lightning-network-helps-blockchains-scale/>
...
![A vault with two keys](img/d7f16f1d7829b948c3e51806b08700d2.png)
...
![Alice and Bob](img/e411d379989b7a12e3bae2a1c9af640f.png)
...
![Bob sends an initial channel-opening transaction](img/94adbe9af869bcd795d064e479445dc7.png)
...
![Alice accepts and signs](img/a9e41bc3f8d8435f64e611a9c1a46d98.png)
...
![Signed transactions waiting](img/c5cab0921ac1f2fb451aaa381a520b7f.png)
...
![Channel is open, transactions are in the blockchain](img/27229bc8bd6449cf74c1a7d7f97b9074.png)
...
![Bob sends the first transaction](img/fb49ac0482991ef2178c4cc8a28e6883.png)
...
![Alice signs](img/2efe59dda9d621c3dc67274f79d7d2a9.png)
...
![The new transaction overwrites the old](img/b927f6eb640e7c7dd3a7db76dac2c87d.png)

爱丽丝现在有机会要么签署并广播新的交易，从而获得 0.2 BTC 并结束工作关系，要么继续这样做，发送更多的文章，并获得更多的这种增量交易。她也可以保持离线或闲置一周，失去这一切。

![Alice signs the second transaction](img/6f8c63708a8d4e5d016284b1ecb29c4b.png)
...
![Docked payment](img/5616c381be8bf71dc8a582583cda2aab.png)
...
![Alice aims to send an older transaction](img/72217ee98bf80d2605f19d7f044435fa.png)
...
![Last transaction is still OK for sending to the blockchain](img/3fbf6890154320115de8856a87e98314.png)
...
![Alice rejects Bob's attempt at a robbery](img/9760295e3e5113f02fc1083c7e3f20b8.png)
...
![Alice signs and broadcasts the last transaction](img/a5c3985458d22ca4a45afd74560e73fe.png)
...
![The final transaction is in the blockchain](img/5aade242922f2a5ea93e0bf446e827c1.png)
...
![Sending through Bob to Roko](img/18b9345d27fce816a0f866075f7f09d4.png)
