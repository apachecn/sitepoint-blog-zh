...
> 原文:[https://www . site point . com/caching-hat-trick-varnish-memcached-and-PHP-libraries/](https://www.sitepoint.com/caching-hat-trick-varnish-memcached-and-php-libraries/)

之前，我们看了一些常见的缓存机制，我们可以轻松地利用它们来提高应用程序的速度。在这一部分中，我们将介绍一些可以和 PHP 一起使用的用于缓存的附加软件。

![Abstract image with text cache](../Images/d9b4a56583246b4095b730b2ad037ac6.png)
...
![memcached](../Images/43c006d006ef5b6ac6cf9e2058fe750e.png)
...
![phpmemcachedadmin](../Images/d3daa71d666bf7c8a465325d9c6b8196.png)
...
![varnish initial request](../Images/7650d6bf32159a758545fef94cad8e40.png)

现在刷新页面，再次检查花费的总时间。我花了 90 毫秒:

![varnish second request](../Images/31479eafb34a94056e33427cf931551b.png)

让我们也检查一下从第二个请求中得到的响应头:

![varnish response headers](../Images/4d59d7ad413bef4bfc212fb4125fe170.png)
