...
> 原文：<https://www.sitepoint.com/20-docs-guides-front-end-developers-10/>
...
[![CSS Mod Queries and Range Selectors](img/454165bbe3892a5f2ce99463f179a919.png)](http://www.modqueries.com/)

## [2。你可能不需要 JavaScript](http://youmightnotneedjs.com/)

这个网站收集了一堆不同的技术，展示了只用 HTML、CSS、Sass 可以做什么。

[![You Might Not Need JavaScript](img/c2c1b9f696e8d22a322cc80738236c2f.png)](http://youmightnotneedjs.com/)
...
[![The HTML5 Mega Cheat Sheet](img/aefdfed80c0ed18b93113a78872ba22d.png)](https://makeawebsitehub.com/the-html-5-mega-cheat-sheet/)
...
[![SVG Authoring Guide](img/3a48b08d7fb74d7168c95f531c68272f.png)](http://w3c.github.io/svgwg/specs/svg-authoring/)
...
[![HTML 5.2 W3C Working Draft](img/7571ea2aa299a6dbb4a1ffac7c3b23ad.png)](https://www.w3.org/TR/html52/)

## [6。网络开发人员清单](http://webdevchecklist.com/)

当开发人员完成一个项目时，这是一个很好的、广泛的清单。包括可用性、可访问性、SEO、代码质量、安全性等类别。此外，类别中的每个项目都包含帮助您核对项目的链接。

[![Web Developer Checklist](img/41b326f1bff5b6fd74d97580fa212808.png)](http://webdevchecklist.com/)

## [7。我能制作动画吗？](http://canianimate.com/)

一个简单的网站，允许你搜索一个 CSS 属性，它会告诉你这个属性是否是“可动画的”,并提供更多关于浏览器如何计算动画的信息。

[![Can I animate...?](img/3a40577b3e46e7df359b95d7531996e1.png)](http://canianimate.com/)
...
[![Test on the right mobile devices](img/bfc4d1057eb610829df6d14e2434409a.png)](https://www.browserstack.com/test-on-the-right-mobile-devices)
...
[![Designer's Web Performance Optimization Checklist](img/38da2959f85243b1550d3f721fe916d3.png)](http://jonyablonski.com/designers-wpo-checklist/)

## 10。网络平台的特性有多有用？

“根据 caniuse.com 和 StatCounter 的数据，该页面显示了拥有支持各种 web 平台功能的浏览器的用户的百分比。显然，这没有考虑多填充能力或其他回退方案。”

[![How available are the web platform's features?](img/d117a35207a3e86cf24a9b0a50434728.png)](https://paulirish.github.io/web-feature-availability/)
...
[![The State Of JavaScript Developer Survey](img/38d29520a2f0be9229bdbbc695aaed7f.png)](http://stateofjs.com/)

## 12.移动使用统计

这是一个实时、动画的移动使用数据信息图，展示了在线活动的各个方面是如何随着时间的推移而增长的。

![Mobile Usage Statistics](img/7ea6b8b241c6566c5e3fd8394f8219a0.png)

## 13。字体加载策略综合指南

Zach Leatherman 关于处理 web 字体的详细的技术指南，为处理这个问题的开发人员提供了大量的最佳实践和建议。

[![A Comprehensive Guide to Font Loading Strategie](img/c1e734f2621c0cf9385510ee40d465ed.png)](https://www.zachleat.com/web/comprehensive-webfonts/)
...
[![MDN Learning Area](img/ffab83982af189d02912d4ba91c1276a.png)](https://developer.mozilla.org/en-US/docs/Learn)

## 15。弹力球

Sparkbox 的团队制作了一个简单的交互式页面，展示了如何使用各种技术来创建弹跳球动画。当考虑使用动画库时，这可能是比较 API 和潜在编码开销的好方法。

[![Bouncy Ball](img/9cb5ddeb4cccd7eda8d4e7cf36237f07.png)](http://sparkbox.github.io/bouncy-ball/)

## 16。无障碍指南(清单)

“让工作变得可访问能够全面创造更好的体验。无论您在项目中的角色或阶段如何，都可以使用该清单来帮助在您的流程中构建可访问性。”包括面向开发人员、工程师、项目经理、质量保证和编辑的部分。

[![Accessibility Guidelines (checklist)](img/a2b059732fb8ac06d151241ecfad0539.png)](http://accessibility.voxmedia.com/)
...
[![WebAIM Accessibility Checklist](img/81804346f74427a6840c9e133c973afa.png)](http://webaim.org/standards/508/checklist)

## 18。你不需要(可能不需要)连字符/下划线

这是一个很好的广泛的资源，列出了使用普通 JavaScript 来替代由 Lodash 和下划线等实用程序库完成的工作的技术，包括提到了对每种技术的浏览器支持。

[![You don't (may not) need Lodash/Underscore](img/904de12168f41669770beb152fbc9248.png)](https://github.com/you-dont-need/You-Dont-Need-Lodash-Underscore)
...
[![Accessibility Patterns for the Web](img/853bfe6cda7ace6a3b0a49479c7e9795.png)](http://ianmcburnie.github.io/mindpatterns/)

## 20。角码审核

Angular 1.x 的清单，帮助您进行代码审查，并确保您使用公认的风格、架构、安全性、可访问性和性能的最佳实践。您也可以注册，以便在 Angular 2 有类似的清单时得到通知。

[![Angular Code Review](img/ae47ad3572d5042932d795139161b276.png)](https://angularcodereview.com/)
