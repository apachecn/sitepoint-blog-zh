...
> 原文:[https://www.sitepoint.com/crud-app-node-react-feathersjs/](https://www.sitepoint.com/crud-app-node-react-feathersjs/)

构建一个现代项目需要将逻辑分成前端和后端代码。此举背后的原因是为了促进代码的可重用性。例如，我们可能需要构建一个访问后端 API 的本地移动应用程序。或者，我们可能正在开发一个模块，它将成为一个大型模块化平台的一部分。

![An operator, sitting at an old-fashioned telephone switchboard - Build a CRUD App Using React, Redux and FeathersJS](../Images/f2158a6ce4c10fc9bc2c4e48d3cf76f9.png)
...
![Screenshot of the empty list of contacts](../Images/da4e0e4ac4fa83d820e36d075860c3ea.png)
...
![Screenshot of the contact list showing two contacts](../Images/364fc757d67022a5af5eee91ae41c883.png)
...
![The two contacts rendered with the semantic-ui styles](../Images/610f81bfe8279019c596d4ecc96bdec3.png)
...
![error message example](../Images/2e8daa0d28a9473781b6211e686000c8.png)
...
![Client-side validation errors](../Images/cd80602f5ebb56326d864a71b117b487.png)
...
![contact list with three contact cards](../Images/0eb9c7be3faf177494cdea3179e0150e.png)
...
![Edit form displaying an existing contact](../Images/4d8637849979c2383b6e1ecbad6cca2a.png)

完成更改并点击保存。

![List of edited contacts](../Images/280958d0d7b87aa46fbb9ec2c730c58d.png)
