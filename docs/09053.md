...
> 原文:[https://www . site point . com/bookmarklet-show-JavaScript s-page/](https://www.sitepoint.com/bookmarklet-show-javascripts-page/)
...
![webdeveloper-toolbar](../Images/d269cda657c37476bbca6487d29a8ce1.png "webdeveloper-toolbar")

访问任何网页，选择工具栏>信息>查看 JavaScript。

![firefox-show-javascript](../Images/62bed5965b984b76de435d7b26c48302.png "firefox-show-javascript")

它显示了页面上使用的所有 JavaScript，包括包含的内容。js 文件也是。

![firefox-show-javascript2](../Images/c20272dbb3feefae3506a3ea242462a1.png "firefox-show-javascript2")
