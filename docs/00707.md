...
> 原文:[https://www . site point . com/WordPress-settings-API-build-custom-admin-page/](https://www.sitepoint.com/wordpress-settings-api-build-custom-admin-page/)
...
![Currently our admin page is empty](../Images/8fa6b0e3d0cd89130d5a031aed89cad4.png)
...
![Our settings page now has content in it](../Images/f9c6c67efa1e3dcb0a78997a4675fba1.png)
...
![The effect of running wp option get stp_api_settings in WP CLI](../Images/716bf601219fc554e4cf9aaa7d75a661.png)

这向我们展示了这两个字段作为数组的字段保存在我们的`wp_options`数据库中，作为`stp_api_settings`设置。

如果我们现在转到 WP CLI shell，我们可以尝试在插件或主题文件中获取这些选项的代码:

![Fetching options in our plugin or theme files](../Images/07e45433a6f08d1773610bea79df308e.png)
