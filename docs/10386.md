...
> 原文:[https://www . site point . com/how-to-build-ipad-apps-with-xcode-and-interface-builder/](https://www.sitepoint.com/how-to-build-ipad-apps-with-xcode-and-interface-builder/)
