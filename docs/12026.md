...
> 原文：<https://www.sitepoint.com/focus-on-typography-part-4-space/>

看了一下[对比度](https://www.sitepoint.com/focus-on-typography-part-1-contrast/)、[层次](https://www.sitepoint.com/focus-on-typography-part-2-hierarchy/)和[大小](https://www.sitepoint.com/focus-on-typography-part-3-size/)，在我们关注排版的最后部分，我们正在看**空间**。
...
空白是页面上图形、文本元素和列之间的空间。这是布局和设计中最重要的原则之一。重要的是不要认为你的文字(或图形)周围的空间只是空白。空间实际上是一个独立的设计元素，用来创造一个经典或优雅的外观，正如我之前提到的，这是你作为设计师需要做出的决定。不要让你的页面一起掉下来。
...
这就结束了我们对在你的网站上使用排版的四个基本原则的研究。我希望你已经发现它是有用的，并且可以看到通过使用几个，如果不是所有这些概念，你可以创建有吸引力的，易读的页面。

我想看看你的一些链接，这些链接指向你喜欢使用空白作为设计元素的页面。
