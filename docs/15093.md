...
> 原文:[https://www.sitepoint.com/design-website-photoshop-3/](https://www.sitepoint.com/design-website-photoshop-3/)

##### 优化和导出

我们现在将优化并导出每个切片。现在使用“切片选择工具”选择名为 gray_bar 的切片，按住 shift 键，单击 blue_square 切片。由于这两个都是单色图像，我们可以同时优化两者。使用这些设置将两个切片优化为 gif:

![881_screen5](../Images/da000a2c17374185d875829eeacf6ead.png)

接下来，使用“切片选择工具”选择页眉，然后按住 shift 键，同时单击页脚。因为这些切片有复杂的颜色过渡，所以最好保存为 jpegs 格式。使用这些设置:

![881_screen6](../Images/3e2fc6e1f713e2d3f7ae8777864d68bd.png)

我在这里加入少量模糊的原因是为了平滑一些通常与 jpeg 图像相关的像素化。然而，这在优化照片时并不常见，因为照片看起来会失焦。

要导出这些图像，请使用“切片选择工具”选择页眉、页脚、蓝色方块和灰色条:

![881_screen7](../Images/4fbf5224c4d6a870ac00cea09c5dbae1.png)

在“文件”菜单中选择“优化另存为”:

![881_screen8](../Images/9b31e1e68da108f213a0e3013fa46c24.png)
...
![881_screen9](../Images/6aacbe500953c814d7bd61d1157fd676.png)
