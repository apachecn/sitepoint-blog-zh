...
> 原文:[https://www . site point . com/CSS-pseudo-classes-styling-elements-based-on-their-index/](https://www.sitepoint.com/css-pseudo-classes-styling-elements-based-on-their-index/)
...
![SelectorFirstChild](../Images/60319521322902960a0b9bf5f3d4d386.png)
...
![SelectorFirstChild2](../Images/0ee62c20d75aaa87eb21a6d609797bf7.png)
...
![SelectorNthChild1](../Images/5d586fe7873469569f96751c7cb6ca54.png)

将`:nth-child`切换到`:nth-last-child`会反转该条带，因为计数从底部开始，如下所示。

![SelectorNthChild2](../Images/ffe2e50ed1204254c7391fa87eeb66d3.png)

用更复杂的论点尝试一些复杂的例子怎么样？我们将从下面显示的文档开始，它包含 20 个条目。

![SelectorNthChild3](../Images/1efed4498d08e3d31b1f99548bab4dcd.png)
...
![SelectorNthChild4](../Images/214d12a7e8f726a4dd95698970bd8d18.png)
...
再次， *一个* 是一个音程。这几乎就像是T5【nT7】的乘数，从 1 开始。因此，如果 *A* = 3，那么 *3n* 将匹配第 3、第 6、第 9 等元素。正如你在下面所看到的，这正是所发生的。

![SelectorNthChild5](../Images/abab62d3d60eb46f93d5e4f2c32f9945.png)
...
![SelectorNthChild6](../Images/f64de84dd7303518f9096aaf2d91d27a.png)
...
![SelectorNthChild7](../Images/ab612b8499c7a8fd80337a017e25ce1e.png)
...
![SelectorOnlyChild](../Images/174e0d361df1238d35933476dbcf3a1f.png)
...
![NthOfType1](../Images/a0d8af7c360f3c5d0d63d6e7c5b46604.png)
...
![NthOfType2](../Images/b801c24f383453bf36b25530cf0ff8c6.png)

`:last-of-type`伪类的工作方式类似，匹配其父类的最后一个元素，如下所示。然而，`:only-of-type`将匹配一个元素，如果它是其父元素类型的*子元素，如下图所示。*

 *![NthOfType3](../Images/8736ee6aae5911ecd71b5ac00aaf9d93.png)

![NthOfType4](../Images/f174af89786c1f226d01aa0f0cddfa05.png)
...
![NthOfType5](../Images/5ae3c00cf811359faeb5883cd0cd1836.png)
...
![NthOfTypeOdd](../Images/1c3c698a71200026c5f56b8a48b41a07.png)

类似地，使用`:nth-last-of-type(even)`选择偶数编号的`p`元素，但是计数从文档中的最后一个`p`元素开始——在本例中是第 18 个元素(如下所示)。

![NthLastTypeEven](../Images/5c2517b0f99cdc12432b1d837bf1799b.png)
