...
> 原文:[https://www . site point . com/disco-with-frameworks-and-design-patterns-a-fresh-look-at-dependency-injection/](https://www.sitepoint.com/disco-with-frameworks-and-design-patterns-a-fresh-look-at-dependency-injection/)

依赖注入是关于代码可重用性的。这是一种设计模式，旨在通过将对象创建/配置与使用分离，使高级代码可重用。

![Illustration of people's outlines dancing in a disco](../Images/e818cf2ab21c54db48d523a7632d8cff.png)
