...
> 原文:[https://www.sitepoint.com/10-easy-jquery-plugins/](https://www.sitepoint.com/10-easy-jquery-plugins/)
...
是一个 JavaScript 图像放大器，构建在流行的 jQuery JavaScript 框架之上。jQzoom 是一个非常棒而且非常容易使用的脚本，可以放大你想要的东西。
 ...
 [![jQZoom Evolution](../Images/c6c4e5f398a439800d4dc2cb7dec91e6.png)](http://www.mind-projects.it/projects/jqzoom/) 
...
一对核心数据工具，帮助你添加你自己的定制动画。
 ...
 [![queue & dequeue](../Images/3930a6ab2fda61c4a248bc2e8ec520c0.png)](http://jqueryfordesigners.com/api-queue-dequeue/) 
...
是一个 jQuery 插件，现在集成了笨拙的 Showcase——一个 JavaScript 框架 jQuery 插件。
 ...
 [![Awkward Viewline](../Images/df9b35157496ab1616c612b0c80dd49c.png)](http://www.awkwardgroup.com/sandbox/awkward-showcase-a-jquery-plugin/) 
...
是一个简单易用的 jQuery 插件，允许你给你的网站或博客上的任何图片(甚至是外国图片)添加注释。
 ...
 [![jQuery-Notes 1.0.2](../Images/0ff52d078785346df1191300e46f3c02.png)](http://jquery-notes.rydygel.de/index.php) 
...
jQuery QuickFlip 获取任何一段 HTML 标记，然后像翻卡片一样翻过来。效果类似于 iPhone 上的 UI 动画。
 ...
 [![QuickFlip 2: The jQuery Flipping Plugin Made Faster and Simpler](../Images/95b2ab5151eda38b6b073159f1477e7c.png)](http://jonraasch.com/blog/quickflip-2-jquery-plugin) 
...
背景具有渐变效果，因此您可以看到发光的边框在鼠标经过时平滑流动。用 gif 试试吧！
 ...
 [![Semitransparent rollovers](../Images/cfbcaaa6361ebd6096bc421a14a407c6.png)](http://coderseye.com/files/demos/pngrollover/index.html) 
...
导航几乎是隐藏的——只有当用户将鼠标悬停在项目旁边的区域时，项目才会滑出。这给了一个美丽的效果，使用这种技术可以节省你的网站空间。
 ...
 [![Beautiful Slide out Navigation: A CSS and jQuery Tutorial](../Images/22a86643f5ef393eb3b6c9444784418f.png)](http://tympanus.net/codrops/2009/11/30/beautiful-slide-out-navigation-a-css-and-jquery-tutorial/) 
...
是一个由 Elliott Kember 开发的开源 jQuery 插件，它可以让你分享页面折叠的美妙之处。
 ...
 [![The Sexy Curls jQuery Plugin](../Images/b0025b3461649253331a7f5aa05e4ea9.png)](http://elliottkember.com/sexy_curls.html#none) 
...
目的是当用户滚动时，有一个固定的导航跟随用户，并通过淡出和变得几乎透明来微妙地显示自己。当用户悬停在它上面时，菜单会再次变得不透明。
 ...
 [![Fixed Fade out Menu: A CSS and jQuery Tutorial](../Images/49c4d7b2238e975053fe20b6469a31bb.png)](http://tympanus.net/codrops/2009/12/11/fixed-fade-out-menu-a-css-and-jquery-tutorial/) 
...
易于实现，跨浏览器兼容现代浏览器(当然有一些优雅的降级)，重量轻，只有 1.75KB。这对你来说意味着它是快速，性感和公正的工作。
 ...
 [![Reveal: jQuery Modals Made Easy](../Images/c5fc75edcedf3e0200b6e7859b9e3d6f.png)](http://www.zurb.com/playground/reveal-modal-plugin) 
