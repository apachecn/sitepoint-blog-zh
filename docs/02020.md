...
> 原文:[https://www . site point . com/hashi corps-packer-is-it-something-for-PHP-developers/](https://www.sitepoint.com/hashicorps-packer-is-it-something-for-php-developers/)

![Packer logo](../Images/fd317e2043bb95aeaefa4408fa715979.png)
...
![An image of two numbers: 2016 and 2006, and an arrow from the former to the latter](../Images/67069ce1243ffe728e933208aca2aa4c.png)
...
![Funny image of fire being put out in IBM office](../Images/4ffb11ea111cff26137882adfd21c708.png)
...
![Image of server next to an image of an older iPhone](../Images/5b3b7d2a748bd9931c483591ff6a23e0.png)
...
![A stock image displaying a rating of adjectives, the top one names "Excellent" being selected with a checkmark](../Images/05f4c3e16b2bd01553c34478ebc512bc.png)
...
![A diagram depicting a two separate sections: internet and local environment. The local environment section has four sequential and arrow-connected items: a personal computer, Packer, Vagrant, and Virtual Box Image, all with their corresponding icons or logos. The internet section branches off from the Packer logo in the local environment section, and contains a single item: the words "Rackspace image" with the Rackspace logo](../Images/9b11f27e60cd44ce8de783c6f13c1683.png)
...
![Default Packer command help output in the command line](../Images/ec8ffb9f685f4a4a09754aad0cd731e0.png)
...
![The selection process in the Rackspace UI needed in order to create a basic server](../Images/7f8d9c363caadf3c8dff4d2792460b29.png)

服务器激活后，创建新服务器的映像(右上角的 Actions 按钮)。一旦构建并保存了映像，您就可以删除服务器了。

进入“服务器->图像”，你应该会看到你的新图像。点击它进入图像的详细页面。我们需要图像 ID。

![Obtaining the image ID from the Rackspace UI](../Images/a75f20441e268588acf2bfcee83e23d3.png)
...
![Screenshot of modifying the JSON file as per instructions above](../Images/0fd96dd283038b37f8b5480c15b9449b.png)
...
![Diagram depicting the packer build process. Four sections connected with arrows. First item says "Packer + json base image". Second says "Build". Third says "Provision". Fourth says "New Image".](../Images/229e5888d573f30269565aeb4afcec88.png)
...
![A debian Nginx welcome screen](../Images/d7cd992e34f811210a4e003e411c682d.png)
...
![A screenshot of a successful build output in the console](../Images/95ae6e674f7aca925ed683790c75f618.png)
