...
> 原文：<https://www.sitepoint.com/15-random-jquery-plugins-2012/>
...
Anystretch 是一个 jQuery 插件，允许你添加一个动态调整大小的背景图片到任何页面或块级元素中。图像将拉伸以适合页面/元素，并将随着窗口大小的变化自动调整大小。
 ...
 [![jQuery Anystretch](img/1ec281d5c59fb2388735ee48a6273ced.png)](https://github.com/danmillar/jquery-anystretch) 
...
为 HTML5 添加类似于书籍或杂志中真实页面的美丽过渡。
 ...
 [![turn.js](img/473599f21bb602049287605318ba49e8.png)](http://www.turnjs.com/) 
...
一个免费的轻量级 jQuery 插件，使您能够显示与悬停标签、链接或您选择的任何 html 元素相关的信息。
 ...
 [![Hover Card](img/bb8929de9d34cf4b106f673885600fae.png)](http://designwithpc.com/Plugins/Hovercard#demo) 
...
这个插件允许你创建一个带有多个固定面板的网页，这些面板展开时会产生有趣的效果。就像幕布升起一样。
 ...
 [![Curtain.js](img/9925bc7ab2d0afa3a8d4a4d8904eac28.png)](http://curtain.victorcoulon.fr/#intro) 
...
这是一个定义自定义滚动路径的插件。
 ...
 [![jQuery Scroll Path](img/01645d4c5fc2fdf2f2f05d414f7743ad.png)](http://joelb.me/scrollpath/) 
...
一个强大的基于 JavaScript 的平滑滚动导航系统，利用了健壮的 jQuery 库。创建时完全考虑了易用性，这个插件可以在任何网站上运行。
 ...
 [![Page Scroller](img/bb3d359e65ceb364fbed547e5c7651f3.png)](http://pagescroller.com/) 
...
一个 4KB 的 jQuery 插件，而不是一个 118KB 的谷歌博客吧！
 ...
 [![jquery-ed-google-blog-bar](img/36974274fa6917176daa0cb203dcc880.png)](http://code.google.com/p/jquery-ed-google-blog-bar/) 
...
允许你在输入字段中使用占位符属性的插件。
 ...
 [![Placeholder Plugin](img/8d125bf5c72a587e2f8013a80023e5f9.png)](http://web.enavu.com/design/advanced-jquery-placeholder-plugin-cross-browser-support/) 
...
一个连续的 jQuery UI 转盘。
 ...
 [![rcarousel](img/ee5d58be4dfc34433fb6597e2e47966e.png)](http://ryrych.github.com/rcarousel/#examples) 
...
是一个微小的 JavaScript 框架，旨在减轻痛苦，并为开发 JavaScript 应用程序提供基本结构。
 ...
 [![Sammy.js](img/af74b651a15abd73a0a612018e3679bf.png)](http://sammyjs.org/) 
...
一个 jQuery 插件，目前有以下效果:淡入、向左滑动、滑动和随机。您可以通过设置效果选项来选择要使用的效果。
 ...
 [![textualizer](img/8ad0cf4e9294861d54a2a35422a5115b.png)](http://kiro.me/textualizer/) 
...
Adipoli 是一个简单的 jQuery 插件，用于带来时尚的图像悬停效果。
 ...
 [![Adipoli jQuery Image Hover](img/aef280864718c7cc6597e48d3da517c1.png)](http://jobyj.in/adipoli/) 
...
从图像中抓取主色或调色板的脚本。使用 JavaScript 和 canvas 标签来实现它。
 ...
 [![Color Thief](img/272057b87035cff3f4a62311c1db83ed.png)](http://lokeshdhakar.com/projects/color-thief/) 
...
一个简单快速的导航菜单插件，可以在所有主流浏览器中流畅地呈现。它易于定制，可以插入到任何网站或 web 应用程序中。
 ...
 [![BoxyMenu](img/dde930c0c978636887c46806d8a4bd03.png)](http://www.egrappler.com/boxymenu/index.htm) 
...
一个 jQuery 插件，用于 Internet Explorer 中的:before 和:after。
 ...
 [![jQuery Pseudo](img/384e4a29f03742e9e5f1d6fe43a6387a.png)](http://jquery.lukelutman.com/plugins/pseudo/) 
