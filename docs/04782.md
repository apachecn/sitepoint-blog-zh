...
> 原文:[https://www . site point . com/adding-a-Google-sign-in-to-WordPress/](https://www.sitepoint.com/adding-a-google-sign-in-to-wordpress/)

本教程是针对那些想在 WordPress 主题中添加 Google+登录的开发者的。对于为电子商务、论坛和其他需要用户登录的网站构建的主题，提供 Google+登录按钮选项使用户的注册和登录过程更快、更容易，因为他们不必填写表格。

![Google+ Sign-In example on Flixster](../Images/95c07eadc69f5ae158d631662f63bae0.png)
