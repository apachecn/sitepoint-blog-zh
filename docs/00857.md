...
> 原文:[https://www . site point . com/server-side-optimization-with-nginx-and-pm-static/](https://www.sitepoint.com/server-side-optimization-with-nginx-and-pm-static/)
...
![28 seconds for page load](../Images/181350ad25d7eb2d7dc23dbc6e387fc8.png)

诚然，这 28 秒应该只发生在初始负载。调整后，我们能够实现生产就绪时间:

![1.2 seconds per request](../Images/680e9638e19a265668f04f54fd6f972f.png)
...
![nfs setting](../Images/e88c02d35588dec02e38fa7bb62b9e1b.png)
...
![0.9 Locust rps](../Images/3c27272ff7315e93d55bdd519edb7d72.png)
...
![Locust](../Images/d168e560c706eb10d1042ae145e45c3c.png)
...
![Locust - pm static](../Images/22b296f2f2bc2f6c54212c5100afae7c.png)

然而，在 Pingdom 工具上，当系统没有压力时，我们得到了可承受的 3.48 秒:

![pm static - Pingdom](../Images/a25b07f0d22a358a811c2acf672a353d.png)
...
![Nginx cache headers](../Images/dc5bfca4155be240c1fc3c3fb3b11c3c.png)
...
![Nginx cache swarming](../Images/8c2e92eff31f77a19dc73421d8030469.png)
...
![Caching Locust terminal](../Images/c1799a78c3dd03bc8d4b211562a2aedd.png)

我们还可以看到失败请求的百分比从 17%上升到了 0.53%。

然后我们去了 Pingdom 的页面测试并测试了我们的网站:

![GTmetrix](../Images/6791f43c7b7372fd619b903eebc60aaa.png)

我们可以看到，我们成功地将页面加载时间降低到了一秒钟以下！

我们还测试了单个图片库页面，该页面包含其他相关的最新图片库:

![Single gallery page test](../Images/fd45e80e3d26eec6934c171434ed48d6.png)
