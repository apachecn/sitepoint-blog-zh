...
> 原文：<https://www.sitepoint.com/learn-ruby-on-rails-1/>
...
![1562_fig1](img/1eae6afc300b0b5dfd63ef1693cfb42e.png)
*图 3.1。对象之间的通信*
...
![1562_fig2](img/bcd4fe6fca0f58c0cfb81b0bf0b6175d.png)
*图 3.2。类别和对象*
...
![1562_fig3](img/f0ce630a9a5d91eb1544256b34a9556f.png)
*图 3.3。问一个简单的问题*

在某些情况下，问答类比不太合适。在这些情况下，我们可以重新表述类比，把问题看作是一个指令，而答案是一个状态报告，表明指令是否被成功执行。这可能类似于图 3.4 中的图表。

![1562_fig4](img/6378b8bdeb6a2155c687be203254a8d0.png)
*图 3.4。发送指令*
...
![1562_fig5](img/6eeeff5782ce08d6f2fb01f462f4065b.png)
*图 3.5。传递参数*
