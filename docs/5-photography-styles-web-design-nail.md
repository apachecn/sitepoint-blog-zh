...
> 原文：<https://www.sitepoint.com/5-photography-styles-web-design-nail/>
...
**洛巴戈拉**–【http://www.lobagola.com/ 

![Lobagola](img/13a1c39c2a05543b2a1565767c332e21.png)

月球眼穿[http://月球服. com/](http://luneteyewear.com/)

![Lunet](img/f17195392fb9cb1f13ae9670c9a6a233.png)

http://www.lecoldeclaudine.com/fr 的 T2

![Claudine](img/28a35a9aa3c0ea46a82f6be9b961f9fa.png)
...
![original](img/acacd1c73b6b221cc338accc19206e38.png)

第二步:选择颜色点击图层窗口底部的调整图层按钮，选择选择颜色。

![Selective color](img/876f51ee05bc69fdd29509a78d3398cb.png)

转到新打开的窗口，从下拉列表中选择黑色，然后将黑色通道移动到-13。

![download (1)](img/cbbbc6585a32dc5035033ed1e7c0c3aa.png)

现在选择颜色显示中性，移动黑色通道到-16。

![download (3)](img/ba8ac0c57f33e2c006af9fefdeff7190.png)

**第三步:曲线**

添加一个新的调整层，方法与步骤 2 相同，但选择曲线。改变红色，绿色和蓝色通道，以反映下面的图像。

![download (5)](img/603f9681b1302a71d4c2b8445142a7c8.png)

**第四步:渐变填充**

创建一个渐变填充层，改变颜色，使它们反映#ec2a61 和#440332。保持一个线性梯度你希望有一个-127.87 度的角度。

![download (4)](img/cc74788a35b3d409dc6bcb9c5e1868a7.png)

将图层模式改为网屏，不透明度降至 24%。

![girl2](img/091553544c4e129c7a8131fc136f904d.png)

第五步:渐变填充 2
现在添加第二个渐变填充层，但这一次你的颜色反映#0065e1 和#1ab044。让你的线性梯度角度为 39.29 度。

![download (7)](img/77e4ee8c699a663e46dd63edbef9652f.png)
...
![Yellows](img/dc4258822a755a389b9d12fee76b8d35.png)

**果岭**

![Greens](img/a0fec2c91c289f7f6620d22c774ff40e.png)

蓝调

![Blues](img/afe5c5e3a1e72f65ccc842a09440ac33.png)

这是最后的样子:

![Final](img/a094c636ef29df273b2e354dcd002f18.png)
...
![Kaban Hosoi](img/ef998cf88cd0471058094dd38dbac55c.png)

伊恩·科伊尔:【http://process.iancoyle.com/】T2

![In Coyle](img/23c67a327c0cd961abfe82c5dbf4b5cc.png)

**手动**:【http://www.manual.is/ 

![Manual](img/1fc8850024ec4f1266e950fe5b842a40.png)
...
![Original](img/61ca96d45480f094d45594bf0481ad97.png)

步骤 2:曲线
点击图层窗口底部的黑白图标，选择曲线，添加一个新的调整图层。

![Curves](img/373c978f60aa1618fc591c1643c124c1.png)

在 RGB 通道上，改变曲线以反映下图。

![download (14)](img/649a4d3a27ad403a7733260e05f68857.png)

第三步:亮度和对比度
新建一个调整图层，这次是亮度和对比度。将对比度滑块缩放到最左侧，使其为-50。

![download (15)](img/82bfca3f8704309e7cb7d3901359f897.png)

步骤 4:曲线 2
创建另一个曲线调整层，改变红色和蓝色通道，只反映下图。

![download (16)](img/6bdbdaa5e43f65f6e54ba7a12ab7f3de.png)
...
![download (17)](img/0875daf60dc2f7e54c8f6670dbbd7c68.png)
...
![Underbelly](img/7a8d190f4bdccfae183d8e4509de300f.png)

**电气主线**:【http://www.electricmainline.co.uk/ 

![Electric Mainline](img/8415e5f17679d93dc02cd0807f781719.png)

**阳狮调制解调器**:【http://www.publicis-modem.fr/ 

![Publicis](img/a38d68e869258bb2f9706e0e3f98f792.png)
...
![Original - sunflowers](img/2ff4074d1fb988800de692a687589ef9.png)

第二步:黑白
你要做的第一件事是在调整菜单下将你的图像转换成黑白。一旦你有了它的黑色和白色，你将需要像这样调整数字。

![download (22)](img/ec853d2ff7d507e9f255a35f2f5068d6.png)

第三步:渐变贴图
现在通过进入调整菜单给你的图像添加一个渐变贴图。确保颜色为#e10019 和#6f0303，并选中反转框。别忘了把图层模式改成正片。

![download (19)](img/953457fa72180a48ea3da3dc3f1ac2a4.png)

第四步:色阶
为了使我们的图像变亮，我们现在将添加一个色阶调整，并改变数字来反映下图。

![download (20)](img/21fac2ea13e7d5cee24fd1da7f62782a.png)

第五步:渐变填充
我们现在将通过添加渐变填充来改变图像的光线方向。把你的颜色改成#ffffff 和#373737。确保线性角度为-90 度，渐变比例为 117%。当你输入你的数字，你可以改变你的图层模式，叠加 48%的不透明度。

![download (21)](img/937c64127a86857e05cc35ecd7da180c.png)
...
![Final](img/ee9eabfa57ad6ba3f6face910fad5089.png)
...
![Folklore Surf](img/cfb64a3f23cc90c7c743f73a257b0b57.png)

**康塞普塔**【http://www.concepta.at/】T2

![Concepta](img/5264406b34fbaa4cafb6c277c292abd9.png)

**法国里尔通讯社**http://www.laconfection.fr/ T2

![Agence](img/5561e563d827c39904988be641bb3310.png)
...
![Original](img/a74f0f4cad9bfdf155079b83f668c972.png)

**第二步:渐变贴图**首先你要做的是设置你的前景#ffffff，你的前景设置为#000000。

![download (23)](img/a49f1a5d4d24ce5fe73684a81532a275.png)

接下来打开渐变贴图调整图层菜单，将#ffffff 的位置更改为 12%，将#000000 的位置更改为 85%。

![download (26)](img/53941f2aa3c83c402a8687236bda5160.png)

选中“反转”框。

![download (27)](img/3fd362ea190c43539a522cc4e1f4c954.png)

**第三步:曲线**添加曲线调整，完成黑白图像的定制。改变 RGB 通道以反映下图。

![download (28)](img/b817e05aca2f99b20a612e9446c96225.png)

这是最终的图像:

![Final](img/7b2e264dd6218e55f5f626f18339a765.png)
...
**罗莎**–【http://pixelgrade.com/demos/rosa/ 

![The Rosa](img/cfb76286e07272019587c86e9c0a09fa.png)

**迈阿密热火回归黑色**—【http://throwbackblack.com/ 

![Heat](img/5f582404dad97aae0be1e71fe82627c3.png)

**安迪·沃尔夫眼镜**

![Wolf wear](img/30f00469c8d830ebf0883d14c950fc5c.png)
...
![contrast1](img/ae28b444088ef192bd536d379e34839c.png)

第二步:曲线
打开照片后，进入曲线调整层，像这样修改 RGB 通道的曲线。

![contrast2](img/c8e5de6e8a1dcacaa5579e8f18f9fc40.png)

第三步:选择颜色
下一步创建一个选择颜色调整层，从下拉菜单中选择黑色。更改滑块以匹配下图。

![download (31)](img/17331f8dc30e835fb98a607c10f3bb19.png)

**第四步:色相/饱和度**
添加色相/饱和度调整图层，饱和度更改为+14。

![download (32)](img/75eab04537851176039398b975c718dd.png)

**第五步:关卡**

![download (33)](img/ea036e64c04f8c5a754a0bd9aafa0f43.png)

这是最终的图像:

![Final](img/1bbdf22705aff8f1414e5980a59828b8.png)
