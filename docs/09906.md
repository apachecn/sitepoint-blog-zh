...
> 原文:[https://www.sitepoint.com/top-10-jquery-database-plugins/](https://www.sitepoint.com/top-10-jquery-database-plugins/)
...
![jQuery-Collections.jpg](../Images/cb3fd60f5fbf69ffd7c3ec52bd1b3321.png)
T3】来源

 [T2】](http://dynamicjqueryme.sourceforge.net/)

## [2。动态数据库菜单](http://dynamicjqueryme.sourceforge.net/)

这将向你展示如何在 jQuery 菜单中放置 sql 函数。
![jQuery-Database-Menu.jpg](../Images/14f0645046e305bd0e7e1a41d1201a85.png)
T3】来源

 [T2】](http://www.reynoldsftw.com/2009/03/live-mysql-database-search-with-jquery/)

## [3。MySQL 数据库搜索](http://www.reynoldsftw.com/2009/03/live-mysql-database-search-with-jquery/)

减少每次击键后的数据量。
![jQuery-MySQL-Live-Search.jpg](../Images/63e28434502adfc22ca4ee3fcd3bdeb6.png)
T3】来源

 [T2】](http://stephenwalther.com/blog/archive/2010/03/26/using-jquery-to-insert-a-new-database-record.aspx)
...
![jQuery-Database-Record.jpg](../Images/6c760bed866b7e04c0e3232ab40b2052.png)
T3】来源

 [T2】](http://plugins.jquery.com/project/jqueryclientdb)

## [5。jQuery 客户端数据库](http://plugins.jquery.com/project/jqueryclientdb)

对于小型和不需要任何服务器端脚本。
![jQuery-Client-Side-Database.jpg](../Images/e86d4278f129a0e2fc23a393d8874974.png)
T3】来源

 [T2】](http://grasshopperpebbles.com/ajax/jquery-plugin-impagepopulate/)

## [6。ImPagePopulate](http://grasshopperpebbles.com/ajax/jquery-plugin-impagepopulate/)

从数据库中检索数据并将其填充到网页上是一项非常繁琐的任务。
![jQuery-ImPagePopulate.jpg](../Images/90e4d32ccd7e32f56a4fbc203b7d28d4.png)
T3】来源

 [T2】](http://plugins.jquery.com/project/table2csv)

## 7 .[。表 2CSV](http://plugins.jquery.com/project/table2csv)

这提供了 html 表格到 csv 字符串的转换。
![jQuery-Table2CSV.jpg](../Images/6de0c2677a4178f4a36f88eb2ed14687.png)
T3】来源

 [T2】](http://www.wiseguysonly.com/2008/12/07/drag-and-drop-reordering-of-database-fields-sortables-with-jquery/)
...
![jQuery-Drag-n-Drop-Sorter.jpg](../Images/34ed412c812ebc7215edd56937ab79bd.png)
T3】来源

使用 jQuery 的 ajax 函数创建一个使用 JSP 执行数据库连接的功能性登录页面。
![jQUery-AJAX-JSP-Login.jpg](../Images/cd1656bbb644b8ff7b28d26c0f9de1f4.png)
T3】来源

 [T2】](http://www.kensodev.com/2009/05/22/using-jquery-tree-for-database-data/)

## 10。数据库的 jQuery 树

![jQuery-Tree-for-Database.jpg](../Images/19867c2cfa40c0e9fe43cffd383a0d52.png)
...
[![sequelshpere](../Images/fa638fa470ada0f395b3934bcdea491b.png)](http://www.sequelsphere.com/) 
