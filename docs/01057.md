...
> 原文:[https://www . site point . com/angular-rxjs-create-API-service-rest-back end/](https://www.sitepoint.com/angular-rxjs-create-api-service-rest-backend/)
...
![REST API Back End: Two people holding a radio aerial, communicating with a giant Angular logo on a hill.](../Images/06322020dfacbddf125310f30ad9cb57.png)

## 快速回顾一下

下面是我们的应用程序架构在第 2 部分结束时的样子:

![REST API back end: Application Architecture](../Images/a66248d8a0927eec9943eff37719029d.png)
...
![REST API back end: Application Architecture](../Images/4f2a5e5855823cc27ddfc1ddd7a3bfb7.png)
...
![REST API Back End: What we should see now](../Images/6605a4ebcaa5975316382f4f93fcb852.png)
...
![REST API Back End: all tests passing](../Images/6524fbb990d69ac05825f809beb78ad6.png)
