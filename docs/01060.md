...
> 原文:[https://www.sitepoint.com/angular-2-tutorial/](https://www.sitepoint.com/angular-2-tutorial/)
...
![Angular CLI: Illustration of a monitor covered with post-it notes and todo lists](../Images/ff3e73fe750a4999bdb0e533911c9873.png)

在每篇文章中，我们将细化应用程序的底层架构，并确保我们有一个如下所示的应用程序工作版本:

![Angular CLI: Animated GIF of Finished Todo Application](../Images/81843c65a1bbfc0788218baeb15102f5.png)

到本系列结束时，我们的应用程序架构将如下所示:

![Angular CLI: Application Architecture of Finished Todo Application](../Images/6db5688b31588ee55527b981c0d63c50.png)
