...
> 原文:[https://www . site point . com/6-we B- development-myths-Microsoft-edge/](https://www.sitepoint.com/6-web-development-myths-microsoft-edge/)
...
![HTML5Test](../Images/1a710e1b55ae88f756bebf2c3eb74c03.png)

**如何检查这个**

要识别微软 Edge 和 EdgeHTML 版本，只需进入**设置** ( *右上角的点-点-点图标*)并向下滚动到底部。

![EdgeHTML settings](../Images/60f28cdc39b12e8e3d7a9536b0977862.png)
...
![HTML Document declaration](../Images/7fcc317c99580295bf16324a1418a664.png)
...
![Modernizr.js](../Images/f267359fc085dc8b017fd95dd856045a.png)

下面是微软 Edge 上的输出:

![Microsoft Edge view](../Images/b83d902ad28221a4cb411a83dcf4aff7.png)

这里是关于微软 IE6 的。等等！什么……IE6？是的，我也在 IE6 上试过测试。这并不意味着你应该使用 IE6。只是为了证明 HTML5 代码能够工作，因为浏览器的 HTML 布局/呈现引擎是容错的。它呈现它所理解的东西。

![Microsoft IE6 view](../Images/711201abfda51f4201751674c09645ee.png)
...
![Browsers performance benchmark](../Images/d94b227b1c247929b0a168447e2e9b44.png)
...
![ES6 compatibility table](../Images/4decc4f05f47b0b9021335121b83eb1f.png)
