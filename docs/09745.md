...
> 原文:[https://www . site point . com/better-semantics-with-CSS-combinators-and-selectors/](https://www.sitepoint.com/better-semantics-with-css-combinators-and-selectors/)
