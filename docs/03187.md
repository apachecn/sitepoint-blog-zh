...
> 原文:[https://www . site point . com/favorite-visual-studio-extensions/](https://www.sitepoint.com/favorite-visual-studio-extensions/)
...
![Code alignment](../Images/1c7d19b5d908d0d8e1f2b7f7e8de1f20.png)
...
![Visual Studio toolbar](../Images/ad87c66952e5b22129975a485348e409.png)

如果我点击 **Align by…** 文本，会出现一个对话框，我可以输入我想要对齐的字符。使用冒号分隔的键值对时非常有用。

![Text box dialogue](../Images/f4fa35c27543627e6421a7e88310bce5.png)

下面是我在自己的代码中使用的一个例子:

![switch.js sample code](../Images/303a888214c0a5fc57381ef56cf1a14f.png)
...
![change.VideoStream.js sample code](../Images/132b7265562b08b3cc01c4d347fd8625.png)
...
![ReSharper](../Images/848b0054bfef83b119c46f4c0cef1231.png)
...
![ReSharper debugging](../Images/6905188a8eaec5b021fa8086a59c3e84.png)

更有用的是，ReSharper 可以告诉我代码是否可以重构，或者是否有更简洁的方式来编写代码。我已经多次使用这种方法，它真的帮助我理解了如何编写更干净的代码。

在 JavaScript 方面，它可以指出我何时声明了变量，但从未使用过它们。

![ReSharper on JavaScript side](../Images/8575835e7aa88f497cb3503f0eb09772.png)

它还能在我声明一个对象之前告诉我什么时候使用它:

![ReSharper detecting JavaScript duplicate declaration](../Images/c9a358ebc1ce19d9a36b11167eddb69c.png)

它甚至能发现重复的声明:

![ReSharper detecting JavaScript duplicate declaration](../Images/b03485a18da37b132822de0ed7408c33.png)
...
![Open Command Line](../Images/2a91a8619d07b68397b9c82e6fe78582.png)
...
![Open Command Line accessing PowerShell](../Images/89ce2576fa610f016665cc7c08b6593c.png)

## JSLint.Net 视觉工作室

![JSLint.Net](../Images/1579f1b9030ed34ffff50df0094d5b1e.png)
...
![Web Essentials 2015](../Images/4c16a16104bbfc54444815e77515cc58.png)
...
![Web Essentials 2015](../Images/1bdb29f257456f093281c2307b7d7558.png)
