...
> 原文:[https://www . site point . com/easy-database-schema-diagrams-with-db visualizer/](https://www.sitepoint.com/easy-database-schema-diagrams-with-dbvisualizer/)
...
![A schema diagram of the Habari project](../Images/4858689e8ce9a45888d9bf7e7c3e960a.png)
...
3.  #### 安装ˌ使成形
    ...
    ![](../Images/45162237ba3cef91b2e65ce6f3d58ca6.png)

    在左边选择 **MySQL** ，在**驱动文件路径**表单的**用户指定的**标签中，点击**浏览**图标，选择我们之前提取的`jar`文件。

    ![Loading the MySQL driver](../Images/7aa89f228d86db45d1cee073ac93a162.png)
...
5.  #### 设想
    ...
    ![An animated diagram of the database schema for the Habari project](../Images/edbb600e3e7b5b3934d26e294daccded.png)
