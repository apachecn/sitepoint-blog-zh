...
> 原文：<https://www.sitepoint.com/5-questions-every-logo-designer-should-ask/>

在设计师继续创作标志之前，有两个基本问题需要回答:
...
[![LEGO](img/419a1a8dfab05ca54918df06e812a6b8.png)](https://www.sitepoint.com/wp-content/uploads/2010/05/LEGO.png)

## 提问

为了找到这些大问题的答案，设计师需要提出更多的问题。
...
提示:展示和获得这些问题答案的一个很好的方法是将它们整理成一份客户工作表，让客户单独或与你一起填写。请留意即将发表的一篇探讨客户工作表的文章。
