...
> 原文:[https://www . site point . com/animating-bootstrap-carousels-gsap/](https://www.sitepoint.com/animating-bootstrap-carousels-gsap/)
...
![Animating Bootstrap carousels: a carousel horse wearing the GSAP cape](../Images/6af26312ad1dfc0f1ad8bd976487d230.png)
...
![Animating Bootstrap Carousels: the first slide of the carousel](../Images/e2b1a288d95f1dd3b0081fdabf2f6edf.png)
...
![Animating Bootstrap Carousels: the second slide of the carousel](../Images/618077e87d9ccd1dc81308846464ae80.png)
...
![How to download GSAP](../Images/58e97355fa947c362555b3a86a68c258.png)

如果我们选择*定制*单选按钮，我们可以选择我们想要使用的库的部分。然而，对于我们的项目，我们将保持简单，只包括它的完整健壮版本。

![How to include GSAP into our Codepen demo](../Images/47639306d76b7b43ac8ebbe77e32e0e3.png)
...
![Animating Bootstrap Carousels: which styles initially GSAP applies to the button before animations](../Images/9588dcb3f55eb350014970bb2e48cd2d.png)

然后，当动画播放时，它变得可见(`opacity: 1`、`visibility: inherit`)，并返回到其默认位置(`transform: matrix(1, 0, 0, 1, 0, 0)`)。

![Animating Bootstrap Carousels: which styles finally GSAP applies to the button after animations](../Images/500364f15d2aa981b62c47c9bf0ea541.png)
...
![How the cms-wrapper element of the second slide initially looks like before animations](../Images/02ad1846bb2de2310ea1047b76f8f455.png)
...
![What the cms-wrapper element of the second slide looks like after animations](../Images/239bb77e82096bb9a9061e96d23ba4ed.png)
...
![Animating Bootstrap Carousels: How the source element of the second slide looks like after animations](../Images/6efc5d96381b79cdfd0e6554f6244991.png)
...
![What the carousel looks like with JavaScript disabled](../Images/d5da55ffabfa72f2405844fdfefd674b.png)
...
![Removing the no-js class from the HTML element](../Images/572944d13b4a75e87cdb894da009c1e7.png)
