...
> 原文:[https://www . site point . com/Amazon-dynamo db-store-PHP-sessions-with-load-balancer/](https://www.sitepoint.com/amazon-dynamodb-store-php-sessions-with-load-balancer/)
...
![Create the table, step 1](../Images/5b5a3ad41f8264ac4b4e349d6f132b08.png)
...
![Create the table, step 2](../Images/50b052e3a838d905224deafbf01ad300.png)
...
![Choose the AMI to launch](../Images/b32db949fc973fa732044060a2c894ba.png)
...
![Instance settings recap](../Images/c58154c08221e2f020eada3a3bc8679a.png)
...
![Load balancer creation screen](../Images/8b13fdf36fa83d431d89aab6f0228106.png)

为负载平衡器选择一个名称，并验证监听器配置是否与屏幕截图的配置相匹配，即:将负载平衡器端口 80 上的所有 HTTP 流量转发到实例端口 80 上的 HTTP。

![Load balancer health settings](../Images/c1586882e6f12310fe7b0e69be403996.png)
...
![Attach instances](../Images/ba5bac666f27135a362e4166c92e9d5b.png)

下一个屏幕让您选择哪些当前运行的实例可以添加到负载平衡器。选择之前创建的两个实例并继续。查看最终配置并确认它是否适合您。现在，您应该能够看到负载平衡器的详细信息以及所有已连接实例的状态。

![ELB recap screen](../Images/18447e1b4e77bacda32d2fd1233834b8.png)
...
![Screenshot comparison](../Images/38a3d716fae2f2642cd5e61eaaf5ee17.png " ")
