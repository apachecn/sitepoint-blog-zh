# 初学者最佳 JavaScript 书籍指南

> 原文:[https://www . site point . com/best-JavaScript-books-for-初学者/](https://www.sitepoint.com/best-javascript-books-for-beginners/)
...
如果你想了解更多关于学习 JavaScript 的最佳方法，以及你认为哪种方法最适合你，[看看这篇德克萨斯大学的博文](https://techbootcamps.utexas.edu/blog/best-ways-to-learn-javascript/)。
...
[![learn js visually: book cover image](../Images/3ed150e8de140a0746c8582ed71cf9ca.png)T2】](https://amzn.to/3Nn5pON)

由 Ivelin Demirov 撰写， *[可视化学习 JavaScript](https://amzn.to/3Nn5pON)*如果你之前没有编程经验，这是一本很棒的书。顾名思义，它强调视觉学习。这本书以一个动画“JS-robot”为特色，贯穿始终用来说明代码及其用途。
...
[![beginnning js book cover](../Images/9d711650762d2f21d71ec43feb1bdf2c.png)T2】](https://www.wiley.com/en-gb/Beginning+JavaScript%2C+5th+Edition-p-9781118903742)
...
[![JavaScript: the definitive guide book cover](../Images/ddd70c40d11cbc7465f5c805988f7d40.png)T2】](https://www.oreilly.com/library/view/javascript-the-definitive/9781491952016/)
...
这本书是由 David Flanagan 写的，它的第七版是最近才出版的，所以它包含了 JavaScript 的所有最新特性。它从基础开始，但难度很快增加到更技术性的东西——如 Node.js 的服务器端 JavaScript。
...
[![a smarter way to learn js cover](../Images/a1cc6ec999be7c28b5cdc13996b6dd10.png)T2】](https://amzn.to/3Dn93Uz)
...
[![Head First JavaScript book cover](../Images/1d33ca0943fc7f9515efa0f271a93a08.png)T2】](https://www.oreilly.com/library/view/head-first-javascript/9781449340124/)
...
[![Secrets of the JavaScript Ninja book cover](../Images/369d05ae11aa0e819e628c2f9a749ce0.png)T2】](https://www.manning.com/books/secrets-of-the-javascript-ninja-second-edition)

*[JavaScript 忍者](https://www.manning.com/books/secrets-of-the-javascript-ninja-second-edition)* 的秘密是由 jQuery 库的创建者 John Resig 编写的，但是它根本没有提到使用那个库。相反，它详细介绍了普通 JS 的基本原理。它非常快地跳到一些非常难的概念，例如[闭包](https://www.sitepoint.com/demystifying-javascript-closures-callbacks-iifes/)，但是它以一种容易理解的方式涵盖了它们。它的发展速度很快，并且在书的结尾涵盖了一些高级主题，这使得这本书适合已经有一些编程经验的人，而不是完全的初学者。

它写于 2016 年，尽管它涵盖了许多当时处于前沿的较新的 JavaScript 功能，如承诺、地图和生成器，但它开始显示出它的年龄，并且可能比目前所需的更侧重于跨浏览器支持。

### 雄辩的 JavaScript 第三版:编程的现代介绍

![Eloquent JavaScript cover](../Images/f60fa38f18199cc7d93b59ff8d59b8ef.png)
...
![Book cover of You Don't Know JavaScript Yet](../Images/d973dfe48f4b55acfc8efbc0fda48fd0.png)
...
![Book cover for Learn to Code with JavaScript](../Images/fbfc07713a733c7a4b191a9713f423d8.png)
...
从上面的分类中，你应该能够计划你最初的 JavaScript 之旅，挑选两三本书——第一本作为你的第一本书，其他的作为进一步阅读，当你成为一个更好更有经验的 JavaScript 开发人员，并且想要探索 JavaScript 的内部工作和更多技术方面的时候。
