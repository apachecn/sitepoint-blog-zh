...
> 原文:[https://www . site point . com/nitrous-io-rails-development-cloud/](https://www.sitepoint.com/nitrous-io-rails-development-cloud/)

![ProvisioningBox](../Images/acbdd8bdef587a59b7716dc108d63fd7.png)
...
> 
> ![EarnN20](../Images/9f6da873e8d9660774983afead0bae46.png)

在任何情况下，您都应该至少添加一个 SSH 密钥。此外，和以前一样，有一种简单的 GUI 方式为您的盒子生成一个密钥。

### 创建您的第一个盒子

一氧化二氮的每个“实例”。木卫一被称为“盒子”。![NewBox](../Images/18fe61485030f79b4022b6590b9fd997.png)

前往*箱子*并设置一个箱子。

在这里，您必须选择您希望使用此框的环境。在我们的例子中，我们将选择‘Ruby on Rails ’,但是我鼓励你探索其他的；特别是如果这些是你经常使用的技术。

![CreateBoxROR](../Images/6c7e6c0b9ff6ede36b4b83cef289de4e.png)
...
点击*框*链接，点击你的新框。
![PublicKey](../Images/9c091f372b43b1aec83d3b8d8324f17f.png)
...
![PreviewMenu](../Images/59824c73053eb62c06ee50178c64b7ee.png)
...
![PublicKeyGithub](../Images/314cc2333424e8931fdc9b23b9acd555.png)
