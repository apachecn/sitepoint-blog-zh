...
> 原文:[https://www.sitepoint.com/html-css-beginners-guide-5/](https://www.sitepoint.com/html-css-beginners-guide-5/)
...
![Displaying a basic page](../Images/d8a85409cf438a349e8d1018e9ca1b38.png)

## 分析网页

我们在简单的页面中引入了两个新元素:一个标题元素和几个段落元素，分别用`<h1>`标签和`<p>`标签表示。你能看出你输入的标记和你在浏览器中看到的有什么关系吗？下图显示了文档显示的直接比较。

![Comparing the source markup with the view presented in the browser](../Images/fb783dc805420e0fa3f8a47d24f39fa6.png)
...
![Using unordered and ordered lists to organize information](../Images/15e02295c46fa427b4f6a8219c64d4a3.png)
