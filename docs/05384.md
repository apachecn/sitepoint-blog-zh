...
> 原文：<https://www.sitepoint.com/killer-backgrounds-with-illustrators-svg-pattern-tool/>

[![Intricately patterned Persian House](img/0f06cce3e336dd40d2e0c3e6a6e1be3a.png)](https://www.flickr.com/photos/horizon/50291848/)
...
![Illustrator pattern panel](img/9849dd669d21ff39f4959f7eb1d22414.png)
...
![initial circles](img/80249ef69466b8bfd47b4d9974907007.png)

接下来，选择两个圆并按 Command/Ctrl + 8 创建一个复合路径。

删除您可能已经应用的任何描边，并选择任何颜色作为填充。我会选择宝蓝色。垂直和水平对齐图块内的圆。

![Type type selection](img/d3a26120f8e594f593b46ac377749e0d.png)
...
默认网格在水平方向和垂直方向上均匀分布图形。 | ![Grid default](img/f5d90d4744f9f1920d26e8c2e5ae1ae4.png) |
| 

### 一排排地砌

此设置水平交错排列图形，就像一排排砖块。 | ![brick-by-row](img/48b34d6f5ac766a43b32ed4512af4621.png) |
| 

### 逐列砌砖

这交错的图形就像一排排的砖块，但是是垂直的。 | ![Brick-by-column](img/269de956367d45552dbfa4e509628961.png) |
| 

### 按行十六进制

这在水平方向上以六边形模式交错排列图形。 | ![Hex-by-row](img/45c80dcc0977b492ade9d2008a0f8155.png) |
| 

### 按列十六进制

这使图形垂直交错成六边形。 | ![Hex-by-column](img/f50de2be0bd000be4199c9ccecc62de1.png) |
...
![Triangle trimmed](img/6fc790a7cb3505c639ec90fada659b81.png)

接下来，添加一个圆，在三角形的底部顶点上绘制圆心。

为此，在向外拖动时按住 Alt/Option 和 Shift 键。请注意 Illustrator 如何在正方形的顶部自动绘制圆形，重复该图案。

![Circle-triangle](img/0b4902590c4c8801ae124e8848ce9a74.png)

接下来，选择**多边形工具**并创建一个六边形。让它的底边接触到图案正方形的底边，右上角接触到三角形的边，如下图所示。

![Triangle Circle Hexagon](img/26cd6a64e052a9e02ec45749a22361bb.png)
...
![Three component pattern.](img/6300188b38a4e50289b647beb327e9ed.png)

## 将您的模式导出为 SVG

![Step 1: Make pattern ](img/0878e3f5220c58301a39cfce31cd4a7d.png)
...
![Step 2: Make pattern ](img/8230cb07955215892910e61eb8c9cbd5.png)

#### 第二步

接下来，使用**椭圆工具**，创建一个具有相同尺寸的圆，但是放置它，使它的一半与正方形重叠。现在，创建一个尺寸为 50px x 50px 的白色圆圈，并将其放置在左侧。

![Step 3: Make pattern ](img/bbb06bcb6479d2bf5d2a605301c6285a.png)

![Step 4: Make pattern ](img/4d5b9a7264722fe0c64c9b9730a3f906.png)
...
![Wave Swatch](img/97df983b7aad831072f2959f39ea3dc7.png)
...
![Illustrator SVG options panel](img/9986c922d02587d240a335d4f8066ef9.png)
...
![SVG pattern sample](img/cbe639d1f56a0bcd667f75ba60b16d57.png)

将宽度和高度分别设置为 30 将创建一个更紧凑、更小的 SVG 模式，如下所示。

![SVG pattern 30](img/4032f0308416c5b61adba46d9e73d042.png)
