...
> 原文：<https://www.sitepoint.com/10-jquert-text-transformation-plugins/>
...
jQuery 插件允许网站上的弯曲文本。
 ...
 [![Arctext.js](img/7334e06f8bc8e6b2197258bd94766701.png)](http://www.republicof3.com/arctext-js-jquery-plugin-allows-curved-text-on-websites/) 
...
是一个相当简单的 Jquery 文本效果插件。它模仿了你有时在机场和火车站看到的那些闪烁的信息板的风格。
 ...
 [![Airport](img/cd4c4e660abaec5cf3afc4e24bb3b16b.png)](http://www.unwrongest.com/projects/airport/) 
...
是一个 jQuery 插件，用于显示具有伪等距效果的文本。与 Safari 2+，Internet Explorer 6+，Firefox 2+，Google Chrome 3+，Opera 9+兼容并经过全面测试。
 ...
 [![JQISOTEXT](img/8ec8bd824aab313eede4d57ac19f0b7e.png)](http://workshop.rs/2010/01/jqisotext-jquery-text-effect-plugin/) 
...
是一个 jQuery 插件，可以将放大镜附加到单词的字母上。
 ...
 [![jLensMagnify](img/4065f607163d0b47f2e0d081724a712b.png)](http://www.senamion.com/blog/) 
...
s to fit the width of the parent element. Gives the text that lovely vertical alignment.
 ...
 [![BigText](img/e970874a1587c63af952047eb326055b.png)](http://www.zachleat.com/web/bigtext-makes-text-big/) 
...
一个 jQuery 插件，用于生成大的、粗体的、响应性强的标题
 ...
 [![slabText](img/64d0e21cc1d1279a7057acb7976dab85.png)](http://www.frequency-decoder.com/demo/slabText/) 
...
这里有一个教程将向你展示如何在 jQuery 中制作 3D 飞行文本。
 ...
 [![3D Flying Text](img/8677db0f306dfa49039842b268f4da1b.png)](http://www.devirtuoso.com/2009/08/3d-flying-text-in-jquery/) 
...
让您美化您的网页，通过样式的第一个字母的任何元素，同时保持 HTML 标记干净，可读的人和机器。
 ...
 [![jQuery Fancy Letter](img/d097cf7ed048c938face3353ca6c95fd.png)](http://plugins.learningjquery.com/fancyletter/) 
...
使字体大小灵活。在你的流体或响应性布局上使用这个插件来实现可扩展的标题，填充父元素的宽度。
 ...
 [![FitText](img/c7378d95f25a2ee9be2398c6d4ec7296.png)](https://github.com/davatron5000/FitText.js) 
...
这将自动以报纸专栏格式布局您的内容。您可以指定列宽或静态列数。
 ...
 [![Columnizer](img/1f7e399479c03c17d43a0065000039fc.png)](http://welcome.totheinter.net/columnizer-jquery-plugin/) 
