...
> 原文:[https://www.sitepoint.com/learn-adobe-air-part-1/](https://www.sitepoint.com/learn-adobe-air-part-1/)
...
![Figure 1\. The download page for the Aptana Studio AIR plugin](../Images/401644e64d8e5e41faecdc8cff84dd4f.png)

选择*下载并安装*来安装 AIR 插件，并选择 *Adobe AIR Support* 复选框，如下图所示。

![Figure 2\. Installing the AIR plugin for Aptana Studio](../Images/93243a6bb2e5594476c6165cfcc9e90f.png)
...
![Figure 3\. The HTML view of the Adobe AIR HTML/JavaScript Introspector](../Images/5de2a333a96ea6fc3080f7a6843e14ed.png)
...
![Figure 4\. The Adobe AIR Introspector in action](../Images/52a8528459f0a94a5c7b99864b90f5b8.png)
...
![Figure 5\. A prototype of our Notes application, built in HTML](../Images/c9bd2129ebd6eb7f97ab0e2000d4eecc.png)
...
![Figure 6\. Running our Note Storage project for the first time](../Images/eaf50a9ead99daed80915b9209d080ac.png)

您的 AIR 应用程序将显示在自己的窗口中，包括我们之前创建的原型 HTML。它应该是这样的:

![Figure 7\. The first iteration of our Note Storage application](../Images/4c7dd2524259695abea416c5ffb98082.png)
...
![Figure 8\. An example menu item created by the AIR Menu Builder](../Images/41dca232abcd5e344ba67aba3936b50a.png)
...
![Figure 9\. Running the GetNotes function in the Introspector console](../Images/37e683ba6e4fabd40dd13ec177158944.png)
