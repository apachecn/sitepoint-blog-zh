...
> 原文：<https://www.sitepoint.com/10-javascript-cheat-sheets/>
...
这个网站将您链接到各种备忘单和其他开发人员资源，以帮助您进行编程，包括 JavaScript 和其他应用程序。
 ...
 [![QuicklyCode](img/749d51c59877086759fb0a0acf37e6c8.png)](http://www.quicklycode.com/tag/javascript) 
...
JavaScript 和 HTML(包括 HTML、CSS、JavaScript、AJAX、Web2.0)以及其他软件/技术的便捷快速参考搜索。
 ...
 [![gotAPI](img/40c965f5b18bcf4c02699a50f77f4e1a.png)](http://www.gotapi.com/html) 
...
JavaScript 的快速参考指南，列出了方法和函数，包括正则表达式和 XMLHttpRequest 对象的指南。
 ...
 [![JavaScript Cheat Sheet](img/bce857464732a9782e82321317271fdc.png)](http://www.addedbytes.com/cheat-sheets/javascript-cheat-sheet/) 
...
一个由 Kyle Hayes 设计的备忘单，但是由 phiggins 在#dojo 上生成完整的 API 与 Dojo 1.3 完全兼容。
 ...
 [![Dojo 1.3 Base API Cheat Sheet](img/d91ccd023f9dfa0cc5aff1814f204c9b.png)](http://kylehayes.info/2009/04/01/dojo-13-base-api-cheat-sheet/) 
...
它包括核心、本机、类、元素、实用程序和请求的文档。
 ...
 [![MooTools 1.2 Cheat Sheet](img/20d855af4164b86624a02df0905737e3.png)](http://mediavrog.net/blog/2008/06/11/mootools/mootools-12-cheat-sheet/) 
...
这个备忘单是奥斯卡·奥特罗对 jQuery 1.3 库中的函数和属性的快速参考。
 ...
 [![jQuery 1.3 Cheatsheet](img/550bee640cb4d0c9e97c79370274f745.png)](http://oscarotero.com/jquery/) 
...
理解 jQuery 选择器是最有效地使用 jQuery 库的关键。这张参考卡将 jQuery 选择器的强大功能触手可及。
 ...
 [![jQuery Selectors](img/b09e3fc78c8b18fcee74be68cba0f003.png)](http://refcardz.dzone.com/refcardz/jquery-selectors) 
...
jQuery 可视化备忘单是针对 web 设计人员和开发人员的 jQuery 1.3 的实用参考。这个备忘单包含完整的 jQuery API 参考，以及详细的描述和一些示例代码。
 ...
 [![JQuery 1.3 Visual Cheat Sheet](img/a5e4844a87cb82e8efdcd1c65a72a2c3.png)](http://woorkup.com/2009/09/26/jquery-1-3-visual-cheat-sheet/) 
...
最常见的 DOM 方法一览。
 ...
 [![DOM JavaScript Cheat Sheet](img/cca7eb94ff5e440e1b9f35055014fdbd.png)](http://christianheilmann.com/stuff/JavaScript-DOM-Cheatsheet.pdf) 
...
这个页面是 JavaScript 特性的矩阵。您可以使用下面的界面来比较不同浏览器的功能支持。
 ...
 [![JavaScript Features](img/7028a5bca1722521a5ff52f3e7503f0a.png)](http://jsfeatures.net/wiki/) 
