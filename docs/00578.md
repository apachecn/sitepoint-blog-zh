...
> 原文:[https://www.sitepoint.com/headless-cms-vue/](https://www.sitepoint.com/headless-cms-vue/)
...
![Signing up to GraphCMS](../Images/7740e3038b3f4d7661212acd55e4b418.png)

用你喜欢的方式注册。一旦您完成了帐户认证和验证过程，您应该能够访问主控制面板。

![The GraphCMS main dashboard](../Images/947bce427b2bc785e5658fdb66428324.png)

在上面的例子中，我已经创建了一个名为“BlogDB”的项目。继续创建一个新的，你想怎么叫都行。输入名称后，您可以保留其余字段的默认值。点击*创建*，你将被带到他们的项目计划。

![GraphCMS plans](../Images/1f3f89667aa3f89a0152c63f80a1e760.png)

出于本教程的目的，选择免费开发者计划，然后点击*继续*。您将被带到项目的仪表板，它看起来像这样:

![The GraphCMS project dashboard](../Images/b4bd1f1e670a340bc0fc9c2d66728250.png)
...
![Field attributes in the Advanced tab](../Images/6ae8ca3f77e999a3caddddee9889acf7.png)
...
![GraphCMS models](../Images/b0dba726f84072fc522ad0ed396444e7.png)
...
![A page view of our app](../Images/a118ec97e88baddb5532dd805f188638.png)
...
![A GraphCMS query example](../Images/d13f35aec468331c9680616357b9bba0.png)

这里有一个突变的例子:

![A GraphCMS mutation example](../Images/4ccefd5ccb3ef9dd9196d042ff6cae25.png)
...
![Our post list](../Images/89238615b5213ed1f06e08fd8c3f53c5.png)
...
![Post comments](../Images/dda86f7ffe3c8e253c3e65ab411c0ad9.png)
