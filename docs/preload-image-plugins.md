...
> 原文：<https://www.sitepoint.com/preload-image-plugins/>
...
[![preloadjs](img/d84117bfcbfb0561b0e0d4ca7f09cf5d.png)](http://www.createjs.com/#!/PreloadJS) 
[源码+演示](http://www.createjs.com/#!/PreloadJS) [教程](http://www.jquery4u.com/speed/web-app-image-preloading-setup-2mins/)

## 图像加载器

用于预加载图像的 JQUERY 插件。
[![imageloadjs](img/a185b475ea70f5fabbfe6004798eaa19.png)](http://nick-jonas.github.io/imageloader/) 
[源+演示](http://nick-jonas.github.io/imageloader/)

## PxLoader

HTML5 应用程序的 JavaScript 预加载程序。
[![pxloader](img/b0930d1b061b9ae1a90c47a50777e90d.png)](http://thinkpixellab.com/pxloader/) 
[源+演示](http://thinkpixellab.com/pxloader/)

## UXResponsiveWebAppLoader

使用 jQuery 和 CSS3 的类似 Webapp 的预加载器。
[![uxwebappresonlpreload](img/60f289fdd8b5f56252c7b5f2f3e2fc2b.png)](http://anteksiler.com/experiments/webapploader/) 
...
[![jQuery Image Loader Plugin](img/f8ef99065649c0de4910229b5617c305.png)](http://www.krio.me/jquery-image-loader-plugin/) 
[来源](http://www.krio.me/jquery-image-loader-plugin/) [演示](http://www.krio.me/scripttest/imgLoader/)

## 2.QueryLoader2

轻松预载您的图像。
[![QueryLoader2](img/03b3dfa1049d016d443f5d07504c2e95.png)](http://www.gayadesign.com/diy/queryloader2-preload-your-images-with-ease/) 
...
[![Smart Preloader](img/bf177a8dbf4d4076b1fb490f245bf8f1.png)](http://www.egrappler.com/jquery-image-preload-plugin-smart-preloader/) 
...
[![Preload Images with jQuery Preload](img/18cae3218ec5d50d5da433f648e70608.png)](http://dreamerslab.com/blog/en/preload-images-with-jquery-preload-plugin/) 
...
[![jQuery Cycle Plugin](img/bd1157eb1fc51b79eef0e7860d1dfaa3.png)](http://jquery.malsup.com/cycle/) 
[源+演示](http://jquery.malsup.com/cycle/)

## 6.延迟加载图像 jQuery 插件

它会延迟(长)页面中图像的加载。在用户向下滚动之前，文件夹下的图像(在页面的最下方)不会被加载。这与图像预加载正好相反。与包含重磅图片内容的长页面最终用户结果是一样的
[![ Lazy Load Images](img/2724266c399fb99b3f4091f8e89493c9.png)](http://www.appelsiini.net/2007/9/lazy-load-images-jquery-plugin) 
...
[![jPreLoader](img/5e21804cc5a5a938ab9c7dd1bf09041b.png)](http://www.inwebson.com/jquery/jpreloader-a-preloading-screen-to-preload-images/) 
...
[![Caching Images With JavaScript](img/141a127ffbb0771e949cf7ae8a8c11f4.png)](http://www.useragentman.com/blog/2012/01/16/caching-images-with-javascript-and-html5-progress-bars/) 
...
在浏览器的本地存储中缓存图像。
[![jQuery Image Cache ](img/c6bd8334b859fe446a3ce0cad6fb20d8.png)](http://dumitruglavan.com/jquery-image-cache-plugin-cache-images-in-browsers-local-storage/) 
