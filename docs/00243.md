...
> 原文:[https://www.sitepoint.com/create-firefox-add-on/](https://www.sitepoint.com/create-firefox-add-on/)
...
如果你跟着做，从[我们的回购](https://github.com/sitepoint-editors/firefox-alarms-addon/tree/master/assets/images)中获取这些文件，并将它们放在适当的目录中(`assets/images/`)。
...
![Manage Your Extension](../Images/85f904105503a226c8835f61b0e9ca30.png)

为**临时延期**打开新的一页。

![Temporary Extensions](../Images/ab01a38094fb03b4600241d751d1917f.png)

点击**加载临时插件**按钮，选择您刚刚创建的`manifest.json`文件。如果一切都做得正确，您将看到新创建的附加组件及其相关信息和我们在`manifest.json`中指定的图标。

![Personalized Alarms add-on](../Images/f189b7139c9e377e405b13dcad4b76dd.png)
...
![Add-on in toolbar](../Images/ceebb754648d46293e8b94fbd0353c79.png)

如果你点击它，你可以看到我们刚刚创建的弹出页面。

![Add-on Popup](../Images/17b487d6a2842d97840981ea584c0d66.png)
...
![Options Page](../Images/6cf5de6cba9d877900b3cae3597c3c08.png)

现在，尝试添加一个任意名称和时间的测试闹钟，并点击“添加闹钟”。之后，您应该能够在弹出窗口中看到它。

![Add-on Popup](../Images/ee9513a868e45ef8947d758d77afec58.png)
...
![Background Script Console](../Images/b668bb1414b8e7b207451b9b3f754f4e.png)
...
![Notification](../Images/d66508a34d97842b3148a59d1a466a0c.png)
...
在我们开始之前，我们将使用来自[羽毛](https://feathericons.com/?query=trash)的垃圾图标。可以从那里下载，也可以从本教程的 GitHub 资源库中获取。应该是在`assets/images/trash.svg`里面加的。
...
![Popup with Delete Button](../Images/4eda9ee5b2354bdc02b67a43374f260a.png)
...
![Submit add-on](../Images/7cd1247861a58893fca79f40585d4860.png)

然后将开始提交新附加组件的过程。你首先会被询问是在 Firefox 附加组件管理器上发布附加组件，还是自己发布。选中第一个默认选项，点击**继续**。

![Submit add-on Options](../Images/8f45413dfbb726e875909fdef1f63942.png)
...
![Add-on Source Code](../Images/d367570fe237ca505b83d68cab1178a1.png)
...
![Firefox add-on](../Images/cde1adfdba4e531cc5b1133a50e3dd7a.png)
