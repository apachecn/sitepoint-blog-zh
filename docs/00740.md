...
> 原文:[https://www . site point . com/secure-a-node-API-with-oauth-2-0-client-credentials/](https://www.sitepoint.com/secure-a-node-api-with-oauth-2-0-client-credentials/)
...
![Client Credentials Flow](../Images/8c2395e0fdbc18857147ca9731964cec.png)
...
![Add Authorization Server](../Images/bc61fec5454520cdc7d04af307c721ff.png)

一旦创建了授权服务器，您将需要一个供客户端访问的范围。点击**范围**选项卡，添加一个范围。您可以拥有许多这样的工具，它们可以帮助定义 API 的哪些部分正在被使用，或者甚至是谁正在使用它。

![Add Scope](../Images/135a5ab9b5fda2eeaded911e81c0791e.png)
...
![Add Rule](../Images/e36b3334f0108cd1d9bd7567b516d9c3.png)
...
![Client Credentials](../Images/5194ab3d94b9591f7f12b02817143752.png)
