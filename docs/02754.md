...
> 原文:[https://www.sitepoint.com/file-sharing-component-react/](https://www.sitepoint.com/file-sharing-component-react/)
...
![filesharer component ready to connect](../Images/d7eb5c281248e1d76ffc966f46f2527c.png)

下面是当前用户已经连接到一个对等点，并且该对等点已经与该用户共享了一些文件时的情况:

![filesharer component with shared files](../Images/902d61035f8971077853d127f1a038dc.png)
