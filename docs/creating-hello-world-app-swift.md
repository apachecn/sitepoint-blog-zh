...
> 原文：<https://www.sitepoint.com/creating-hello-world-app-swift/>
...
![Creating a new project with Xcode](img/87ad9027e816989c68207f98f01e9a32.png)
...
![XCode Screen Overview](img/dbdb368fceb9b576bc9b78f8daff6267.png)
...
![Changing View size](img/0a69d0ba35c3f8ffc198a0d88e21aa2c.png)

在这一点上，我们将通过在界面中间添加一个按钮来增加界面的趣味性。要实现这一点，看一看“*对象库*”。

该库包含一系列我们可以放入界面的对象，如果您滚动(或搜索)列表，您会发现一个“*按钮*对象:

![XCode Object Library](img/e30a4273674ef5653cae84febf5189d1.png)
...
![App Preview](img/8eaf2c5a35a8b5b963d7945e2be08223.png)

要在一系列模拟设备上测试应用程序，请在播放按钮旁边的“*方案*菜单中选择可用选项:

![Schemes Menu](img/c8e3a25aecc36a25488bd78d891a0a45.png)
...
![Debug Console](img/d1118aa6b12884ebe6ff8147beea5ef6.png)
