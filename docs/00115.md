...
> 原文：<https://www.sitepoint.com/introducing-mysql-a-beginners-guide/>
...
![A typical database table containing a list of jokes](img/eca2cff76893d1d0e9740bd7ce972751.png)
...
![If you can see this, you have MySQL Workbench running](img/0284cd1fd7fafbb20f254b1d00f51365.png)
...
![Add a connection](img/b09bdefeaf512bddd1feb2813438b6b2.png)

当您按下 **+** 按钮时，您会看到一个新窗口。

![Add a connection](img/d9b534a22ff5e339275c911d2b37f55b.png)
...
![Password prompt](img/82a92f386014bcf256a9e59c32bbcd59.png)
...
![The main MySQL window showing information that was entered](img/97808515eef87850cd7193834dd240c0.png)

既然连接已经建立，那么每次打开 MySQL workbench 时，它都会存在。您不需要每次都添加连接。

您终于准备好真正连接到数据库了。为此，只需双击新创建的代表您的连接的框，您将看到一个不同的屏幕。

![Initial screen](img/fbd5b285054168dcd8655b5364d5fd8f.png)
...
![Creating a schema](img/38adc49c125a34851dfd63e9c546b380.png)
...
![Confirming the schema creation](img/9880add00fa945057a40686f5dd595bb.png)
...
![The Internet Joke Database schema](img/93bddacc1eb693b9e9504d5250e5ab3d.png)

现在您有了一个数据库，您需要告诉 MySQL Workbench 您想要使用它。为此，只需双击新创建的模式，它的名称就会变成粗体。您一次只能选择一个模式，并且您需要告诉 MySQL Workbench 您想要使用哪个模式。

![The ijdb schema selected](img/793d5fd57eacdf7346c255b572e2eba7.png)
...
![The ijdb schema expanded](img/31b289aee787014447b7e42ee2f272cd.png)
...
![MySQL Workbench New Table window](img/7ebf5d930c2dd4d6cd33120b1ea478a3.png)
...
![Creating the joke table](img/27edd8373edc5bf99b202830d1df4c69.png)
...
![The joke table complete](img/331a346779fbcc9ef2f66669c0ef8fe8.png)
...
![A new query panel](img/923bbac2913a41aa8066a83e146259a8.png)
...
![Executing an INSERT query using MySQL Workbench](img/eaa8dc02059599ddd9137444b04f6694.png)

当查询执行时，屏幕底部会出现一个面板，告诉您查询是否成功执行。

![Checking a query has executed successfully](img/e48a1ae92e1df85fbeb5957d184757ee.png)
...
![MySQL Workbench results](img/6b0d984f946f15d2fa356d052802adc1.png)
...
![You can select only what you need](img/ea8d2392349da6be1c55f7902e61a404.png)
...
![The LEFT function trims the text to a specified length](img/461dee85f352c5680fa7b3ae1bf56476.png)
...
![The COUNT function counts the rows](img/e0267fc15802e714e6b03054e96db44c.png)
