...
> 原文:[https://www . site point . com/debug-web GL-html 5-mobile-experiences-visual-studio-emulators/](https://www.sitepoint.com/debug-webgl-html5-mobile-experiences-visual-studio-emulators/)
...
![VSE](../Images/782c53c77e78d3b5f17d73d120e1a93f.png)

并选择您感兴趣的图像:

![VSEandroid](../Images/814b98c1d4cdd342ed53a487a5b011fc.png)
...
![babylon-gs](../Images/5a2a9d7b638cb97f4bfd272e27b9b0c0.png)
...
![vseforandroid](../Images/1bb119e2a2a9cbc81b18fde20350594e.png)
...
![chrome-flags](../Images/a3e6b7b5fd7bee541345798f047c02a9.png)

你现在应该可以启动我们的一个场景了，比如我们著名的**埃斯皮里图**场景:【http://www.babylonjs.com/index.html?ESPILIT/】T2

![Espilit](../Images/687ba23a279cddc10dbc7538118fa17d.png)

在我的第一代联想 X1 上使用简单的**HD 4000**T4】GPU 在 Windows 10 上使用 25 fps ！对于一个模拟器来说还不错！显然，您仍然需要一个真实的设备来测试 WebGL 代码的性能。

更好的是，由于模拟器完美地支持触摸，你也可以在你的 WebGL 体验中测试和调试多点触摸。例如，将摄像机切换到“**虚拟操纵杆摄像机**”:

![joystick-camera](../Images/b617f67e2051d89ec37a92460c5b2263.png)

现在，您只需用两根手指轻触电脑屏幕，即可进入 3D 场景:

![3dscene](../Images/104449c5b234ff76ca9704943ebcba46.png)
...
![IE11](../Images/bb2bec70cd2863b6f50ce32fb4e326e7.png)

**<u>注意:</u>** 在 Visual Studio 模拟器内部甚至连 Web 音频都支持 Chrome！举个例子，这个演示在 it 界行得通:【http://www.babylonjs-playground.com/index.html?22 T4】

![webaudio](../Images/c0e6e052033cbc0ffc4038a947f7de14.png)
...
![flexbox](../Images/fc2bf5d479d765c4e9950e52dee9d025.png)

例如，你可以在 Android 模拟器(左边)看到突出显示的**“大厦”flexbox 项目**，它的大小目前是`172px x 112px`。

让我们回顾一下 **Windows Phone 模拟器**(在右边)上的同一个站点:

![Phone-emulator](../Images/5ea397bde9231c63637dcb1921f17ee2.png)
...
![console](../Images/3e60c2fd64c2d3276c4e0bf1a874dbba.png)
