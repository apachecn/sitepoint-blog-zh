...
> 原文:[https://www . site point . com/base-converting-and-binary-operators/](https://www.sitepoint.com/base-converting-and-binary-operators/)
...
![Base Converting and Binary Operators 1](../Images/4ae8b8ed2d77f56ded6ee442d278bc28.png)
...
![Base Converting and Binary Operators 2](../Images/fd4ffc72c4fd08057c84028ec72717e2.png)
...
![Base Converting and Binary Operators 3](../Images/67341da4ba5316a7cba89255a9b498b2.png)

由于每个容器被限制为一个单元或包，所以组成二进制数的值只能是 1 或 0。它要么是满的(值为 1)，要么是空的(值为零)。当写出容器值的字符串时，它可以类似于列表上的一系列复选标记:1 可以被认为是复选标记，0 是没有复选标记。

![Base Converting and Binary Operators 4](../Images/927e0d61703ecf6ae3a2187bbbbb854b.png)
...
![Base Converting and Binary Operators 5](../Images/f50075fca16d0bdcd69c0bd568fb44b0.png)
...
![Base Converting and Binary Operators 6](../Images/c5637e84fd368b68617d55d4f826e115.png)
...
![Base Converting and Binary Operators 7](../Images/f71db1eb842a9035f7bc0d2bded6a5c4.png)
...
![Base Converting and Binary Operators 8](../Images/8cdd6360ec1b20e919c92012ec3187d4.png)
