...
> 原文:[https://www.sitepoint.com/jquery-serializearray-function/](https://www.sitepoint.com/jquery-serializearray-function/)
...
```
 <form action="">
	...
	<label for="message">Message</label>
	 <textarea rows="20" name="message" id="message" cols="40"><input type="image" title="Send Message" src="/images/send_message.png" id="cm_send_message" alt="Send Message"/>
</form></code></pre>
