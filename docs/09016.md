...
> 原文:[https://www . site point . com/10-helical-jquery-plugins-design-development/](https://www.sitepoint.com/10-helpful-jquery-plugins-design-development/)
...
![LoadMask.jpg](../Images/f48ef21ae659dd3b508f279944f81237.png)
[源头](http://code.google.com/p/jquery-loadmask/)

## 2.线索提示

一个插件，当用户的鼠标悬停在(或者，可选地，点击)你在脚本中指定的任何元素时，你可以很容易地显示一个漂亮的工具提示。
![clueTip.jpg](../Images/a35c017f6a14f406bb0cfda05591d997.png)
T3】来源

## 3.悬停意图

一个试图确定用户意图的插件…就像一个水晶球，只是随着鼠标的移动！它的工作方式类似于(并且是从)jQuery 内置的 hover。
![hoverIntent.jpg](../Images/264ad8599f2e92a7261704a93b2cafc6.png)
T3】来源

## 4.jQuery 实时查询插件

Live Query 利用 jQuery 选择器的强大功能，自动绑定事件或触发匹配元素的回调，甚至在页面加载和 DOM 更新之后。
![jQuery-Live-Query-Plugin.jpg](../Images/bf7a6ffd951030682483aa17eefeb82b.png)
T3】来源

## 5.JavaScript 浮动框 JQuery 插件

大多数情况下，网页内容不适合屏幕，我们将不得不向下滚动到页面来阅读全部内容。这样做的话，我们将会丢失上面的那些信息。这个 JavaScript 浮动菜单将完成这个任务，并保持指定的内容可见。
![JavaScript-Floating-Box-JQuery-Plugin.jpg](../Images/7c4c5190cef8ca86668c9c119bdfc825.png)

## 6 .波平

用自动 Ajax 请求创建一个简单的模式窗口。
![Popin.jpg](../Images/d83e796bfe21c5a28c65661cfa1b1ddc.png)

## 7.具有可选时区支持的 AJAX 日历小部件

Any+Time JavaScript 库包括一个高度可定制的、jQuery 兼容的 datepicker/ timepicker(日历/时钟小部件)和一个强大的日期/字符串解析/格式实用程序。
![AJAX-Calendar-Widget-with-Optional-TimeZone-Support.jpg](../Images/ab276e6d00637fde95ecc7d69f0d5455.png)
T3】来源

## 8.jQuery Doubleselect 插件

根据第一个选择框填写第二个选择框。
![jQuery-Doubleselect-Plugin.jpg](../Images/4e21836f66591e624e1019b0ad9730b0.png)
T3】来源

## 9.jQuery 3 状态切换插件

是一个 jQuery 插件，它同时使用单选按钮和复选框来表达列表项的选择和一些状态。
![jQuery-3-State-Switch-Plugin.jpg](../Images/c2dfaaebdddcabc17233744a009fb04a.png)
T3】来源
...
![a-tools.jpg](../Images/1e307cc996b1689944113a3e8513eaee.png)
T3】来源
