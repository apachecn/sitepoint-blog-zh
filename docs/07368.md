...
> 原文:[https://www.sitepoint.com/getting-started-with-fuel-cms-1/](https://www.sitepoint.com/getting-started-with-fuel-cms-1/)
...
![](../Images/9bc6248f901c9c1779858e83f2bc034a.png "fuelcms-1-01")
...
![](../Images/21a0f24ac61bcb31951213b5327f7047.png "fuelcms-1-02")

您可能想做的第一件事是创建一个页面。这是一个与大多数其他内容管理系统相似的简单过程。在左侧菜单中，单击页面，然后单击创建按钮。

输入一个位置(这是 URL 片段，所以没有空格！)，页面标题和您的内容，然后单击保存。

![](../Images/57aef64a503dda6c0a04b404eb06c970.png "fuelcms-1-03")

可以通过进入*http://localhost/index . PHP/test*访问页面。您将看到您输入的文本，但与安装页面的设计相同。

![](../Images/8dc7d1bc7e73a743c4edda333ab2b1eb.png "fuelcms-1-04")
...
![](../Images/e3607734a1c67c7357fae7eb6b6eac44.png "fuelcms-1-05")
