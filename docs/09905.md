...
> 原文:[https://www.sitepoint.com/15-javascript-libraries/](https://www.sitepoint.com/15-javascript-libraries/)
...
![Taffy-DB-.jpg](../Images/fc9586ba6e913a3bf4c2d6e8cbc8d101.png)
T3】来源

 [T2】](http://www.activerecordjs.org/)
...
![ActiveRecordjs.jpg](../Images/375ba6450e9923bfbf8486522e1d76ef.png)
T3】来源

 [T2】](http://sylvester.jcoglan.com/)
...
![Sylvester-.jpg](../Images/c7630f37480a0abc0983f06c161e9dd6.png)
T3】来源

 [T2】](http://ejohn.org/projects/javascript-pretty-date/)

## 10。漂亮的约会

一个智能的 JavaScript 解决方案，以更漂亮、更友好的方式显示上个月的日期。它显示相对于当前时间的日期；例如，“昨天”、“3 小时前”等。
![Pretty-Date-.jpg](../Images/95195e6bd0cf85a81f03f1df8016244d.png)
T3】来源

## 11.JavaScript URL 库

一个更容易处理和操作 URL 的库。可以以字符串的形式到达 URL 的每个部分，并在需要时修改它。这个 URL 库是非常新的，但已经如前所述工作。
![JavaScript-URL-Library-.jpg](../Images/b0059710a2dbe97530d7dab87d6a2f53.png)

 [T2】](http://typeface.neocracy.org/)
...
![Typefacejs.jpg](../Images/52fde373887f5c3700caf1476abb925a.png)
T3】来源

 [T2】](http://amberjack.org/)

## 13。Amberjack

一个很小的 JavaScript 库(大约 4 KB)，可以帮助你在网站上添加好看的网站导览。一旦激活，一个模态框通过显示任何类型的内容来引导用户。
![Amberjack.jpg](../Images/4667b1a39733613bb36f17fad9abbb59.png)
T3】来源
...
![JsLoad.jpg](../Images/0a4ba2bc3626acbcf67121b850da7d2a.png)
T3】来源

 [T2】](http://www.scriptiny.com/2008/04/custom-javascript-dialog-boxes/)

## 15。自定义 JavaScript 对话框

一个用于创建自定义对话框的轻量级库(大约 4.5 KB)。可以显示四个框:警报、警告、提示、成功。通过一个简单的功能，你可以指定盒子的标题，要显示的内容以及显示多少秒。
![Custom-JavaScript-Dialog-Boxes-.jpg](../Images/b2906884d1bd2be5a3d7ec53cddfc543.png)
T3】来源
