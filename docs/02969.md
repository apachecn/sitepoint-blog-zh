...
> 原文:[https://www . site point . com/build-SMS-appointment-reminder-app-with-twilio/](https://www.sitepoint.com/build-sms-appointment-reminder-app-with-twilio/)
...
![Screenshot of the Google Console screen](../Images/5b553bb96a2b7076a40f0372489ca769.png)

在这里，您可以点击右上角的`select project`菜单并选择`create a project`。这将打开一个模态窗口，允许您输入项目的标题。

![Screenshot of the New Project form](../Images/a4145ef7e53f1dab707c2197d14b350e.png)

创建项目后，将显示仪表板。从那里你可以点击`use Google APIs`，搜索谷歌日历 API 并启用它。

![Screenshot of the Google Calendar API overview screen](../Images/84cfe023313058bd28558ec400f9b6bb.png)

启用 API 后，它会要求您创建凭证。点击`Go to Credentials`开始设置。这将向您显示以下内容:

![Screenshot of the API credentials screen](../Images/2a0d2ef7bb26ef7fa73cb8b7d478e06c.png)
...
![Screenshot of the OAuth consent screen](../Images/fa461164bbb35c719fe807414f2313ee.png)
...
![Screenshot of the create client ID form](../Images/b4de3ee4634e71554dbeb4a30b048235.png)
