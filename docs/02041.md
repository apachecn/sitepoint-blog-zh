...
> 原文:[https://www . site point . com/creating-a-firebase-back end-for-IOs-app/](https://www.sitepoint.com/creating-a-firebase-backend-for-ios-app/)
...
![Login View](../Images/1fb61978ded1d13d9e5511874cb57b6f.png)

登录视图有一个注册按钮，点击它可以进入注册视图；在这个视图中，有一个注册表单和一个登录按钮，您可以返回到登录视图。

![Sign Up View](../Images/a1f5f271cc600dabb1ce48b016fc1d71.png)
...
![Create Firebase Project](../Images/cc501dcd540179b9459f240396ba35c0.png)
...
![Add Firebase to iOS App](../Images/9e57b222dd3b698d0efec0a85add323e.png)
...
![Add Firebase to iOS App](../Images/544b482f1300640a074b02e1476a51c4.png)

我们已经完成了上述步骤，所以点击*继续*。

按照对话框最后一页的说明，将 Firebase 初始化代码添加到您的 *AppDelegate* 类中。当应用程序启动时，它会连接到 Firebase。

![Add Firebase to iOS App](../Images/e25207757af5e4fb641404f5e672912d.png)
...
![Enable Email Password Authentication](../Images/f9ba48b352c0a389bc08e8ea24159440.png)
...
![Email Templates](../Images/4eac5b4a0e59afa22cac0531704c71d4.png)
...
![Reset Password](../Images/aed31f3067f337aab3211dd95ab3825a.png)

![Reset Password](../Images/d6c6eaed5b733129caccc3967beec4fb.png)
...
![Add Item](../Images/9b7f0b697fea7cda4a9b686baf932275.png)

您添加的任何项目都将被添加到表格视图中。

![Item List](../Images/062b537704c5d0f041231044190bb69b.png)

检查 Firebase 控制台，您将看到添加的数据。

![Item List on Firebase Console](../Images/d98afcdf7f5eff8a700b86d95a9044ac.png)

若要删除项目，请在项目上滑动以显示删除按钮。

![Delete Item](../Images/81c1106e2a35af2a4083c0361b57244d.png)
