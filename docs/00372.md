...
> 原文:[https://www.sitepoint.com/getting-started-with-eleventy/](https://www.sitepoint.com/getting-started-with-eleventy/)
...
![first 11ty render](../Images/0ebcc5209cc46349d54e45e72d2599e2.png)
...
![the unstyled menu](../Images/27d7a6f156c37470e06be64d1c85e80c.png)
...
![11ty blog post](../Images/2adaa85dc74512b7863fd6cd56edd767.png)
...
![11ty article list](../Images/71e93734a7b9bd93e7c444272af5a582.png)
...
![11ty article](../Images/a7f4f1ab0736dbce4be16c2f02f59924.png)
...
Eleventy 可以使用`.eleventy.js`中的`.addPassthroughCopy()`功能从任何文件夹中复制文件。例如，要将`src/images/`中的所有文件复制到`build/images/`，您应该添加:
...
在`src`中创建一个`images`目录，添加一些图片，然后用下面的代码创建一个新的`src/images/images.11ty.js`文件:
...
重新运行`npx eleventy --serve`，图像的优化版本将被复制到`build/images/`文件夹中。
...
![11ty images](../Images/4d8a636dbc67f381c4d32e18253262b0.png)
...
![final site](../Images/59ed520ca63faf007e04a83a7e57a93e.png)
