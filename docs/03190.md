...
> 原文:[https://www.sitepoint.com/up-and-running-with-camaleon-cms/](https://www.sitepoint.com/up-and-running-with-camaleon-cms/)

![Screenshot 2015-11-29 15.25.56](../Images/71e41314d359721b3f2a4f880733e13d.png)
...
![camaleon-output](../Images/ae7bb84d0496af187956ab6758e3e58a.png)
...
![camaleon-welcome](../Images/711620705f6735f58ff646da19100370.png)

### 用户设置

Camaleon CMS 提供默认用户名和密码(`admin/admin`)来登录管理仪表板。我们需要改变这种情况。登录您的仪表板。点击屏幕左侧显示的用户图像右侧的图标，如下所示。

![camaleon-dashboard1](../Images/68c3a4104e6f234fc0e1ffff60dca2dd.png)
...
![camaleon-add-user](../Images/0e7e428d5d2f6aa4b1f8c505747af214.png)

您还可以通过编辑角色的操作来控制用户可以执行的操作。为此，点击仪表板左侧**用户**下的**用户角色**。还可以添加和删除用户角色。

![camaleon-edit-user-roles](../Images/e2af2ca14761364fc6b76fcd191b3172.png)
...
![camaleon-languages](../Images/0d4eabd2484379a5b85ae7142b91b576.png)
...
![camaleon-create-post1](../Images/994f7182df2fa55e0d1b4613afab2699.png)

在顶部字段中，插入标题。在标题下面的大区域写下你的文章。使用格式按钮来自定义您的帖子:

![camaleon-style-post](../Images/9d399baadbccb8577bbefeb123429fdf.png)

要添加图像，将光标放在想要放置图像的文本上，点击内容工具栏上的 ***插入/编辑图像*** ，如下图所示:

![camaleon-insert-image](../Images/4d6dfc4a2db5add72d70b387df86accc.png)

在弹出的对话框中，在`Source`字段中输入图像的链接或点击旁边的`search icon`上传图像。

![camaleon-image-upload](../Images/fad144890dce334e1ec57a2e93752243.png)

如果你点击了搜索图标，媒体管理器就会打开，让你把图片导入到你的文章中。

![camaleon-import-image](../Images/f3a56dbce1453a5eab55491b9004aaf0.png)
...
![camaleon-create-page](../Images/6878daed2fda30b0070eeab9fd0e57f3.png)
...
![camaleon-categories2](../Images/40fdc5bca2f2d2c83fb8930439d62a7a.png)

**给职位分配类别**

一旦创建了类别结构，您就可以将文章添加到类别中。点击`Content > Post > Add New`创建一篇新文章，只需选择文章的类别。

![camaleon-categories3](../Images/fd631a4453699c22ead72d5fc4b63cc0.png)

### 创建菜单

菜单是常见链接的列表，通常显示为站点的主要导航。

![camaleon-menu1](../Images/7a31a280e3b7c3ee0938a8bc6b4d094b.png)

要创建自定义菜单，点击`Appearance`，从下拉选项中点击`Menus`。默认情况下，会为您创建一个菜单:**主菜单**。要更改**主菜单**的名称，请在文本框中输入您喜欢的名称，然后点击**更新菜单**。

![camaleon-menu2](../Images/e503ade5b4c67e20d3dfb4ddfd7b675f.png)
...
![camaleon-menu3](../Images/d23d132fa302a62a62a641328d45ce7a.png)
