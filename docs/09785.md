...
> 原文:[https://www . site point . com/new-properties-and-values-in-background-with-css3/](https://www.sitepoint.com/new-properties-and-values-in-backgrounds-with-css3/)
...
![content-box](../Images/7b007ab53cba0628b0cde7e5537ef79d.png)
*内容框图*
...
![padding-box](../Images/e026c6c90d9b77eeb0d77485f9eca4ce.png)
*填充框图*
...
![border-box](../Images/ee70b17906f66dc5210842ebc72d298f.png)
...
![initial background image position](../Images/5fd0c615743edcd57ef216b64cc6bb5a.png)
*初始背景图位置图*
...
![background-image positioned](../Images/aa29f4d18147a8f793b4ca7b64ccc8fd.png)
*显示使用正值定位的背景图像的图表*
...
![background-image positioned using negative values](../Images/c0819ff822af0f822e3809eba8f2eb42.png)
*显示使用负值定位的背景图像的图表*
...
![repeat-x and repeat-y](../Images/0459107e94c92b5c26182f9a25f42c3b.png)
*显示重复 x 和重复 y 的图表*
...
![background-image set with space value](../Images/752313757932093539d6fdacf66b74fc.png)
*显示用空间值设置的背景图像的图*
...
![background-image set with round value](../Images/17eec053b1d19380097d54b93bfb875e.png)
*显示背景图像设置为圆形值的图*
...
![background images positioned in relation to the content-box, padding-box and border-box](../Images/fe712d4679cb13364b75e5d852f03440.png)
...
![background-image clipped inside content-box, padding-box and border-box](../Images/a58a5f6475cfc1b1dc0c12af7348bc2d.png)
...
![background-image set with contain](../Images/e1afdc1a801c35c8c37bbd605e425382.png)
*用包含*的图显示背景-图像集
...
![background-image set with cover](../Images/9521366e25950a4438569c11a0160c78.png)
*显示带有封面的背景图像集的图表*
...
![background images set in layers on top of each other](../Images/89db3aab84a50f3796b32d787a87ef12.png)
*图中显示的背景图片层层叠加*
