...
> 原文:[https://www.sitepoint.com/authentication-angular-auth0/](https://www.sitepoint.com/authentication-angular-auth0/)
...
![Daily Deals App](../Images/030ff688ed2cad6964a3e895e888c0b8.png)
...
![Creating Auth0 API](../Images/fab8c42e4ffb85703521576560b44816.png)
...
![API with No Auth Token](../Images/c14f5725489ae3be197aaa8079586f6a.png)
...
![Auth0 centralized login](../Images/8f8971775cfcdab1ed506252e8e254ed.png)

就是这样。我们现在准备测试我们的应用程序。如果 Node.js 服务器没有运行，请确保首先启动它。转到`localhost:4200`，你应该会被自动重定向到`localhost:4200/deals`并看到公开交易列表。

![Daily Deals Authenticated](../Images/c383f3d5d07005547a52ebbe1fc7da6c.png)
...
![Consent Dialog](../Images/399303e08b7f1c2ebde7d799f6a459c1.png)

*注意:因为我们使用`localhost`作为我们的域，一旦用户第一次登录，或者如果将来范围改变，将显示一个同意对话框，询问用户是否希望授权访问 API。如果您使用的是非本地主机域，并且客户端是第一方客户端，则不会显示此同意对话框。*

![Exclusive Daily Deals](../Images/cd0d4e539979754dedbc0d6476d00558.png)
