...
> 原文:[https://www.sitepoint.com/css-extend-full-width-bars/](https://www.sitepoint.com/css-extend-full-width-bars/)

很抱歉标题太长，但这是 CSS 布局中面临的一个常见问题。通常，我们需要一个元素超出(居中的)页面宽度来填充浏览器窗口。考虑一个典型的页面设计:

![full width design](../Images/74a17457500cbb1278da550a02ff86ec.png)
