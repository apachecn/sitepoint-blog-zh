...
> 原文:[https://www.sitepoint.com/secure-laravel-apps-2fa-via-sms/](https://www.sitepoint.com/secure-laravel-apps-2fa-via-sms/)
...
![Twilio and Laravel](../Images/d6e9f9e802704b929e2b3bcbd70f81cd.png)
...
*   他输入电子邮件和密码。
    ...
    ![Login form](../Images/bf7b87568714a075cc40c0504ce52429.png)

*   我们使用电话号码发送验证码。

    ![2FA verification code SMS](../Images/4c984de5cb52eee94359a2da28ea76b9.png)

*   用户必须输入收到的代码。

    ![Type verification code](../Images/bd139211dec9ca0e05c1b7da2593498b.png)

*   如果密码正确，我们就让他们登录。否则，我们再给他们一次尝试登录的机会。

    ![Dashboard](../Images/9ec33b0d439d1b261db6b5318ae344a6.png)
...
![Testing application](../Images/a7ad12c5534b0730d2c6ff0a21c4e0bd.png)
