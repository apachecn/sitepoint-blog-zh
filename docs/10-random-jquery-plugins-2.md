...
> 原文：<https://www.sitepoint.com/10-random-jquery-plugins-2/>
...
像 autocomplete 一样，当添加到输入字段时，使用户能够在键入时快速找到并从预填充的值列表中进行选择，但以表格和分页的方式进行。ComboGrid 为选择项目提供了键盘导航支持。
 ...
 [![ComboGrid](img/6f89b1a28100329a68ea6f2020f06ee2.png)](http://combogrid.justmybit.com/index.php) 
...
是一个 jQuery 验证码插件。它要求用户画出他们在画布上看到的形状，以便提交表单。
 ...
 [![MotionCAPTCHA](img/bfbebb403773002add16a51a48cafc91.png)](http://www.josscrowcroft.com/projects/motioncaptcha-jquery-plugin/) 
...
是一个免费的 jQuery 插件，确保用户的安全密码。这个简单的 jQuery 插件可以与任何在线表单(注册表单/用户注册表单)无缝集成，以检查密码强度，并为用户提供创建强而安全的密码的线索。
 ...
 [![Power PWChecker](img/1ce13c30cd687cd4d60c5f70e975f058.png)](http://www.egrappler.com/jquery-strong-password-plugin-power-pwchecker/) 
...
是一个开源插件，用于为你的 HTML5 视频添加提示点和字幕。
 ...
 [![Cuepoint.js](img/356cf88d1160c83bdc01a627188c2eac.png)](http://cuepoint.org/) 
...
使用谷歌地图第 3 版的 jquery 插件。
 ...
 [![gMap3](img/f2561bfa28236ad72db249ea60202190.png)](http://gmap3.net/) 
...
是一个创建好看的幻灯片的插件。您可以自定幻灯片显示的每个方面。
 ...
 [![Skitter](img/b26228cc5f5dba1d2ae245863b366841.png)](http://thiagosf.net/projects/jquery/skitter/) 
...
是一个 jQuery 插件，用于在 Opera 9+，Firefox 3.6+，Safari 3.2+，Chrome 和 IE7+上查看和缩放照片。照片是从 JSON/JSONP 数据结构中检索出来的，并在网格中随机移动。
 ...
 [![Mosaiqy](img/8412c74af03a7a8b964e475c2a9f22a8.png)](http://www.fabriziocalderan.it/mosaiqy/) 
...
是一个免费的开源 jQuery 幻灯片插件。
 ...
 [![Diapo](img/936f5ab991d8daf43b8cef7a0a7ba1a4.png)](http://www.pixedelic.com/plugins/diapo/) 
...
是一个 jQuery 插件，模拟了 iphone/ipad 在浏览器中的滚动体验。该插件为溢出的 DOM 元素添加了一个可拖动的漂移，以及一组褪色的“拇指”。OverScroll 在 Safari 5+、Chrome 5+和 Firefox 3+上运行得最好，但在大多数现代浏览器上也应该运行得不错。
 ...
 [![OverScroll](img/d5e26e89d46492bb0b502867fb2a9d62.png)](http://www.azoffdesign.com/plugins/js/overscroll) 
...
确定当前在视窗中的 HTML 元素的比例，以及它在整个视窗中所占的比例和可能可见的区域的比例。它还提供了可见矩形在文档、元素和视口空间中的坐标。
 ...
 [![Query.fracs](img/925e2316beba6ac019a4ef9bcd87c71d.png)](http://larsjung.de/fracs/) 
