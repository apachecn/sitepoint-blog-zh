...
> 原文:[https://www . site point . com/real-time-photo-update-app-insta gram-API/](https://www.sitepoint.com/real-time-photo-update-app-instagram-api/)
...
![Screenshot of registering a new client to use the Instagram API](../Images/347d6014b7dc2eff7d232babaad11d98.png)
...
![A screenshot of ngrok running and displaying the forwarding urls](../Images/03407b0290195c38c9b82c3e145a5702.png)

现在，如果您重新启动服务器，事情应该会按计划进行:

![A screenshot of the finished app](../Images/6a1e1a8a719790a944dab1f3df5858e2.png)

一旦用户订阅，应用程序将开始通过 socket.io 从服务器接收照片数据，然后显示它。

![A screenshot of the finished app viewing photos for the #pokemon tag](../Images/d265a8981aa3288c79918d4651388a37.png)
