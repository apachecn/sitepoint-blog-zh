...
> 原文:[https://www . site point . com/bootstrap-card-component-introduction/](https://www.sitepoint.com/bootstrap-card-component-introduction/)
...
![Bootstrap card component: Basic card layout](../Images/6dae8fd4f8b1f312ee1b3f4972fa2c85.png)

可以看出，卡片占据了其容器`div`的整个宽度。

通过简单地将`card-body`类与`card-img-overlay`类进行切换，我们可以将图像用作覆盖图:

![Bootstrap card component: Using the image as an overlay](../Images/3bf1dcbb9257087bd1a84f356bbc4284.png)
...
![Bootstrap card component: Adding the image at the bottom of the card](../Images/aa31008a4ce641592bed64afef95e752.png)
...
![Bootstrap card component: Reducing card width](../Images/651293c9ef76e55b7c159156e0e0f6d9.png)
...
![Bootstrap card component: Controlling card width with Bootstrap grid](../Images/22172f3792dea7bd384f7def02a1f069.png)
...
![Bootstrap card component: Adding a header and footer](../Images/10a9234390fd0e12d899039a2ac1ba1e.png)
...
![Bootstrap card component: Adding a tabbed navigation element](../Images/581dd74dabb067adddc19f617186d103.png)
...
![Bootstrap card component: Adding navigation pills](../Images/5bbd09bceddd99dc747050407fc69c1b.png)
...
![Bootstrap card component: Adding links inside cards](../Images/be73849b3d91e2884a1a49718a80e109.png)
