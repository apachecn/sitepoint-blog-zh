...
> 原文:[https://www . site point . com/quick-tip-how-to-permanently-change-SQL-mode-in-MySQL/](https://www.sitepoint.com/quick-tip-how-to-permanently-change-sql-mode-in-mysql/)

我最近在做一个遗留项目，需要从 MySQL 5.5 导入一些数据。代码中的所有查询在 MySQL 5.5 中都能完美运行，所以我假设升级到 5.7 会是无缝的。并非如此。

![MySQL logo](../Images/4a8339e744e31799a9dfb16e1f4b78fb.png)
