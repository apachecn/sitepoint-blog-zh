...
> 原文：<https://www.sitepoint.com/happenings-in-ruby-4/>
...
![](img/6ccf2d8a587236528e0adf942eb07939.png "Screen Shot 2012-05-28 at 1.45.59 PM")这里有一个很好的关于 Struct 和 OpenStruct 区别的堆栈溢出问题。归结起来就是性能(不都是吗？)因此，如果您在 Ruby 代码中大量使用 OpenStruct，您绝对应该阅读这里的基准测试。
