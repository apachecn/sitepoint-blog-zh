...
> 原文:[https://www.sitepoint.com/xul-nets-biggest-secret-3/](https://www.sitepoint.com/xul-nets-biggest-secret-3/)
...
<q>*“一开始有 3 个前端(FE):MAC、windows、unix。每个都需要一组开发人员来维护。添加一个新功能(甚至只是一个按钮)需要 3 名工程师浪费至少一天(更常见的是一周)的时间，直到该功能完成。这必须改变。*T3】</q>
