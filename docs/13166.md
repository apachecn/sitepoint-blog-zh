...
> 原文:[https://www . site point . com/help-create-the-acid 3-test-for-JavaScript-compliance/](https://www.sitepoint.com/help-create-the-acid3-test-for-javascript-compliance/)

![acid3.png](../Images/90681c2c53e10364de5ae04f15ec8e17.png)随着去年年底宣布 [IE8 通过了 CSS 渲染](https://www.sitepoint.com/ie8-passes-acid2-test-web-standards-project-dies-of-shock/)的 Acid2 测试(或者将会通过，当它发布的时候)，[网络标准项目](http://webstandards.org/)将目光放在了他们使命的下一阶段，鼓励浏览器制造商为网络用户提供一致的体验。
