...
> 原文:[https://www . site point . com/authenticating-users-via-oauth-with-Cordova-and-ionic/](https://www.sitepoint.com/authenticating-users-via-oauth-with-cordova-and-ionic/)
...
![Default App Screen](../Images/e6691468355d5b8ccc02168d614dbce8.png)
...
![Google Login App](../Images/03185ec698b203cebd6323c50f9fccee.png)
...
![Create new project Google Developer Console](../Images/374346342a5583fdd35fffd4e4656745.png)

点击左侧菜单中的*凭证*选项卡，并点击*创建凭证*按钮。

![Create credentials ](../Images/64530f2f21982b1ad4b9c65fe19e63a3.png)

从菜单中选择 *OAuth 客户端 ID* ，点击*创建凭证*。

![enter image description here](../Images/000d83ba08253da856b2ae511bec3079.png)

选择*应用类型*为 *Web 应用*，设置回调 URL，点击*创建*，如图所示:

![Set Application Type](../Images/6cd17a41e498d6e7cef46e9d55d87e49.png)
...
![OAuth App Using ngCordova Plugin](../Images/3a2bf42e0e2ff4a02df215808347e71e.png)
