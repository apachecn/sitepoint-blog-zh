...
> 原文:[https://www . site point . com/how-laravel-facades-work-and-how-to-use-them-where/](https://www.sitepoint.com/how-laravel-facades-work-and-how-to-use-them-elsewhere/)

Facade 模式是一种软件设计模式，常用于面向对象编程。事实上，facade 是一个包装复杂库的类，为它提供一个更简单、更易读的接口。Facade 模式还可以用于为一组复杂且设计不佳的 API 提供统一且设计良好的 API。

![Facades diagram](../Images/329f457511279480d69d3f9ce3199477.png)
