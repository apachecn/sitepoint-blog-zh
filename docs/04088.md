...
> 原文:[https://www . site point . com/migrated-Babylon-js-azure-CORS-gzip-indexed db/](https://www.sitepoint.com/migrated-babylon-js-azure-cors-gzip-indexeddb/)
...
![image1-march-april-peaks](../Images/396874ea17fc55e41a220cd212debf37.png)
...
![image2-march-peaks](../Images/88b30278364a1ead6bfb67119484d747.png)
...
3.  我在 Visual Studio 解决方案资源管理器中右键单击了 Web 项目。
    ![image3-publish-screenshot](../Images/6a720789ed9fc04abb6a5b6f81b2fcc1.png)
4.  工具的神奇之处就在这里。当我使用绑定到我的 Azure 订阅的 Microsoft 帐户登录 VS 时，向导让我简单地选择我想要部署的网站。
    ![image4-azzure-publishing-options](../Images/fcb812bb13305cf7c09ca03390439cd7.png)
...
![image5-web-hosting-plan-mode](../Images/69f704eee5ef05315c0b6abea210013a.png)
...
![image6-instace-options](../Images/7b58253af88d49f7e08e4c7927395e50.png)
...
![image7-web-developer-tools-babylonjs](../Images/6d7233d8fac6214ec0c81d84e012c683.png)

如您所见，绿色的日志线意味着一切正常。

这是一个失败的例子。如果您尝试直接从本地主机(或任何其他域)从我们的 blob 存储中加载我们的场景，您将在日志中得到这些错误:

![image8-access-control-origin-header](../Images/19dc8b55d20cf4d0478b226eab28cd5d.png)
...
![image9-gzip-in-explorer](../Images/8348de61c29eeb7e0ec5e53e474acb9c.png)
...
![image10-check-gzip-working](../Images/274b436952f0413aa12f4fd5b1b56dc9.png)

### 启用 CDN

一旦你完成了前面的两个步骤，你只需要点击 Azure 管理页面中的一个按钮来启用 CDN 并将其映射到你的 blob 存储:

![image11-enabling-cdn-mode](../Images/5770e82c4bd05e49f2b13b66c8c98cde.png)
...
![images12-requests-made-first-time](../Images/8d1c5aab3d488fe126971644a528b416.png)

收到 153 个项目和 43.33 MB。但是如果你已经同意让 babylonjs.com 使用你电脑上的额外存储空间，这是你第二次加载相同场景时会看到的:

![images13-second-request-babylon-manifest](../Images/2e4d37adb494fdb6bc6def616a030308.png)
...
![images14-site-homepage-user-computer-storage](../Images/59ddc80ed31b052534f5b441422ba54a.png)
