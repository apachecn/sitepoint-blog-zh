...
> 原文:[https://www.sitepoint.com/debugging-adobe-air-application/](https://www.sitepoint.com/debugging-adobe-air-application/)
...
![Aptana welcome](../Images/0e6538324c9e24a9286002a454819f83.png)

这个工作台的大部分与 AIR 调试无关，所以我们可以通过关闭除 Project 之外的所有视图来简化透视图。

让我们创建一个新的 AIR 项目；打开 **Aptana 项目**下的**文件>新建>项目**，选择 **Adobe AIR 项目**。

![New project dialog](../Images/8e939e702418fa51bf698c2f57db7783.png)

点击**下一步**并给你的项目命名——我选择了“调试”。

![Create an Adobe AIR Project](../Images/4275aae2019f4a1a6044fc8edbd8423d.png)
...
![Import frameworks dialog](../Images/7c11437b70b49c3431aa319e79fcb355.png)
...
![Workbench](../Images/4ef62b801517d0a441d9d0e07dc82a87.png)
...
![Run Debug button](../Images/5cc697b54e16c384f6dccd843e49cd81.png)

我们的应用程序窗口出现:

![](../Images/16f60a8043a328ea125d69961be142b5.png)

单击“使用 AIR APIs 读取本地文件”按钮。文件被读取，并出现警报窗口:

![Adobe AIR alert box](../Images/bf6f4aa617cd606e45b600516e0e95c0.png)

点击 **OK** (或者类似的，取决于你的操作系统)，返回 Aptana。控制台视图应该出现在代码窗口的下方。

![Debug console](../Images/c081b77d5e18a979539f78816eb77832.png)
...
![Adobe AIR Introspector](../Images/cb86e4e36d3905221f0c1ce93c35c464.png)
...
![Adobe AIR Introspector](../Images/7dbe5cb38978c1cc903381bee9958d8a.png)
...
![Adobe AIR Introspector](../Images/44f0de6cc858dcb03cb2705ea47b5b45.png)
...
![A JavaScript Breakpoint](../Images/5d44e4fa69d396a82652ba1c1036b512.png)

这设置了一个断点，或一个脚本执行将暂停并给我们一些喘息时间的点。现在，保存`Debug.html`并使用**调试**按钮运行您的应用程序，而不是运行:

![Debug button](../Images/0bee2ffef3de33d149faa210273c9c62.png)

当应用程序窗口打开时，点击**读取本地文件**按钮。这一次，窗口冻结，Aptana Studio 出现一个对话框:

![Debug perspective switch](../Images/99512587b0128f8e46a81b7e37da0911.png)
...
![Aptana debug perspective](../Images/a611978a6dfa1d05037252e0b1c6748e.png)
...
![Debug view](../Images/07551b1e96daf96646131b1cadf53186.png)
...
![Variables view](../Images/8e2255519849a950019f0047d946af7f.png)

对接这一观点未能做到公平。右键单击变量标题选项卡，单击分离，并根据需要调整结果窗口的大小。(或者，您可以将它停靠在工作台的一侧，以换取水平屏幕空间。)好多了。

![Variables view docked](../Images/a9bd15f57c5c4dd6f285ad149c29e90d.png)
...
![Expressions view](../Images/efab11f738f1f0f64846093043076c7f.png)

让我们创建一个手表表达式。但是首先，让我们恢复脚本执行:点击 Debug 视图上的 **Resume** 按钮。

![Resume button](../Images/61202ae5cf1425dd26268c846b8d4446.png)
...
![Aptana outline](../Images/b1fb80462dc9f2d41867a8f83e01fb9f.png)
