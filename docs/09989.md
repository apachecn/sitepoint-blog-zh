...
> 原文:[https://www . site point . com/managing-your-adobe-business-catalyst-website-with-adobe-Dreamweaver/](https://www.sitepoint.com/managing-your-adobe-business-catalyst-website-with-adobe-dreamweaver/)
...
![extension_mgr](../Images/ac2940bdf8fe7ccfdca0df5b8f093ba2.png)

退出扩展管理器并启动 Dreamweaver，如果默认情况下没有打开，则进入**窗口> Business Catalyst** 打开右侧面板。

![bc_panel_logged-out](../Images/2ccbfcfb62458cb5576cc5afd588869d.png)

输入您的 Business Catalyst 帐户凭据并登录。该面板将会显示链接到您帐户的网站。

![bc_panel_logged-in](../Images/c76af3259270431aad2f427247ce32b1.png)
...
![panels](../Images/4be4953219a9af7982342c3f7899a1a2.png)
...
![template-design-view](../Images/a620a77bd0da56c49f7d69b0d9caa137.png)

当你点击窗口顶部的 **Split** 选项卡时，你会在左边看到代码，在右边看到渲染视图。

![template-split-view](../Images/bf987a95da56acb3f6ddecf22fb08f27.png)

双击呈现页面的一个区域，光标将会跳到页面上的那个点，这样就可以很容易地编辑模板。当您编辑模板时，页面的任何部分都可以被修改，正如您稍后将看到的，使用模板的页面有一些方便的限制，以确保您只更改页面的可编辑部分。

![template-snippet-cursor](../Images/5f46251886a50fed52b62f3d1149ddba.png)

我们已经决定，第一个任务将是扩展公共导航来访问新的部分。因此，我将对顶部导航中的链接集进行更改，添加名为“练习”的新部分。

![IDE_code-hints](../Images/b0d779d529a926fe3e8d21b3b0560fce.png)

默认情况下，Dreamweaver 通过在您键入时提示代码来加快开发速度。该行为可以根据您的喜好进行调整。我将向模板添加一个新链接，并保存更改。当我保存时，系统提示我是否要更新使用此模板的文件。

![update-files-template-prompt](../Images/f47678d7e2953f789802e70cf3eece57.png)
...
![header-pre-templ-change](../Images/19c663eee73ff2a183d9cd27bcaec6c4.png)

我如何将这些更改发送到服务器？我已经配置了 FTP 设置，现在我只需要用本地更改同步远程服务器上的文件。

![synch_remote_1](../Images/3bdd24127cd7de57a8f01790658ca3bd.png)

在这个视图中，我移除了我的**文件**窗格，并将其打开以显示本地和远程文件系统。

使用![sync-button-icon](../Images/639fc61908dda0ace46004410364d92a.png)按钮同步两个环境。

为了安全起见，单击按钮后，使用**预览**功能，Dreamweaver 会向您显示将受到影响的文件。

![synch-remote-preview](../Images/20bed67fc4d2f35e62cdc9c9f3bf32f3.png)

如果我去了网站，我可以看到在网站的主要部分使用的模板已经进行了更改。

![header-post-templ-change](../Images/e048fd5b23fd1985618e5e3d2bc3c5d6.png)
**创建新页面**
...
![create-page-from-template](../Images/586fb77fb69d8286b474b9bd09c12c47.png)

当您切换到**分割**视图时，您可以在左侧**代码**窗格中看到您的代码，并在**设计**窗格中看到可编辑的渲染视图。您的 Business Catalyst 模板已经定义了一个可编辑的**内容区域**，Dreamweaver 限制您只能编辑该代码部分的内容。

![create-page-from-template-2](../Images/403e7c9022c95861409b15c50a5a832f.png)
...
![bc-content-area](../Images/10c2496a9501f2522b18151117f1d6eb.png)
...
![create-webapp1](../Images/f669888e29c21ea5d5ede8f4ddd59f88.png)

你要做的第一件事是定义你想要的字段——在这种情况下，我会保持简单，为**练习**、**图像**和**指令**添加一个字段。

![web-app-add-fields](../Images/26b52d41302ee827b57c0bf4d78ff3b1.png)
...
![web-app-details-template](../Images/2c9c883546e8ed1bc768541ab9b71ed5.png)
**向页面添加 Web App 模块**
...
![add-webapp-pane](../Images/b927776b29b5e7a12329273425ce5346.png)

系统会提示您选择要添加到页面的应用程序。您将看到您创建的 Web 应用程序-在这种情况下，您可以看到我们在上一节教程中创建的**服装列表**，以及新的**练习**应用程序。选择你的应用，点击**下一步**。

![add-webapp-to-page](../Images/4ef39b188def75b7fa36fcba6fc5aac5.png)

选择要添加到页面的模块类型。因为我想要所有记录的列表，我将选择**所有项目**并点击**下一个**。

![add-module-2](../Images/06c67d6cb9da7186fff200a32fcd32a3.png)

最后一步是单击 **Insert** ，模块标签将被插入到您的页面中。

![add-module-3](../Images/38cdcc175aed799a8dae20c935a8de0a.png)

你可以在你的 HTML 中看到`{module_webapps,...}`标签，你可以把它包装成你想要的任何样式。

![add-module-html](../Images/65960385601b242cb2c685da1fc2addb.png)

保存对文件的更改，并与远程服务器同步。当您转到已发布的网站时，您可以看到包含列表的新页面:

![exercise-listings-page](../Images/2f5d344778e524667fce26cdf09e86c2.png)

通过点击链接，您可以进入**详细信息**页面:

![exercise-details-page](../Images/5aa0bc6c41e159e9c86ba52edd24b647.png)
**总结**
