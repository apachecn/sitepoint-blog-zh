...
> 原文:[https://www . site point . com/how-to-add-auth-to-your-pwa-with-okta-and-stencil/](https://www.sitepoint.com/how-to-add-auth-to-your-pwa-with-okta-and-stencil/)
...
![Application Listing Screen](../Images/469cc120fc5e8c5e861cc4e3b10da92c.png)

然后，您将被带到应用程序创建向导。选择**单页 App** ，点击底部的**下一个**。

![Create Application Screen SPA](../Images/eb4c7c70dfc17bc4f4b40bd9576a2f40.png)
...
![Application Settings Screen](../Images/18169d849aa79c0328ea07e085cfd91c.png)

点击底部的**完成**。

从列表中选择您新创建的应用程序，点击 **General** 选项卡查看常规设置。

![General Settings Client Id](../Images/7ea36e0f32032dd8e4217fbe5011eb04.png)
...
![](../Images/639a3849e58c8cc850ce5f1d209d5724.png)

您还需要您的 Okta org URL，位于 Okta 仪表板页面的右上角。

![Okta Dashboard Org Url](../Images/a2f3e74b3b4d0991186d94890ac3f50e.png)
...
![Stencil App Login Page](../Images/47faa9eaea5464df033eeb5f5c5fd187.png)
