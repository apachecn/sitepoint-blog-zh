...
> 原文:[https://www . site point . com/better-user-interfaces-Android-action-bar/](https://www.sitepoint.com/better-user-interfaces-android-action-bar/)
...
![Action Bar](../Images/adb07cdd502faea91f183033246775b3.png)
...
![Action Bar with Action Buttons](../Images/e48f6539480e2a8258eb93c4550884ec.png)

### 拆分操作栏

由于操作项与应用程序图标和标题共享操作栏空间，您可能需要拆分操作栏，以便操作项显示在屏幕底部。这将为它们提供更多的空间，因此用户可以看到更多的项目。如果有足够的空间，例如在较大的屏幕上或在横向模式下，动作栏将不会被拆分。

![Split Action Bar](../Images/1e7e247af644e65a4c6d5b61e145e3dd.png)
...
![Up Navigation](../Images/91b5b769b4dbb677ed509d5b5335a952.png)
...
![Search Widget](../Images/c5c6a5a6d2e71f48330334ece83886c0.png)
...
![Custom Action View](../Images/ba8ed511c73799951c606c78cc3c6e22.png)
