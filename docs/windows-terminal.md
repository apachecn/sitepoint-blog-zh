...
![Windows Terminal](img/da1ba9e26e5971400393ddded8355abd.png)
...
![Windows Terminal at the Microsoft Store](img/c68daef5e101b68bcf6279f1db84b8e6.png)
...
![Windows Terminal start](img/7fb1bccd30a9f596a612a14696028dbe.png)
...
![Windows Terminal split panes](img/ea3668b752273f349e37632ed8524a2f.png)
...
![Windows Terminal tab name and color](img/f3dfd0c2e835caae428f69c9346c559e.png)
...
![Windows Terminal search](img/4b8728b60bae89aa4977d4c915aeb031.png)
...
| `"icon"` | 下拉列表和选项卡中显示的图标的完整路径，例如`"img/tux.png"`。24 位 png 是最佳选择；不幸的是，不支持 SVG |
...
| `"backgroundImage"` | 背景图像的完整路径，例如`"img/background.png"` |
| `"backgroundImageOpacity"` | 背景图像的不透明度从`0`(完全透明)到`1`(完全不透明) |

最后，添加`"experimental.retroTerminalEffect": true`到一个复古 CRT 效果的配置文件！…

![Windows Terminal CRT effect](img/11b68aca61a6f244cb76625ecbb73628.png)
...
![Campbell color scheme](img/3fbafd83a2d3516191b8cfe270e6bf71.png)

`"Campbell Powershell"`:

![Campbell PowerShell color scheme](img/b978b05fe60f73962e7707383f4c93a1.png)

`"One Half Dark"`:

![One Half Dark color scheme](img/af8fa0d402ef818488251b44765a7154.png)

`"One Half Light"`:

![One Half Light color scheme](img/97c92595e1757bb7e2347bd21c795f50.png)

`"Tango Dark"`:

![Tango color scheme](img/22364d444a0e9be37891ee771b5cb5ab.png)

`"Tango Light"`:

![Tango Light color scheme](img/6efc2bc750d44bb15a616d656e6a0bc2.png)

`"Vintage"`:

![Vintage color scheme](img/430b2ac9b2cd37e543b34fe2c85f2a66.png)
...
![Windows Terminal command](img/4a49caff6a618795e82a7b485b32b46f.png)
