...
> 原文:[https://www . site point . com/deploying-a-django-app-with-mod-wsgi-on-Ubuntu-14-04/](https://www.sitepoint.com/deploying-a-django-app-with-mod-wsgi-on-ubuntu-14-04/)
...
![the view.py file](../Images/0afc7049a6a63e7adb06142946b8f327.png)在本节中，我们将安装所需的包，并设置一个由`mod_wsgi`提供服务的 hello world Django 应用程序。我们假设您已经登录到一个新创建的虚拟机。
