...
> 原文:[https://www.sitepoint.com/mean-shaders-create-html5-webgl/](https://www.sitepoint.com/mean-shaders-create-html5-webgl/)
...
![A demo of Babylon.js' Oculus Rift support](../Images/33ae649a4ca31f4bbf20dd48a830bc8d.png)
...
![A diagram of the Vertex Buffer](../Images/527f16cbbd547a9cdbb09b13cf2353e5.png)

*   顶点着色器应用于三角形的每个顶点。顶点着色器的主要目标是为每个顶点(3D 顶点在 2D 屏幕上的投影)生成一个像素:

![A co-ordinate diagram](../Images/1170d64771518e5d0f5ce48146a19076.png)

*   使用这 3 个像素(它们在屏幕上定义了一个 2d 三角形)，GPU 将对附加到像素(至少是其位置)的所有值进行插值，像素着色器将应用于 2d 三角形中包含的每个像素，以便为每个像素生成一种颜色:

![Pixel interpolation with a 2d triangle](../Images/4830007be914752b8f235c75ee7e65b3.png)
...
![Process diagram](../Images/f3c95704941f517ae2fd20077c30a795.png)
...
![The worldViewProjection matrices](../Images/2ecfeb97f5a922ca2ddd3cb531040cc9.png)
...
![Pixel shader result](../Images/1ebaabe6547d04c19bb4a2575f6025ac.png)
...
![A checkerboard texture to use as a starting point](../Images/7de47f21a087afc589ae91b55a99e309.png)

![A globe shape to use as a starting point](../Images/0d96624227dbb3152a67d8a5a4d459f0.png)
...
![The CYOS dashboard](../Images/7b72c7c3a1b0fc6c14982abbce4a0d9a.png)
...
![Basic shader result](../Images/333551a8c9e8a4cc977ca38755689bb9.png)
...
![Black and white shader result](../Images/3f63e1817be5d115ab1dcf39ef549590.png)
...
![Cell shading shader result](../Images/538f6f95a8d8a46035f957db28c0cb2a.png)
...
![Phong reflection components](../Images/441af751eea58615518253a2a73e083e.png)

我们星球上的结果:

![Phong shader result](../Images/1acec0e6ebad32f9d21d6710c4445a8f.png)
...
![Discard shader result](../Images/f5a2b994060ed801942c8ee9e43291c9.png)
...
![Wave shader result](../Images/873057a272384423ced0006bb4eca708.png)

### 球形环境映射

这个很大程度上是受这个教程的启发。我将让您阅读这篇优秀的文章，并使用相关的着色器。

![Spherical environment mapping result](../Images/516afb7f4a847c9f76abd4ddda7f24ec.png)
...
![Fresnel shader result](../Images/28d169af9707820dde2dcc821ebc9a4a.png)
