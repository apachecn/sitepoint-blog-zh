...
> 原文:[https://www.sitepoint.com/vorlon-js-helps-improve-web-code/](https://www.sitepoint.com/vorlon-js-helps-improve-web-code/)
...
![Vorlon.js](../Images/d2f7bbb23f117a50497c65eb1210994e.png)
...
1.  ### 网络标准
    ...
    *   **使用现代文档类型**:像`<!DOCTYPE html>`这样的现代文档类型对浏览器兼容性更好，并且支持使用 HTML5 特性。
    ...
    ![Web Standards](../Images/59a4bd156a1c43617190a14853a225bb.png)
...
2.  ### 易接近
    ...
    *   **使用`aria`属性**
    ...
    ![Accessibility](../Images/22bab723f4b4c1373bd04e1e054b66a5.png)
...
3.  ### 演出
    ...
    *   尝试捆绑你的文件:简单的算法，检查你是否为所有的脚本创建了一个文件来减少 HTTP 请求
    ...
    ![Performances](../Images/d343e37e23c85eff59e4d99e6d053165.png)
...
4.  ### 移动网络
    ...
    *   **使用响应式方法**:即使你的网站只针对特定的设备，你也可能会有用户使用意想不到的设备或屏幕比例。
    ...
    ![Mobile Web](../Images/c5fc17632615c4fa490930d79fb5435e.png)
