...
> 原文:[https://www . site point . com/create-an-automated-score board-sense-the-a-a-raspberry-pi/](https://www.sitepoint.com/create-an-automated-scoreboard-that-senses-your-score-with-a-raspberry-pi/)
...
*   **[【斯伯丁 NBA Slam Jam 过门迷你篮球架](https://www.amazon.com/gp/product/B0085AOZIK/ref=as_li_tl?ie=UTF8&camp=1789&creative=9325&creativeASIN=B0085AOZIK&linkCode=as2&tag=sitepoint09-20&linkId=d8e8bc69bbf028cdbbde2f195611dcc2)![](../Images/a3e770aae6a7e9bb06254e1d53d5af09.png)**——这是我用过的迷你篮球架。你可以用一个不同的——尤其是如果它的网络工作得更好的话！
*   **[树莓派 3.3190G 7”触摸屏显示器](https://www.amazon.com/gp/product/B0153R2A9I/ref=as_li_tl?ie=UTF8&camp=1789&creative=9325&creativeASIN=B0153R2A9I&linkCode=as2&tag=sitepoint09-20&linkId=12564b5131303fa31b06069177fcb330)![](../Images/6ee127749c6e68865fefbec8428427dc.png)**——这是我最喜欢的树莓派显示器，它是一个触摸屏，所以你可以与 UI 互动，而不需要连接鼠标。
*   **[RS Raspberry Pi 7 英寸液晶触摸屏外壳，黑色](https://www.amazon.com/gp/product/B01GQFUWIC/ref=as_li_tl?ie=UTF8&camp=1789&creative=9325&creativeASIN=B01GQFUWIC&linkCode=as2&tag=sitepoint09-20&linkId=cf414f1db79199c6822a3b1ae7a4f808)![](../Images/8268961c1d3adbcc394ae46fe37517de.png)**——为了让显示器和 Pi 一起看起来更好看，我把我的 Pi 放在这个黑色外壳里。
*   **[HC-SR04 超声波测距传感器模块](https://www.amazon.com/gp/product/B00F167T2A/ref=as_li_tl?ie=UTF8&camp=1789&creative=9325&creativeASIN=B00F167T2A&linkCode=as2&tag=sitepoint09-20&linkId=ec650235474281cc51ed390479c7fa56)![](../Images/1a4dd2dab36f240615c765344cb2ee43.png)**——我身边有一个备用的廉价克隆 HC-SR04 传感器，但我会推荐买一个质量好的。我的那个偶尔会有奇怪的读数，而且有点喜怒无常。
...
![Patrick Catanzariti using his mini-basketball loop with scoreboard](../Images/23edf7334508bef2e1c2ddb4a5a78066.png)
...
![](../Images/52be42c8254cfcb18710026df6a0c2b1.png)
...
![](../Images/163bf7ba0bc92f067de33571336448e2.png)

添加跳线电缆后，看起来更像这样:

![](../Images/526cfd27f762fe9cca7fc5559d436c4d.png)
...
![](../Images/6bcb6cdb03a8976b8d8890a2af486278.png)
...
![](../Images/b4a2db95ec0f4ee72c672860098acef9.png)
...
![](../Images/c3dd92d1fa45096f402baf5555cf46d0.png)

我非常担心圆周率是否会被粘住，为了安全起见，我在铁环下面放了一个豆包。幸运的是，在它挂在那里一个多星期并被篮球砸了无数次之后…它仍然挂着！那盘带子太神奇了。

![](../Images/e2c04a846021c900a0ae698e08739836.png)

我最初用同样的胶带将我的传感器*贴在篮筐上，但使用胶带意味着我被限制在篮筐下足够平的某个地方，以至于可以将它粘住……这最终有点太低了，篮球网经常干扰跟踪。所以这就是我如何建议你*不要*贴传感器！*

![](../Images/64f01e2459fd03d611012eb89a2e0596.png)

相反，我把传感器从那个点上拿下来，用 blutack 把它直接粘在铁环下面。

![The ultrasonic sensor stuck right below the hoop](../Images/eced3b6f0f05f5c9ebdb2531df75f5f3.png)

我更成功的放置了超声波传感器！

球网仍然挡在路上，所以我用 NBA 环箍包装上的一个扎带把一些球网绑在一起，以避免干扰:

![Tying up the net a bit to avoid interference](../Images/4dc87cfacc8cdece2d754fed490c3904.png)
...
![Console running successfully](../Images/f33fbe8d9c0c27f74c2347a3c53fea4e.png)

如果我们打开 Raspberry Pi 的浏览器，进入 *http://localhost:8080* ，我们应该会看到我们的记分牌已经准备好了！

![](../Images/9c303bb699752479cd22b533af7c627e.png)
...
![Menu, Internet, Chromium Web Browser](../Images/f61fa6fa45b961ec94da87daed6823c1.png)

铬合金将安装在哪里

作为一个网页，最好的部分是它很容易定制！我定制了一个菲尼克斯太阳队的主题:

![Patrick's Suns themed version of the scoreboard](../Images/98465f68ec39aeafe03b6f8a6fdfd019.png)
