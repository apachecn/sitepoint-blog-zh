...
> 原文:[https://www.sitepoint.com/first-kindle-book-case-study/](https://www.sitepoint.com/first-kindle-book-case-study/)
...
![For best quality, a cover image should have a height-to-width ratio of 1.6.](../Images/c547297e7a36a08d397750be8bd5298f.png)
...
**Kindle Previewer 和起始页**T3】当你在 Kindle Previewer 中打开一本书时，它会显示被标识为起始页`<reference>`元素的值的 HTML 文件的内容。
...
![The opening screen also provides links for accessing help, the ability to change default settings, and more.](../Images/77ff419f8bec423277c422ee44407ef8.png)
...
[![Kindle Previewer treats the introduction page as the beginning page. The page is being shown as it would appear on the basic Kindle e-ink device.](../Images/bbbced14dc82daabe840517667eb6b27.png)](https://www.sitepoint.com/wp-content/uploads/2013/09/kindlefig3.jpg) 
...
![You can view a book's NCX hierarchy and additional information about the book.](../Images/b19e8a37f614a242479b570118244fda.png)
...
![A cover image of 500x800 pixels nicely fits my Kindle device's screen.](../Images/1e955446df2558b16271dd9db53243d0.png)
...
![The bookshelf lists all of your book entries.](../Images/8ae15a78c7dd1fbe197aaa7289c6ec80.png)
**图 6:** 书架上列出了你所有的书条目。
...
![The BIG Java Quiz awaits its first review.](../Images/6ea82ab21e1197faad50f3effdd09174.png)
**图 7:**Java 大测验等待第一次复习。
