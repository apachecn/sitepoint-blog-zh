...
> 原文:[https://www . site point . com/4-simple-ways-add-audio-WordPress-site/](https://www.sitepoint.com/4-simple-ways-add-audio-wordpress-site/)

![](../Images/96e824960ed47d142a35a9c33f8ec77c.png)
...
![](../Images/67f6e0b6ee898b7129d8a81574c91b76.png)

现在是添加图像后的文章的文本视图(见第二段)。该屏幕截图还展示了其他一些手动添加音频播放器代码的方法。

![](../Images/6c758184e287fe3518e33e7ea0edec79.png)

而这就是帖子预览时，或者发布后的样子。为音频文件显示一个迷你播放器。请注意，这三种方法的播放器看起来都一样。

![](../Images/a661ce25a01b09120685961cbcbbc892.png)
...
![](../Images/146b2a718cc678c68d43cdcbdac9c1e8.png)

以下是您可以为播放列表选择的选项。

![](../Images/f7b6e6b0927cc31aa5fee2327ea9af5b.png)

这是一个添加了播放列表的帖子的文本视图。

![](../Images/c28da1db918d670eec739ede3aff0f70.png)

这是它出版后的样子。

![](../Images/222bc0dcf067815eb5d8343a89b92140.png)
...
![](../Images/3ffd3565fe70c17dfac35c7f6021f9fb.png)

下面是粘贴到帖子中的代码的样子。

![](../Images/5aa04dd5a3badf94327a6c8c3faf0066.png)

这是你的帖子发布后 SoundCloud 播放器的样子。

![](../Images/472d5be5c1cbb7d8bca246e8de48bdf9.png)
