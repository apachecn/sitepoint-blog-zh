...
> 原文:[https://www . site point . com/essential-WordPress-plugins-for-solopreneurs/](https://www.sitepoint.com/essential-wordpress-plugins-for-solopreneurs/)

![6 Essential WordPress Plugins for Solopreneurs](../Images/7ea1f1f035a5cf6678a92a3c702ff613.png)
...
![Tawk.to](../Images/e46fe28dfd846f2e93ad0db1ea59fa80.png)

您在网站上指定的每个页面都会在右下角有一个方便的聊天窗口，您可以根据自己的需要进行完全定制。一旦你的访问者点击了聊天窗口，他们就会被提示输入他们的名字和电子邮件来开始聊天。

![Tawk.to](../Images/85d51df0b18150ebab01a201261f5ab4.png)
...
![Tawk.to](../Images/529c12de2a26296641f96ab73bdce75e.png)
...
![Sumo](../Images/58c93c56d5b7739a25621f8bcb8da02b.png)

为你的 WordPress 网站下载 Sumo ,你可以使用大量的工具，让你的网站更专业，帮助你获得更多的转化率。

![Sumo](../Images/99c36fbe2c73ea071ecb261939818c75.png)

有了热图，你可以直观地看到你的访问者点击了哪里，以及他们是如何浏览你的网站的。这让你更深刻地了解某些文字、按钮或视觉效果如何有效地转化为销售和注册。

![Sumo](../Images/d1d97eea83f153c418587d6de3fef626.png)

您可以创建仅在访问者即将离开页面时显示的弹出窗口。这些网站会提示他们输入优惠券代码来保存销售或优质内容，以吸引他们继续阅读。

![Sumo](../Images/c71e91f90eee79af41591fa02e961f1b.png)
...
![MailChimp For WordPress](../Images/13a73b1e41812461aa5d4b31aae9c00b.png)
...
![MailChimp For WordPress](../Images/4a93f92006b4e9a088edfee787eaa2f3.png)

在创建用户友好的表单时，您可以自定义从按钮宽度和高度到背景颜色甚至文本大小的所有内容。几乎你能想到的任何东西都可以根据你的喜好进行定制，而不会影响任何功能。

![MailChimp For WordPress](../Images/3e5ad11ca58fb61cb579e7d94280234c.png)
...
![Beaver Builder](../Images/2d5a27474c00ca6eabd4317ec02ed6b5.png)
...
![Beaver Builder](../Images/108384b2ae67d764edadfdbd951d9328.png)

页面生成器赋予你拖拽创建和重新排列站点任何部分的能力。最棒的是，所有这些都是在你网站的前端完成的，这意味着你的访问者将会看到你所创建的东西。你可以拖动不同的文本框、图像、视频等模块。

![Beaver Builder](../Images/c1d9d80da81acde4f68b896557088ace.png)
...
![Broken Link Checker](../Images/861eecd8dbefc8d392b8f8c0569f112c.png)

这个插件成为你的眼睛和耳朵，帮助你找出网站上任何不起作用、重定向或丢失图片的链接。它有能力主动监控你的网页，博客文章，以及任何你想要的自定义域，以发现任何这样的链接。

![Broken Link Checker](../Images/255e7b9213ba6db15098eb44dc4130a7.png)
