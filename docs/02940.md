...
> 原文:[https://www . site point . com/how-to-consume-laravel-API-with-angular js/](https://www.sitepoint.com/how-to-consume-laravel-api-with-angularjs/)

在第 1 部分中，我们构建了服务器部分。现在我们可以建立我们的客户。我们要用 AngularJS 做一个*单页应用*。我们将使用一个非常基本的动态构建的引导模板。

![AngularJS logo](../Images/cd534df3ec2884528813158432b70716.png)
...
![Basic main page](../Images/a3fd9def66d1e909654ccd6eb2456620.png)

角度路由组件自动将`/#/`添加到 URL。现在，如果我们手动将`login`添加到字符串中，我们将得到如下结果:

![Route testing](../Images/1e37d3090b0f115978dfa98689f548d8.png)
...
![The working app](../Images/43e3375eed8cdf427078476f47a8d295.png)
