...
> 原文:[https://www . site point . com/design-develop-Microsoft-community-2015-setting-up-site/](https://www.sitepoint.com/design-develop-microsoft-community-2015-setting-up-site/)
...
![VSC1 - 01 - final version](../Images/7e7459119a3d41858329f5c3dfc8de1f.png)

让我们看看我们将在网站中使用的几个模板。转到[主引导站点](http://getbootstrap.com/)并点击顶部的开始。向下滚动基本模板，直到找到示例。

大屏幕看起来会满足我们对网站顶部的要求。

![VSC1 - 02 - jumbotron](../Images/7b58826a3acfcc1409f5828ef1764fd4.png)

它在顶部有一个大的灰色区域，我们可以用我们的图像替换它。灰色区域上方也有文字。三根柱子也在那里。太棒了。

现在我们需要为客户找到一些报价。查看模板示例，看起来 Carousel 会做我们想要的事情。

![VSC1 - 03 - carousel](../Images/2c76d7bed8073493c2645cea205fb7d5.png)

您可以在缩略图中看到它，但如果您单击它，它将显示完整的模板。向该模板的底部滚动。有几行文字比较大，非常适合引用。

![VSC1 - 04 - quotes template](../Images/7bd50b05225bf397d4742e2e78079fd9.png)
...
![VSC1 - 05 - adobe color cc](../Images/e6ae68fbdf7aedf83cf6191788d74866.png)

如果您将鼠标移到该方案上，将会出现提示。单击编辑。这使您可以查看配色方案的详细信息。单击较亮的黄色。这是我们将在大屏幕上使用的标题字体的颜色。

![VSC1 - 06 - adobe color scheme](../Images/d71ee652892790d28685e1a9b21c2bc0.png)
...
![VSC1 - 06.5 - new VSC project](../Images/3a27557434a0091f38b17c35228e1da2.png)

接下来，选择 ASP.NET 预览开始网站:

![VSC1 - 07 - preview starter web](../Images/56f0bf3c36b787ba8d6dcd01485d4c24.png)

如果您运行该项目，它应该会显示一个类似于以下内容的网页:

![VSC1 - 08 - base site](../Images/f801917c27aabc32cd44177748865566.png)
...
![VSC1 - 09 - wwwroot folder](../Images/5a9b57d26bbbbc7446084390ac795f7e.png)

wwwroot 文件夹背后的原因是为了进一步将动态代码与静态代码分开。C##(动态)代码文件仍然在控制器、模型和视图文件夹中，正如您所期望的那样。

下面我展开了`wwwroot`文件夹，以便更好地了解它的内部结构和里面的内容。

![VSC1 - 10 - wwwroot expanded](../Images/120b52f7453d6548b7849548cb70ccc7.png)

另一个变化是 DLL 和其他引用现在是如何分组的。我们有一个可以扩展的组，而不是大量的参考文献列表。

请注意，下面仅列出了 DNX 4.5.1 和 DNX 核心 5.0 的参考资料。

![VSC1 - 11 - wwwroot references](../Images/ef8f210e0ad861a1f3c783ec4509a843.png)

如果我展开 DNX 核心 5.0 参考，我会看到 Nuget 包和 dll 的列表。

![VSC1 - 12 - nugets and dlls](../Images/449780b29cd8481a5e4b648c3a4656c8.png)
...
![VSC1 - 13 - bootstrap index file](../Images/11708c099cec7e3272631fb3adca61e4.png)

复制两个 div 并粘贴到`Index.cshtml`文件中。现在运行应用程序。您应该看到以下内容:

![VSC1 - 14 - basic bootstrap page](../Images/2550736b24d5d7d28a18547ef1df06a9.png)
...
![VSC1 - 15 - meaningful headers](../Images/87533a70b55838d91c0fd0d93cddd395.png)
...
```
.jumbotron {
    background-image: url('../images/musician-349790_1920.jpg');
...
![VSC1 - 16 - basic guitar page](../Images/3be9461b51dd06f2eb9779fac233e4a4.png)

如你所见，我们越来越接近了。大屏幕应该一直延伸到边缘。这让我们的整体设计更有深度。为此，在`Index.cshtml`中，移除包围`@Renderbody()`的`container body-content`格。

![VSC1 - 17 - editing the jumbotron](../Images/8ac3d500af2a3b7875a58417624458cc.png)

现在，您的代码应该如下所示:

![VSC1 - 18 - edited jumbotron](../Images/985f7a07e3cc0ebd5b4af636fc2587da.png)
...
![VSC1 - 19 - adding featurettes](../Images/0034a94966e180e82bdcf8f88da1a930.png)
...
![VSC1 - 20 - finalized version](../Images/13494b28c5f0f94c0229b7af957c655a.png)
