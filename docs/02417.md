...
> 原文:[https://www . site point . com/es6-template-literals-techniques-and-tools/](https://www.sitepoint.com/es6-template-literals-techniques-and-tools/)
...
![Example code - 1](../Images/1401b500eb8b6bb29db5f49da46b3e8a.png)

## 模板功能

在这个阶段，模板文字开始变得有趣起来。您可以创建一个复杂的模板文字来减少将这些内容嵌入到字符串中的时间。然而，当与产生相同输出的函数结合时，模板文字开始发挥作用。

![Example code - 2](../Images/802a63f7f727a2ba441b3a1ae75f8973.png)
...
![List of links](../Images/4fb4ad1bdd14d4d0c22e7e43c84ef76c.png)

表格可以用类似的方式构建:

![Example code - 3](../Images/bfc40fab6be61149d2194e48b4154bfa.png)
