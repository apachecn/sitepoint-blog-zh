...
![Welcome to Your Vue.js App](../Images/44fcd1a6ef5a425682d91cce9a8a0b2b.png)
...
![Project anatomy](../Images/8f704ef826a1b17f6f009a6f7050f297.png)
...
![Vue Project Manager](../Images/c0d8cde9d36342f948336d75ed4db37b.png)

从*创建*选项卡创建一个新项目。浏览您想要创建项目的位置，然后点击 *+在此创建新项目*按钮。

![Create a new project here](../Images/343626129edbdeb6a84b51638ed23595.png)

您将被带到一个新的界面，在这里您需要输入关于您的项目的不同细节，比如名称、项目的位置、包管理器以及您是否想要初始化 Git 存储库。

![Create a new project](../Images/40a05cec808e686c66b196afe31cd27c.png)
...
![Select a preset](../Images/0123e46500f9b2c079efc00cac9e010b.png)
...
![Project dashboard](../Images/31767377b7b2759fa445b653703c2ede.png)
...
![Project tasks](../Images/b1242f18fe427ee72e21a982bd3c49c9.png)

接下来，点击*服务*按钮，然后点击*运行任务*按钮为您的项目服务。

![Run task](../Images/af0607c2987b43b8e69af21c385814bd.png)

您可以使用*停止任务*按钮停止服务项目。您还可以从这个界面打开应用程序，并查看关于项目的信息，例如资产的大小、模块和依赖项、速度统计等等。

![App statistics](../Images/7e6e98e004c564ef01c22a5d61ee2d23.png)
