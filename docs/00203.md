...
> 原文:[https://www.sitepoint.com/django-send-email/](https://www.sitepoint.com/django-send-email/)
...
![Django local server](../Images/9ad204d2b67a4588951cf4f527b5b58f.png)
...
4.  现在您已经启用了双因素身份验证，是时候获取应用程序密码了。你可以通过进入谷歌账户的[安全区](https://myaccount.google.com/security)，向下滚动到登录谷歌区，点击**应用密码**来完成。
    ![App password](../Images/5d49a6e4c1ea61c046ba15da191ec797.png)

在被重定向到应用程序密码页面之前，您需要重新提示您的密码(帐户密码)。

一旦你进入，点击**选择应用**，在这里你将为应用密码选择一个自定义名称——比如“Django 发送电子邮件”——然后点击**生成**。

![App password generation](../Images/ddef1e333963425dafbf6c6c991de6d2.png)

将出现一个新窗口，并提供 16 个字符的密码。复制它，因为我们需要它来配置我们的 Django 项目。

![Generated app password](../Images/5640d99d769d548102463c8c393e2cf6.png)
...
![Django sent email](../Images/b62a43b662e68a4baf85065a04a558c6.png)
...
![Contact Form](../Images/5c6aa46a7a593395eb1c5cafcac4415a.png)

这是成功信息的图像。

![Success message](../Images/9f44269a8bf0d765ba15893643b994c3.png)

这是收件箱里邮件的图片。

![Inbox](../Images/46c7e9a4f3db1b777e7e58cc6d48100d.png)
