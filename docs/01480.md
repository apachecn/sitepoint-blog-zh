...
> 原文:[https://www . site point . com/ultimate-guide-deploying-PHP-apps-cloud/](https://www.sitepoint.com/ultimate-guide-deploying-php-apps-cloud/)
...
![PHP-Heroku Architecture](../Images/78e24679cd08b26bb7cd894448256a06.png)
*PHP Heroku 架构*
...
![Landing page](../Images/4d62c54d22d6d031598c1bb293c471cf.png)
*登陆页面*

![Logged In User](../Images/b7cfee75c5fa9128ccdd1c3bf120b3f1.png)
*登录用户*
...
![Create a new app](../Images/f0dd02a1e0bcc90e654868c9e1e1c789.png)
*从仪表盘创建新应用*

给它起一个像这样的名字:

![Give the app a name](../Images/817ee1653fca7e5e2314d066f8a2a696.png)
*给 app 起个名字*

选择部署方法。在我们的例子中，我们将像这样使用 GitHub:

![Connect to GitHub](../Images/a4d39ec120096af6e3b230f49c976ebe.png)
*连接 GitHub*
...
![Search for repo](../Images/6895ea69eeef7b2580aab76d5c193c8d.png)
*寻找回购*

像这样点击`connect`

![Click on connect](../Images/f7d81298bbec81101b67ef2a7cca7864.png)
*点击连接按钮*

Heroku 会像这样连接回购协议

![Connected repo](../Images/f58a94ab936018dbe9a1da2a9d3c40b2.png)
*连通工程*
...
![Option to enable deploy](../Images/1a9b7da0a143c03350c81860f58b2ed3.png)
...
![Build Succeeded](../Images/26dcf1b48670a4a67d9d9895e07063ee.png)
*打造成功*

![New version of app](../Images/fe207bad5b0bda87b52f9ada2c233783.png)
*新版本*
...
![Installing Google SDK](../Images/aec05bb21e40749fd749f169ac793328.png)
*安装谷歌 SDK*

![Running gcloud](../Images/9d652df91541b8aeebebe96c26978599.png)
*运行 gcloud*
...
![Live App](../Images/fd1ee43ae947fb0b00a1804ceb9b939d.png)
*直播 App*
...
![BlueMix Signup](../Images/a803cb2c62b61d329131de28b06ee0d0.png)
*注册 Bluemix*
...
![Dashboard](../Images/d03520d794639712442f99533029b329.png)
...
![Authenticating via the terminal](../Images/94e87fba0b7439eea9aa5749a3128600.png)
*登录 Bluemix*
...
![Starting Deploy](../Images/76c87ce9156314fa8913b5dc7707b79e.png)
*开始部署*

![Ending Deploy](../Images/dc0660f965a7ddbc2a0cf77a7e277a35.png)
*结局部署*
...
*   打开 Bluemix [仪表盘](https://console.ng.bluemix.net/dashboard/apps/)。
    ...
    ![Dashboard - App running](../Images/96ccf32f7084f41ad4112e3afa4f897c.png)

*   点击应用程序。您将被重定向到另一个页面，其中包含有关该应用程序的更多详细信息。

*   从左侧面板中选择**运行时间**。

    ![Click on Runtime](../Images/869c1cab190a4aa6062adb7d0092d9d1.png)

*   现在，点击**环境变量**

    ![Select Environment Variables](../Images/d8139fe3cf6edbf988f5671ef0688138.png)

*   向下滚动并点击**添加**按钮，添加环境变量，如下所示

    ![Add environment variables](../Images/bcc19e190a179ef07b61ad4a546ea121.png)
...
1.  首先，用微软 Azure 创建一个[账户。](https://portal.azure.com)
    ...
    ![Dashboard](../Images/f3685a2ed47cbc4a342b34efef29714b.png)
    *仪表盘*
...
4.  点击 **Web + SQL** ，然后继续创建。
    ...
    ![Web + SQL](../Images/9a7c2bbee8f210871e08a1336b2f2d62.png)

5.  系统会提示您选择您喜欢的套餐类型。我选择了*免费试用*。这样，你将获得 200 美元的 Azure 点数。

6.  给你的应用命名，然后创建一个 SQL 数据库。嗯，我们的应用程序不需要它，但出于某种原因，Azure 强迫你创建它。

    ![Create a new app](../Images/8c31390fa3bde015a1c17ab598748a50.png)
    *创建新 app*

7.  现在我们的应用程序已经创建完毕，点击左侧面板的**应用程序服务**即可查看您的应用程序。

    ![App services](../Images/8282e4d8df8b01e0e02431cca1f9d6f5.png)
    *新 app*
...
9.  授权访问您的回购，选择项目和分支。在我的例子中，我有一个`azure`分支。这是我将代码部署到 Azure 平台的分支。
    ...
    ![Configuration in your app](../Images/ee13959750204023dc466ec7dfc4fc56.png)

10.  查看部署通知。

    ![Deployment Notifications](../Images/31fa83d9d3c729970dc00115a8c0897e.png)
...
1.  默认情况下，azure 部署不会对我们的`composer.json`或`composer.lock`文件做任何事情。因此，没有软件包被安装。现在回到**应用服务**，点击你的应用，然后进入**开发工具**，选择**扩展**。选择`Composer`扩展并同意法律条件。
    ...
    ![Add extension](../Images/7a62ef94e0d07d9eb32e8c7c4045491a.png)

2.  现在，对你的应用程序做一点修改，然后再次推送到 GitHub。您应该看到它像这样展开:

    ![Make a change](../Images/614ec3b816f67ef8e310651e4cc88700.png)

    ![Deployment details](../Images/ceb695c5d6710cbcfc40f5868dfaec67.png)

3.  现在，请再次查看您的应用。应该是[直播](http://starwarzapp.azurewebsites.net)和工作！

    ![Landing Page](../Images/080cec6e3a4389ff527f32105f5b6a51.png)
...
4.  连接到数据库。
    ...
    ![The connection info](../Images/5d665230627205a9820defcb2ccb312b.png)
...
*   创建新应用程序。
    ![Create new app](../Images/42a092771f604b686ca87ae8a15b6572.png)
*   点击`create web server`。
    ![Create web server](../Images/5417dc7d20e93e0155ebcf7fbf5f0ae3.png)
*   创建 web 服务器环境。
    ![Environment type](../Images/76428e5fe25315369f8bfd47e3710432.png)
*   上传您的代码。Elastic Beanstalk 要求您上传代码库的 zip 文件。你可以手动拉上拉链，但我更喜欢在我的终端上这样做:`zip ../starwarsapp.zip -r * .[^.]*`
*   现在，像这样上传到 AWS:
    ![Upload code to AWS](../Images/56a009c308cab3e65f83e8bfc0721df3.png)
*   检查应用程序 URL 的可用性。我的长这样:
    ![URL](../Images/3df4d707d83100b482643529fb281944.png)
*   下一页允许我们配置一个数据库实例。我们的应用程序不需要，所以我们可以跳过这个。
    ![Skip setting up DB Instance](../Images/b6073077a586e41f644457fa550532ad.png)
*   这一步允许我们修改我们的配置细节。默认的对我们的应用来说是可以的。
    ![Configuration details](../Images/8c64a836328b3aacc742eb65c45b3480.png)
*   现在，像这样添加你的环境变量:
    ![Environment Variables](../Images/cf517bb5d6eac312d5a87e2e8c00bfbd.png)
...
*   像这样添加权限:
    ![Permission](../Images/79b092146a443818d76b5d615abe87ba.png)
*   启动前请查看信息。
    ![Review](../Images/0b33d2d909fd8d2d1876687b5e507559.png)
*   发射。

![Deployed](../Images/10e7a334140fdd3ca75b15627d30efbb.png)

![Live app](../Images/47714b41164b90e8d2c6ffcedbc932d7.png)
*直播 app*
...
![Laravel Forge](../Images/7a86d9b041deb59f2027c4fa6fd81f5f.png)
*拉勒韦尔锻造*
