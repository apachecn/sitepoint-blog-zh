...
> 原文：<https://www.sitepoint.com/a-guide-to-positive-reinforcement-in-ux-design/>
...
![A submitted form that reads “Sending…” in place of “Submit”](img/3bfa5d85bcae6473a5db04a141ddd2cf.png)

请求完成后，我们会看到一条确认我们提交的消息。这个例子展示了正向强化是如何消除用户悬在空中的感觉的。

![A green thankyou message indicates success](img/de1c0a2d6a02a1e48cf594897d71afe7.png)
...
![Intercom sign-up process showing how close the process is to completion with a progress bar](img/9f68f0c44fdedc08f07d25dd398b7082.png)
