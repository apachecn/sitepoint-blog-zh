...
> 原文：<https://www.sitepoint.com/learn-design-character-using-illustrator/>

![The Michelin Man ](img/84e61240652ad8c36651672c15977c43.png)
...
![4 website screenshots with characters](img/19034ac5ee6acedf3774672e566e6ebe.png)
...
![The Final result: A one-eyed blue monster](img/7fa90df242edc18946a401da0c7a6311.png)

### 第一步:

![Create a new file ](img/7a17b4312be8cbe014376b49cb6bc8ce.png)
...
![Now pick the Rounded Rectangle Tool](img/2429a7dfee70da51c833e9e70a7f90b6.png)

### 第三步:

选择这个形状，点击相应层右边的环形目标，进入“效果”>“风格化”>“内部发光”。在此应用给定的设置。

![Apply style effects](img/44a03ebc03b240686365cd62835232f1.png)

### 第四步:

现在创建一个新图层，点击图层面板底部的“创建新图层”图标，选择钢笔工具(“P”)绘制两个尖尖的投影，如下图所示。你可以尝试各种类型的投影来制作一个独特的角色。

![Adding spikey appendages](img/b6e83061e7e7cea6329509265d18f51e.png)

接下来，我们将复制字符右侧的形状。为此，选择形状，并前往“对象”>“变换”>“反映”。现在选择垂直轴，按“复制”。将副本放在右侧。之后，选择两边的形状，并在路径查找器面板中按下“联合”形状模式(“Shift + Ctrl + F9”)。

![Copy this shape for the right side of character](img/dc74984bf3d418b84e315cedb3989c40.png)
...
![Use Direct Selection Tool ](img/dfc04b37fbc481c030353bf04d28431d.png)

### 第五步:

现在![Create a new layer ](img/04da81e086bf347bdc036590cddef787.png)在其余的形状下面，用钢笔工具(“P”)画几根头发尖状物。选择它们并应用给定的内部发光设置。
...
![character12](img/18ee604950eb6a25224d8bcfcdabb72d.png)

要使高光使用钢笔工具(“P”)绘制一条曲线路径，使填充为“无”，并选择白色笔划(1pt)。确保为笔画选择“宽度轮廓 1”。为对方反映亮点。

![character12b](img/a987655c097cdce3af96f5221cb01bc3.png)

### 第十三步:

选择#27A9E1 填充颜色，用黑色笔画(笔画粗细:1 磅)并用椭圆工具画一个小椭圆。选择椭圆并为内部发光应用给定的设置。

![character13](img/0a97758c56421865d82e6d89087fb9fe.png)

如下图再画两个椭圆。

![character13b](img/fb0f3dfb7957e85d1cbd80bf7465184a.png)

### 第十四步:

接下来，选择蓝色的椭圆，进入“扭曲和变形”>“折叠和膨胀”，在这里应用给定的设置。然后，进入“扭曲和变形”>“粗糙化”，使用下面的设置。

![character14](img/eb2dcfab46e52dd549f21aac71291cd5.png)

### 第十五步:

现在我们来举例说明它的嘴。选择#564D49 填充颜色和#404041 颜色的笔画，并绘制如下所示的两个椭圆。选择它们，并点击“负前”在探路者面板。之后，选择嘴，并应用内部发光给定值。

![character15](img/d4589b3638bc7a2c6b913d23acadb0bf.png)

选择嘴的形状，并将其偏移 4px。之后，改变其填充颜色为#2E8DCC，使中风为“无”，并适用于 8x 高斯模糊效果。

![character15b](img/a0c8e84072757deb7b509cccba1b5813.png)

### 第十六步:

接下来，使用钢笔工具(“P”)用#404041 笔画(1 磅)画一条曲线。之后，画出舌头和牙齿，并在上面应用给定的内部发光设置。如果你喜欢，你可以试试更尖的或矩形的牙齿。

![character16](img/cf1d9735fe72e9146abc03089691c970.png)

对于阴影，使用#58585B 填充颜色画一个小椭圆，并制作它的反射副本。选择两个椭圆，应用 16px 高斯模糊效果。

![character16b](img/c1941b5f2bb956e63828adcd6bdaef85.png)

### 第十七步:

现在在眼睛和舌头上创建高光，在身体上创建阴影，使用和步骤 16 中解释的相同的技术。然而，使用“覆盖”混合模式的阴影形状超过身体 40-60%的不透明度。

![character17](img/019cbb6a09d1d246ca632b157f08d2a3.png)

### 第十八步:

接下来，制作两条曲线，如下图所示，应用 5px 高斯模糊效果。

![character18](img/73f05ed6c70dd298f1e0853751a34d4e.png)

### 第十九步:

复制步骤 18 中形成的曲线，并把它们放在眼球下面。

![character19](img/45f867f68eea56a8bade50048144721b.png)

### 第二十步:

接下来，画一个形状大致低于其余的层，使黑色填充颜色的阴影，并应用 14px 高斯模糊效果。

![character20](img/d45397bff5795f9e696edaac557f9fab.png)
