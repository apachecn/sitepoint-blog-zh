...
> 原文:[https://www.sitepoint.com/prototype-with-flash-catalyst/](https://www.sitepoint.com/prototype-with-flash-catalyst/)
...
![Adobe Illustrator mockup](../Images/a107d0a74ae7fcb99d106c2e2789088d.png)
...
![Flash Catalyst Interface](../Images/0206b2dd70c09283db17d5609d25d508.png)
...
2.  这是*画板*，是您导入的作品出现的地方。您可以四处拖放图稿，并使用有限的 Illustrator 样式工具来操作它，以及创建新的图稿，包括简单的线条、形状和文本。
    ...
    **图 3。平视显示器**
    ...
    ![The HUD](../Images/d3134f8e6addf93c8839334592674b95.png)
...
![Design workspace](../Images/1455b93794e7a88370e148e082bb8d86.png)

点击它，切换到[图 5【代码工作区】](#fig_code_view "Figure 5. Code workspace")所示的代码工作区。

**图 5。代码工作区**

![Code workspace](../Images/64a514454a76eed257463bf2ac8afcb2.png)
...
![Button state editing](../Images/138f04962e1fc6c1297b9e7197c8b274.png)
...
![Data List HUD](../Images/a4861957971f0444efb2483768aeab12.png)
...
![Add fictional names to the list](../Images/c73e3c0159d254fd36dd53c3b7a6a531.png)
...
![State transitions](../Images/cd43b369dc8d13918943b5747f3806a5.png)
...
![Resize handle](../Images/32d44f7baf317fbd705f4db3743b2b7a.png)

点击调整大小手柄，向右拖动滚动条，直到工具提示显示持续时间 2.0s ，它将看起来像[图 11，“增加持续时间”](#fig_duration "Figure 11. Increasing the duration")。

**图 11。增加持续时间**

![Increasing the duration](../Images/0a973fa0bdd946c59de9b057a525296a.png)
...
![Setting interaction rules](../Images/531d3773543253977c498849311b4a8b.png)
