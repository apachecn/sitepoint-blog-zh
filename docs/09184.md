...
> 原文:[https://www.sitepoint.com/10-jquery-ui-plugins/](https://www.sitepoint.com/10-jquery-ui-plugins/)
...
简单方便地创建交互式“特色项目”小部件。
![Feature-List.jpg](../Images/549b57ac93f0f8861ae92da6257cc1a0.png)

## 2.舞池

当你点击一个产品时，产品图片会缩小以看到特写镜头和描述。
![Dance-Floor.jpg](../Images/271897b1ccec7c991738910d3b27aa7d.png)

## 3.搜索和共享

使突出显示文本成为一种功能性更强的操作。更具体地说，它试图理解用户文本选择的意图，并相应地呈现各种选项。
![Search-Share.jpg](../Images/b7d58d7d080b0df274f6dc005470b1be.png)
[来源](http://www.latentmotion.com/search-and-share/)

## 4.侧面导航工具提示/弹出气泡

使用 jQuery 的工具提示/弹出气泡。
![Side-Navigation-Tooltip-Popup-Bubble.jpg](../Images/0b0b6f1bef887737cda89fbebcce020a.png)

## 5.脸书风格警报确认框

这向你展示了如何实现一个脸书风格的警告框。
![Facebook-Style-Alert-Confirm-Box.jpg](../Images/526ee9733180ae0c5b653dfd58e2fd2e.png)
[来源](http://www.9lessons.info/2009/08/facebook-style-alert-confirm-box-with.html)

## 6.创建一个交互式、可过滤的投资组合

如何在 jQuery 中创建一个看起来像是用 Flash 制作的交互式文件夹。
![Create-an-Interactive-Filterable-Portfolio.jpg](../Images/dcbfbfc3952b55c2af6259929b4ab4b9.png)
...
![Facebook-like-Autosuggestion.jpg](../Images/f1bf232fc98461f274cbea19e189add9.png)
[来源](http://www.9lessons.info/2009/06/autosuggestion-with-jquery-ajax-and-php.html)

## 8.喜爱的评级

本教程将向你展示如何像 amypink.com 一样实施一个“表达爱意”的评级系统。
![Favorite-Rating.jpg](../Images/4543c66456474cfcf395b4320a0e8c2c.png)
...
![Magic-Scroller.jpg](../Images/18c2cb9400a411676801e83b5c423b5b.png)
[来源](http://plugins.jquery.com/project/magicScroller)

## 10.Google Wave 历史滑块

使用谷歌波浪式历史滑动条，让访问者能够及时返回查看评论线程上发生的变化。
![Google-Wave-History-Slider.jpg](../Images/2b2e53e273c7eed30b2e587c0d32f74f.png)
