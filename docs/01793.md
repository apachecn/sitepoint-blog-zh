...
> 原文:[https://www . site point . com/Android-app-accessibility-check list/](https://www.sitepoint.com/android-app-accessibility-checklist/)
...
**不易接近**
![Touchable control sizes -Incorrect](../Images/d39a9f2bd01df0b6182fbd5074caa089.png)

**更易接近**
![Touchable control sizes -Correct](../Images/3ce838b0bfac26847fd087946991d42d.png)
...
**不易接近**
![Text Field Hints -Incorrect](../Images/277bd71caa21cee0fcf8d6988f8bcd47.png)

**更易接近**
![Text Field Hints - Correct](../Images/6798fc5b8c6a02f2094fcf060b19c39f.png)
...
![Calendar Control](../Images/078eeed65eb3d93a698082f2df9be7ca.png)
...
![DatePicker control to add Date of Birth](../Images/47a81d834cfc2fdcb624a99c5e7848a2.png)
...
![Decorative images and graphics](../Images/0d772625d3b8df7471dfc2e32a861d7a.png)
...
![Function- Speak](../Images/126db03d8f22f9540c24f59f8d116c62.png)

```
android:contentDescription="Speak" 
```

![Function- Pause](../Images/50a82bbb119795715b525b3ecff7758e.png)
...
![App title -correct](../Images/bb03e3a8852f1777f254ed089358d134.png)

如果你不更改应用标题，Android 会自动显示应用名称。

![App title -incorrect](../Images/3c03114af2706a334513ed21bdec2fb8.png)
...
**不易接近**
![No Spacing -incorrect](../Images/2dfebcea8e23c990a82c9b6b3b988baf.png)
...
![Check Contrast Ratio](../Images/5dcded049791972294f0cbfe822c858f.png)
...
![Correct Contrast Ratio for app](../Images/a6ff03e031d6376dc5007bb89556c211.png)

在下图中，我们添加了和上面一样的前景色和背景色。

![Correct Contrast Ratio added to app for text “Vote Now!”](../Images/81d9d036ac5bc34ae6f9d37fbafa12b8.png)
