...
> 原文:[https://www.sitepoint.com/longdesc2/](https://www.sitepoint.com/longdesc2/)
...
如果你想知道， [D-link](http://webaim.org/techniques/images/longdesc#d) 是一种老派的方法，其中“D”代表描述。这与标准文本链接的技术基本相同，但链接文本只有字符“D”，而不是更详细的文本链接，如示例中的“查看该图表的详细描述”这也可以使用[链接的 1 像素透明图像](https://www.w3.org/TR/WCAG10-HTML-TECHS/#img-dlink-invis)和属性为“D”或“描述”的`alt`来完成。不再推荐使用 D-link 方法。
...
![Chart with text link to long description.](../Images/e04263ba51411967714eda4e20f31619.png)
...
![Chart with focused link.](../Images/42ee50e7bd9dc5979cf99924266bc089.png)

![Long description of chart displayed in place of chart; close link at end.](../Images/cea1311adc0c97accb6091fae0a0b953.png)
...
![Example of chart created with CSS.](../Images/ebc2d516cb3d55ce66f51576f3f48797.png)
...
![Example of chart created with jQuery Visualize.](../Images/659ff77a9ec874f0cb8d4231b44b0783.png)
