...
> 原文:[https://www.sitepoint.com/intro-business-catalyst/](https://www.sitepoint.com/intro-business-catalyst/)
...
**图 1。**商业催化剂仪表盘![The Business Catalyst Dashboard](../Images/47d738041911d24fdc9d001d0274df89.png "figure1")
...
![The interface design](../Images/0231d43d12c2d8cd5e5cd71aa4f3d8ac.png "figure2")

我是计划的忠实粉丝；俗话说:“量两次，切一次。”正如您在图 3“理解模板和页面”中看到的，我已经确定了模板中的图像和文本区域，并且设计了一个简单的导航方案。我将从设计一个模板和一个页面开始。

**图 3。了解模板和页面**

![Understanding the Template and the Page](../Images/086f2d77c9f061b9e2e78d308c976ba5.png "figure3")
