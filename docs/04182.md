...
> 原文:[https://www . site point . com/build-node-js-powered-chat room-we B- app-debugging-remote/](https://www.sitepoint.com/build-node-js-powered-chatroom-web-app-debugging-remotely/)
...
1.  设置好 Azure 帐户后，返回 IDE，右键单击项目，然后单击发布。
    ...
    ![Publishing Via Azure](../Images/d009dcd759c4a9e0ce26bef82fc2d785.png)
...
4.  单击*新建*创建一个新的 Azure 网站，或者，如果您已经创建了一个网站，您可以从下拉列表中选择它。
    ...
    ![Publishing New Azure Website](../Images/8dd6bec58fc1ad09c832cb9ba502107c.png)

5.  您需要完成向导中的字段(如下所示)。确保选择一个唯一的站点名称，然后点击*创建*。

    ![Completing the Wizard](../Images/1be029c14e79734872c56ff48e2b11e3.png)

6.  您将看到一个预填充的向导。点击*发布*。

    ![Publishing Final Step](../Images/00e5461054f607c1c5911ab26a09ccca.png)
...
![Enabling Web Sockets](../Images/2ed9d465f62f05917db36610381c0af0.png)
...
2.  选择左侧的设置选项卡，并确保从下拉菜单中选择*调试*配置。
    ...
    ![Publishing to the Web in Debug Mode](../Images/c661a5c59083f59a8a962c5168b6d29c.png)
...
![Attach Node.js Debugger](../Images/bc4dca29fc64229cf3434433fefae9f2.png)

## 读取日志和流式日志

如果你想流最新的日志，这是相当容易的！你所要做的就是在服务器浏览器中右击你的网站，然后选择*查看流日志*。

![Streaming Logs](../Images/782e80ab004f5a36aeaad6dcd3cf2f9e.png)

## 结论

瞧啊。你有它！你现在在云中有一个匿名的实时聊天室！在整个系列中，我们学习了如何设置 Node.js，如何使用 Express 开发 web 前端，如何将我们的应用程序部署到云，如何使用 Socket。IO 加一个实时层，然后怎么一起部署！

![barney](../Images/e9fe26332c0502d9a756ab986475736b.png)
