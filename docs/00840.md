...
> 原文:[https://www . site point . com/以太坊-dapps-编译-部署-测试-tns-tokens/](https://www.sitepoint.com/ethereum-dapps-compiling-deploying-testing-tns-tokens/)
...
![Compiled contracts](../Images/30ae76e50dc38ea3223a0a432e62e5a1.png)
...
![Ganache UI](../Images/95ec75bdf99e20cf15407cde3256947d.png)
...
![A successful migration](../Images/a54b327fd35b5c835dc2bfeb17dd779a.png)
...
![Configuring the network in MEW](../Images/8ef80481c0b8e2da02daac954b9c2e92.png)

打开您在部署脚本中设置为`from`值的钱包。如果您使用的是 Ganache，您会在 Ganache UI 的屏幕上或终端的 Ganache 输出中看到它的私钥。

![The private key is accessible in the Ganache UI](../Images/381ed6a69bc4ef1ec70e1d30ce4933d7.png)

最后，需要告诉 MEW 这个令牌是存在的。我们通过添加自定义令牌来实现这一点。

![Adding a custom token in MEW](../Images/831d5e943b0f8754fdf0c2bdc814d26c.png)

添加令牌后，您会立即注意到该帐户现在有 1 亿英镑的余额，并且可以在货币下拉选择菜单中发送它们。让我们试着发送一些到另一个地址。

![Sending some tokens](../Images/89e36b3157bf4b7e5af87183347b71e3.png)

![Transaction is being prepared](../Images/fb3fdc1a7e2962c363276269eeb1f599.png)

![Tokens have been received](../Images/b66c6a965d2414031a2956390e8d2282.png)
...
![A failing migration](../Images/ec97ed465be7d21c66fff9d93758cd7a.png)

这是因为该地址没有乙醚用于部署合同。不过，这很容易解决。去 Rinkeby 水龙头那里要一些。它是免费的。

![Asking for Rinkeby test ether](../Images/cba17fb203a405256a520897bea1bb16.png)
...
![The token is now marked as trusted](../Images/b0c3beb20fc335b0ef8d28ad292973e7.png)
