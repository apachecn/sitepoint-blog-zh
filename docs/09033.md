...
> 原文:[https://www . site point . com/10-jquery-cool-menu-effect-plugins/](https://www.sitepoint.com/10-jquery-cool-menu-effect-plugins/)
...
非常容易使用，紧凑的插件，创建一个右键菜单。
 ...
 [![Right Click Menu](../Images/8d28b1c823f98d229e54d1f4b263902c.png)](http://rightclickmenu.freevar.com/) 
...
由 jQuery 提供视觉效果的 100% CSS 菜单。Javascript 仅用于效果。包括 IE6 在内的全面跨浏览器兼容性。效果:鼠标悬停和展开子菜单外观上的平滑淡入淡出动画。易于设置:简单的嵌套无序列表，用于无限级别的菜单项。
 ...
 [![jQuery Multi Level Menu - FX CSS Menu with Submenus](../Images/9b74505910c074b3e570ae39d655a598.png)](http://apycom.com/menus/11-yellow-green.html) 
...
另一个 jQuery 插件，帮助设计者不再需要编写代码来激活他们的菜单栏。这个插件以一种非常抽象的方式为设计者提供效果。
 ...
 [![jQuery Menu Effect Plugin](../Images/f09ed989fba90cb002e41f0f4003d8ea.png)](http://hungred.com/useful-information/jquery-menu-effect-plugin/) 
...
不仅仅是简单的淡入淡出效果。需要大量的 CSS 作品和正确的图像，但结果是真棒！
 ...
 [![Attractive jQuery Menu with Fade in and Fade out Effect](../Images/6e600073fa57cad2dfdbd831806fab6b.png)](http://www.queness.com/post/411/create-an-attractive-jquery-menu-with-fadein-and-fadeout-effect) 
...
有没有见过一些优秀的 jQuery 导航，让你想自己做一个？今天，我们的目标就是通过建立一个菜单，并用一些平滑的效果来制作动画。
 ...
 [![Make a Smooth Animated Menu with jQuery](../Images/e3b96cbd1632f3dfddff2cc76c44b936.png)](http://buildinternet.com/2009/01/how-to-make-a-smooth-animated-menu-with-jquery/) 
...
了解如何创建一个动画菜单(非常类似于龙互动菜单)。
 ...
 [![Animated Menus Using jQuery](../Images/6e2fb0415a918ab1aeb7bbb5437f1048.png)](http://www.shopdev.co.uk/blog/animated-menus-using-jquery/) 
...
创建一个简单的菜单，当我们将鼠标悬停在它上面时，除了菜单之外，用黑色覆盖物覆盖所有的东西。菜单将保持白色，子菜单区域将扩展。我们将使用 jQuery 来创建这种效果。
 ...
 [![Overlay Effect Menu with jQuery](../Images/c60d4a8e54393565d6760ef18485979d.png)](http://tympanus.net/codrops/2010/11/25/overlay-effect-menu/) 
...
在本教程中学习如何创建颜色渐变菜单。
 ...
 [![Color Fading Menu with jQuery](../Images/6c27cccdaa0cc283ebd84067481d5f24.png)](http://css-tricks.com/1357-color-fading-menu-with-jquery/) 
...
为一组图标链接添加上升悬停效果。使用 jQuery 的动画效果，我实验了带有反射和阴影的图标。
 ...
 [![Realistic Hover Effect With jQuery](../Images/1babb68908a162eae5f098ba72e84f08.png)](http://www.adrianpelletier.com/2009/05/31/create-a-realistic-hover-effect-with-jquery-ui/) 
...
滑动菜单在我们空间有限的地方非常有效。这是一个用 jQuery 构建的滑动顶部菜单，可以通过打开和关闭按钮或任何带有相关类名的标签来触发。
 ...
 [![Sliding Top Menu With jQuery](../Images/5f92fb3b4c352b4d8c22ae7e2827fbb7.png)](http://www.webresourcesdepot.com/sliding-top-menu-with-jquery/) 
